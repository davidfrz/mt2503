...
#define TDDNC_SUPPORT (defined(MT6260) || ((defined(MT6261) || defined(MT2501) || defined(MT2502))&& !defined(__DUAL_TALK_MODEM_SUPPORT__)))
...
#define __DSP_WAKEUP_EVENT__ (defined(MT6250) || defined(MT6260) || defined(MT6261) || defined(MT2501) || defined(MT2502))
   ...
   #define BGSND_ENABLE
#if defined(MT6261)   
   #define __CCCI_OVER_UART_SUPPORT__
#endif   
   //#define __SMART_PHONE_MODEM__
#endif   
/*
