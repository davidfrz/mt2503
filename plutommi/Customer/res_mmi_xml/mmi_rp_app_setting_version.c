...
* DESCRIPTION
*  Automatically generated populate function for mmi_rp_app_setting_version_populate
* PARAMETERS
*  void
* RETURNS
*  void
*****************************************************************************/
void mmi_rp_app_setting_version_populate(void)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
...
/******************** Menu resource IDs - begin ********************/
    ADD_APPLICATION_MENUITEM5((
        ...
        IMG_ID_SETTING_VERSION_INFO));

/******************** Menu resource IDs - finish ********************/

/******************** Menu Hilite/Hint Handlers - begin ********************/
    ADD_APPLICATION_MENUITEM_HILITE_HANDLER(MENU_ID_SETTING_VERSION_INFO, HighlightVersionInfo);
