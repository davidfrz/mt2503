...
void l4c_ps_gprs_status_update_lind(l4c_gprs_status_enum status, kal_uint8 cell_support_egprs, kal_uint8 data_speed_support, kal_uint8 data_bearer_capability);    
...
void l4c_em_set_essp_lrsp(kal_bool result);
void l4c_em_get_essp_lrsp(kal_uint32 mode);
