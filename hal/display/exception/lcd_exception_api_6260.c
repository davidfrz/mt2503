...
extern kal_uint32 lcd_debug_dump_register[3][12];	// Add for debug
extern kal_bool needDump_Registers;
...
/* under construction !*/
	...
	lcd_debug_dump_register[2][0] =  (*(volatile kal_uint16 *)0xA0450000);
	lcd_debug_dump_register[2][1] =  (*(volatile kal_uint16 *)0xA0450004);
	lcd_debug_dump_register[2][2] =  (*(volatile kal_uint16 *)0xA0450008);
	lcd_debug_dump_register[2][3] =  (*(volatile kal_uint16 *)0xA045000C);
	lcd_debug_dump_register[2][4] =  (*(volatile kal_uint16 *)0xA0450010);
	lcd_debug_dump_register[2][5] =  (*(volatile kal_uint16 *)0xA0450080);
	lcd_debug_dump_register[2][6] =  (*(volatile kal_uint16 *)0xA0450084);
	lcd_debug_dump_register[2][7] =  (*(volatile kal_uint16 *)0xA0450090);
	lcd_debug_dump_register[2][8] =  (*(volatile kal_uint16 *)0xA04501F0);
	lcd_debug_dump_register[2][9] =  (*(volatile kal_uint16 *)0xA04501F4);
	lcd_debug_dump_register[2][10] =  (*(volatile kal_uint16 *)0xA04501FC);
	lcd_debug_dump_register[2][11] =  (*(volatile kal_uint16 *)0xA0450250);
	// register dump end

	needDump_Registers = KAL_FALSE;	// Disable loging in the next blt, save the correct information
    REG_LCD_START = 1;  // Reset LCD controller.
    REG_LCD_START = 0;
    REG_LCD_INT_ENABLE = 0;
    REG_LCD_TECON = 0;
