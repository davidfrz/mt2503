 ...
 * $Log: $
 *
 * 04 11 2014 yufei.shen
 * [MAUI_03491565] [BT Dialer 3.0 IT]A2DP reconfig failed
 * .
 *
 * 04 11 2014 yufei.shen
 * [MAUI_03491565] [BT Dialer 3.0 IT]A2DP reconfig failed
...
//for local app, when connect the sink role, need stop and close to idle
<EVENT id="EVT_ID_SRV_A2DP_CONNECT"   type="SENDER"/>
//it is for bt music to update the UI, not used in BTD3.0
<EVENT id="EVT_ID_SRV_A2DP_SINK_CONNECT"   type="SENDER"/>
//for local app, when connect the source role, need to play by a2dp
<EVENT id="EVT_ID_SRV_A2DP_OPEN"   type="SENDER"/>
