...
typedef struct _fixed_icontext_list_menuitem_type
{
	...
	U32 item_icon_flags[FIXED_ICONTEXT_LIST_MAX_ICON_COLUMNS]; 
	U32 item_icon_len[FIXED_ICONTEXT_LIST_MAX_ICON_COLUMNS];
...
typedef struct _fixed_icontext_list_menuitem
{
	...
	void (*resize_icon_text_coordinates)(S32 icon_index, S32 icon_width, S32 icon_height);
...
#if  defined( __MMI_MAINLCD_128X128__)&& defined(__MMI_WEARABLE_DEVICE__)
#define __128X128_WEARABLE_DEVICE_UI__
#endif
...
extern void gui_show_fixed_list_menu_special_info(fixed_list_menu *m);
extern void wgui_fixed_list_set_clip(S32 x1, S32 y1, S32 x2, S32 y2);
extern void wgui_fixed_list_set_text_clip(S32 x1, S32 y1, S32 x2, S32 y2);

extern void gui_list_key_ssp_back_show_item(S32 direction,U8 flag_key_down);

extern void fixed_list_goto_previous_item_up(void);
extern void fixed_list_goto_next_item_up(void);

extern S32 gui_first_display_item_y;
extern S32 gui_last_display_item_y;



extern U8 flag_ssp_key_change_list;
#endif
