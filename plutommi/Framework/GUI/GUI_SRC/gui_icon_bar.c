...
static void gui_icon_bar_set_key_handler(void)
{
    ...
    SetKeyUpHandler(gui_icon_bar_prev_arrow_key_up_handler, prev_key_code);
    SetKeyDownHandler(gui_icon_bar_prev_arrow_key_down_handler, prev_key_code);
    SetKeyUpHandler(gui_icon_bar_next_arrow_key_up_handler, next_key_code);
    SetKeyDownHandler(gui_icon_bar_next_arrow_key_down_handler, next_key_code);
    SetKeyDownHandler(gui_icon_bar_ok_key_up_handler, KEY_ENTER);
}
