...
* $Log$
 *
 * 06 10 2014 deepak.singhrawat
 * [MAUI_03503892] [BT Music] Fatal Error (0x823, 0x80) - MMI
 * .
 *
 * 05 29 2014 deepak.singhrawat
 * [MAUI_03502371] the alert type should be Ring only, Vib only, Ring&Vib, Mute
 * .
 *
 * 05 20 2014 deepak.singhrawat
 * [MAUI_03491177] [Wearable Device] Checkin for wearable device sound and volume setting
 * .
 *
...
#endif /* #if defined(__MMI_FM_RADIO__) && defined(__MMI_FM_RADIO_BIND_EARPHONE__) */
