...
{
    if(strcmp(func_name,"vm_bitstream_record_open") == 0)
        return (VMINT)vm_bitstream_record_open;  
    if(strcmp(func_name, "vm_bitstream_record_close") == 0)
        return (VMINT)vm_bitstream_record_close;
    if(strcmp(func_name,"vm_bitstream_record_start") == 0)
        return (VMINT)vm_bitstream_record_start;  
    if(strcmp(func_name, "vm_bitstream_record_stop") == 0)
        return (VMINT)vm_bitstream_record_stop;
    if(strcmp(func_name,"vm_bitstream_record_get") == 0)
        return (VMINT)vm_bitstream_record_get;  
    if(strcmp(func_name, "vm_bitstream_record_set") == 0)
        return (VMINT)vm_bitstream_record_set;
	return 0;
}
