    ...
    const mmi_frm_proc_id_info_struct id_info)
{
    ...
    MMI_TRACE(MMI_BOOTUP_TRC_GROUP, TRC_FRM_BOOTUP_FLOW_INIT_SIM_MODULE);
...
static mmi_frm_proc_result_enum mmi_bootup_decide_mode_multiple_sim(void)
{
    ...
    {
#endif
        MMI_TRACE(MMI_COMMON_TRC_G3_BOOTUP, TRC_FRM_BOOTUP_STATIC_OR_DYNAMIC, 'S');
    ...
    {
        MMI_TRACE(MMI_COMMON_TRC_G3_BOOTUP, TRC_FRM_BOOTUP_STATIC_OR_DYNAMIC, 'D');
    ...
    const mmi_frm_proc_id_info_struct id_info)
{
    ...
    MMI_TRACE(MMI_BOOTUP_TRC_GROUP, TRC_FRM_BOOTUP_BOOT_PROTOCOL, g_mmi_bootup_mode_cntx.mode);
...
static void mmi_bootup_on_protocol_ready(void *user_data)
{
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
    MMI_TRACE(MMI_BOOTUP_TRC_GROUP, TRC_FRM_BOOTUP_PROTOCOL_READY);
