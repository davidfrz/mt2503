...
#ifndef __MBA_CUST_ONLY__
extern CUSTPACK_IMAGE_HEADER mtk_image_header;
extern CUSTPACK_AUDIO_HEADER mtk_audio_header;
...
#endif
 const CUSTPACK_THEME_HEADER *p_mtk_theme_header = NULL;
 const  mmi_res_theme_system_strcut* g_mmi_res_theme_system;
#endif
...
void InitializeResourceVariables(void)
{
    ...
    if (((kal_uint32) custpack2ndJumpTbl > 0x1) && ((kal_uint32) & CustPackResPreamble > 0x1))  /* dummy reference to make the variable exist */
    {
        ...
        /* CustPack Image Initialization */
    #ifndef __POPULATE_NO_IMAGE_DATA__
        pimage_header = &mtk_image_header;
        nCustImageNamesEXT = (CUSTOM_IMAGE*) pimage_header->CustImageNamesEXT;
        CurrMaxImageNumEXT = pimage_header->MaxImageNumEXT;
    #endif
    #endif/*#if !defined(__MMI_UI_DISPLAY_LEVEL_NONE__)*/
	...
	#ifndef EMPTY_MMI
        /* CustPack Autogen Audio Initialization */
        paudio_header = &mtk_audio_header;
        nCustAudioNamesEXT = (CUSTOM_AUDIO*) paudio_header->CustAudioNamesEXT;
        CurrMaxAudioNumEXT = paudio_header->MaxAudioNumEXT;
	#endif
    ...
    {
        /* CustPack Java Root CA Certs Initialized in init procedure */
        resource_java_root_ca = (custpack_java_root_ca_header_struct*) custpack_java_root_ca;
    }
#endif /* !__J2ME__ */
    ...
    if (((kal_uint32) custpack2ndJumpTbl > 0x1) && ((kal_uint32) & CustPackResPreamble > 0x1))
    {
    	p_mtk_theme_header=&mtk_theme_header;
    #ifdef __MMI_THEMES_V2_SUPPORT__
        MMI_themes = ptheme_header->mmi_themes;
    #else 
        MMI_themes = p_mtk_theme_header->mmi_themes;
    #endif 
        n_MMI_themes = p_mtk_theme_header->n_themes;
        mtk_n_MMI_themes = p_mtk_theme_header->n_themes;
        mmi_theme_phone_model = (char*)p_mtk_theme_header->theme_model;
    }

    /* Venus Theme */
    if (((kal_uint32) custpack2ndJumpTbl > 0x1) && ((kal_uint32) & CustPackResPreamble > 0x1))  /* dummy reference to make the variable exist */
    {
       g_mmi_res_theme_system=&g_mmi_res_theme_system_data;
        g_mmi_res_theme_system_data_ptr = (mmi_res_theme_system_strcut*)g_mmi_res_theme_system;
    }
#endif/*#if !defined(__MMI_UI_DISPLAY_LEVEL_NONE__)*/
#endif 
