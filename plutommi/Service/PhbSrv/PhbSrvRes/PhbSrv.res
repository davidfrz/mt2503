 ...
 * $Log$
 *
 * 03 30 2015 yanchao.yang
 * [MAUI_03534579] AsterV2 patch to 11CW1418SP4
 * .
 *
 * 02 12 2015 yanchao.yang
 * [MAUI_03530156] DUT system date change when come out of tiny mode
 * .
 *
 * 07 23 2014 yanchao.yang
 * [MAUI_03495002] [IOT] Contacts are displayed in reverse order in DUT
 * .
 *
 * 07 02 2014 mingliang.xu
 * [MAUI_03508598] [PBAPC] Call log app/srv split
 * .
 *
 * 06 04 2014 mingliang.xu
 * [MAUI_03501589] It shows junk characters in contacts view when selected to send SMS in mentioned scenario.
 * .
 *
 ...
 * .
 *
 * 03 07 2014 ting.wang
 * [MAUI_03484337] [IOT]baby monitor code check in
 * No need filter-out str/img resource in IoT project.
 *
 * 01 15 2014 ting.wang
 * [MAUI_03481156] [IOT] check in on 11C trrunk
 * Add slim modification for removing unnecessary resource.
 *
...
<APP id="SRV_PHB">
  ...
  <SENDER id="EVT_ID_GATT_UPDATE_TF" hfile="PhbSrvGprot.h"/>
	...
	<RECEIVER id="EVT_ID_PBAP_NOTIFY" proc="srv_phb_pbapc_disconn_hdlr"/>
	<RECEIVER id="EVT_ID_PBAP_NOTIFY" proc="srv_phb_pbapc_clog_disconn_hdlr"/>
#endif
