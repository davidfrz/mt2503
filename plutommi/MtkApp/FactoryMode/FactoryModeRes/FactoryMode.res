 ...
 * $Log$
 *
 * 12 18 2014 zhen.tian
 * [MAUI_03523754] [Wearable]check in factory mode test for wearable project
 * .
 *
 * 12 18 2014 zhen.tian
 * [MAUI_03523754] [Wearable]check in factory mode test for wearable project
...
<APP id="APP_FACTORYMODE">
...
#if defined(__MMI_WEARABLE_DEVICE_FACTORY_MODE__)
    <STRING id = "STR_ID_FM_BACKLIGHT"/>
  #ifdef __MMI_WEARABLE_DEVICE_FM_SENSOR_TEST__
    <STRING id = "STR_ID_FM_SENSOR"/>
    <STRING id = "STR_ID_FM_G_SENSOR_CALIBRATION"/>
  #endif /*__MMI_WEARABLE_DEVICE_FM_SENSOR_TEST__*/
    <STRING id = "STR_ID_FM_MIC_SPEAKER"/>
    <STRING id = "STR_ID_FM_TEST_MIC_SPEAKER"/>

#endif /*defined(__MMI_WEARABLE_DEVICE_FACTORY_MODE__)*/
    ...
    <MENUITEM id="MENU_ID_FM_WEARABLE_LCD" str="STR_ID_FM_LCD"/>
 
    <MENUITEM id = "MENU_ID_FM_BACKLIGHT" str = "STR_ID_FM_BACKLIGHT"/>  
	#ifdef  __MMI_FM_TOUCH_PANEL_ACCURACY_TEST__
	  <MENUITEM id = "MENU_ID_FM_WEARABLE_TOUCH_PANEL" str = "STR_ID_FM_TOUCH_PANEL"/> 
  #endif /*__MMI_FM_TOUCH_PANEL_ACCURACY_TEST__*/
  
    <MENUITEM id="MENU_ID_FM_MIC_SPEAKER" str="STR_ID_FM_MIC_SPEAKER"/>
    ...
    <MENUITEM id="MENU_ID_FM_ADC" str="STR_ID_FM_ADC"/>
	  ...
	  <MENUITEM id="MENU_ID_FM_G_SENSOR_CALIBRATION" str="STR_ID_FM_G_SENSOR_CALIBRATION"/>
    #endif /*__MMI_WEARABLE_DEVICE_FM_SENSOR_TEST__*/
	  <MENUITEM id="MENU_ID_FM_BT" str="STR_GLOBAL_BLUETOOTH"/>
	  <MENUITEM id="MENU_ID_FM_RESET" str="STR_GLOBAL_RESET"/>
