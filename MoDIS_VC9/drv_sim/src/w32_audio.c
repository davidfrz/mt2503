...
bt_a2dp_mp3_codec_cap_struct mp3_cap_snk[1];
bt_a2dp_aac_codec_cap_struct aac_cap[1];
bt_a2dp_aac_codec_cap_struct aac_cap_snk[1];
...
kal_uint32 BTIF_Get_BT_HW_Native_Clk(void){return 0;}
...
void Media_Set_A2DP_Stream_Start_Time(A2DP_Stream_Start_Param *p_param) {return;}
kal_uint32 Media_Get_A2DP_Reserved_Bytes(void) {return 0;}
kal_uint32 Media_Get_A2DP_Delay_Timing(A2DP_Stream_Device device) {return 0;}
kal_uint32 Media_Add_A2DP_Next_Device_Start_Time(kal_uint8 *p_in, kal_uint8 *p_out, kal_uint32 payload_len, kal_uint32 start_time) {return 0;}
kal_uint32 Media_Check_A2DP_Stream(kal_uint8 *p_payload, kal_uint32 payload_len) {return 0;}
kal_uint32 Media_A2DP_Get_Payload_Sample_Count(A2DP_Stream_Codec_Type codec_type, kal_uint8 *p_in, kal_uint32 payload_len) {return 0;}
kal_uint32 Media_A2DP_Get_Silence_Payload_Length(A2DP_Stream_Codec_Type codec_type, kal_uint32 silence_cnt) {return 0;}
kal_int32 Media_A2DP_Produce_Silence_Payload(A2DP_Stream_Codec_Type codec_type, kal_uint8 *p_out, kal_uint32 silence_cnt, kal_uint32 silence_len) {return 0;}
...
// VAD
Media_Status VAD_Enable(VAD_Callback handler) {return MEDIA_SUCCESS;}
Media_Status VAD_Disable(void) {return MEDIA_SUCCESS;}
Media_Status VAD_SetSensitivity(kal_uint8 threshold) {return MEDIA_SUCCESS;}
kal_bool VAD_IsEnable(void) {return KAL_TRUE;}
kal_uint8 VAD_GetSensitivity(void) {return 0;}
