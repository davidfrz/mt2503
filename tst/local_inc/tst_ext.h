...
#define TFTPP_EVENT_MOVE_OUT_DMP_FILE_OK 0x01

extern kal_eventgrpid tft_ppmode_event_group;
extern kal_bool tst_file_ppmode_reader_start_log2ROM;
...
#ifdef __TST_WRITE_TO_FILE_PINGPONG_MODE__
extern void tst_file_ppmode_log2ROM_start_API (void);  // let TFT start write log to file
extern int tst_file_ppmode_move_start_API (void); //let TFT change file state, call it before moving dmp file
extern int tst_file_ppmode_move_ok_API (void); //let TFT change file state, call it after moving dmp file done
#endif //__TST_WRITE_TO_FILE_PINGPONG_MODE__
