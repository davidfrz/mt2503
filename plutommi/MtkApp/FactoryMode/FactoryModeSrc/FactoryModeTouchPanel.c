...
static void mmi_fm_tp_test_jitter_data_init(mmi_fm_tp_test_item_struct* item)
{
    ...
    kal_prompt_trace(MOD_MMI,"[FM]mmi_fm_tp_test_jitter_data_init custom_data.non_border_pass_criterion = %d",custom_data.non_border_pass_criterion);
    context->non_border_pass_criterion = mmi_fm_tp_get_pixel_from_um(custom_data.non_border_pass_criterion);
    item->dump_screen = custom_data.Dump_Screen ? 1: 0;
    kal_prompt_trace(MOD_MMI,"[FM]mmi_fm_tp_test_jitter_data_init context->non_border_pass_criterion = %d", context->non_border_pass_criterion);
	#ifdef __MMI_WEARABLE_DEVICE_FACTORY_MODE__
	context->non_border_pass_criterion += 10;
...
#ifdef __MMI_WEARABLE_DEVICE_FACTORY_MODE__
            custom_data->non_border_pass_criterion = 2000;
...
/*****************************************************************************
 * FUNCTION
 *  mmi_fm_tp_test_result_timeout_hdlr
 * DESCRIPTION
 *  
 * PARAMETERS
 *  void
 ...
 *  void
 *****************************************************************************/
void mmi_fm_tp_test_result_timeout_hdlr(void)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
	...
	if(SCR_ID_FM_TOUCH_PANEL != mmi_frm_scrn_get_active_id())
		return;
...
#ifdef __MMI_WEARABLE_DEVICE_FACTORY_MODE__
	StartTimer(FM_GENERAL_TIMER, 1000, mmi_fm_tp_test_result_timeout_hdlr);
#endif /*__MMI_WEARABLE_DEVICE_FACTORY_MODE__*/
}
...
/*****************************************************************************
  * FUNCTION
  *  mmi_fm_select_wearable_touch_panel
  * DESCRIPTION
  *  mmi_fm_select_wearable_touch_panel
  * PARAMETERS
  *  void
  ...
  *  void 
  *****************************************************************************/
extern void mmi_fm_select_wearable_touch_panel(cui_menu_event_struct *evt)
{
	...
	mmi_fm_tp_test_item_enter(GRP_ID_FM_ROOT, MENU_ID_FM_TOUCH_PANEL_JITTER_TEST);
}
