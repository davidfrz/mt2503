...
#define __MMI_BT_SPP_SERVER_MULTILINK_SUPPORT__
 ...
 * PARAMETERS
 *  	handle: spp instance handler         
 *  	uuid: spp server uuid, such as:
 *               U8 spp_128bit_uuid[16]={
 *					0x00,0x00,0x11,0x01,
 *					0x00,0x00,0x10,0x00,
 *					0x80,0x00,0x00,0x80,
 *					0x5F,0x9B,0x34,0xFB
 ...
 *  	void
 *****************************************************************************/
extern void srv_spp_bind_128bit_uuid(SppHandle handle, U8* uuid);
 ...
 *  	void
 *****************************************************************************/
extern void srv_spp_connect_128bit_uuid(SppHandle handle,
				U8* uuid,
 ...
 *  	void
 *****************************************************************************/
extern void srv_spp_connect_128bit_uuid_ex(SppHandle handle, 
					U8* uuid,
					srv_bt_cm_bt_addr* bt_addr,
					void* buf,
  					U32 tx_size,
...
/*********************************************************************/
/*****************************************************************************/
extern void srv_spp_disconnect_from_cm(S32 conn_id);

/*****************************************************************************/
extern void srv_spp_register_profile(U32 profile_id);
