...
#define CFG_MRE_CORE_DCL                    (__ON__)
#define CFG_MRE_CORE_TS                     (__ON__) 
...
#define CFG_MRE_SAL_VIBR                    (__ON__)
...
#define CFG_MRE_SAL_BASE64                  (__ON__)
...
#define CFG_MRE_SAL_VAD                     (__ON__)
#define CFG_MRE_SAL_NWSETTING                   (__ON__)
#define CFG_MRE_SAL_DNSD                   (__ON__)
#define CFG_MRE_SAL_BTNOTIFY                     (__ON__)
#define CFG_MRE_SAL_NAT                   (__ON__)
#define CFG_MRE_MAGIC_API_SAMPLE            (__ON__)
#define CFG_MRE_SAL_WDT                     (__ON__)
#define CFG_MRE_SAL_BTGATT                     (__ON__)
#define CFG_MRE_SAL_DCC					(__ON__)
#define CFG_MRE_BT_PDMS                         (__ON__)
#define CFG_MRE_BT_HFP                       (__ON__)
...
#define CFG_MRE_APP_LAUNCH                  (__ON__)
#define CFG_MRE_SAL_PAYMENT 				(__ON__)
#define CFG_MRE_SAL_BASE64                  (__OFF__)
