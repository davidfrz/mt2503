...
//	ADD_APPLICATION_STRING2(BRS_STR_ID_RESEND_POST,"Do you want to resubmit user data ?","Do you want to resubmit user data ?");    //Not in use
	#if WAP2
	ADD_APPLICATION_STRING2(BRS_STR_ID_RESET,"Reset","Reset");
	ADD_APPLICATION_STRING2(BRS_STR_ID_SUBMIT,"Submit","Submit");
	#endif
//	ADD_APPLICATION_STRING2(BRS_STR_ID_NO_MIME_MSG,"Do you wish to load this object ?","Do you wish to load this object?");     //Not in use
	#if 0
/* under construction !*/
	#endif
