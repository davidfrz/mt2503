...
enum {
    ...
    EV_EXT_CMD_IND = BTHF_EV_EXTERNAL_COMMAND
};
...
enum {
    ...
    REQ_SEND_CMD = BTHF_REQ_SEND_COMMAND,
    REQ_END,
    CNF_ACTIVATE,
    CNF_DEACTIVATE,
    CNF_SLC_CONN,
...
typedef struct _bthf_dev {
    ...
    U8 mic_gain;
    MMI_BOOL incoming;
    U8 indicator_value[BTHF_IND_TOTAL];
...
static bthf_request_struct *bthf_find_req_ext(bthf_list_struct *list, U32 req_id, BTHFDataType type);
...
static void bthf_send_data(bthf_request_struct *req, bthf_device_struct *dev);
