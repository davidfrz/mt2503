...
typedef struct
{
    U8 x1, y1;
    U8 x2, y2;
} fmrdo_rectangle_struct;


typedef struct
{
    U8 channel_name_text_color_r, channel_name_text_color_g, channel_name_text_color_b;
    U8 down_img_bg_color_r, down_img_bg_color_g, down_img_bg_color_b;
    U8 down_img_bg_opacity;
	U8 dimm_img_opacity;
    U8 channel_font_size;
    MMI_STR_ID title;
    U16 bg_image_id;
    U16 next_button_up_image_id;
    U16 prev_button_up_image_id;
    U16 vol_inc_button_up_image_id;
    U16 vol_dec_button_up_image_id;
    U16 power_button_on_up_image_id;
    U16 power_button_off_up_image_id;
    fmrdo_rectangle_struct next_button_area;
    fmrdo_rectangle_struct prev_button_area;
    fmrdo_rectangle_struct vol_inc_button_area;
    fmrdo_rectangle_struct vol_dec_button_area; 
    fmrdo_rectangle_struct power_button_area;
