            ...
            mma_mms_slide_text_object_struct *media)
{
...
#endif /* __MMI_MMS_POSTCARD__ */ 
    {
        ...
        {
			/*mma_charset_enum encoding_type = translate_mmi_charset_to_mma(mmi_chset_guess((const char*)g_srv_mms_parser_cntx->src_buffer, len, CHSET_BASE, CHSET_GUESS_ALL));*/
            srv_mms_viewer_change_encoding(g_srv_mms_parser_cntx->src_buffer, dest_buffer_size, dest_buffer, temp->encoding);
