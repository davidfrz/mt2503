...
void wgui_watch_progress_bar_create(gui_watch_progress_bar_struct *instance,
        U16 x,
        U16 y,
        U16 max_value,
        U16 level_value)
{
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
	 gui_watch_progress_bar_create(instance, x, y, max_value, level_value);
}

void wgui_watch_progress_bar_draw(gui_watch_progress_bar_struct instance)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
    gui_watch_progress_bar_draw(instance);
