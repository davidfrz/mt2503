...
static mmi_pen_hdlr g_mmi_sms_editor_longtap_hdlr_bakcup = NULL;
extern U32 mmi_imc_pen_get_pen_down_type(void);

mmi_pen_hdlr mmi_sms_entry_editor_options_long_tap_hdlr(mmi_pen_point_struct pos)
{
	...
	if(mmi_imc_pen_get_pen_down_type() != 2) //mmi_imc_pen_down_ui_type_enum
	{
		mmi_sms_entry_editor_options();
		return;
	}
	
	if(g_mmi_sms_editor_longtap_hdlr_bakcup != NULL)
	{
		g_mmi_sms_editor_longtap_hdlr_bakcup(pos);
	}
}
#endif
...
void mmi_sms_entry_editor(void)
{
    ...
    /* set category rsk */
        ...
        SetLeftSoftkeyFunction(mmi_sms_entry_editor_options, KEY_EVENT_UP); 
		 ...
		 g_mmi_sms_editor_longtap_hdlr_bakcup = mmi_pen_get_pen_handler(MMI_PEN_EVENT_LONG_TAP);
		 wgui_register_pen_long_tap_handler(mmi_sms_entry_editor_options_long_tap_hdlr);
#endif
