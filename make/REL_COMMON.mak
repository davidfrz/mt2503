...
NON_REL_FILES_LIST += plutommi\Service\BTNotificationANCS\BTNotiAncsSrv.c
NON_REL_FILES_LIST += plutommi\Service\MreInstallerSrv\MreInstallerSrv.c
...
# MAUI_03541519 Add Ucm folder for switch ability
CUS_REL_BASE_COMP += plutommi\AppCore\Ucm
...
NON_REL_DIRS_LIST += hal\system\AP_BtSS_sec\src
NON_REL_DIRS_LIST += hal\system\csci\src
NON_REL_DIRS_LIST += hal\system\csd\src
NON_REL_DIRS_LIST += tiny_system\csd\exception\src
NON_REL_DIRS_LIST += tiny_system\csd\logging\src
NON_REL_DIRS_LIST += tiny_system\hal\sleep_drv\src
NON_REL_DIRS_LIST += tiny_system\hal\system\BtSS_sec\src
NON_REL_DIRS_LIST += tiny_system\hal\system\csci\src
NON_REL_DIRS_LIST += tiny_system\hal\system\dcm\src
NON_REL_DIRS_LIST += tiny_system\kernel\kal\src
NON_REL_DIRS_LIST += tiny_system\test

CUS_REL_BASE_COMP += make\system_ubin
CUS_REL_BASE_COMP += make\ubinverno
CUS_REL_BASE_COMP += hal\system\AP_BtSS\src
CUS_REL_BASE_COMP += hal\system\region\src

NON_REL_DIRS_LIST += vendor\redbend_fuediff\include
NON_REL_FILES_LIST += vendor\redbend_fuediff\wearable_rvct31_fw.lib
NON_REL_FILES_LIST += vendor\rock_fota\libiotpatch_gmobi_rcvt31_20141022.lib

NON_REL_DIRS_LIST += LinkIt_Plugin
NON_REL_DIRS_LIST += LINKIT_SDK
