...
#define SRV_BT_CM_MAX_DISCOVERY_RESULTS_IN_LIST    20
#else
...
typedef enum
{
	SRV_BT_CM_VISIBILITY_PREVENT_CONN,
 ...
 *****************************************************************************/
extern S32 srv_bt_cm_switch_on_ex(U8 power_on_mode);
...
//#endif  /* __MMI_BT_AUTHORIZE__ */
    ...
    SRV_BT_CM_EVENT_BLE_ACTIVATE                  = 0x00080000, /*BLE active notify*/
    #endif
...
//#endif
	SRV_BT_CM_EVENT_LINK_STATE_IND				= 0x80000000,  /* bond cancel */
	SRV_BT_CM_EVENT_FAIL_CONN_TO				= SRV_BT_CM_EVENT_LINK_STATE_IND
...
typedef struct
{
    ...
    void* user_data;            /* user data */
#ifdef __BT_4_0_BLE__
	U8 	link_type;				/* link_type*/
#endif
    U8 reason;            /* activate result */
	srv_bt_cm_bt_addr dev_addr; /* device address */
} srv_bt_cm_link_sate_ind_struct;

typedef srv_bt_cm_link_sate_ind_struct srv_bt_cm_fail_conn_to_struct;
...
#ifdef __MMI_BT_SUPPORT__
extern MMI_BOOL srv_bt_cm_addr_is_nul(srv_bt_cm_bt_addr* bd_addr);
...
typedef enum
{
	SRV_BT_CM_LINK_TYPE_NONE = 0x00,
	SRV_BT_CM_LINK_TYPE_EDR = 0x01,
	SRV_BT_CM_LINK_TYPE_LE = 0x02,

	SRV_BT_CM_LINK_TYPE_DUAL = SRV_BT_CM_LINK_TYPE_EDR | SRV_BT_CM_LINK_TYPE_LE,

	SRV_BT_CM_LINK_TYPE_TOTAL
}srv_bt_cm_link_type_enum;
#endif

#ifdef __MMI_BT_DIALER_SUPPORT__

extern MMI_BOOL srv_bt_cm_is_dev_in_link_table(const srv_bt_cm_bt_addr* dev_addr);
/*****************************************************************************
 * FUNCTION
...
extern MMI_BOOL srv_bt_cm_is_headset(U32 cod);
 ...
 *****************************************************************************/
extern S32 srv_bt_cm_set_prevent_connect_flag(MMI_BOOL flag);

extern MMI_BOOL srv_bt_cm_get_prevent_connect_flag(void);
void srv_bt_cm_reset_prevent_connect_flag(void);
 ...
 *  void
 ******************************************************************************/
extern void srv_bt_cm_set_as_master(MMI_BOOL master);
 ...
 *  MMI_BOOL
 ******************************************************************************/
extern MMI_BOOL srv_bt_cm_is_master(void);
 ...
 *  MMI_BOOL
 ******************************************************************************/
extern MMI_BOOL srv_bt_cm_is_box(const srv_bt_cm_bt_addr* dev_addr);
 ...
 *  MMI_BOOL
 ******************************************************************************/
extern MMI_BOOL srv_bt_cm_is_box_ext(U32 cod, U8 *device_name);

#endif  //__MMI_BTBOX_NOLCD__

#endif
#ifdef __BT_4_0_BLE__
extern S32 srv_bt_cm_get_link_type(void);
/* only for Android device*/
extern S32 srv_bt_cm_get_dev_link_type(srv_bt_cm_bt_addr* dev_addr);

/****************************************************************************** 
 * FUNCTION
 *  srv_bt_cm_get_link_num
 * DESCRIPTION
 *  query the linked num according to the link type.
 * PARAMETERS
 *  link_type
 *
 * RETURNS
 *  S32 link_num
 ******************************************************************************/
extern S32 srv_bt_cm_get_link_num(srv_bt_cm_link_type_enum link_type);
#endif
