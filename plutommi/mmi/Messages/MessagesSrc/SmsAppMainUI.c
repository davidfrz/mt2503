...
#ifdef __MMI_TELEPHONY_SUPPORT__
#ifdef __MMI_SMS_ICON_BAR_SUPPORT__
...
#endif /* __MMI_SMS_ICON_BAR_SUPPORT__ */
#endif /* __MMI_TELEPHONY_SUPPORT__ */
#ifdef __MMI_MESSAGE_SMS_HILITE_VIEWER__
...
mmi_pen_hdlr mmi_sms_viewer_entry_option_long_tap_hdlr(mmi_pen_point_struct pos)
{
...
void mmi_sms_entry_viewer(void)
{
    ...
    /******* Handling for ZAWGYI language ****************************************************/
        ...
        if (enable_action)
        {
		  ...
		  wgui_register_pen_long_tap_handler(mmi_sms_viewer_entry_option_long_tap_hdlr);
		#endif
        }
...
#if defined(__MMI_BT_MAP_CLIENT__) && defined(__MMI_WEARABLE_DEVICE__) 
		cui_menu_set_non_leaf_item(cui_menu_gid, MENU_ID_SMS_VIEWER_OPT_RESEND, MMI_FALSE);
...
/* under construction !*/
    ...
    else
    {
		...
		if (mmi_sms_get_valid_sim_op_count(srv_nw_usab_is_usable) == 0)
		{
			cui_menu_set_item_hidden(cui_menu_gid, MENU_ID_SMS_VIEWER_OPT_RESEND, MMI_FALSE);
		}
    #endif /*defined(__MMI_BT_MAP_CLIENT__) && !defined(__MMI_WEARABLE_DEVICE__)*/
...
#endif /*__MMI_SMS_CLASS0_MSG_SLIM__*/
#ifndef __MMI_SMS_SLIM__
...
//   #endif
        ...
        #if (defined( __MMI_DUAL_SIM_MASTER__) && !defined(__MMI_MSG_EDITOR_WITH_RECIPIENT__) || \
			defined(__MMI_BT_MAP_CLIENT__) && !defined(__MMI_WEARABLE_DEVICE__))
