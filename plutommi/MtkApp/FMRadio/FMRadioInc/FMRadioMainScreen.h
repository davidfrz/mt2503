...
typedef struct
{
    fmrdo_main_rect_struct button_area;
    PU8 up_img;
...
typedef struct
{
    ...
    color down_img_bg_color;
    U8 down_img_bg_opacity;
	U8 dimm_img_opacity;
    U8 channel_font_size;
    PU8 bg_image;
	fmrdo_rectangle_struct channel_name;
	fmrdo_rectangle_struct freq_area;
    fmrdo_main_push_button_struct vol_up_button;
    fmrdo_main_push_button_struct vol_down_button;
    fmrdo_main_push_button_struct next_button;
    fmrdo_main_push_button_struct prev_button;
...
extern void mmi_fmrdo_init_main_images(void);
extern void mmi_fmrdo_show_main(void);
...
extern void mmi_fmrdo_press_volume_up(void);
extern void mmi_fmrdo_press_volume_down(void);
...
extern void mmi_fmrdo_redraw_main_volumebar(U8 volume);
