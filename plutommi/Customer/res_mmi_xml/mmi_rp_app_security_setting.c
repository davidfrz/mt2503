...
* DESCRIPTION
*  Automatically generated populate function for mmi_rp_app_security_setting_populate
* PARAMETERS
*  void
* RETURNS
*  void
*****************************************************************************/
void mmi_rp_app_security_setting_populate(void)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
...
/******************** Menu resource IDs - begin ********************/
    ADD_APPLICATION_MENUITEM5((
        ...
        STR_ID_SECSET_APP_NAME,
        IMG_SECSET_MENU_ENTRY));
...
/******************** Menu Hilite/Hint Handlers - begin ********************/
    ADD_APPLICATION_MENUITEM_HILITE_HANDLER(MENU_ID_SECSET_MAIN_MENU, mmi_secset_main_menu_highlight_hdlr);
