...
#if !defined(__MMI_GSM_CALL_SUPPORT__) && !defined(__MMI_BT_CALL_SUPPORT__)
#include "GlobalResDef.h"
#include "UCMGProt.h"
#endif /* !__MMI_GSM_CALL_SUPPORT__ && !__MMI_BT_CALL_SUPPORT__ */
...
#include "VolumeHandler.h" // mmi_vol_get_speech_vol
...
U16 mmi_ucm_call_launch(U16 caller_gid, mmi_ucm_make_call_para_struct *make_call_para)
{
    ...
    else if (!srv_bt_cm_is_profile_connected(SRV_BT_CM_HF_CONNECTION))
    {
        ...
        return GRP_ID_INVALID;
    #else
        mmi_ucm_bt_enter_reconnect_cnf();
        return GRP_ID_INVALID;
