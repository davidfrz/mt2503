...
#define __MMI_BT_MAPC_NEW_SMS_POPUP__
#endif
...
<APP id="APP_SMSBTUNIFIEDMESSAGE">   
 <!-- 
    ...
    ***************************************************************
    ...
    <STRING id="STR_ID_SRV_BT_EMPTY_SUBJECT"/> 
    <STRING id="STR_ID_SRV_BT_SMS_TEMPLATE"/>
    <STRING id="STR_ID_SRV_SMS_TEMPLATE"/>
    <STRING id="STR_ID_SRV_BT_SMS_TEMPLATE_1"/>
    <STRING id="STR_ID_SRV_BT_SMS_TEMPLATE_2"/>
    <STRING id="STR_ID_SRV_BT_SMS_TEMPLATE_3"/>
    <STRING id="STR_ID_SRV_BT_SMS_TEMPLATE_4"/>
    <STRING id="STR_ID_SRV_BT_SMS_TEMPLATE_5"/>
    <STRING id="STR_ID_SRV_BT_SMS_TEMPLATE_6"/>
    <STRING id="STR_ID_SRV_BT_SMS_TEMPLATE_7"/>
    <STRING id="STR_ID_SRV_BT_SMS_TEMPLATE_8"/>
    <STRING id="STR_ID_SRV_BT_SMS_TEMPLATE_9"/>
    <STRING id="STR_ID_SRV_BT_SMS_TEMPLATE_10"/>
    <STRING id="STR_ID_SRV_BT_SMS_CALL_SENDER"/> 

     #ifdef __MMI_BT_MAPC_NEW_SMS_POPUP__
    <STRING id="STR_ID_SRV_BT_SMS_SINGLE_NEW_MSG"/>
    <STRING id="STR_ID_SRV_BT_SMS_MULTI_NEW_MSG"/>
    <STRING id="STR_ID_SRV_BT_SMS_NEW_MSG_CHECK"/>
    <STRING id="STR_ID_SRV_BT_SMS_NEW_MSG_SUFFIX"/>
    <STRING id="STR_ID_SRV_BT_SMS_NEW_MSG_DISMISS"/>
     #endif
    ...
    ***************************************************************
    ...
    //#ifdef __MMI_WEARABLE_DEVICE__
     <SCREEN id="SCR_ID_SMS_BT_CONNECT_CHECK"/>
     <SCREEN id="SCR_ID_SMS_BT_FAIL_CONFIM"/>
     <SCREEN id="SCR_ID_SMS_BT_FAIL_RETRY_CONFIM"/>
     <SCREEN id="SCR_ID_SMS_BT_CONNECT_CONFIM"/>
     <SCREEN id="GRP_ID_SMS_BT_CONFIM"/>
     <SCREEN id="SCR_ID_SMS_BT_TEMPLATE"/>
     <SCREEN id="SCR_ID_SMS_BT_DELETE_MSG_CONFIM"/>
     <SCREEN id="GRP_ID_SMS_BT_DELETE_MSG_CONFIM"/>

     #ifdef __MMI_BT_MAPC_NEW_SMS_POPUP__
     <SCREEN id="GRP_ID_SMS_BT_NEW_MSG"/> 
     <SCREEN id="SCR_ID_SMS_BT_NEW_MSG"/> 
     #endif
...
#ifdef __MMI_BT_MAPC_NEW_SMS_POPUP__
    <RECEIVER id="EVT_ID_SRV_BT_NOTI_NEW_SMS" proc="mmi_sms_bt_dialer_new_msg_hdlr"/>
#endif
