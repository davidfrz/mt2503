...
#define MC3210_DFLT_INTS   (FRONT_BACK | PORTRAIT_LANDSCAPE | TAP | \
                            MEASUREMENT | SHAKE_X | \
...
/* acceleration 14-Bits,+/-8g */
#define MC3210_RANGE       16	//+/-1.5g
#define MC3210_RESOLUTION  14	//8-Bits

#define ACC_0G_X      8192
#define ACC_1G_X      (8192+1024)
#define ACC_MINUS1G_X (8192-1024)
#define ACC_0G_Y      8192   
#define ACC_1G_Y      (8192+1024)
#define ACC_MINUS1G_Y (8192-1024)
#define ACC_0G_Z      8192       
#define ACC_1G_Z      (8192+1024)
#define ACC_MINUS1G_Z (8192-1024)
