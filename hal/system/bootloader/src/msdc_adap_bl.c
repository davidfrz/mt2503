...
int BL_MSDC_Init(void)
{
    ...
    DRV_SetBits(0xA0020c40, 0x0001); // CMD    
	  ...
	  DRV_SetBits32(0xA0020c30,0x00001111);//clk,cmd,dat0,EINT
	  DRV_SetBits32(0xA0020c00,0x00011000);//dat1,dat2
	  DRV_SetBits32(0xA0020c10,0x00000100);//dat3
#elif defined(MT6261)||defined(MT2501)||defined(MT2502)
		DRV_SetBits32(0xA0020C34,0x10000000);//GPIO31 MCCK set mode1 set
		DRV_SetBits32(0xA0020C44,0x00011111);//GPIO36 GPIO35 GPIO34 GPIO33 GPIO32 MCDAT3 MCDAT2 MCDAT1 MCDAT0 MCCM0 set mode1 set
#endif
...
extern DCL_STATUS DclSD_DeInitialize(void);
int BL_MSDC_DeInit(void)
{
	...
	DRV_ClearBits(0x80020200, 0x0FFF);
#elif defined(MT6260)
	  DRV_ClearBits32(0xA0020c30,0x00001111);//clk,cmd,dat0,EINT
	  DRV_ClearBits32(0xA0020c00,0x00011000);//dat1,dat2
	  DRV_ClearBits32(0xA0020c10,0x00000100);//dat3
#elif defined(MT6261)||defined(MT2501)||defined(MT2502)	  
	  DRV_SetBits32(0xA0020C38,0x10000000);//clr GPIO31 MCCK set mode1 clr
		DRV_SetBits32(0xA0020C48,0x00011111);//clr GPIO36 GPIO35 GPIO34 GPIO33 GPIO32 MCDAT3 MCDAT2 MCDAT1 MCDAT0 MCCM0 set mode1 clr
#endif
