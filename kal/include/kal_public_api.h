 ...
 *     and the related data allocated for the timer could not be freed once its created.
 ...
 * NOTE
 *  (1)It is strongly suggested to call this function only at system initialization stage, 
 *     and the related data allocated for the stack timer could not be freed once its created.
