...
/*add for BT dialer*/
        ...
        #define CAT632_BORDER 12
        #define CAT632_APPNAME_TITLE_GAP 10
        #define CAT632_CONTENT_DATETIME_GAP 15
        #define CAT632_CONTROL_AREA1_HEIGHT 60
        #define CAT632_INPUTBOX_HEIGHT 70
        #define CAT632_CONTROL_AREA2_HEIGHT 20	
    #else
...
//cat6333
#define CAT6333_APPNAME_AREA_HEIGHT 35 //include GAP
#ifdef __MMI_WEARABLE_DEVICE_UI_ENHANCE__
#define CAT6333_INPUTBOX_HEIGHT (115 - 20)
#else
#define CAT6333_INPUTBOX_HEIGHT 115 
#endif /*__MMI_WEARABLE_DEVICE_UI_ENHANCE__*/
#define CAT6333_INPUTBOX_TIME_GAP 15

//cat6335
//#define CAT6335_TEXT_AREA_HEIGHT 145
#define CAT6335_TEXT_PROGRESS_AREA_GAP 8
#define CAT6335_PROGRESS_HEIGHT 9
#define CAT6335_PROGRESS_BG_OFFSET 3
#endif
...
#ifdef __MMI_WEARABLE_DEVICE__ //for full pop up
extern void wgui_showcategory6333_screen(
				UI_string_type str_appname,
				UI_string_type left_softkey,
                UI_string_type right_softkey,
				UI_string_type str_message,
				UI_string_type str_datetime);
extern void wgui_showcategory6335_screen(
        U16 left_softkey,
        U16 right_softkey,
        WCHAR* message,
        U8 percentage);
