...
mtk_int32
mtk_gps_sys_timer_create(MTK_GPS_TIMER_E selected_timer);
mtk_int32
...
/*****************************************************************************
 * FUNCTION
 *  mtk_gps_get_lle_info
 * DESCRIPTION
 *  Get the information of LLE running status for determination of stopping running or not
 * PARAMETERS
 *  lle_info        [OUT] information of LLE running status
 * RETURNS
 *  MTK_GPS_SUCCESS to indicate that running can stop
 *  MTK_GPS_ERROR   to indicate that running should continue
 *****************************************************************************/
mtk_int32
mtk_gps_get_lle_info(MTK_GPS_LLE_INFO_T *lle_info);
//#endif
...
mtk_gps_sys_uart_poll(void);
 ...
 /*****************************************************************************
 * FUNCTION
 *  mtk_gps_get_restart_condition
 * DESCRIPTION
 *  get gps restart condition
 * PARAMETERS
 *  void
 * RETURNS
 *  restart type:RESTARTTYPE_HOT,RESTARTTYPE_WARM,RESTARTTYPE_COLD
 *****************************************************************************/
mtk_gps_restart_condition mtk_gps_get_restart_condition(void);
