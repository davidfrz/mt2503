...
vm_sm_builtin_struct mre_buildin_vtp_array[MRE_BUILDIN_VTP_COUNT];
vm_sm_builtin_struct mre_buildin_vxp_array[MRE_BUILDIN_VXP_COUNT];
...
extern const __align(4) VMUINT8 all_sensor_init_vxp[];
#endif



VMUINT vm_init_default_game(VMUINT* appcount, VMUINT* smcount, VMUINT* socount, VMUINT* vtpcount, VMUINT* vxpcount)
{
	VMUINT count = 0;
	VMUINT sm_count = 0;
	VMUINT so_count = 0;
...
#ifdef __MMI_MRE_ALL_SENSOR_INIT__
        mre_buildin_app_array[count++] = (VMUINT8 *)all_sensor_init_vxp;        
#endif
...
{
	VMUINT vxp_count = 0, vsm_count = 0, so_count = 0, vtpcount = 0, vxpcount = 0;
	VMUINT i = 0;
	
#ifndef __MMI_MRE_3RD_ROM_PRELOAD__
	vm_init_default_game(&vxp_count,&vsm_count,&so_count, &vtpcount , &vxpcount);
