...
extern kal_uint8 l4c_gprs_ipv4v6_prepare_new_cid(l4c_gprs_ipv4v6_act_struct* act_ptr, kal_uint8 pdp_type, kal_bool is_ext_pdp); //mtk02285, MAUI_03127025, IPV4V6 fallback: cid2 vs. ps_dialup_port[]
...
extern kal_bool l4c_gprs_ipv4v6_pdp_activate_req_helper(l4c_gprs_ipv4v6_act_struct** v4v6_act_ptr,kal_uint8 cid,kal_uint8 src_id); //L4CPPP_FB
...
extern kal_bool l4c_gemini_need_switch(msg_type msg_id);

extern kal_bool l4c_phb_approve_fdn(kal_uint8 *tel_number, /* BCD coding, include TON/NPI in the first byte */
