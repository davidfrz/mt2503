...
#if 1//def FSEditor_CUI_MEMORY_FROM_ASM

//#define FSEditor_CUI_ASM_DEBUG_TRACE  //debug info

#define FSEditor_DATA_SIZE               sizeof(cui_fseditor_struct) 
#define FSEditor_DATA_ASM_SIZE  (FSEditor_DATA_SIZE)

typedef enum
{
    CUI_FS_EDITOR_NOT_CREATE = 0,
    CUI_FS_EDITOR_CREATE_WITH_ASM,
    CUI_FS_EDITOR_CREATE_WITH_ADM,
    CUI_FS_EDITOR_CREATE_WITH_MEMORY_POINT,
    CUI_FS_EDITOR_CREATE_INFO_MAX_ID  
    
}cui_fseditor_create_info;



typedef struct cui_fseditor_asm_instance_struct
{       
    cui_fseditor_create_info is_create; /* is  created flag from ASM */   
    KAL_ADM_ID app_adm_id; /* ID of ADM which created CUI */
    mmi_id app_id;         /* ID of APP which created CUI*/       
    cui_fseditor_struct * cui_fseditor_instance;/* instance 's address of ASM */
} cui_fseditor_asm_instance_struct;
