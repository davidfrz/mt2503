...
#if defined(__SECURE_USB_DOWNLOAD__) || defined(__SECURE_UART_DOWNLOAD__) || defined(__CARD_DOWNLOAD__) || defined(__FUNET_ENABLE__) || defined(__FUDIFFNET_ENABLE__)
...
#endif /* __SECURE_USB_DOWNLOAD__ || __SECURE_UART_DOWNLOAD__ || __CARD_DOWNLOAD__ || __FUNET_ENABLE__ */
