...
static void vm_res_init_data_type(VMINT type, vm_mi_res_type_node_t * restype_ptr)
{
	...
	case VM_RES_TYPE_TIMER_EX:
	    ...
	    sysreserve = 10;
	    break;
  case VM_RES_TYPE_BLOCK_PRECISE_TIMER:
      total = 10;
      break;
	...
	case VM_RES_TYPE_DCL:
	    total = 20;
		break;
#endif
#ifdef __MRE_CORE_ATCMD__
	case VM_RES_TYPE_ATCMD:
		total = 20;
		break;
#endif
    ...
    case VM_RES_TYPE_BTPDMS:
        total = 10;
        break;
        
    case VM_RES_TYPE_BTHFP_HF:
        total = 10;
        break;
        
    case VM_RES_TYPE_MAGIC:
        total = VM_RES_TYPE_MAGIC_NUM;
        break;
	...
	case VM_RES_TYPE_VAD:
	    total = 20;
		break;
#endif
    case VM_RES_TYPE_SOC_SERVER:
        total = 2;
        sysreserve = 1;
        break;
    case VM_RES_TYPE_NOTIFY:
        {
            total = 5;
            sysreserve = 1;
        }
		break;
    case VM_RES_TYPE_NAT:
        total = 50;
        sysreserve = 1;
        break;

#ifdef __MRE_SAL_BTGATT__
	case VM_RES_TYPE_BTGATT:
	    total = 20;
		break;
#endif
    case VM_RES_TYPE_BEARER:
        total = 50;
        sysreserve = 2;
        break;
		
#ifdef __MRE_SAL_DCC__
	case VM_RES_TYPE_DCC:
		total = 48;
		break;
#endif
