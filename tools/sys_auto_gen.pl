...
# Constants
#****************************************************************************
my $SYSAUTOGEN_VERNO = " v0.06 -> p0.07";
		       # p0.07 by Dongming, 20140728, New feature for IOT FOTA
...
my $UBIN_IMAGELAYOUT      = $ARGV[13];
#****************************************************************************
# 1 >>> Run Process
#****************************************************************************

$g_exit = system("perl tools\\sysgen1.pl $BB_PATH $themf");
$g_exit = system("perl tools\\scatGen.pl $ARGV[0] $ARGV[1] $ARGV[2] $ARGV[3] $ARGV[4] $ARGV[5] $ARGV[6] $ARGV[7] $ARGV[8] $ARGV[9] $ARGV[10] $ARGV[13]") if($g_exit == 0);
$g_exit = system("perl tools\\sysgen2.pl $BB_PATH $IMAGELAYOUT $BL_IMAGELAYOUT $themf $TS_IMAGELAYOUT $UBIN_IMAGELAYOUT") if($g_exit == 0);
