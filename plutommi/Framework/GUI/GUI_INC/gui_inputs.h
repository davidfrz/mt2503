...
#if defined(__MMI_FTE_SUPPORT__)&&defined(__MMI_WEARABLE_DEVICE__)&&(defined(__MMI_MAINLCD_240X240__)||defined(__MMI_MAINLCD_320X320__))
	#define __MMI_EDITOR_SSP_SUPPORT_NO_DRAW_SCROLLBAR_WHEN_NO_PEN_MOVE__
#endif

#if defined(__MMI_FTE_SUPPORT__)&&defined(__MMI_WEARABLE_DEVICE__)&&defined(__MMI_MAINLCD_240X240__)

    #define  __MMI_MULTILINE_INPUT_BOX_SINGLINE_STYLE_WITH_FTE__ 
    #define  __MMI_MULTILINE_INPUT_BOX_SINGLINE_STYLE__
    #define  __MMI_MULTILINE_INPUT_BOX_SINGLINE_STYLE_IN_MRE__
...
#define __MMI_FSEDITORCUI_REMOVE_SOFTKEY__
#define __MMI_INLINECUI_REMOVE_SOFTKEY__
#endif
...
#define EDITOR_MULTILINE_TYPE 1
#define EDITOR_SINGLELINE_TYPE 2

#define MULTI_AND_SINGLE_OTHER_DATA_MAX 2
    typedef struct _editor_multi_and_single_all_data
    {
       U8  editor_type;   // 
       multi_line_input_box * editor;
       
       S32 *wgui_inputbox_buffer_size ;
    
       PU8 *wgui_inputbox_LSK_label_icon;

       U8 *wgui_inputbox_RSK_label_clear ;
    
       UI_string_type *wgui_inputbox_RSK_label_string;
    
       PU8 *wgui_inputbox_RSK_label_icon;
    
       U8 *wgui_inputbox_decimal_flag ;
    
       U8 *wgui_inputbox_decimal_input_mode_flag ;
    
       MMI_BOOL *wgui_inputbox_is_disable_up_down_key_register ;

       MMI_BOOL *wgui_inputbox_is_disable_left_right_key_register ;

       void (**wgui_inputbox_RSK_function) (void) ;
       
       void (**wgui_inputbox_LSK_function) (void) ;
       
       U8 **wgui_inputbox_history_buffer ;
       S16 *wgui_inputbox_history_ID ;

       MMI_BOOL *wgui_inputs_is_clear_key_delete_all;
       void (**wgui_inputbox_set_key_callback) (void) ;

       void (**wgui_inputbox_input_callback) (void);
       void (**wgui_inputbox_navigate_callback) (void) ;   

      
       
    } editor_multi_and_single_all_data;



    extern void gui_create_multi_line_input_box_set_buffer_2(
                    multi_line_input_box *b,
                    S32 x,
                    S32 y,
                    S32 width,
