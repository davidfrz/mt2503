...
#
# 08 29 2014 ray.lin-wang
# [MAUI_03503699] [IoT FOTA] Separate bin FOTA check in
# ubin keep symbol auto build flow.
#
...
## end of ADEFS
######################################
#set the compile option for ubin.
######################################
ifeq ($(strip $(UPDATE_BINARY_FILE_DUMMY_BUILD)),TRUE)
  CFLAGS += -D__UPDATE_BINARY_FILE_DUMMY_BUILD__
endif
