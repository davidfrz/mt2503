...
/*****************************************************************************
 * FUNCTION
 *	srv_spp_register_profile
 * DESCRIPTION
 *	This function is to register spp profile to cm for spp server app
 *     that can't be init on mmi bootup pahse.
 * PARAMETERS
 *
 * RETURNS
 *	void
 *****************************************************************************/
void srv_spp_register_profile(U32 profile_id)
{
	/*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/	
	original_spp.profile_id = profile_id;
...
static void srv_spp_init_cntx(void)
{
	...
	spp_inst_head = NULL;
	#if !defined(__IOT__) && !defined(__BT_NOTI_SRV_REMOVE__)
 ...
 *  void
 *****************************************************************************/
static void srv_spp_uuid_convert_16bit_to_128bit(U16 uuid_16bit, U8* uuid_128bit)
{
 ...
 *  U16 : 16 bit uuid
 *****************************************************************************/
static U16 srv_spp_uuid_convert_128bit_to_16bit(U8* uuid_128bit)
{
...
static void srv_spp_debug_display_uuid(U8* uuid)
{
	/*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
