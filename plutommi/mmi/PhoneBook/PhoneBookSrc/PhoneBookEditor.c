...
mmi_pen_hdlr mmi_phb_entry_op_view_entry_options_long_tap_hdlr(mmi_pen_point_struct pos)
{
...
void mmi_phb_entry_op_view_entry(mmi_scrn_essential_struct* scrn_data)
{
	...
	#if defined(__MMI_WEARABLE_DEVICE__)
		wgui_register_pen_long_tap_handler(mmi_phb_entry_op_view_entry_options_long_tap_hdlr);
	#endif /*__MMI_WEARABLE_DEVICE__*/
