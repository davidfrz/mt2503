...
static void mmi_usb_boot_set_power_key(void)
{
    ...
    {
        SetKeyHandler(mmi_usb_boot_close_for_reset, KEY_POWER, KEY_LONG_PRESS);        
    }
    else
    {
        SetKeyHandler(mmi_usb_boot_close_for_reset, KEY_END, KEY_LONG_PRESS);
    }
}
