...
#define DSP_SPH_AUX_P2W_BUF_DL			    DPRAM2_base(SPH_DM_ADDR_AUX_P2W_DL_BUF)
#define DSP_SPH_AUX_P2W_BUF_UL			    DPRAM2_base(SPH_DM_ADDR_AUX_P2W_UL_BUF)
...
#define DSP_SPH_AUX_P2W_CTRL                DPRAM2_base(SPH_AUX_P2W_CTRL)
