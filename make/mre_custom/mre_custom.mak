...
SRC_LIST =  mre\custom\sal\vmapparray.c \
            ...
            mre\custom\sal\vmmagic.c \
            mre\custom\sal\vmmagic_internal.c \
...
ifneq ($(filter __MMI_MRE_ALL_SENSOR_INIT__, $(strip $(MODULE_DEFS))),)
    SRC_LIST +=  mre\custom\romapp\mre_all_sensor_init.c
endif
