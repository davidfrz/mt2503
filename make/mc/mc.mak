...
#Any of these options are defined will include all the source file as custom may change the feature options by themselves.
#This is request by ACS.
#SD/MMC memory card select.
ifneq ($(strip $(filter __MSDC_SD_SDIO__, $(strip $(MODULE_DEFS)))$(filter __MSDC_SD_MMC__, $(strip $(MODULE_DEFS)))$(filter __MSDC2_SD_SDIO__, $(strip $(MODULE_DEFS)))$(filter __MSDC2_SD_MMC__, $(strip $(MODULE_DEFS)))),)
