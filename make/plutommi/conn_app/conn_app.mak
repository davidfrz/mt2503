...
SRC_LIST = plutommi\mmi\dataaccount\dataaccountsrc\DataAccountApp.c \
           ...
           plutommi\mtkapp\connectivity\connectivitysrc\btcommon\BtConnCfg.c \
...
ifneq ($(strip $(BLUETOOTH_SUPPORT)),NONE)
    ...
    ifneq ($(filter  __MMI_WEARABLE_DEVICE__, $(strip $(MODULE_DEFS))),)
        ifneq ($(filter __MMI_BT_APK_SMART_INSTALL_SUPPORT__ __MMI_BT_APPLICATION_BQB__, $(strip $(MODULE_DEFS))),)
            SRC_LIST += plutommi\mtkapp\connectivity\connectivitysrc\btmtk\BtMmiApkSmartInstall.c
        endif
    endif
...
INC_DIR = applib\inet\engine\include \
          ...
          blueangel\btstd\common\inc \
          blueangel\bt_cust\inc \
          drm\include \
          irda\inc \
          j2me\interface \
          j2me\jal\include \
...
ifneq ($(filter __MMI_BT_BTBOX_NOLCD__, $(strip $(MODULE_DEFS))),)
SRC_LIST += plutommi\MtkApp\Connectivity\ConnectivitySrc\BtCommon\BTB.c
INC_DIR += plutommi\service\btcmsrv
endif
