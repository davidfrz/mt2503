 ...
 *  MMI_BOOL
 *****************************************************************************/
void *custom_phb_xmgnt_approve_func = NULL;
...
kal_bool custom_phb_xmgnt_approve_fdn(
            ...
            kal_uint16 *cause)
        {
            custom_phb_xmgnt_approve_func_cb approve_func = NULL;
...
/* under construction !*/
            #endif
            if (custom_phb_xmgnt_approve_func)
            {
                approve_func = (custom_phb_xmgnt_approve_func_cb)custom_phb_xmgnt_approve_func;
                return (approve_func)(
                        number,
                        num_length,
                        sim_id,
