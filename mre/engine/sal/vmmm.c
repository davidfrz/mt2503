...
{
    return srv_speech_get_mode_volume();
}

void vm_audio_set_mode(VMUINT8 mode)
{
...
{
    if(strcmp(func_name,"vm_audio_set_mode") == 0)
        return (VMINT)vm_audio_set_mode;  
    if(strcmp(func_name,"vm_audio_set_sph_volume") == 0)
        return (VMINT)vm_audio_set_sph_volume;  
    if(strcmp(func_name, "vm_audio_get_sph_mode_volume") == 0)
        return (VMINT)vm_audio_get_sph_mode_volume;
	return 0;
}
