...
/* under construction !*/
    ...
    gdi_draw_solid_rect(0, 0, MAIN_LCD_device_width - 1, MMI_STATUS_ICON_BAR_HEIGHT - 1, GDI_COLOR_TRANSPARENT);    
    if (bar->bar_id)
    {
        gdi_image_draw_resized(0, 0, MAIN_LCD_device_width, MMI_STATUS_ICON_BAR_HEIGHT, get_image((MMI_ID_TYPE)bar->bar_id));
    }
    else if (bar->flags & WGUI_STATUS_ICON_BAR_FLAG_BAR_SPECIAL_STYLE)
    {
        gdi_image_draw_resized(0, 0, MAIN_LCD_device_width, MMI_STATUS_ICON_BAR_HEIGHT, get_image((MMI_ID_TYPE)WGUI_IMG_STATUS_BAR_SPECIAL_BKG));
    }
    else if (bar->flags & WGUI_STATUS_ICON_BAR_FLAG_BAR_SPECIAL_TRANSPARENT_STYLE)
    {
        gdi_image_draw_resized(0, 0, MAIN_LCD_device_width, MMI_STATUS_ICON_BAR_HEIGHT, get_image((MMI_ID_TYPE)WGUI_IMG_STATUS_BAR_SPECIAL_TRANSPARENT_BKG));
    }
    else
    {
        gdi_image_draw_resized(0, 0, MAIN_LCD_device_width, MMI_STATUS_ICON_BAR_HEIGHT, get_image((MMI_ID_TYPE)WGUI_IMG_STATUS_BAR_BKG));
    }
#if 0
/* under construction !*/
/* under construction !*/
...
/* under construction !*/
    ...
    {
        gdi_draw_solid_rect(0, 0, MAIN_LCD_device_width - 1, MMI_STATUS_ICON_BAR_HEIGHT - 1, GDI_COLOR_WHITE);
    }
    ...
    {
        gui_draw_filled_area(0, 0, MAIN_LCD_device_width - 1, MMI_STATUS_ICON_BAR_HEIGHT - 1, f);
    }
#endif
    gdi_layer_pop_clip();
}
...
void gui_status_icon_bar_arrange_oem(void)
{
    ...
    x1 = WEARABLE_DEVICE_128X128__UI_STATUS_ICON_BAR_STRING_W + MMI_UI_STATUSBAR_GAP;
#else
...
void  gui_status_icon_bar_show_tring(void)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
    string = wgui_status_icon_bar_tring ;
    if(wgui_status_icon_bar_tring)
    {
        if (mmi_fe_get_r2l_state())
        {
            string_x = WEARABLE_DEVICE_128X128__UI_STATUS_ICON_BAR_STRING_W -1;
        }    
        else
        {
            string_x = 1 ;
    ...
    {   
        clip_x1 = 0;
        clip_x2 = WEARABLE_DEVICE_128X128__UI_STATUS_ICON_BAR_STRING_W-1;
        clip_y1 = 0;
        clip_y2 = wgui_status_icon_bar_bars[WGUI_STATUS_ICON_BAR_H_BAR].y2;
        gdi_layer_push_and_set_clip(clip_x1,clip_y1,clip_x2,clip_y2);
        //wgui_status_icon_bar_draw_tring_background(clip_x1,clip_y1,clip_x2,clip_y2);
        if(string)
        {
            gui_print_truncated_text(string_x,string_y, WEARABLE_DEVICE_128X128__UI_STATUS_ICON_BAR_STRING_W,string);  
        }    
        gdi_layer_pop_clip();
        //gdi_layer_blt_previous(clip_x1,clip_y1,clip_x2,clip_y2);
    }
}
...
#ifdef  __128X128_WEARABLE_DEVICE_UI_STATUS_ICON_BAR__
    gui_status_icon_bar_show_tring();
#endif
#ifdef WGUI_STATUS_ICON_SHOW_ELEMENT
