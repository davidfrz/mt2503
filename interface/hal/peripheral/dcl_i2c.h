...
typedef union
{
   ...
   I2C_CTRL_CONFIG_T rConfigure;/* confgure the i2c's address,speed.  added for dcl common layer*/
}DCL_CTRL_DATA_T;
#else
#define I2C_CTRLS \
...
/*************************************************************************
*added for dcl common  layer
*************************************************************************/
/*----------------------------------------------------------
*  This function only for MRE users, native user should not use it.
*---------------------------------------------------------*/
extern DCL_STATUS DCLSI2C_Query(DCL_HANDLE handle, void* handle_status);

/*----------------------------------------------------------
*  This function only for MRE users, native user should use DclSI2C_Open 
*---------------------------------------------------------*/
