...
#define SRV_SMS_BTMAPC_MAX_CONTENT_SIZE          SRV_SMS_BTMAPC_MAX_SEGMENT * 153

//#define SRV_SMS_BTMAPC_DISPLAY_CHAR_SIZE         (511)
//#define SRV_SMS_BTMAPC_DISPLAY_BUFFER_SIZE       (1024)

#define SRV_SMS_BTMAPC_DISPLAY_CHAR_SIZE         (SRV_SMS_BTMAPC_MAX_SEGMENT * 153 * ENCODING_LENGTH/2)
#define SRV_SMS_BTMAPC_DISPLAY_USC2_CHAR_SIZE    (SRV_SMS_BTMAPC_MAX_SEGMENT * 153 * ENCODING_LENGTH/2) //(SRV_SMS_BTMAPC_MAX_SEGMENT * 67)   /* (268) */
#define SRV_SMS_BTMAPC_DISPLAY_BUFFER_SIZE       (SRV_SMS_BTMAPC_MAX_SEGMENT * 153 * ENCODING_LENGTH + 2)    /* (1226) */
#define SRV_SMS_BTMAPC_MAX_DISPLAY_BUFF_SIZE     2048
...
typedef struct
{
    ...
    srv_sms_btmapc_bt_enum curr_tab_index;
...
typedef struct
{
    ...
    SrvSmsCallbackFunc callback_func;
    srv_bt_mapc_bt_enum bt_index;  
} srv_sms_btmapc_delete_msg_struct;
