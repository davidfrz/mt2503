...
extern const ire_character_info_table_struct zawgyi_character_info_table[];
#endif
...
#endif
#if defined (__MMI_LANG_ZAWGYI_MYANMAR__)
	{IRE_ZAWGYI_MYANMAR_LANG_START_RANGE, IRE_ZAWGYI_MYANMAR_LANG_END_RANGE, zawgyi_character_info_table, 0 }, /*Myanmar*/
#else
	{0,0,0,0},
#endif
};																							  
...
#endif			
#if defined (__MMI_LANG_ZAWGYI_MYANMAR__)
	{IRE_ZAWGYI_MYANMAR_PROPRIETRY_START_RANGE, IRE_ZAWGYI_MYANMAR_PROPRIETRY_END_RANGE, zawgyi_character_info_table, 0 },
#else
	{0,0,0,0},
#endif
