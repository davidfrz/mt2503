 ...
 *
 * 05 20 2014 min.dong
 * [MAUI_03492965] [wearable device]BT connection check in
 * 	.patch back from wear_v1 to 1418MP.
 *
 * 01 14 2014 min.dong
...
<!----------------- input event __MMI_FRM_INPUT_EVT__--------------------------------------------------->
	...
	<TIMER id="INPUT_EVENT_LED_TIMER"/>
	<TIMER id="INPUT_EVENT_LED0_TIMER"/>
	<TIMER id="INPUT_EVENT_LED1_TIMER"/>
	<TIMER id="INPUT_EVENT_LED2_TIMER"/>
	<TIMER id="INPUT_EVENT_VIB_TIMER"/>	
#endif	
<!----------------- XML END --------------------------------------------------->
