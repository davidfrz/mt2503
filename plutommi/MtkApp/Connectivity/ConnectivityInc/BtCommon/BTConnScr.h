...
extern void mmi_bt_dialor_auto_reconnect(srv_bt_cm_bt_addr* dev_addr);
...
#ifdef __MMI_BT_BTBOX_NOLCD__
extern U32 mmi_bt_dialer_get_index_by_dev_info(srv_bt_cm_bt_addr *bd_addr);
extern U32 mmi_bt_dialer_get_autoreconn_inx_array(srv_bt_cm_bt_addr* dev_addr);
extern U32 mmi_bt_dialer_get_reconn_item(void);
extern void mmi_bt_dialer_auto_reconn_restart(void);
extern U32 mmi_bt_dialer_insert_connected_dev_info(srv_bt_cm_dev_struct *dev_info);
#endif /* __MMI_BT_BTBOX_NOLCD__ */
...
extern void mmi_bt_entry_wristband_setting_menu(void);
