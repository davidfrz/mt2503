...
int GPS_DL()
{
	...
	gps_da.m_path[0] = '\0';
	gps_image.m_num = 1;
	gps_image.m_image_list[0].m_image = (kal_uint8 *)(&Image$$EXT_BL_IOT_FOTA_DECOMPRESSION_BUF$$ZI$$Base);
	gps_image.m_image_list[0].m_path[0] = '\0';
	gps_image.m_image_list[0].m_size = (kal_uint32)(&Image$$EXT_BL_IOT_FOTA_DECOMPRESSION_BUF$$ZI$$Length);
