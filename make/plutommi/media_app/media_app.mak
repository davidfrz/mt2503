...
ifneq ($(filter __MMI_AUDIO_PLAYER__, $(strip $(MODULE_DEFS))),)
	...
	ifneq ($(filter __MMI_AUDIO_PLAYER_BT__, $(strip $(MODULE_DEFS))),)
	  ...
	  SRC_LIST += plutommi\mtkapp\audioplayer\audioplayersrc\AudioPlayerBTSrc.c
	endif
...
SRC_LIST += plutommi\mtkapp\audioplayer\audioplayersrc\AudioPlayerBTSrcSpp.c
endif

ifneq ($(filter __MMI_BT_MUSIC_NOLCD__, $(strip $(MODULE_DEFS))),)
		SRC_LIST += plutommi\mtkapp\audioplayer\audioplayersrc\BTMusic_NoLCD.c
endif
...
ifneq ($(filter __MMI_BTBOX_NOLCD__, $(strip $(MODULE_DEFS))),)
...
ifneq ($(filter __MMI_FM_RADIO__, $(strip $(MODULE_DEFS))),)
	ifneq ($(filter __MMI_FTE_SUPPORT__, $(strip $(MODULE_DEFS))),)
		ifneq ($(filter __MMI_WEARABLE_DEVICE__, $(strip $(MODULE_DEFS))),)
			SRC_LIST += plutommi\mtkapp\fmradio\fmradiosrc\fmradiomainscreen_WD.c
		else
	...
	SRC_LIST += plutommi\mtkapp\fmradio\fmradiosrc\fmradiomsghdlr.c \
		...
		ifneq ($(filter __MMI_WEARABLE_DEVICE__, $(strip $(MODULE_DEFS))),)
			SRC_LIST += plutommi\mtkapp\fmradio\fmradiosrc\fmradiosrc_WD.c
		else
		        SRC_LIST += plutommi\mtkapp\fmradio\fmradiosrc\fmradiosrc.c
		endif
endif
endif
endif
