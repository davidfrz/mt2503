...
#define EINT_CMDS  \
	...
	EINT_CMD_MASK, \
	EINT_CMD_UNMASK, \
	EINT_CMD_SET_DST_MOD_ID, \
	EINT_CMD_SET_AUTO_CHANGE_POLARTIY,
...
typedef struct
{
  ...
  /* For EINT_CMD_SET_DST_MOD_ID command. */
 typedef struct
 {
...
typedef struct
{
	kal_uint8 autoChangePol; /* The value is 1 or 0. 1 means enable auto change polarity, 0 means disable . note that the defualt value is 0 */
