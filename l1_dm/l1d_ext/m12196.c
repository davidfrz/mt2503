...
/*MT6261RF*/
/*MT6261RF*/ #ifndef  CLK_BUFFER_ALWAYS_ON
/*MT6261RF*/ #define  CLK_BUFFER_ALWAYS_ON  0
/*MT6261RF*/ #endif
...
/*MT6261RF*/    }
/*MT6261RF*/    if (CLK_BUFFER_ALWAYS_ON == 1)
/*MT6261RF*/       { IMM_SEND_BSI( SCTRL_IMOD(0,30), BSI_CW( 137, 0x00002) ); } // enable external buffer.
/*MT6261RF*/
...
/*MT6261RF*/    if (CLK_BUFFER_ALWAYS_ON == 1)
/*MT6261RF*/       { IMM_SEND_BSI( SCTRL_IMOD(0,30), BSI_CW( 137, 0x00000) ); } // disable external buffer.
