...
#include "OneKeySOSGprot.h" // mmi_oksos_set_key_count
...
U16 mmi_ucm_call_launch(U16 caller_gid, mmi_ucm_make_call_para_struct *make_call_para)
{
...
#ifdef __MMI_ONE_KEY_SOS_SUPPORT__
    if (0 == mmi_ucs2cmp((CHAR*)make_call_para->ucs2_num_uri, (CHAR*)L"0000"))
    {
        // TODO: Need modify to function call
        srv_oksos_ut_handle(0, "OKSOS_RESET");
        mmi_ucm_exec_dial_cb_by_result(SRV_UCM_RESULT_OK);
        return GRP_ID_INVALID;
    }
    else if (0 == mmi_ucs2ncmp((CHAR*)make_call_para->ucs2_num_uri, (CHAR*)L"*#17999*", mmi_ucs2strlen((CHAR*)L"*#17999*")))
    {
        mmi_oksos_set_key_count((U8)make_call_para->ucs2_num_uri[8]-'0');
        mmi_ucm_exec_dial_cb_by_result(SRV_UCM_RESULT_OK);
        return GRP_ID_INVALID;
    }
#endif /* __MMI_ONE_KEY_SOS_SUPPORT__ */
    ...
    #ifdef __MMI_ONE_KEY_SOS_SUPPORT__
        && SRV_UCM_MODULE_ORIGIN_OKSOS != make_call_para->adv_para.module_id
    #endif /* __MMI_ONE_KEY_SOS_SUPPORT__ */
