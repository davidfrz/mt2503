...
extern UI_horizontal_select_theme MMI_horizontal_select_theme;
...
typedef struct _UI_theme
{
	...
	UI_menuitem_theme* menuitem_theme;
 ...
 //   UI_fixed_twostate_menuitem_theme *fixed_twostate_menuitem_theme;
    ...
    UI_list_menu_theme *fixed_list_menu_theme;
    UI_matrix_menu_theme *matrix_menu_theme;
    UI_matrix_menu_theme *fixed_matrix_menu_theme;
    ...
    UI_horizontal_select_theme *horizontal_select_theme;
} UI_theme;
...
#define set_MMI_current_fixed_twostate_menuitem_theme_list()
...
#define MAX_PROGRESS_INDICATOR_FILLERS 1
