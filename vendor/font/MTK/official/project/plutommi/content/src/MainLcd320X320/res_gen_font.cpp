...
/* Hindi language */
    ...
    AddFont(
        ("Khmer"), ("*#0855#"), ("km-IN"), 
        FONT_DATA_FILE_PATH(Sea\\Khmer18x18_v03a.bdf),
    ...
    AddFont(
        ("Myanmar"), ("*#0095#"), ("my-IN"), 
        FONT_DATA_FILE_PATH(Sea\\Myanmar18x18_v03.bdf),
        MCT_SMALL_FONT |MCT_MEDIUM_FONT|MCT_LARGE_FONT|MCT_SUBLCD_FONT|MCT_VIRTUAL_KEYBOARD_FONT, 
        0, 0);
    AddFont(
        ("Myanmar"), ("*#0095#"), ("my-IN"), 
    ...
    AddFont(
        ("Lao"), ("*#0856#"), ("lo-IN"), 
        FONT_DATA_FILE_PATH(Sea\\Lao_18x18_v01a.bdf),
        MCT_SMALL_FONT |MCT_MEDIUM_FONT|MCT_LARGE_FONT|MCT_SUBLCD_FONT|MCT_VIRTUAL_KEYBOARD_FONT, 
        0, 0);
    AddFont(
        ("Lao"), ("*#0856#"), ("lo-IN"), 
...
/* Gujarati Language */
    ...
    AddFont(
        ("Punjabi"), ("*#9172#"), ("pa-IN"), 
        FONT_DATA_FILE_PATH(Punjabi\\Punjabi_14x14_v15a.bdf),
        MCT_SMALL_FONT | MCT_SUBLCD_FONT | MCT_VIRTUAL_KEYBOARD_FONT,
         0, 1);
    AddFont(
        ("Punjabi"), ("*#9172#"), ("pa-IN"), 
        FONT_DATA_FILE_PATH(Punjabi\\Punjabi_20x20_v15a.bdf),
        MCT_MEDIUM_FONT, 
         0, 1);        
    AddFont(
        ("Punjabi"), ("*#9172#"), ("pa-IN"), 
        FONT_DATA_FILE_PATH(Punjabi\\Punjabi_22x22_v15a.bdf),
        MCT_LARGE_FONT, 
         0, 1);
    AddFont(
        ("Punjabi"), ("*#9172#"), ("pa-IN"), 
    ...
    AddFont(
        ("Telugu"), ("*#9140#"), ("te-IN"), 
        FONT_DATA_FILE_PATH(Telugu\\Telugu_20x16_v17b.bdf),
        MCT_SMALL_FONT | MCT_SUBLCD_FONT | MCT_VIRTUAL_KEYBOARD_FONT,
         0, 1);
    AddFont(
        ("Telugu"), ("*#9140#"), ("te-IN"), 
        FONT_DATA_FILE_PATH(Telugu\\Telugu_26x20_v17b.bdf),
        MCT_MEDIUM_FONT,
         0, 1);
    AddFont(
        ("Telugu"), ("*#9140#"), ("te-IN"), 
        FONT_DATA_FILE_PATH(Telugu\\Telugu_28x22_v17b.bdf),
        MCT_LARGE_FONT,
         0, 1);
    AddFont(
        ("Telugu"), ("*#9140#"), ("te-IN"), 
    ...
    AddFont(
        ...
        FONT_DATA_FILE_PATH(Malayalam\\Malayalam_18x14_v04a.bdf),
        MCT_SMALL_FONT | MCT_SUBLCD_FONT | MCT_VIRTUAL_KEYBOARD_FONT,
        0, 1);
    AddFont(
        ("Malayalam"), ("*#9171#"), ("ml-IN"), 
        FONT_DATA_FILE_PATH(Malayalam\\Malayalam_20x20_v04a.bdf),
        MCT_MEDIUM_FONT,
        0, 1);
    AddFont(
        ("Malayalam"), ("*#9171#"), ("ml-IN"), 
        FONT_DATA_FILE_PATH(Malayalam\\Malayalam_22x22_v04a.bdf),
        MCT_LARGE_FONT,
        0, 1);
    AddFont(
        ("Malayalam"), ("*#9171#"), ("ml-IN"), 
...
/* Chinese  */
    ...
    AddFont(
        ("Chineset"), ("*#0886#"), ("zh-TW"),       
        FONT_DATA_FILE_PATH(Chinese\\uM19x20_20.bdf),
        MCT_MEDIUM_FONT | MCT_LARGE_FONT | MCT_DIALER_FONT, 
        0, 0);
...
#if defined(__MMI_CHINESE_WITH_SMALL_FONT__) && !defined(__MMI_FTE_SUPPORT__)
    AddFont(
        ("Chinesec"), ("*#0086#"), ("zh-CN"), 
...
#if 0//defined(__MMI_UI_VIRTUAL_KEYBOARD_DEFAULT_VERSION_3__) && defined(__MMI_FTE_SUPPORT__)
/* under construction !*/
#ifdef __MMI_VIRTUAL_KEYBOARD__
/* under construction !*/
/* under construction !*/
...
#if defined(__MMI_MAINLCD_320X480__) || defined(__MMI_MAINLCD_240X320__) || defined(__MMI_MAINLCD_320X240__) || defined(__MMI_MAINLCD_240X400__) || defined(__MMI_MAINLCD_240X240__)
