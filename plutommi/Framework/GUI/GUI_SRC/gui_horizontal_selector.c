...
void gui_horizontal_select_register_key_handler(void)
{
    ...
    /*----------------------------------------------------------------*/
     ...
     /* key rule. 09.10.17 */
    SetKeyRepeatHandler(gui_horizontal_select_left_key_down, KEY_LEFT_ARROW);
    SetKeyRepeatHandler(gui_horizontal_select_right_key_down, KEY_RIGHT_ARROW);
    
    SetKeyDownHandler(gui_horizontal_select_left_key_down, KEY_LEFT_ARROW);
    SetKeyDownHandler(gui_horizontal_select_right_key_down, KEY_RIGHT_ARROW);

    SetKeyUpHandler(gui_horizontal_select_left_key_up, KEY_LEFT_ARROW);
    SetKeyUpHandler(gui_horizontal_select_right_key_up, KEY_RIGHT_ARROW);
}
