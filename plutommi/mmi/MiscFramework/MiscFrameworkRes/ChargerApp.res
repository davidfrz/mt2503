...
<!----------------- Screen Id ------------------------------------------->             
   ...
   <NOTIFY id="BTBOX_CHARGER_OUT"  desc="charger-out" />
...
<!-----------------------------------------------------String Resource Area----------------------------------------------------->
    ...
    <RECEIVER id="EVT_ID_WEARABLE_DEVICE_MOVE_LEFT" proc="mmi_charbat_wearable_device_proc"/>
    <RECEIVER id="EVT_ID_WEARABLE_DEVICE_MOVE_RIGHT" proc="mmi_charbat_wearable_device_proc"/>
    <RECEIVER id="EVT_ID_TOUCHSCREEN_MOVE_LEFT" proc="mmi_charbat_wearable_device_proc"/>
    <RECEIVER id="EVT_ID_TOUCHSCREEN_MOVE_RIGHT" proc="mmi_charbat_wearable_device_proc"/>
#endif
