...
void wgui_cat200_resize_and_move(S32 inputbox_y)
{
    ...
    editor_x = MMI_multiline_inputbox_singleline.x;
    #endif /*__MMI_MULTILINE_INPUT_BOX_SINGLINE_STYLE_WITH_FTE__*/
#endif /* __MMI_EDITOR_SINGLINE_SUPPORT__ */
    wgui_inputs_sl_move(editor_x, sl_y);
}
...
//         else
        ...
        #else /*__MMI_MULTILINE_INPUT_BOX_SINGLINE_STYLE_WITH_FTE__*/
            input_box_y = MMI_multiline_inputbox_singleline.y;
        #endif /*__MMI_MULTILINE_INPUT_BOX_SINGLINE_STYLE_WITH_FTE__*/
#endif /* __MMI_EDITOR_SINGLINE_SUPPORT__ */  
    ...
    #else /*__MMI_MULTILINE_INPUT_BOX_SINGLINE_STYLE_WITH_FTE__*/
            gui_fill_rectangle(CAT200_MARGIN_WIDTH + 1, input_box_y, UI_device_width - CAT200_MARGIN_WIDTH - 1 - 1, input_box_y + CAT200_INPUTBOX_H - 1, MMI_multiline_inputbox_singleline.normal_filler->c);
    #endif /*__MMI_MULTILINE_INPUT_BOX_SINGLINE_STYLE_WITH_FTE__*/
#endif /* __MMI_EDITOR_SINGLINE_SUPPORT__ */         
        #endif /* __MMI_FTE_SUPPORT__ */
        }
...
void wgui_cat200_editor_change_callback(void)
{
    ...
    #else /*__MMI_MULTILINE_INPUT_BOX_SINGLINE_STYLE_WITH_FTE__*/    
    refresh_search_list(MMI_multiline_inputbox_singleline.text);
    #endif /*__MMI_MULTILINE_INPUT_BOX_SINGLINE_STYLE_WITH_FTE__*/
...
U32 wgui_cat_search_editor_msg_callback(void * input_box_handle, mmi_imc_message_struct_p msg_ptr)
{
    ...
    #else /*__MMI_MULTILINE_INPUT_BOX_SINGLINE_STYLE_WITH_FTE__*/        
    return mmi_input_box_msg_call_back_multiline_ext(input_box_handle, msg_ptr);
    #endif /*__MMI_MULTILINE_INPUT_BOX_SINGLINE_STYLE_WITH_FTE__*/
        ...
        U8 *history_buffer)
{
    ...
    if (history_buffer != NULL)
    {
        ...
        if (cat200_search_function)
        {
            if (!application_present)
            {
                ...
                #else /*__MMI_MULTILINE_INPUT_BOX_SINGLINE_STYLE_WITH_FTE__*/                        
                no_entries = cat200_search_function((U8*) MMI_multiline_inputbox_singleline.text);
                #endif /*__MMI_MULTILINE_INPUT_BOX_SINGLINE_STYLE_WITH_FTE__*/
    ...
    #else /*__MMI_MULTILINE_INPUT_BOX_SINGLINE_STYLE_WITH_FTE__*/      
    gui_set_multi_line_input_box_theme(&MMI_multiline_inputbox_singleline, &cat200_singleline_inputbox_theme);
    #endif /*__MMI_MULTILINE_INPUT_BOX_SINGLINE_STYLE_WITH_FTE__*/
...
void ShowCategory200Screen_ext_int(
        ...
        U8 *history_buffer)
{
     ShowCategory200Screen_ext_int_2(
        get_string(title),
        title_icon,
        left_softkey,
        right_softkey,
...
void ShowCategory200Screen_ext_int_2(
        UI_string_type title,
        U16 title_icon,
        U16 left_softkey,
        U16 right_softkey,
...
static void wgui_cat199_draw_input_method(void)
{
    ...
    #else /*__MMI_MULTILINE_INPUT_BOX_SINGLINE_STYLE_WITH_FTE__*/
    editor_x = MMI_multiline_inputbox_singleline.x;
    editor_y = MMI_multiline_inputbox_singleline.y;
    editor_height = MMI_multiline_inputbox_singleline.height; 
    editor_width = MMI_multiline_inputbox_singleline.width;    
    editor_normal_filler = MMI_multiline_inputbox_singleline.normal_filler;    
    #endif /*__MMI_MULTILINE_INPUT_BOX_SINGLINE_STYLE_WITH_FTE__*/
...
void wgui_cat199_resize_and_move(S32 inputbox_y)
{
    ...
    #else /*__MMI_MULTILINE_INPUT_BOX_SINGLINE_STYLE_WITH_FTE__*/
    wgui_inputs_sl_move(MMI_multiline_inputbox_singleline.x, inputbox_y);
    #endif /*__MMI_MULTILINE_INPUT_BOX_SINGLINE_STYLE_WITH_FTE__*/
...
void wgui_cat199_redraw_controlled_area(dm_coordinates *coordinate)
{
    ...
    S32 input_box_h = 0;
    UI_filled_area *normal_filler = NULL;    
#ifdef __MMI_UI_LIST_HIGHLIGHT_EFFECTS__
    extern S32 gblock_list_effect;
    S32 temp;
#endif /* __MMI_UI_LIST_HIGHLIGHT_EFFECTS__ */ 
...
/* draw black frame of input area */
    ...
    if (cat200_search_img)
    {
...
#ifdef __MMI_EDITOR_SINGLINE_SUPPORT__    
        input_box_y = MMI_singleline_inputbox.y;
        input_box_h = MMI_singleline_inputbox.height;
        normal_filler = MMI_singleline_inputbox.normal_filler;
#else /* __MMI_EDITOR_SINGLINE_SUPPORT__ */
        #ifndef __MMI_MULTILINE_INPUT_BOX_SINGLINE_STYLE_WITH_FTE__
        input_box_y = MMI_multiline_inputbox.y;
        input_box_h = MMI_multiline_inputbox.height;
        normal_filler = MMI_multiline_inputbox.normal_filler;
        #else /*__MMI_MULTILINE_INPUT_BOX_SINGLINE_STYLE_WITH_FTE__*/
        input_box_y = MMI_multiline_inputbox_singleline.y;
        input_box_h = MMI_multiline_inputbox_singleline.height;
        normal_filler = MMI_multiline_inputbox_singleline.normal_filler;
        #endif /*__MMI_MULTILINE_INPUT_BOX_SINGLINE_STYLE_WITH_FTE__*/
        ...
        wgui_inputs_sl_resize(input_box_w, input_box_h);

        gui_fill_rectangle(CAT200_MARGIN_WIDTH + 1, input_box_y, input_box_x, input_box_y + CAT200_INPUTBOX_H - 1, normal_filler->c);
    ...
    if (g_wgui_cat199_search_button_function)
    {
        ...
        if ((bt_w > 0) && (bt_h > 0))
        {
            ...
            gui_move_icontext_button(
                ...
                input_box_y + (((MMI_SINGLELINE_INPUTBOX_HEIGHT) - (bt_h)) >> 1));
        ...
        U8 *history_buffer)
{
    ...
    #else /*__MMI_MULTILINE_INPUT_BOX_SINGLINE_STYLE_WITH_FTE__*/
    gui_set_multi_line_input_box_theme(&MMI_multiline_inputbox_singleline, &g_cat199_singleline_inputbox_theme);
    #endif /*__MMI_MULTILINE_INPUT_BOX_SINGLINE_STYLE_WITH_FTE__*/
        ...
        U8 *history_buffer)
{
    ...
    #else /*__MMI_MULTILINE_INPUT_BOX_SINGLINE_STYLE_WITH_FTE__*/
        g_mmi_editor_hanler.input_box_handler = &MMI_multiline_inputbox_singleline;
    #endif /*__MMI_MULTILINE_INPUT_BOX_SINGLINE_STYLE_WITH_FTE__*/            
...
void RedrawCategoryControlledArea202Screen(dm_coordinates *coordinate)
{
    ...
    #else /*__MMI_MULTILINE_INPUT_BOX_SINGLINE_STYLE_WITH_FTE__*/
        gui_fill_rectangle(CAT200_MARGIN_WIDTH + 1, input_box_y, input_box_x, input_box_y + CAT200_INPUTBOX_H - 1, MMI_multiline_inputbox_singleline.normal_filler->c);
    #endif /*__MMI_MULTILINE_INPUT_BOX_SINGLINE_STYLE_WITH_FTE__*/            
