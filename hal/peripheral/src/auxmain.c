...
*
*************************************************************************/
#if (!defined(__ACCDET_SUPPORT__)&& !defined(__DRV_EXT_ACCESSORY_DETECTION__)) && !defined(__ACCDET_HYBRID_SOLUTION_SUPPORT__)  && (!defined(__EARPHONE_DISABLE__))
void AUX_EINT_HISR(void)
{
...
#if (!defined(__ACCDET_SUPPORT__)&& !defined(__DRV_EXT_ACCESSORY_DETECTION__))  && (!defined(__EARPHONE_DISABLE__))
...
void aux_task_main( task_entry_struct * task_entry_ptr )
{
	...
	ilm_struct          *aux_ilm ;
#if !defined(__ACCDET_SUPPORT__) && (!defined(__EARPHONE_DISABLE__))  	
	AUX_ID aux_id_nbr;
   ...
   adc_handle_vaux = aux_open_and_create(DCL_AUX_ADC_CHANNEL);
	...
	#if (!defined(__ACCDET_HYBRID_SOLUTION_SUPPORT__)  && (!defined(__EARPHONE_DISABLE__))  	)
