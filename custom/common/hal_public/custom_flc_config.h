...
#if (defined(__WIFI_SUPPORT__) && defined(__CUSTOM_WIFI_FEATURES_SWITCH__)) || defined(__HSUPA_SUPPORT__)
...
#elif (defined(__EGPRS_MODE__) && defined(__EPSK_TX__))
...
#endif
/* under construction !*/
#elif defined(__EGPRS_MODE__)|| (defined(__WIFI_SUPPORT__) && defined(__CUSTOM_WIFI_FEATURES_SWITCH__)) 
#ifdef WISDOM_MMI
/* under construction !*/
#else /* !WISDOM_MMI */
#if defined (__WIFI_SLIM__)
#define FLC2_SPDU_DL_POOL_SIZE  (17 * 1660) 
#else
...
#if (defined(__IOT__) && defined(__WIFI_AP_STA_CONCURRENCY__))
#define FLC2_HS_POOL_MAX_GROW_SIZE  (72 * FLC2_SPDU_UL_SIZE_EM)
#else
