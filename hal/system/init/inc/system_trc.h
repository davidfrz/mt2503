...
BEGIN_TRACE_MAP(MOD_SYSTEM)
...
#if !defined(__DUAL_TALK_MODEM_SUPPORT__) || !defined(__KAL_RECORD_BOOTUP_LOG__)
    /* 1. Boot-up Trace */

    /* ALICE */
    TRC_MSG(SST_INIT_ALICE_ENTER, "Enter ALICE init")
    TRC_MSG(SST_INIT_ALICE_EXIT, "Exit ALICE init")
    ...
    TRC_MSG(SST_INIT_ZIMAGE_ENTER, "Enter post driver init phase 1")
    TRC_MSG(SST_INIT_ZIMAGE_EXIT, "Exit post driver init phase 1 ... [ duration: %d ms ]")
...
#endif //#if !defined(__DUAL_TALK_MODEM_SUPPORT__) || !defined(__KAL_RECORD_BOOTUP_LOG__)
...
typedef enum
{
    ...
    /* ALICE */
     ...
     ,SST_INIT_TASKINIT
     ,SST_INIT_TASKINIT_INDX_STR_ENTER
     ,SST_INIT_TASKINIT_INDX_STR_EXIT
     ,SST_INIT_STR_NUM
}E_SYSTEM_TRACE;

typedef struct{
    E_SYSTEM_TRACE trace_id;
    kal_uint8* p_string;
}S_System_Bootup_Trace;

#ifdef DEFINE_SYSTEM_BOOTUP_TRACE_BUFF
S_System_Bootup_Trace system_boot_up_trace[] = {
    /* 1. Boot-up Trace */
    /* ALICE */
      {SST_INIT_ALICE_ENTER, "Enter ALICE init\n"}
     ,{SST_INIT_ALICE_EXIT, "Exit ALICE init\n"}
     ...
     ,{SST_INIT_L1DINITMODE_ENTER, "Enter L1D init mode set\n"}
     ,{SST_INIT_L1DINITMODE_EXIT, "Exit L1D init mode set ... [ duration: %d ms ]\n"}
     ...
     ,{SST_INIT_ZIMAGE_ENTER, "Enter post driver init phase 1\n"}
     ,{SST_INIT_ZIMAGE_EXIT, "Exit post driver init phase 1 ... [ duration: %d ms ]\n"}
     ...
     ,{SST_INIT_TASKINIT_INDX_STR_ENTER, "    Enter task init - %d task_indx_type\n"}
     ,{SST_INIT_TASKINIT_INDX_STR_EXIT, "    Exit task init - %d task_indx_type ... [ duration: %d ms ]\n"}
};
#else
extern S_System_Bootup_Trace system_boot_up_trace[];
#endif
#endif //#if defined(__KAL_RECORD_BOOTUP_LOG__) && defined(__DUAL_TALK_MODEM_SUPPORT__)
