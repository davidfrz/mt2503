...
static void L4StartTimer_ts(
        U16 nTimerId,
        oslTimerFuncPtr TimerExpiry,
        void *funcArg,
        U32 nTimeDuration,
        U16 alignment,
        MMI_BOOL ignore_by_ts);
#endif
...
#if defined(__TINY_SYS__)
static void StartTimerCommon_ts(U16 timerid, U32 delay, oslTimerFuncPtr funcPtr, void* arg,
							mmi_frm_timer_type_enum timer_type, MMI_BOOL ignore_by_ts);
								...
								mmi_frm_timer_type_enum timer_type, MMI_BOOL ignore_by_ts)
{
	...
	/*----------------------------------------------------------------*/
	L4StopTimer(timerid);
	L4StartTimer_ts(timerid, (oslTimerFuncPtr)funcPtr, (void *)arg, delay, timer_type, ignore_by_ts);
}
 ...
 *  void
 *****************************************************************************/
void StartTimer_ts(U16 timerid, U32 delay, FuncPtr funcPtr, MMI_BOOL ignore_by_ts)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
    ...
    //L4StartTimer(timerid, (oslTimerFuncPtr)funcPtr, 
    //                (void *)timerid, delay, TIMER_IS_ALIGNMENT);
    StartTimerCommon_ts(timerid, delay, (oslTimerFuncPtr)funcPtr, (void*)timerid, TIMER_IS_ALIGNMENT, ignore_by_ts);
}
 ...
 *  void
 *****************************************************************************/
void StartTimerEx_ts(U16 timerid, U32 delay, oslTimerFuncPtr funcPtr, void* arg, MMI_BOOL ignore_by_ts)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
    ...
    //L4StartTimer(timerid, (oslTimerFuncPtr)funcPtr, 
    //                (void *)arg, delay, TIMER_IS_ALIGNMENT);
    StartTimerCommon_ts(timerid, delay, funcPtr, arg, TIMER_IS_ALIGNMENT, ignore_by_ts);
}
 ...
 *  void
 *****************************************************************************/
void StartNonAlignTimer_ts(U16 timerid, U32 delay, FuncPtr funcPtr, MMI_BOOL ignore_by_ts)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
    ...
    //L4StartTimer(timerid, (oslTimerFuncPtr)funcPtr, 
    //                (void *)timerid, delay, TIMER_IS_NO_ALIGNMENT);
    StartTimerCommon_ts(timerid, delay, (oslTimerFuncPtr)funcPtr, (void*)timerid, TIMER_IS_NO_ALIGNMENT, ignore_by_ts);
}
 ...
 *  void
 *****************************************************************************/
void StartNonAlignTimerEx_ts(U16 timerid, U32 delay, oslTimerFuncPtr funcPtr, void* arg, MMI_BOOL ignore_by_ts)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
    ...
    //L4StartTimer(timerid, (oslTimerFuncPtr)funcPtr, 
    //                (void *)arg, delay, TIMER_IS_NO_ALIGNMENT);
    StartTimerCommon_ts(timerid, delay, funcPtr, arg, TIMER_IS_NO_ALIGNMENT, ignore_by_ts);
}
...
void EvshedMMITimerHandler(void *dataPtr)
{
    ...
    #if defined(__MMI_WEARABLE_DEVICE__) && !defined(__IOT__)
    mmi_idle_swatch_base_timer_expire_process((stack_timer_struct*)(((ilm_struct*)dataPtr)->local_para_ptr));
    #endif  //defined(__MMI_WEARABLE_DEVICE__) && !defined(__IOT__)
}
...
*/    
	...
	pTable->tm[i].timer_type = alignment;
    pTable->tm[i].timer_id = nTimerId;
    pTable->tm[i].event_id = evshed_set_event_ts(
                                event_scheduler_ptr[alignment],
                                (kal_timer_func_ptr) L4CallBackTimer,
                                (void*)&(pTable->tm[i]),
                                temp,
