...
typedef enum
{
    MENU_ID_FM_ROOT = 13658 + 1, /* BASE_ID + 1 */
    MENU_ID_FM_WEARABLE_LCD,
    MENU_ID_FM_BACKLIGHT,
    MENU_ID_FM_WEARABLE_TOUCH_PANEL,
    MENU_ID_FM_MIC_SPEAKER,
    MENU_ID_FM_VIBRATOR,
    MENU_ID_FM_ADC,
    MENU_ID_FM_BT,
    MENU_ID_FM_RESET,
    ...
    MENU_ID_FM_LED,
    MENU_ID_FM_LED_MAIN,
    MENU_ID_FM_LED_KEYPAD,
    MENU_ID_FM_LED_STATUS_R,
    MENU_ID_FM_LED_STATUS_G,
    MENU_ID_FM_LED_STATUS_B,
    MENU_ID_FM_LCD,
    MENU_ID_FM_LCD_AUTO,
    MENU_ID_FM_LCD_R,
    MENU_ID_FM_LCD_G,
...
typedef enum
{
    STR_ID_FM_ROOT = 13658 + 1, /* BASE_ID + 1 */
    STR_ID_FM_VERSION,
...
typedef enum
{
    SCR_ID_FM_MISC_AUTO_TEST_SETTING = 13658 + 1, /* BASE_ID + 1 */
...
typedef enum
{
    FM_LCD_COLOR_CHANGE_TIMER = 13658 + 1, /* BASE_ID + 1 */
