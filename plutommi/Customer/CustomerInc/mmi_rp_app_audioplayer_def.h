...
typedef enum
{
    MENU_ID_AUDPLY_PLAYER_SETTING = 35658 + 1, /* BASE_ID + 1 */
...
typedef enum
{
    STR_ID_AUDPLY_TITLE = 35658 + 1, /* BASE_ID + 1 */
...
typedef enum
{
    SCR_ID_AUDPLY_BASE = 35658 + 1, /* BASE_ID + 1 */
...
typedef enum
{
    AUDPLY_PROCESS_ADD_FILE_TIMER = 35658 + 1, /* BASE_ID + 1 */
...
typedef enum
{
    NVRAM_AUDPLY_LIST_AUTO_GEN = 35658 + 1, /* BASE_ID + 1 */   /*         BYTE */ 
...
typedef enum
{
    IMG_ID_AUDPLY_PLAY_ANIMATION = 35658 + 1, /* BASE_ID + 1 */
    IMG_ID_AUDPLY_ICON,
    ...
    IMG_ID_AUDPLY_MAIN_SKIN1_VOLUME_SPEAK_BUTTON_UP,
    IMG_ID_AUDPLY_MAIN_SKIN1_VOLUME_SPEAK_MUTE_BUTTON_UP,
    IMG_ID_AUDPLY_MAIN_SKIN1_OPTION_UP,
    IMG_ID_AUDPLY_MAIN_SKIN1_OPTION_DOWN,
    IMG_ID_AUDPLY_MAIN_SKIN1_BACK_UP,
    IMG_ID_AUDPLY_MAIN_SKIN1_BACK_DOWN,
