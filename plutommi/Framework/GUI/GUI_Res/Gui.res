...
<STRING id = "WGUI_CATEGORY_UK_ABC_STRING_ID">ABC-UK</STRING>;
    ...
    <IMAGE id = "WGUI_VOLUME_UP_UP_IMAGE_ID">CUST_IMG_PATH"\\\\MainLCD\\\\wsettings\\\\Setting_increase.png"</IMAGE>;
    <IMAGE id = "WGUI_VOLUME_UP_DOWN_IMAGE_ID">CUST_IMG_PATH"\\\\MainLCD\\\\wsettings\\\\Setting_increase_pressed.png"</IMAGE>;
    <IMAGE id = "WGUI_VOLUME_UP_DISABLE_IMAGE_ID">CUST_IMG_PATH"\\\\MainLCD\\\\wsettings\\\\Setting_increase.png"</IMAGE>;
    <IMAGE id = "WGUI_VOLUME_DOWN_UP_IMAGE_ID">CUST_IMG_PATH"\\\\MainLCD\\\\wsettings\\\\Setting_decrease.png"</IMAGE>;
    <IMAGE id = "WGUI_VOLUME_DOWN_DOWN_IMAGE_ID">CUST_IMG_PATH"\\\\MainLCD\\\\wsettings\\\\Setting_decrease_pressed.png"</IMAGE>;
    <IMAGE id = "WGUI_VOLUME_DOWN_DISABLE_IMAGE_ID">CUST_IMG_PATH"\\\\MainLCD\\\\wsettings\\\\Setting_decrease.png"</IMAGE>;
    #if defined(__MMI_WEARABLE_DEVICE_UI_ENHANCE__)
    <IMAGE id = "WGUI_PROGRESS_LEVEL_IMAGE_ID">CUST_IMG_PATH"\\\\MainLCD\\\\wsettings\\\\voice_status_bg.png"</IMAGE>;
    <IMAGE id = "WGUI_PROGRESS_BG_IMAGE_ID">CUST_IMG_PATH"\\\\MainLCD\\\\wsettings\\\\voice_status_h.png"</IMAGE>;
    ...
    <IMAGE id = "IMG_DIALING_KEY_HASH">CUST_IMG_PATH"\\\\MainLCD\\\\DialingScreen\\\\TH_DIALING_DEL.PNG"</IMAGE>;
    <IMAGE id = "IMG_DIALING_KEY_STAR">CUST_IMG_PATH"\\\\MainLCD\\\\DialingScreen\\\\TH_DIALING_CALL.PNG"</IMAGE>;
    
    <IMAGE id = "IMG_DIALING_KEY_7_EX">CUST_IMG_PATH"\\\\MainLCD\\\\DialingScreen\\\\TH_DIALING_7.png"</IMAGE>;
    <IMAGE id = "IMG_DIALING_KEY_0_EX">CUST_IMG_PATH"\\\\MainLCD\\\\DialingScreen\\\\TH_DIALING_0.png"</IMAGE>;
    <IMAGE id = "IMG_DIALING_KEY_9_EX">CUST_IMG_PATH"\\\\MainLCD\\\\DialingScreen\\\\TH_DIALING_9.png"</IMAGE>;
    <IMAGE id = "IMG_DIALING_KEY_STAR_EX">CUST_IMG_PATH"\\\\MainLCD\\\\DialingScreen\\\\TH_DIALING_star.png"</IMAGE>;
    <IMAGE id = "IMG_DIALING_KEY_HASH_EX">CUST_IMG_PATH"\\\\MainLCD\\\\DialingScreen\\\\TH_DIALING_special.png"</IMAGE>;
...
#define DIALING_SCREEN_PATH     CUST_IMG_PATH"\\\\MainLCD\\\\DialingScreen\\\\"
    ...
    <IMAGE id = "IMG_DIALING_KEY_HASH_DOWN">DIALING_SCREEN_PATH"TH_DIALING_DEL_down.PNG"</IMAGE>;
    <IMAGE id = "IMG_DIALING_KEY_STAR_DOWN">DIALING_SCREEN_PATH"TH_DIALING_CALL_down.PNG"</IMAGE>;
    
    <IMAGE id = "IMG_DIALING_KEY_7_DOWN_EX">DIALING_SCREEN_PATH"TH_DIALING_7_down.png"</IMAGE>;
    <IMAGE id = "IMG_DIALING_KEY_0_DOWN_EX">DIALING_SCREEN_PATH"TH_DIALING_0_down.png"</IMAGE>;
    <IMAGE id = "IMG_DIALING_KEY_9_DOWN_EX">DIALING_SCREEN_PATH"TH_DIALING_9_down.png"</IMAGE>;
    <IMAGE id = "IMG_DIALING_KEY_HASH_DOWN_EX">DIALING_SCREEN_PATH"TH_DIALING_special_down.png"</IMAGE>;
    <IMAGE id = "IMG_DIALING_KEY_STAR_DOWN_EX">DIALING_SCREEN_PATH"TH_DIALING_star_down.png"</IMAGE>;
...
#if defined(__MMI_FTE_SUPPORT__) && defined(__SLIM_UCM__) && !defined(__MMI_WEARABLE_DEVICE__)
...
#ifdef __MMI_WEARABLE_DEVICE__
	<IMAGE id="IMG_ID_CALL_MUTE_ON">CUST_IMG_PATH"\\\\MainLCD\\\\Call\\\\Incoming\\\\mute_on.png"</IMAGE>
	<IMAGE id="IMG_ID_CALL_MUTE_OFF">CUST_IMG_PATH"\\\\MainLCD\\\\Call\\\\Incoming\\\\mute_off.png"</IMAGE>
	<IMAGE id="IMG_ID_CALL_MUTE_ON_PRESS">CUST_IMG_PATH"\\\\MainLCD\\\\Call\\\\Incoming\\\\mute_on_p.png"</IMAGE>
	<IMAGE id="IMG_ID_CALL_MUTE_OFF_PRESS">CUST_IMG_PATH"\\\\MainLCD\\\\Call\\\\Incoming\\\\mute_off_p.png"</IMAGE>
	<IMAGE id="IMG_ID_CALL_ACCEPT_NORMAL">CUST_IMG_PATH"\\\\MainLCD\\\\Call\\\\Incoming\\\\slide_accept_normal.png"</IMAGE>
	<IMAGE id="IMG_ID_CALL_ACCEPT_PRESS">CUST_IMG_PATH"\\\\MainLCD\\\\Call\\\\Incoming\\\\slide_accept_pressed.png"</IMAGE>
	<IMAGE id="IMG_ID_CALL_REJECT_NORMAL">CUST_IMG_PATH"\\\\MainLCD\\\\Call\\\\Incoming\\\\slide_reject_normal.png"</IMAGE>
	<IMAGE id="IMG_ID_CALL_REJECT_PRESS">CUST_IMG_PATH"\\\\MainLCD\\\\Call\\\\Incoming\\\\slide_reject_pressed.png"</IMAGE>
	<IMAGE id="IMG_ID_CALL_REJECT_DISABLE">CUST_IMG_PATH"\\\\MainLCD\\\\Call\\\\Incoming\\\\slide_reject_d.png"</IMAGE>
	<IMAGE id="IMG_ID_CALL_UNHOLD_NORMAL">CUST_IMG_PATH"\\\\MainLCD\\\\Call\\\\Incoming\\\\unhold_n.png"</IMAGE>
	<IMAGE id="IMG_ID_CALL_UNHOLD_PRESS">CUST_IMG_PATH"\\\\MainLCD\\\\Call\\\\Incoming\\\\unhold_p.png"</IMAGE>

	<IMAGE id="IMG_ID_CALL_ARROW_REJECT1">CUST_IMG_PATH"\\\\MainLCD\\\\Call\\\\Incoming\\\\arrow_left01.png"</IMAGE>
	<IMAGE id="IMG_ID_CALL_ARROW_REJECT2">CUST_IMG_PATH"\\\\MainLCD\\\\Call\\\\Incoming\\\\arrow_left02.png"</IMAGE>
	<IMAGE id="IMG_ID_CALL_ARROW_REJECT3">CUST_IMG_PATH"\\\\MainLCD\\\\Call\\\\Incoming\\\\arrow_left03.png"</IMAGE>
	<IMAGE id="IMG_ID_CALL_ARROW_REJECT4">CUST_IMG_PATH"\\\\MainLCD\\\\Call\\\\Incoming\\\\arrow_left04.png"</IMAGE>
	<IMAGE id="IMG_ID_CALL_ARROW_REJECT5">CUST_IMG_PATH"\\\\MainLCD\\\\Call\\\\Incoming\\\\arrow_left05.png"</IMAGE>
	<IMAGE id="IMG_ID_CALL_ARROW_ACCEPT1">CUST_IMG_PATH"\\\\MainLCD\\\\Call\\\\Incoming\\\\arrow_right01.png"</IMAGE>
	<IMAGE id="IMG_ID_CALL_ARROW_ACCEPT2">CUST_IMG_PATH"\\\\MainLCD\\\\Call\\\\Incoming\\\\arrow_right02.png"</IMAGE>
	<IMAGE id="IMG_ID_CALL_ARROW_ACCEPT3">CUST_IMG_PATH"\\\\MainLCD\\\\Call\\\\Incoming\\\\arrow_right03.png"</IMAGE>
	<IMAGE id="IMG_ID_CALL_ARROW_ACCEPT4">CUST_IMG_PATH"\\\\MainLCD\\\\Call\\\\Incoming\\\\arrow_right04.png"</IMAGE>
	<IMAGE id="IMG_ID_CALL_ARROW_ACCEPT5">CUST_IMG_PATH"\\\\MainLCD\\\\Call\\\\Incoming\\\\arrow_right05.png"</IMAGE>
	
	<IMAGE id="IMG_ID_CALL_VOL_BG">CUST_IMG_PATH"\\\\MainLCD\\\\wsettings\\\\voice_status_bg_dail.png"</IMAGE>
	<IMAGE id="IMG_ID_CALL_VOL">CUST_IMG_PATH"\\\\MainLCD\\\\wsettings\\\\voice_status_h_dail.png"</IMAGE>
	
	<STRING id = "STR_ID_SWATCH_REJECT"/>
	<STRING id = "STR_ID_SWATCH_ANSWER"/>
	<STRING id = "STR_ID_SWATCH_REPLACE"/>
	<STRING id = "STR_ID_SWATCH_VOL_INFO_CONTENT"/>
#endif /*__MMI_WEARABLE_DEVICE__*/
...
//#endif
	...
	#if  defined(__MMI_MAINLCD_240X240__) && defined(__MMI_WEARABLE_DEVICE__)
        <IMAGE id = "IMG_INLINE_ML_HIGHLIGHT_BG">CUST_IMG_BASE_PATH"\\\\EmptyImage.bmp"</IMAGE>;
        <IMAGE id = "IMG_INLINE_ML_NORMAL_BG">CUST_IMG_BASE_PATH"\\\\EmptyImage.bmp"</IMAGE>;

        <IMAGE id = "IMG_INLINE_DISPLAY_ONLY_HIGHLIGHT_BG">CUST_IMG_BASE_PATH"\\\\EmptyImage.bmp"</IMAGE>;
        <IMAGE id = "IMG_INLINE_DISPLAY_ONLY_NORMAL_BG">CUST_IMG_BASE_PATH"\\\\EmptyImage.bmp"</IMAGE>;
...
#if  defined(__MMI_FTE_SUPPORT__) && defined(__MMI_MAINLCD_240X240__) && defined(__MMI_WEARABLE_DEVICE__)

    <IMAGE id = "IMG_INLINE_BUTTON_HIGHLIGHT_UP_BG">CUST_IMG_BASE_PATH"\\\\EmptyImage.bmp"</IMAGE>;
    <IMAGE id = "IMG_INLINE_BUTTON_NORMAL_UP_BG">CUST_IMG_BASE_PATH"\\\\EmptyImage.bmp"</IMAGE>;
    <IMAGE id = "IMG_INLINE_BUTTON_HIGHLIGHT_DOWN_BG">CUST_IMG_BASE_PATH"\\\\EmptyImage.bmp"</IMAGE>;
    <IMAGE id = "IMG_INLINE_BUTTON_NORMAL_DOWN_BG">CUST_IMG_BASE_PATH"\\\\EmptyImage.bmp"</IMAGE>;    
#else
...
//#endif
...
#if defined(__MMI_WEARABLE_DEVICE__)
    <IMAGE id="IMG_BTNOTIFICATON_PAGE_DOT_NORMAL">CUST_IMG_PATH"\\\\MainLCD\\\\Bluetooth\\\\Dot_Normal.png"</IMAGE>
    <IMAGE id="IMG_BTNOTIFICATON_PAGE_DOT_SELECT">CUST_IMG_PATH"\\\\MainLCD\\\\Bluetooth\\\\Dot_Sel.png"</IMAGE> 
#endif

#if  defined(__MMI_FTE_SUPPORT__) && defined(__MMI_MAINLCD_240X240__)&& defined(__MMI_WEARABLE_DEVICE__)
    <IMAGE id = "WGUI_IMG_TEXT_BG_PREVIEW">CUST_IMG_BASE_PATH"\\\\EmptyImage.bmp"</IMAGE>;
#else
    ...
    <RECEIVER id="EVT_ID_WEARABLE_DEVICE_MOVE_RIGHT" proc="mmi_ssp_pen_move_right_hdlr"/>
