...
<APP id="APP_BOOTUP">
...
#endif
#endif
#if defined(__TINY_SYS__)&&defined(__MMI_TOUCH_SCREEN__)
	<RECEIVER id="EVT_ID_GPIO_BACKLIGHT_ON" proc="mmi_tiny_to_ap_power_on_touch"/>
#endif
    ...
    <TIMER id="BOOTUP_WAITING_SCREEN_TIMER"/>
		...
		<TIMER id="KEY_CONTINUE_CLICK_TIMER"/>
#endif

#ifdef __MMI_BT_NOTI_SRV__
    <TIMER id="FOTA_REBOOT_DELAY_TIMER"/>
#endif
