...
const mmi_fm_test_item_struct g_fm_test_item_tab[] =
{
    ...
    {MENU_ID_FM_ROOT,                   NULL,                               NULL }, 
        /* Version */
    {MENU_ID_FM_VERSION,    			mmi_fm_select_version, 			mmi_fm_default_func},
	/* LED */
	{MENU_ID_FM_WEARABLE_LCD,			mmi_fm_select_wearable_lcd,		mmi_fm_default_func}, 
	{MENU_ID_FM_BACKLIGHT,				mmi_fm_select_backlight,		mmi_fm_default_func}, 
#ifdef  __MMI_FM_TOUCH_PANEL_ACCURACY_TEST__
    {MENU_ID_FM_WEARABLE_TOUCH_PANEL,   mmi_fm_select_wearable_touch_panel, mmi_fm_default_func},
#endif /*__MMI_FM_TOUCH_PANEL_ACCURACY_TEST__*/
    {MENU_ID_FM_MIC_SPEAKER,            mmi_fm_select_mic_spk,    		mmi_fm_default_func},   

    {MENU_ID_FM_VIBRATOR,               mmi_fm_select_vibrator,    		mmi_fm_default_func},   
	 /* ADC */
	{MENU_ID_FM_ADC,					mmi_fm_select_adc_menu,			mmi_fm_default_func},
#ifdef __MMI_WEARABLE_DEVICE_FM_SENSOR_TEST__  
	{MENU_ID_FM_SENSOR,					mmi_fm_select_sensor, 			mmi_fm_default_func},	
	{MENU_ID_FM_G_SENSOR_CALIBRATION,	mmi_fm_select_Gsensor_calibration, mmi_fm_default_func},
#endif /*__MMI_WEARABLE_DEVICE_FM_SENSOR_TEST__*/
	{MENU_ID_FM_BT,					    mmi_fm_select_bluetooth,		mmi_fm_default_func},
	{MENU_ID_FM_RESET,					mmi_fm_select_reset,			mmi_fm_default_func},
};
...
static void mmi_fm_avoid_audio_conflict(void)
{
	...
	g_fm_contxt->led_contxt.FM_LEDState = 0;
#endif /*__MMI_WEARABLE_DEVICE_FACTORY_MODE__*/
