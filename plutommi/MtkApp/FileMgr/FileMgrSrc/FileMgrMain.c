...
mmi_fmgr_instance_struct* fmgr_main_get_processing_instance(void);
    ...
    switch (event_type)
    {
        ...
        case FMGRI_EVENT_LSK:
            if (instance->cur_index < 0)
            {
                ...
                mmi_fmgr_hide_all_menu_set(MENU_ID_FMGR_GEN_TYPE_OPTIONS);
                mmi_frm_unhide_menu_item(MENU_ID_FMGR_FOLDER_CREATE);
                ...
                mmi_fmgri_show_option(mmi_fmgri_instance_get_screen_id(instance->id),
                    (U16)MENU_ID_FMGR_GEN_TYPE_OPTIONS, fmgr_main_options_handler , instance->id, icon_id);
#endif
