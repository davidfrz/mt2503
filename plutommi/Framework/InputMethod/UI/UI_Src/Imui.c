...
static void mmi_imui_update_ui_theme(void)
{
	...
	g_imui_ui_theme.scrolling_comp_cand_background_highlighted = (PU8) get_image(MMI_IMUI_IMG_IME_SC_CAND_BG_HL);
	 ...
	 #if defined(__MMI_IME_CANDIDATE_GRID__)
	g_imui_ui_theme.cand_grid_arrow_down = (PU8) GetImageData(g_imui_ui_theme.cand_grid_arrow_down);
	g_imui_ui_theme.cand_grid_arrow_up = (PU8) GetImageData(g_imui_ui_theme.cand_grid_arrow_up);
	g_imui_ui_theme.cand_grid_arrow_down_disable = (PU8) GetImageData(g_imui_ui_theme.cand_grid_arrow_down_disable);
	g_imui_ui_theme.cand_grid_arrow_up_disable = (PU8) GetImageData(g_imui_ui_theme.cand_grid_arrow_up_disable);
    g_imui_ui_theme.cand_grid_back = (PU8) GetImageData(g_imui_ui_theme.cand_grid_back);
    g_imui_ui_theme.cand_grid_backspace = (PU8) GetImageData(g_imui_ui_theme.cand_grid_backspace);
	g_imui_ui_theme.cand_grid_candidate_background = (PU8) GetImageData(g_imui_ui_theme.cand_grid_candidate_background);
	g_imui_ui_theme.cand_grid_candidate_background_highlighted = (PU8) GetImageData(g_imui_ui_theme.cand_grid_candidate_background_highlighted);
	g_imui_ui_theme.cand_grid_expand = (PU8) GetImageData(g_imui_ui_theme.cand_grid_expand);
	g_imui_ui_theme.cand_grid_background = (PU8) GetImageData(g_imui_ui_theme.cand_grid_background);
	g_imui_ui_theme.cand_grid_background_black = (PU8) GetImageData(g_imui_ui_theme.cand_grid_background_black);
    #endif
    #if defined(__MMI_IME_SCROLLING_COMPOSITION__)
	g_imui_ui_theme.scrolling_comp_background = (PU8) GetImageData(g_imui_ui_theme.scrolling_comp_background);
	g_imui_ui_theme.scrolling_comp_cand_background = (PU8) GetImageData(g_imui_ui_theme.scrolling_comp_cand_background);
	g_imui_ui_theme.scrolling_comp_cand_background_highlighted = (PU8) GetImageData(g_imui_ui_theme.scrolling_comp_cand_background_highlighted);
    #endif
#endif
#endif /* #if defined(__MMI_IME_FTE_ENHANCE__) */
...
#ifdef __MMI_RESOURCE_LZMA_IMAGE_GROUP_COMPRESS__
	#if defined(__MMI_IME_CANDIDATE_GRID__)
	SetImageFlushable(g_imui_ui_theme.cand_grid_arrow_down);
	SetImageFlushable(g_imui_ui_theme.cand_grid_arrow_up);
	SetImageFlushable(g_imui_ui_theme.cand_grid_arrow_down_disable);
	SetImageFlushable(g_imui_ui_theme.cand_grid_arrow_up_disable);
    SetImageFlushable(g_imui_ui_theme.cand_grid_back);
    SetImageFlushable(g_imui_ui_theme.cand_grid_backspace);
	SetImageFlushable(g_imui_ui_theme.cand_grid_candidate_background);
	SetImageFlushable(g_imui_ui_theme.cand_grid_candidate_background_highlighted);
	SetImageFlushable(g_imui_ui_theme.cand_grid_expand);
	SetImageFlushable(g_imui_ui_theme.cand_grid_background);
	SetImageFlushable(g_imui_ui_theme.cand_grid_background_black);
    #endif
    #if defined(__MMI_IME_SCROLLING_COMPOSITION__)
	SetImageFlushable(g_imui_ui_theme.scrolling_comp_background);
	SetImageFlushable(g_imui_ui_theme.scrolling_comp_cand_background);
	SetImageFlushable(g_imui_ui_theme.scrolling_comp_cand_background_highlighted);
    #endif
#endif
    return lresult;
...
static U32 mmi_imui_redraw_all(void)
{
...
#endif
    {
        ...
        gui_set_clip(MMI_content_x, 0, MMI_content_x + MMI_content_width - 1, MMI_content_y + MMI_content_height - 1);
#else
...
static void mmi_imui_update_selection_area_fte_theme(mmi_imui_selection_area_struct_p area_ptr)
{
    ...
    #if defined(__MMI_MAINLCD_320X240__) || defined(__MMI_MAINLCD_240X240__)|| defined(__MMI_MAINLCD_320X320__) || defined(__MMI_MAINLCD_240X320__)
