...
#if defined(__MMI_TOUCH_SCREEN__) && defined(__MMI_PICTURE_EDITOR_SUPPORT__)
...
void EntryScreen_121(void)
{
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
    #if !defined(__COSMOS_MMI_PACKAGE__) && !defined(__MMI_ALARM_SLIM__)
...
#if defined(__MMI_DISPLAY_ICONS_IN_TITLE__)
