...
#if defined(__MMI_MRE_PREINSTALL_TCARD_PACKAGE__)||defined(__MMI_MRE_PREINSTALL_SYS_PACKAGE__)|| defined(__MMI_MRE_PREINSTALL_PHONE_PACKAGE__)
	#ifndef	__MMI_MRE_PREINSTALL_
	#define __MMI_MRE_PREINSTALL_
	#endif
#endif

#if defined(__MMI_SMART_DEVICE_SECURITY_SUPPORT__) 
	#ifndef __MMI_MRE_AUTH_SUPPORT__
	#define __MMI_MRE_AUTH_SUPPORT__
	#endif
#endif
...
//#define SRV_MRE_APPMGR_AUTO_START_FOLDER L":\\autostart\\"
#define SRV_MRE_APPMGR_AUTO_START_FILE  L":\\autostart.txt"
#define SRV_MRE_APPMGR_AUTO_FILE_RESULT  L":\\result.txt"
#endif
...
#ifdef __MMI_MRE_PREINSTALL_SYS_PACKAGE__
#define SRV_MRE_APPMGR_PREINSTALL_DRV SRV_FMGR_SYSTEM_DRV
#else
#ifdef __MMI_MRE_PREINSTALL_PHONE_PACKAGE__
#define SRV_MRE_APPMGR_PREINSTALL_DRV SRV_FMGR_PHONE_DRV
#else
#define SRV_MRE_APPMGR_PREINSTALL_DRV SRV_FMGR_CARD_DRV
#endif
#endif
...
typedef enum
{
    ...
    SRV_MRE_APPMGR_APP_TYPE_CTA_FULL = 0x0040,/* Full authorization*/
...
typedef enum
{
    SRV_MRE_APPMGR_APP_AUTH_CALLOUT = 0x00000001, // call out
    SRV_MRE_APPMGR_APP_AUTH_SMS_SEND = 0x00000002, // send sms
    SRV_MRE_APPMGR_APP_AUTH_MMS_SEND = 0x00000004, // send mms
    SRV_MRE_APPMGR_APP_AUTH_GPRS_SWITCH = 0x00000008, // unused
    SRV_MRE_APPMGR_APP_AUTH_GPRS_CONNECT = 0x00000010, // GPRS connect
    SRV_MRE_APPMGR_APP_AUTH_WLAN_SWITCH = 0x00000020, // unused
    SRV_MRE_APPMGR_APP_AUTH_WLAN_CONNECT = 0x00000040, // WLAN connect
    SRV_MRE_APPMGR_APP_AUTH_GPS = 0x00000080, // GPS
    SRV_MRE_APPMGR_APP_AUTH_CALL_RECORDER = 0x00000100, // unused
    SRV_MRE_APPMGR_APP_AUTH_RECORDER = 0x00000200, // recorder
    SRV_MRE_APPMGR_APP_AUTH_CAMERA = 0x00000400, // camera
    SRV_MRE_APPMGR_APP_AUTH_CONTACT_READ = 0x00000800, // unused
    SRV_MRE_APPMGR_APP_AUTH_CALLLOG_READ = 0x00001000, // read calllog
    SRV_MRE_APPMGR_APP_AUTH_SMS_READ = 0x00002000, // read sms
    SRV_MRE_APPMGR_APP_AUTH_MMS_READ = 0x00004000, // read mms
    SRV_MRE_APPMGR_APP_AUTH_BT_SWITCH = 0x00008000, // BT
    SRV_MRE_APPMGR_APP_AUTH_SMS_DELETE = 0x00010000, // delete sms
    SRV_MRE_APPMGR_APP_AUTH_ALL  = 0x80000000, // full authorization
} srv_mre_appmgr_app_authorization_enum;
...
*  MMI_FALSE : If failed.
*****************************************************************************/
extern MMI_BOOL srv_mre_appmgr_get_authorization(mmi_app_package_char *app_name, U32 *app_defined_auth, U32 *user_defined_auth);
...
*  MMI_FALSE : If failed.
*****************************************************************************/
extern MMI_BOOL srv_mre_appmgr_set_user_defined_authorization(mmi_app_package_char *app_name, U32 auth);
...
*  MMI_FALSE : If failed.
*****************************************************************************/
extern MMI_BOOL srv_mre_appmgr_check_user_defined_authorization(mmi_app_package_char *app_name, srv_mre_appmgr_app_authorization_enum auth);
...
*  MMI_FALSE : If failed.
*****************************************************************************/
extern MMI_BOOL srv_mre_appmgr_check_current_defined_authorization(srv_mre_appmgr_app_authorization_enum auth);
...
*  others: If failed.
*****************************************************************************/
extern S32 srv_mre_appmgr_install_app_ex(
    U16 *app_path,
    srv_mre_appmgr_app_type_enum app_type,
    mmi_app_package_char *app_name);
...
*****************************************************************************/
extern S32 srv_mre_appmgr_install_and_auto_launch_app(
                                    U16 *app_path,
                                    srv_mre_appmgr_app_type_enum app_type,
                                    mmi_app_package_char *app_name);
...
*  void
*****************************************************************************/
extern MMI_BOOL srv_mre_appmgr_app_uninstall_and_delete_app();
extern MMI_BOOL srv_mre_appmgr_app_uninstall_and_delete_app_ex(U16* app_name_prefix);
