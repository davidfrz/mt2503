...
typedef enum
{
    ...
    BT_MUSIC_MAIN_PLAY_PAUSE,
#endif
    BT_MUSIC_MAIN_PREV,
    BT_MUSIC_MAIN_NEXT,
#ifdef __MMI_WEARABLE_DEVICE__
	BT_MUSIC_MAIN_VOL_UP,
    BT_MUSIC_MAIN_VOL_DOWN,
#endif
...
typedef struct
{
    ...
    U16 prev_image_id, prev_dimmed_image_id, pre_down_image_id;
	S16 prev_x, prev_y;
	S16 prev_w, prev_h;

    /*move next button*/
    U16 next_image_id, next_dimmed_image_id, next_down_image_id;
	S16 next_x, next_y;
	S16 next_w, next_h;

	/*play button*/
    U16 play_image_id, play_dimmed_image_id, play_down_image_id;
	S16 play_x, play_y;
	S16 play_w, play_h;

    /*pause button*/
    U16 pause_image_id, pause_dimmed_image_id, pause_down_image_id;
	S16 pause_x, pause_y;
	S16 pause_w, pause_h;

	/*volume up button*/
    U16 vol_up_image_id, vol_up_dimmed_image_id, vol_up_down_image_id;
	S16 vol_up_x, vol_up_y;
	S16 vol_up_w, vol_up_h;

	/*volume down button*/
    U16 vol_down_image_id, vol_down_dimmed_image_id, vol_down_down_image_id;
	S16 vol_down_x, vol_down_y;
	S16 vol_down_w, vol_down_h;
	
#ifdef __MMI_TOUCH_SCREEN__
    bt_music_polygon_area_struct prev_button_area;
    bt_music_polygon_area_struct next_button_area;
    bt_music_polygon_area_struct play_button_area;
	bt_music_polygon_area_struct vol_up_button_area;
	bt_music_polygon_area_struct vol_down_button_area;
#endif /* __MMI_TOUCH_SCREEN__ */ 

} mmi_wr_bt_skin_struct;
...
#ifdef __MMI_BT_AVRCP_V13__
extern bt_music_info_struct *mmi_bt_music_get_song_info(void);
#endif
#ifdef __MMI_WEARABLE_DEVICE__
extern void mmi_wr_bt_music_redraw_main_btns_bt(void);
#endif 
extern S16 mmi_bt_music_get_main_sel_btn(void);

extern void mmi_bt_musice_set_btn_status(void);
#ifdef __MMI_WEARABLE_DEVICE__
extern MMI_BOOL mmi_wr_bt_music_is_in_launch(void);
#endif
/***************************************************************************** 
*
*****************************************************************************/
