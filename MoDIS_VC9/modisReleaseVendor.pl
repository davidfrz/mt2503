...
if ($feature{'NAND_FLASH_BOOTING'} ne "NONE") {
  push(@level2, "MoDIS\\CustMMI3rdROM") if (-e "MoDIS\\CustMMI3rdROM");
  push(@level2, "MoDIS\\CustEnfbVenusThemeData") if (-e "MoDIS\\CustEnfbVenusThemeData");
  push(@level2, "MoDIS\\CustEnfbVenusAppIconData") if (-e "MoDIS\\CustEnfbVenusAppIconData");
  push(@level2, "MoDIS\\hw_data.gbd") if (-e "MoDIS\\hw_data.gbd");
  push(@level2, "MoDIS\\CustENFBFontData") if (-e "MoDIS\\CustENFBFontData");
}
