...
VMINT vm_get_sim_sym(VMCHAR* func_name)
{
    ...
    if(strcmp(func_name,"vm_sim_get_imei") == 0)
        return (VMINT)vm_sim_get_imei;           
    if(strcmp(func_name,"vm_sim_get_imsi") == 0)
        return (VMINT)vm_sim_get_imsi;           
    if(strcmp(func_name,"vm_sim_get_imei_ext") == 0)
        return (VMINT)vm_sim_get_imei_ext;           
    if(strcmp(func_name,"vm_sim_get_operator") == 0)
        return (VMINT)vm_sim_get_operator;           
    if(strcmp(func_name,"vm_sim_get_card_status") == 0)
        return (VMINT)vm_sim_get_card_status;           
    if(strcmp(func_name,"vm_sim_has_card") == 0)
        return (VMINT)vm_sim_has_card;           
    if(strcmp(func_name,"vm_sim_query_operator_code") == 0)
        return (VMINT)vm_sim_query_operator_code;           
    if(strcmp(func_name,"vm_sim_set_active_card") == 0)
        return (VMINT)vm_sim_set_active_card;           
    ...
    if(strcmp(func_name,"vm_gsm_sim_get_imsi_ext") == 0)
        return (VMINT)vm_gsm_sim_get_imsi_ext;            
	return 0;
}
