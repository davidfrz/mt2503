...
/* Below are NOT script generated code struct */
    ...
    /*support receive cmd pass by L4c*/
    typedef struct
    {
        LOCAL_PARA_HDR
        kal_uint8 *cmd_string;
    } l4c_pass_cmd_to_mmi_ind_struct;

    /*support write data to UART form MMI*/
    typedef struct
    {
        LOCAL_PARA_HDR
        kal_uint8* data;
        kal_uint32 data_size;
    } mmi_write_to_uart_req_struct;
