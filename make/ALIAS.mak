...
ifeq ($(strip $(MMI_VERSION)),IOT_MMI)
  PLUTOMMI_CHILD = mmi_framework mmi_service gdi mmi_device_control
else
  PLUTOMMI_CHILD = conn_app inet_app media_app mmi_app mmi_framework mmi_service gdi mmi_device_control
endif
