...
#define BT_MAP_MAX_HANDLE_STR_LEN  64
#define BT_MAP_MAX_LEN_EXTERN 2
#else
//encode with utf_8
#define BT_MAP_MAX_TEMP_FILE_NAME_LEN 80
#define BT_MAP_MAX_HANDLE_STR_LEN 32
#define BT_MAP_MAX_LEN_EXTERN 1
#endif
...
{
    LOCAL_PARA_HDR
    U8 mas_id;  /* Range 0~255 */
    U8 srv_name[BT_MAP_MAX_SRV_NAME_LEN + 1];  /* UTF8 zero-terminated string */
    U16 srv_name_len;
...
typedef struct
{
    ...
    U8 dev_name[BT_MAP_MAX_DEV_NAME_LEN + 1];  /* UTF8 zero-terminated string */
...
typedef struct
{
    ...
    U8 mas_id;  /* Range 0~255 */
    bt_map_addr_struct addr;
    U8 folder[BT_MAP_MAX_FOLDER_NAME_LEN + BT_MAP_MAX_LEN_EXTERN];  /* UTF8 zero-terminated string. Only used when NEXT and DOWN */
...
typedef struct
{
    ...
    U16 list_size;
    U16 data_size;
    U8 file[BT_MAP_MAX_TEMP_FILE_NAME_LEN + BT_MAP_MAX_LEN_EXTERN];  /* UTF8 zero-terminated string "fl[0~7].xml" */
...
typedef struct
{
    ...
    U8 mas_id;  /* Range 0~255 */
    bt_map_addr_struct addr;
    U8 child_folder[BT_MAP_MAX_FOLDER_NAME_LEN + BT_MAP_MAX_LEN_EXTERN];  /* UTF8 zero-terminated string. Empty if current folder */
    U16 list_size;
    U16 list_offset;
    U8 max_subject_len;  /* Range 1~255 */
    bt_map_msg_list_mask_enum mask;
    bt_map_filter_msg_enum filter_msg;
    U8 filter_begin[BT_MAP_MAX_DATE_STR_LEN + 1];  /* UTF8 zero-terminated string */
    U8 filter_end[BT_MAP_MAX_DATE_STR_LEN + 1];  /* UTF8 zero-terminated string */
    bt_map_filter_status_enum filter_status;
    U8 filter_rec[BT_MAP_MAX_CONTACT_STR_LEN];  /* UTF8 zero-terminated string */
    U8 filter_orig[BT_MAP_MAX_CONTACT_STR_LEN];  /* UTF8 zero-terminated string */
...
typedef struct
{
    ...
    U8 mas_id;  /* Range 0~255 */
    bt_map_addr_struct addr;
    BOOL unread;  /* TRUE: unread, FALSE: read */
    U8 datetime[BT_MAP_MAX_DATETIME_STR_LEN + 1];  /* UTF8 zero-terminated string */
    U16 list_size;
    U16 data_size;
    U8 file[BT_MAP_MAX_TEMP_FILE_NAME_LEN + BT_MAP_MAX_LEN_EXTERN];  /* zero-terminated string "ml[conn].xml" */
...
typedef struct
{
    ...
    U8 mas_id;  /* Range 0~255 */
    bt_map_addr_struct addr;
    U8 handle[BT_MAP_MAX_HANDLE_STR_LEN + BT_MAP_MAX_LEN_EXTERN];  /* UTF8 zero-terminated string */
    BOOL attachment;  /* TRUE: has attachment, FALSE: no attachment */
...
typedef struct
{
    ...
    U16 data_size;
    U8 file[BT_MAP_MAX_TEMP_FILE_NAME_LEN + BT_MAP_MAX_LEN_EXTERN];  /* UTF8 zero-terminated string "gm[conn].xml" */
...
typedef struct
{
    ...
    BOOL retry;  /* FALSE: no retry, TRUE: retry */
    bt_map_charset_enum charset;
    U8 file[BT_MAP_MAX_TEMP_FILE_NAME_LEN + BT_MAP_MAX_LEN_EXTERN];  /* UTF8 zero-terminated string "pm[conn].xml" */
    U16 data_size;
...
typedef struct
{
    ...
    U16 data_size;
    U8 file[BT_MAP_MAX_TEMP_FILE_NAME_LEN + BT_MAP_MAX_LEN_EXTERN];  /* UTF8 zero-terminated string "er[conn].xml" */
