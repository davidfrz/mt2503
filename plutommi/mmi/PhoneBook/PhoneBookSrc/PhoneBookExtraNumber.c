...
mmi_pen_hdlr mmi_phb_extra_number_entry_options_long_tap_hdlr(mmi_pen_point_struct pos)
{
...
void mmi_phb_extra_number_list_entry(void)
{
            ...
            MMI_FRM_FULL_SCRN))
    {
	    ...
	    EnableCenterSoftkey(0, IMG_GLOBAL_COMMON_CSK);
			...
			wgui_register_pen_long_tap_handler(mmi_phb_extra_number_entry_options_long_tap_hdlr);
