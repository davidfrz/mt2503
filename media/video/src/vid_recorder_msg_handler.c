...
#ifndef __CAMCO_USE_HORIZONTAL_SENSOR_AS_VERTICAL__
    open_param.image_width = preview_data_p->image_width;
    open_param.image_height = preview_data_p->image_height;
#else
    open_param.image_width = preview_data_p->image_height;
    open_param.image_height = preview_data_p->image_width;
#endif
...
static med_result_enum vid_cal_start_preview(media_vid_preview_req_struct* preview_struct)
{
    ...
    cal_mdp_video_data.VideoImageRotAngle = MM_IMAGE_ROTATE_90;
#else
