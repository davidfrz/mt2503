...
S32 srv_fmgr_async_copy_overwrite(const WCHAR* src_path, const WCHAR* dest_path, S32 flag, 
                                mmi_proc_func user_proc, void* user_data)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    ...
    ret = srv_fmgri_async_copy(src_path, dest_path, flag, user_proc, user_data, FS_MOVE_COPY|FS_MOVE_OVERWRITE);
