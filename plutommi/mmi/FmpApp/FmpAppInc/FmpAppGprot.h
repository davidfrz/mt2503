...
#ifndef FMPAPP_GPROT_H
#define FMPAPP_GPROT_H
 ...
 *  void
 *****************************************************************************/
extern void mmi_fmpapp_launch(void);
/*****************************************************************************
 * FUNCTION
 *  mmi_fmpapp_grp_proc
 * DESCRIPTION
 ...
 *  void
 *****************************************************************************/
extern MMI_RET mmi_fmpapp_grp_proc(mmi_event_struct *evt);
 ...
 *****************************************************************************/
extern void mmi_fmpapp_client_init(void);

/*****************************************************************************
 * FUNCTION
 *  mmi_fmpapp_client_deinit
 * DESCRIPTION
 *  to de-initial find me locator role
 * PARAMETERS
 *  void
 * RETURNS
 *  Status of the profile initial
 *****************************************************************************/
extern void mmi_fmpapp_client_deinit(void);
...
/*****************************************************************************
 * FUNCTION
 *  mmi_fmpapp_server_init
 * DESCRIPTION
 *  to initial find me target  role
 * PARAMETERS
 *  void
 * RETURNS
 *  Status of the profile initial
 *****************************************************************************/
extern void mmi_fmpapp_server_init(void);
 ...
 *	void
 *****************************************************************************/
void mmi_bt_event_notify_fmpapp(U32 event, void* para);
 ...
 *  void
 *****************************************************************************/
void mmi_bt_power_on_init_fmps(void);
 ...
 *  void
 *****************************************************************************/
void mmi_bt_power_on_deinit_fmps(void);
