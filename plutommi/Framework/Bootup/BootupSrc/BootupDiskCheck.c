...
static void mmi_bootup_disk_check_shutdown(mmi_bootup_disk_check_cntx_struct *cntx)
{
    ...
    srv_shutdown_exit_system(FRAMEWORK_BOOTUP);
}
                ...
                mmi_bootup_disk_check_cntx_struct *cntx)
{
    ...
    MMI_TRACE(MMI_BOOTUP_TRC_GROUP, TRC_FRM_BOOTUP_DISK_CHECK_FOR_SANITY, drive_path[0], cntx->error_code);
        ...
        void *user_data)
{
    ...
    MMI_TRACE(MMI_BOOTUP_TRC_GROUP, TRC_FRM_BOOTUP_CHECK_DISK, cntx->error_code);
