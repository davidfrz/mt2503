 ...
 */
    ...
    defined(MT6253T) || defined(MT6253) || defined(MT6253D) || \
...
// ---------- MT6255 series  ---------- //
  ...
  //this option define depend on 3D feature option,
  //so to do:will be sync with 3D feature option
  #if 0  
/* under construction !*/
  #endif 
...
// ---------- MT6253 series  ---------- //
  ...
  #define DRV_LCD_ROI_BACKGROUND_COLOR_RGB888
  #undef DRV_LCD_ROI_BACKGROUND_COLOR_RGB565
  #define DRV_LCD_ROTATOR_SUPPORT
  #define LCD_SNAPSHOT_SUPPORT
  ...
  #define DRV_LCD_SET_MEMORY_ACCESS_TYPE_SUPPORT
  #define DRV_LCD_SET_32_BURST_READ_ACCESS_SUPPORT
  /* MT6238/6238 alignment issue */
  #define DRV_LCD_HW_MEMORY_OUTPUT_OFFSET_SUPPORT

  //#ifdef __MDP_LCD_FW_UPDATE__
  #define MDP_FW_TRIGGER_LCD                
  #define DRV_LCD_FW_UPDATE_SUPPORT       
  //#endif

  // rotation is calculated in counterclockwise
...
#endif  // #if defined(DRV_LCD_MT6253_SERIES)
...
#endif  // #if defined(DRV_LCD_MT6235_SERIES)
...
// ---------- MT6251 series ---------- //
  ...
  #define DRV_PARALLEL_INTERFACE_COUNT        (0)
  #define DRV_SERIAL_INTERFACE_COUNT          (1)

  #define DRV_PALETTE_ENTRY_COUNT             (256)
  #define DRV_LCD_ROI_BACKGROUND_COLOR_RGB888
  #undef DRV_LCD_ROI_BACKGROUND_COLOR_RGB565

  /*start of XXXXX*/
  #undef DRV_LCD_GAMMA_CORRECTION_SUPPORT
  #undef DRV_LCD_HW_TRIGGER_SUPPORT
  #undef DRV_LCD_DC_TRIGGER_SUPPORT
  #define DRV_LCD_CMD_QUEUE_COUNT   1
  #define DRV_LCD_CMD_QUEUE_NUMBER 16
  #undef DRV_LCD_FW_UPDATE_SUPPORT
  #define DRV_LCD_DEBUG_SUPPORT

#endif  // #if defined(DRV_LCD_MT6251_SERIES)
...
// ---------- MT6516 series ---------- //
  ...
  #if defined(__APPLICATION_PROCESSOR__) && (defined(IC_MODULE_TEST) || defined(IC_BURNIN_TEST))
    #undef DRV_LCD_NOT_EXIST
    #define TV_OUT_BTMT
  #endif
...
#endif  // #if defined(DRV_LCD_MT6516_SERIES)
...
// Feature options for MT6236
//#define LCD_WMEM_PARGB8888 LCD_WMEM_ARGB8888_WITH_PIXEL_ALPHA //defined in drv_sw_features_display.h
//#define LCD_LAYER_SOURCE_COLOR_YUYV422
//#define LCD_LAYER_SOURCE_COLOR_PARGB8888
#define LCD_LAYER_SUPPORT_HW_DITHER
#define LCD_LAYER_SUPPORT_PITCH
