...
static void gdi_image_ab2_rle_ps_draw_to_common(
    gdi_image_ab2_rle_ps_struct *ps, 
    const gdi_image_ab2_rle_info_struct *rle_info,
    U8 *dst_ptr,
    U32 dst_pixel_bytes, 
    ...
    U8 type)
{
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
    /* 32 for 8888, 24 for 6666*/
    //GDI_ASSERT(32 == type || 24 == type);
...
static void gdi_image_ab2_rle_ps_draw_to_8888(
    ...
    U32 n)
{
    gdi_image_ab2_rle_ps_draw_to_common(ps, rle_info, dst_ptr, dst_pixel_bytes, n, 32);
}
...
static void gdi_image_ab2_rle_ps_draw_to_6666(
    ...
    U32 n)
{
    gdi_image_ab2_rle_ps_draw_to_common(ps, rle_info, dst_ptr, dst_pixel_bytes, n, 24);
}
...
static GDI_IMAGE_AB2_INLINE U32 gdi_image_ab2_PARGB8888_to_ARGB8888(U32 src_color)
{
    ...
    if (alpha)
    {
        ...
        {
            src_color <<= 8;
            out_pixel |= ((U32)((S16)(src_color >> 24) * inv) >> GDI_UTIL_INV_ALPHA_MUL_255_PRECISION_BITS) << (i * 8);
        }
    }
    else
    {
