...
#define MMI_CLOG_CMN_INST_FLAG_BT_HANDLE             (0x0004 << MMI_CLOG_CMN_INST_FLAG_BASE)

#define MMI_CLOG_CMN_INST_FLAG_TYPE_BASE             (3 + MMI_CLOG_CMN_INST_FLAG_BASE)
...
/*---------------------- Main menu -------------------------------------------*/
extern void mmi_clog_launch_ex(MMI_ID parent_gid, mmi_clog_lt_type_enum lt_type, mmi_clog_lt_id_enum lt_id, MMI_BOOL is_bt);
...
extern void mmi_clog_bt_reset_pbapc_num();
#endif
