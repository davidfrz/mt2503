...
{\
    ...
    {\
        if ((g_indic_rule_engine_cntx.ire_prev_char_lang_id.lang_id_index != IRE_LANGUAGE_ID_MYANMAR)&&(g_indic_rule_engine_cntx.ire_prev_char_lang_id.lang_id_index != IRE_LANGUAGE_ID_MYANMAR_ZAWGYI)) \
        {\
...
#else /*#if defined (__MMI_MULTITAP_BANGLA_SPEC__)*/
...
#else /*#if defined(__MMI_IRE_SLIM__)*/
#if defined (__MMI_MULTITAP_BANGLA_SPEC__)
...
#endif/*#if defined (__MMI_MULTITAP_BANGLA_SPEC__)*/
#endif /*#if defined(__MMI_IRE_SLIM__)*/
