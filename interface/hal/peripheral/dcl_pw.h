...
typedef enum {
	...
	PW_CMD_IS_POWERON_REASON_VALID, /* check if power on reason is valid */
} DCL_CTRL_PW_CMD;
#else /* __BUILD_DOM__ */
#define PW_CMDS \
	PW_CMD_POWERON, \
	...
	PW_CMD_IS_POWERON_REASON_VALID,
#endif /* __BUILD_DOM__ */		
...
*          11. PW_CMD_GET_CHARGER_BOOT_TYPE: query which is power on reason, AC or USB or non-cable
*          12. PW_CMD_IS_POWERON_REASON_VALID: check if power on reason is valid
*
...
*          11. PW_CMD_GET_CHARGER_BOOT_TYPE: pointer to a PW_CTRL_GET_CHARGER_TYPE
*          12. PW_CMD_IS_POWERON_REASON_VALID: A null pointer
*
* RETURNS
