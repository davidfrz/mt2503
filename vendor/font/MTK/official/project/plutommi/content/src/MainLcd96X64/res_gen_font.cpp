...
int main(int argc, char* argv[])
{
    ...
    AddFont(
        ("English"), ("*#0044#"), ("en-US"), 
        FONT_DATA_FILE_PATH(Latin\\neptune_tiny_font.bdf),
        MCT_SUBLCD_FONT, 0, 0);
    AddFont(
        ("English"), ("*#0044#"), ("en-US"), 
        FONT_DATA_FILE_PATH(Latin\\pluto_small_BWUI.bdf),
...
/* Bengali Language */
    ...
    AddFont(
        ("Bengali"), ("*#9133#"), ("be-IN"), 
        FONT_DATA_FILE_PATH(Bengali\\Bengali_14x14p_v27b.bdf),
        MCT_SMALL_FONT | MCT_MEDIUM_FONT| MCT_SUBLCD_FONT | MCT_VIRTUAL_KEYBOARD_FONT, 
        0, 1);
    AddFont(
        ("Bengali"), ("*#9133#"), ("be-IN"), 
        FONT_DATA_FILE_PATH(Bengali\\Bengali_16x16p_v27b.bdf),
        MCT_LARGE_FONT, 
        0, 1);
    AddFont(
        ("Bengali"), ("*#9133#"), ("be-IN"), 
