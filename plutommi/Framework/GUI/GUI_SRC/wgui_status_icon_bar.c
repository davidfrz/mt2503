...
/* under construction !*/
	...
	{STATUS_ICON_BT_MISSED_CALL, IMG_SI_BT_MISSED_CALL_INDICATOR, GUI_STATUS_ICON_BAR_ICON_NO_GROUP},   
#endif
...
/* under construction !*/
    ...
    {STATUS_ICON_BT, IMG_SI_BT, GUI_STATUS_ICON_BAR_ICON_NO_GROUP},
    {STATUS_ICON_BT_CON, IMG_SI_BT_CON, GUI_STATUS_ICON_BAR_ICON_NO_GROUP},
    {STATUS_ICON_BT_BLE_CON, IMG_SI_BT_BLE_CON, GUI_STATUS_ICON_BAR_ICON_NO_GROUP},
    {STATUS_ICON_BT_DUAL_CON, IMG_SI_BT_DUAL_CON, GUI_STATUS_ICON_BAR_ICON_NO_GROUP},
#endif  //__MMI_BT_SUPPORT__
...
/* under construction !*/
    ...
    {STATUS_ICON_RESERVED3, 		IMG_MCARE_STAT_MCR, 	    GUI_STATUS_ICON_BAR_ICON_NO_GROUP},
	 ...
	 /* Icon of pxp config alert */
	 {STATUS_ICON_PXPAPP_CONFIG_ALERT, IMG_PXPAPP_CONFIG_ALERT, GUI_STATUS_ICON_BAR_ICON_NO_GROUP},
#endif

#ifdef __MMI_BT_PBAP_CLIENT__
 {STATUS_ICON_BT_SYNC_PB_BG, IMG_SI_BT_SYNC_PB_BG, GUI_STATUS_ICON_BAR_ICON_NO_GROUP},
#endif

#ifdef __MMI_WEARABLE_DEVICE__
    {STATUS_ICON_CALENDAR, IMG_SI_CALENDAR, GUI_STATUS_ICON_BAR_ICON_NO_GROUP},
    #ifdef __MMI_BT_NOTIFICATION__
    {STATUS_ICON_NOTIFICATION, IMG_SI_NOTIFICATION, GUI_STATUS_ICON_BAR_ICON_NO_GROUP},
    #endif  //__MMI_BT_NOTIFICATION__
    {STATUS_ICON_PEDOMETER, IMG_SI_PEDOMETER, GUI_STATUS_ICON_BAR_ICON_NO_GROUP},
...
#ifdef __MMI_WEARABLE_DEVICE__
static S32 g_swatch_available_icons[] = 
{
    STATUS_ICON_BATTERY_STRENGTH,
    STATUS_ICON_MISSED_CALL,
#ifdef __MMI_BT_PBAP_CLIENT__
    STATUS_ICON_BT_MISSED_CALL,
#endif
    #ifdef __MMI_MMS_2__
    ...
    STATUS_ICON_BT,
    STATUS_ICON_BT_CON,
    STATUS_ICON_BT_BLE_CON,
    STATUS_ICON_BT_DUAL_CON,
    #endif  //__MMI_BT_SUPPORT__
#ifdef __MMI_BLE_PXP_SUPPORT__
    STATUS_ICON_PXPAPP_CONFIG_ALERT,
#endif
    STATUS_ICON_MUTE,
...
static U8 g_swatch_available_icon_num = sizeof(g_swatch_available_icons) / sizeof (S32);
#endif  //__MMI_WEARABLE_DEVICE__
...
/*****************************************************************************
 * FUNCTION
 *  wgui_status_icon_bar_is_enable_in_watch
 * DESCRIPTION
 *  Check whether the icon is enable in watch
 * PARAMETERS
 *  icon_id         [IN]    The id of status icon
 * RETURNS
 *  MMI_BOOL
 *****************************************************************************/
static MMI_BOOL wgui_status_icon_bar_is_enable_in_watch(S32 icon_id)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
    for (j = 0; j < g_swatch_available_icon_num; j++)
    {
        if (g_swatch_available_icons[j] == icon_id)
        {
            return MMI_TRUE;
            break;
        }
...
#ifdef  __128X128_WEARABLE_DEVICE_UI_STATUS_ICON_BAR__
U16 * wgui_status_icon_bar_tring = NULL;
void  wgui_status_icon_bar_set_tring(U16 * string)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
    wgui_status_icon_bar_tring = string;
}
#endif
...
void wgui_status_icon_bar_initialize(void)
{
    ...
    bar->height = MMI_STATUS_ICON_BAR_HEIGHT;
    bar->x1 = 0;
    bar->y1 = 0;
    bar->x2 = MAIN_LCD_device_width - 1;
    bar->y2 = MMI_STATUS_ICON_BAR_HEIGHT - 1;
#if (MMI_MAX_SIM_NUM >= 2)
    bar->n_signal = 0;
    bar->n_sms_full = 0;
#endif
    ...
    bar->y = MMI_STATUS_ICON_BAR_HEIGHT;
    bar->width = 17;
    bar->height = MAIN_LCD_device_height - MMI_STATUS_ICON_BAR_HEIGHT - MMI_button_bar_height;
    bar->x1 = MAIN_LCD_device_width - 17;
    bar->y1 = MMI_STATUS_ICON_BAR_HEIGHT;
...
/* under construction !*/
    ...
    for (i = STATUS_ICON_MAINLCD_START; i < MAX_STATUS_ICONS; i++)
    {
        ...
        #ifdef __MMI_WEARABLE_DEVICE__
        if (wgui_status_icon_bar_is_enable_in_watch(icon_id))
        #endif  //__MMI_WEARABLE_DEVICE__
        {
...
void wgui_status_icon_bar_change_timer_format_callback(void)
{
    ...
    if(wgui_status_icon_bar_clock_element_id != WGUI_STATUS_ICON_BAR_INVALID_ELEMENT_ID)
    {
        ...
        if(wgui_status_icon_bar_clock_index != WGUI_CLOCK_INVALID_INDEX)
        {
            ...
            wgui_clock_resize(wgui_status_icon_bar_clock_index, clock_width, MMI_STATUS_ICON_BAR_HEIGHT);
            wgui_clock_move(
                wgui_status_icon_bar_clock_index,
                wgui_status_icon_bar_elements[wgui_status_icon_bar_clock_element_id].x + wgui_status_icon_bar_bars[WGUI_STATUS_ICON_BAR_H_BAR].x,
                wgui_status_icon_bar_elements[wgui_status_icon_bar_clock_element_id].y+ wgui_status_icon_bar_bars[WGUI_STATUS_ICON_BAR_H_BAR].y);
