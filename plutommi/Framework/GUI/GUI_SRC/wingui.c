...
#if !defined(__L1_STANDALONE__) && !defined(__SKIP_EX_DISPLAY_LCD__)
extern void (*InitDebugPrintPtr)(void);
extern void (*DebugPrintPtr)(kal_uint8, kal_uint8, kal_uint8*);
extern void InitDebugPrint(void);
extern void DebugPrint(U8 x,U8 y,S8 * s);
#endif   /* !__L1_STANDALONE__ && !__SKIP_EX_DISPLAY_LCD__ */
#endif/*#ifdef __MTK_TARGET__*/
//end add for smart watch
...
#ifdef __MTK_TARGET__	
#if !defined(__L1_STANDALONE__) && !defined(__SKIP_EX_DISPLAY_LCD__)
	InitDebugPrintPtr = InitDebugPrint;    
	DebugPrintPtr = DebugPrint;
#endif   /* !__L1_STANDALONE__ && !__SKIP_EX_DISPLAY_LCD__ */
#endif/*#ifdef __MTK_TARGET__*/
//end add for smart watch
