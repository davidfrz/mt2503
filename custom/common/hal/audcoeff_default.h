...
#include "l1audio.h"
#if defined( __BT_BOX_SUPPORT__) || defined(__WEARABLE__) || defined(__BT_DIALER_SUPPORT__)
...
#define DEFAULT_AUDIO_16K_COMPEN_FILTER \
{ \
...
#define DEFAULT_AUDIO_FLT_COEFF \
{ \
...
#else
#define DEFAULT_AGC_DSP_PARAMETERS \
{\
...
{ \
    2047,  2272,   511,    31, 57351, 24607,   400,   132, \
      80,  4325,   611,     0,     8,     0,     0,     0  \
}
