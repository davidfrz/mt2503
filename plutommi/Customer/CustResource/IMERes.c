...
/*WCSSneedmultitapABC,sowedon'tdisableitinQwertykeypad*/
{
    ...
    IMM_INPUT_TYPE_ENGLISH_SENTENCE | IMM_INPUT_TYPE_SENTENCE |IMM_INPUT_TYPE_NO_TITLECASE_SENTENCE | IMM_INPUT_TYPE_USER_SPECIFIC | IMM_INPUT_TYPE_EMAIL | IMM_INPUT_TYPE_URL | IMM_INPUT_TYPE_ASCII_CHAR | IMM_INPUT_TYPE_QUICK_SEARCH,
  #else
