...
<RECEIVER id="EVT_ID_USB_ALM_STATE" proc="mmi_usb_alm_state_callback"/>
    ...
    <RECEIVER id="EVT_ID_WEARABLE_DEVICE_MOVE_LEFT" proc="mmi_usb_wearable_device_proc"/>
    <RECEIVER id="EVT_ID_WEARABLE_DEVICE_MOVE_RIGHT" proc="mmi_usb_wearable_device_proc"/>
    <RECEIVER id="EVT_ID_TOUCHSCREEN_MOVE_LEFT" proc="mmi_usb_wearable_device_proc"/>
    <RECEIVER id="EVT_ID_TOUCHSCREEN_MOVE_RIGHT" proc="mmi_usb_wearable_device_proc"/>
#endif
