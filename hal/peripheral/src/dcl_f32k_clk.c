...
DCL_STATUS DclF32K_Control(DCL_HANDLE handle, DCL_CTRL_CMD cmd, DCL_CTRL_DATA_T *data)
{
    ...
    switch (cmd)
    {
        ...
        case F32K_CLK_CMD_MEASURE_EOSC32_FREQ:
        {
            F32K_CLK_CTRL_MEASURE_EOSC32_FREQ_T *prMeasureEosc32Freq;
            prMeasureEosc32Freq = &(data->rMeasureEosc32Freq);
            return_status = F32K_Measure_EOSC32_Freq(&(prMeasureEosc32Freq->eosc32Freq));
        }
        break;
