...
extern void csd_get_mode_string_inject(module_type srcid,kal_uint8	cmdindex);
extern void csd_lock_suspend_en(kal_uint8	enable);
extern void csd_lock_hibernation_en(kal_uint8	enable);
extern void AP_BtSS_Reset_Stat(void);
extern void AP_BtSS_Dump_Stat(void);
extern void AP_BtSS_SetSleepAssertTime(kal_uint32 time_value);
#endif
/***************************************************************************** 
...
#if defined(__TINY_SYS_AP__)
{
    ...
    else if(strcmp((kal_char*) tst_inject->string, "tinylog_mode") == 0)
    {   
    		csd_get_mode_string_inject(MOD_UEM,tst_inject->index);
    }
    else if(strcmp((kal_char*) tst_inject->string, "tiny_lks") == 0)
    {
    		csd_lock_suspend_en(tst_inject->index);
    }
    else if(strcmp((kal_char*) tst_inject->string, "tiny_lkh") == 0)
    {
    		csd_lock_hibernation_en(tst_inject->index);
    }
	else if(strcmp((kal_char*) tst_inject->string, "btss_reset_stat") == 0)
    {
    		AP_BtSS_Reset_Stat();
    }
    else if(strcmp((kal_char*) tst_inject->string, "btss_dump_stat") == 0)
    {
    		AP_BtSS_Dump_Stat();
    }else if(strcmp((kal_char*) tst_inject->string, "ts_sleep_assert_time")==0)
    {
            AP_BtSS_SetSleepAssertTime(tst_inject->index);
	}
 }
