...
#include  	"us_timer.h"
#include  	"drv_comm.h"
void ts_disable_penirq(void)
{
	DRV_WriteReg(0xA0730010,0x8); /*enable tp clk*/
	ust_busy_wait(30);
	DRV_WriteReg(0xa0790054,0xd501); /*tp sample to disable tp penirq*/
	ust_busy_wait(100);
	DRV_WriteReg(0xA073000c,0x8); /*disable tp clk*/
}
#endif
