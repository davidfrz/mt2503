...
#ifdef __MMI_MULTILINE_INPUT_BOX_SINGLINE_STYLE_WITH_FTE__ // MMI_FTE_MULTILINE_REPLACE_SINGLELINE

//extern multi_line_input_box MMI_multiline_inputbox_multiline;   //for save multiline data
extern multi_line_input_box MMI_multiline_inputbox_singleline;  //for save singleline data


extern void wgui_inputs_singleline_save_all_data();
extern void wgui_inputs_singleline_set_all_data();

extern void wgui_inputs_ml_create_set_buffer_ext(UI_string_type buffer, S32 buffer_length, S32 text_length, S32 edit_position,multi_line_input_box * editor);
extern void wgui_inputs_ml_show_ext(multi_line_input_box *editor);
extern void wgui_inputs_ml_redraw_ext(multi_line_input_box *editor);
extern S32 wgui_inputs_ml_multitap_input_string_ext(PU8 str,multi_line_input_box * editor);
extern MMI_BOOL wgui_inputs_ml_multitap_input_ext(UI_character_type c,multi_line_input_box * editor);
extern void wgui_inputs_ml_multitap_input_complete_ext(multi_line_input_box * editor);
extern MMI_BOOL wgui_inputs_ml_direct_input_ext(UI_character_type c,multi_line_input_box * editor);
extern MMI_BOOL wgui_inputs_ml_direct_input_no_draw_ext(UI_character_type c,multi_line_input_box * editor);
extern void wgui_inputs_ml_delete_character_ext(multi_line_input_box * editor);
extern void wgui_inputs_ml_delete_character_no_draw_ext(multi_line_input_box * editor);

extern void wgui_inputs_ml_previous_character_ext(multi_line_input_box * editor);
extern void wgui_inputs_ml_next_character_ext(multi_line_input_box * editor);
extern void wgui_inputs_ml_delete_current_character_ext(multi_line_input_box * editor);
extern void wgui_inputs_ml_delete_all_characters_ext(multi_line_input_box * editor);
extern void wgui_inputs_ml_set_mask_ext(U8 m,multi_line_input_box * editor);
extern MMI_BOOL wgui_inputs_ml_get_display_status_ext(multi_line_input_box * editor);
extern void wgui_inputs_ml_resize_ext(S32 width, S32 height,multi_line_input_box * editor);
extern void wgui_inputs_ml_move_ext(S32 x, S32 y, multi_line_input_box * editor);
extern U8 wgui_inputs_ml_is_empty_ext(multi_line_input_box * editor);

extern void wgui_inputs_ml_redraw_remaining_characters_display_ext(multi_line_input_box * editor); 
extern void wgui_inputs_ml_redraw_remaining_characters_display_internal_ext(multi_line_input_box * editor);  
extern void wgui_inputs_ml_redraw_input_information_bar_ext(multi_line_input_box * editor);    
extern void wgui_inputs_ml_handle_right_softkey_down_ext(multi_line_input_box * editor);  
extern void wgui_inputs_ml_handle_right_softkey_up_ext(multi_line_input_box * editor);  
extern void wgui_inputs_ml_setup_ext3(
        S32 x,
        S32 y,
        S32 width,
        S32 height,
...
extern void wgui_inputs_ml_close_ext(multi_line_input_box * editor);  
extern void wgui_inputs_ml_set_decimal_flag_ext(U32 input_type,multi_line_input_box * editor);  
extern U32 mmi_input_box_msg_call_back_multiline_ext(void * input_box_handle, mmi_imc_message_struct_p msg_ptr); 
extern void wgui_inputs_ml_move_cursor_ext(wgui_inputs_cursor_pos_enum pos,multi_line_input_box * editor);  

extern U32 wgui_inputs_ml_insert_string_ext(UI_string_type str, U32 len, MMI_BOOL is_redraw, multi_line_input_box * editor);  
extern void wgui_inputs_ml_disable_ext(multi_line_input_box * editor);  
extern void wgui_inputs_ml_enable_ext(multi_line_input_box * editor); 
extern MMI_BOOL wgui_inputs_ml_is_disable_ext(multi_line_input_box * editor);  
extern S32 wgui_inputs_ml_get_scroll_bar_width_ext(multi_line_input_box * editor);  
extern void wgui_inputs_ml_set_RSK_ext(multi_line_input_box * editor);
extern void wgui_inputs_ml_handle_navigate_ext(multi_line_input_box * editor);
    
extern void wgui_inputs_ml_handle_input_ext(multi_line_input_box * editor);  
extern void wgui_inputs_ml_handle_right_softkey_long_press_ext(multi_line_input_box * editor); 
extern void wgui_inputs_ml_reset_ext(multi_line_input_box * editor);
 

extern void wgui_inputs_ml_register_keys_ext(multi_line_input_box * editor);  
