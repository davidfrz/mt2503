...
typedef enum
{
    SRV_SMS_BTMAPC_BT_INDEX0 = 0x00,  
    SRV_SMS_BTMAPC_BT_INDEX1 = 0x01,             
    SRV_SMS_BTMAPC_BT_INDEX2 = 0x02,                     

    SRV_SMS_BTMAPC_BT_INDEX_RESERVED    = 0xFF  /* Reserved */
} srv_sms_btmapc_bt_enum;
...
extern U16 srv_sms_btmapc_get_notify_count(void);
extern U16 srv_sms_btmapc_update_notify_count(void);
extern U16 srv_sms_btmapc_reset_notify_count(void);
#endif
