...
//	#define DRV_USB_PPP_BW_LIMIT // MT6236 BW -> ADMUX
	...
	#define DRV_USB_COST_DOWN_CHIP	
	#define __USB_HS_SLEW_RATE_CAL__		
#elif defined(DRV_USB_6250_SERIES)	
	#define DRV_USB_IP_V1_PLUS //Mentor1.1 enhance
	#define DRV_USB_LOGGING_V5
	#define DRV_USB_LOGGING_V5_SINGLE_DSP	
	#define DRV_USB_LOGGING_MT50	
	#define DRV_USB_PHY_T55_IP
	#define DRV_USB_UPLL_MT50_SERIES
	#define DRV_USB_HW_RST
#elif defined(DRV_USB_6260_SERIES)||defined(DRV_USB_6261_SERIES)
	#define DRV_USB_IP_V1_PLUS //Mentor1.1 enhance
	#define DRV_USB_LOGGING_V5
	#define DRV_USB_LOGGING_V5_SINGLE_DSP	
	#define DRV_USB_PHY_T55_IP
	#define DRV_USB_DMA2_RX_REDUCED
	#define DRV_USB_DMA_NO_SHARE_CHANNELS
#endif
