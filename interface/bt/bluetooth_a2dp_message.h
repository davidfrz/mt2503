...
typedef enum
{
...
#ifdef BTMTK_ON_MAUI
    MSG_ID_BT_A2DP_AUDIO_SYNC_SET,//for audio sync setting: sync flag and dialer index
#endif
    ...
    //for SINK codec
    MSG_ID_BT_A2DP_SINK_CODEC_START_REQ,
    MSG_ID_BT_A2DP_SINK_CODEC_START_CNF,
    MSG_ID_BT_A2DP_SINK_CODEC_STOP_REQ,
    MSG_ID_BT_A2DP_SINK_CODEC_STOP_CNF,
...
#ifdef BTMTK_ON_MAUI
    MSG_ID_BT_A2DP_STREAM_OPEN_DONE,
#endif
    ...
    MSG_ID_BT_A2DP_DATA_GROUP_START = MSG_ID_BT_A2DP_STREAM_DATA_OUT,
#else
...
#ifdef BTMTK_ON_MAUI
    MSG_ID_BT_A2DP_FM_VIA_CONTROLLER_START_REQ,
    MSG_ID_BT_A2DP_FM_VIA_CONTROLLER_GROUP_START = MSG_ID_BT_A2DP_FM_VIA_CONTROLLER_START_REQ,
#else
