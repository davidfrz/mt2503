...
extern void srv_dtcnt_wlan_init_wlan(void);
...
extern void srv_dtcnt_wlan_set_scan_desired_ssid_list_req(U8 ssid_list_num, const srv_dtcnt_ssid_struct * const ssid_list);
extern void srv_dtcnt_wlan_set_roaming_para_req(MMI_BOOL enable_roaming);
extern void srv_dtcnt_wlan_set_dwell_time_req(U16 dwell_time);
#ifdef __WIFI_SNIFFER_SUPPORT__
extern void srv_dtcnt_wlan_send_sniffer_mode_req(sniffer_mode_onoff_enum mode, srv_dtcnt_wlan_sniffer_on_cfg_struct *cfg);
#endif
extern U32 srv_dtcnt_wlan_get_total_prof_num(void);
#endif /* __MMI_WLAN_FEATURES__ */
