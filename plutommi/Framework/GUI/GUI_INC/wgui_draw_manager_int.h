...
#else
#define dm_setup_and_draw_dialer_inputbox(X) 0
#endif
...
#else
#define dm_get_typical_stopwatch_coordinates(X,Y) NULL
#define dm_get_nway_stopwatch_coordinates(X,Y) NULL
#endif
...
#else
#define dm_enable_fixed_layer_mode(x) NULL
#endif
...
#else
#define dm_is_fixed_layer_mode_enabled() NULL
#endif
