...
extern cui_pwd_basic_cntx_struct *cui_pwd_basic_get_cntx(mmi_id instance_id);
extern cui_pwd_guard_cntx_struct *cui_pwd_guard_get_cntx(mmi_id instance_id);
        ...
        void *user_tag)
{
	...
	if(cntx->extra_msg_str)
    {
        //mmi_wcsncpy(cntx->extra_msg_str, extra_msg, CUI_PWD_MAX_EXTRA_MSG_STR_LEN);
        mmi_wcscat(message, L"\n");
        mmi_wcscat(message, cntx->extra_msg_str);
    }
...
mmi_id mmi_secset_sim_display_popup_for_guard_ext(
	    mmi_id instance_id, 
        mmi_sim_enum sim,
        srv_sim_ctrl_pwd_type_enum chv_type,
        mmi_secset_sim_string_enum str_type,
        ...
        void *user_tag)
{
	...
	if(cntx->guard_extra_msg_str)
    {
        //mmi_wcsncpy(cntx->extra_msg_str, extra_msg, CUI_PWD_MAX_EXTRA_MSG_STR_LEN);
        mmi_wcscat(message, L"\n");
        mmi_wcscat(message, cntx->guard_extra_msg_str);
    }
