...
void mmi_sms_um_bt_ui_cc_del_grp_cntx_ext(void)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
    mmi_sms_um_bt_ui_cc_grp_cntx_struct *grp_cntx = g_sms_um_ui_p->cc_cntx.grp_table;
...
void mmi_sms_um_bt_ui_cc_delete_all_scrn_ext(void)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
    ...
    for (i = 0 ; i < MMI_UM_UI_MAX_SCRN_CNTX_NUM ; i++)
    {
        if (g_sms_um_ui_p->cc_cntx.scrn_table[i].scrn_id > 0)
        {
            mmi_sms_um_bt_ui_cc_delete_scrn_cntx(g_sms_um_ui_p->cc_cntx.scrn_table[i].scrn_id);	
        }
    }
}
#endif
