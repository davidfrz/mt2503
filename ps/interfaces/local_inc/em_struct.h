...
typedef enum
{
    ...
    /* need to use together w/ PLMN LIST function    */
    /* RR will send power scan result to L4 once if  */
    /* this request is sent before PLMN LIST request */
    EM_GSM_SEND_POWER_SCAN_RESULT
} em_feature_enum;
...
typedef struct
{
    ...
    kal_uint16 msg_len;
    kal_uint16 list_len;
    kal_uint16 arfcn[200];
    kal_int16 power_in_quarter_dbm[200];
} l4cps_em_power_scan_result_ind_struct;
