...
typedef union {
    ...
    kal_uint8 APP_IDLE_SWATCH[ASM_HEAP_SIZE_APP_IDLE_SWATCH + 4];
...
typedef union {
    ...
    kal_uint8 APP_IDLE_SWATCH[ASM_BASE_SIZE_APP_IDLE_SWATCH + 4];
...
typedef union {
    ...
    kal_uint8 APP_IDLE_SWATCH[ASM_FG_SIZE_APP_IDLE_SWATCH + 4];
...
typedef union {
    ...
    kal_uint8 APP_IDLE_SWATCH[ASM_TOTAL_SIZE_APP_IDLE_SWATCH + 4];
...
/* app_fg */
typedef union {
    kal_uint8 APP_GB_WINGUO[ASM_APP_FG_SIZE_APP_GB_WINGUO + 4];
...
typedef union {
    ...
    kal_uint8 APP_IDLE_SWATCH[APPLIB_MEM_AP_POOL_SIZE_CONFIG(ASM_TOTAL_SIZE_APP_IDLE_SWATCH)];
