...
typedef enum
{
    MENU_ID_SNDREC_MAIN = 35357 + 1, /* BASE_ID + 1 */
...
typedef enum
{
    STR_ID_SNDREC_MAIN = 35357 + 1, /* BASE_ID + 1 */
...
typedef enum
{
    GRP_ID_SNDREC_START_BASE = 35357 + 1, /* BASE_ID + 1 */
    GRP_ID_SNDREC_MAIN,
...
typedef enum
{
    SNDREC_TIMER_FILELIST_SEEK = 35357 + 1, /* BASE_ID + 1 */
...
typedef enum
{
    NVRAM_AUTO_VM_SETTING_VM_SUPPORT = 35357 + 1, /* BASE_ID + 1 */       /*         BYTE */ 
...
typedef enum
{
    IMG_ID_SNDREC_MAIN_ICON = 35357 + 1, /* BASE_ID + 1 */
    IMG_ID_SNDREC_FTE_ANIMAL,
