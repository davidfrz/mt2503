...
#if defined(__MMI_CSTAR_SM_CHINESE__) && defined(__MMI_CSTAR_MULTITAP_PHONETIC_INPUT__) //6261
    {
...
#if defined(__MMI_CSTAR_SM_CHINESE__) && defined(__MMI_PHB_PINYIN_SORT__) //6261
...
{
#if (defined(__MMI_CSTAR_SM_CHINESE__) || defined(__MMI_CSTAR_TR_CHINESE__)) && defined(__MMI_PHB_PINYIN_SORT__)
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
