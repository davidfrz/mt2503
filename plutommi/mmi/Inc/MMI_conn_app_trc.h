...
#define MMI_CONN_TRC_G4_EPO         TRACE_GROUP_4
...
BEGIN_TRACE_MAP(MOD_MMI_CONN_APP)
    ...
    /* --------------------------------------------------------------- */
    //wlansrvscanonly.c
    TRC_MSG(WLAN_SO_TRC_BOOTUP, "[WLAN Srv SO TRACE] wlan_scan_only_bootup()")
    TRC_MSG(WLAN_SO_TRC_SCAN_CNF, "[WLAN Srv SO TRACE] wlan_scan_cnf_hdlr()")
    TRC_MSG(WLAN_SO_TRC_SCAN, "[WLAN Srv SO TRACE] wlan_scan()")
    TRC_MSG(WLAN_SO_TRC_DEINIT_CNF, "[WLAN Srv SO TRACE] wlan_deinit_cnf_hdlr()")
    TRC_MSG(WLAN_SO_TRC_DEINIT, "[WLAN Srv SO TRACE] wlan_deinit()")
    TRC_MSG(WLAN_SO_TRC_INIT_CNF, "[WLAN Srv SO TRACE] wlan_init_cnf_hdlr()")
    TRC_MSG(WLAN_SO_TRC_INIT, "[WLAN Srv SO TRACE] wlan_init()")
    //wlansrvscanonly_atcmd.c
    TRC_MSG(WLAN_SO_AT_TRC_INIT, "[WLAN Srv SO TRACE] srv_wlan_scan_only_init()")
    TRC_MSG(WLAN_SO_AT_TRC_SET_MODE_HDL, "[WLAN Srv SO TRACE] srv_wlan_scan_only_set_mode_hdl()")
    TRC_MSG(WLAN_SO_AT_TRC_SCAN_HDL, "[WLAN Srv SO TRACE] srv_wlan_scan_only_scan_hdl()")
    TRC_MSG(WLAN_SO_AT_TRC_SCAN_CB, "[WLAN Srv SO TRACE] srv_wlan_scan_only_scan_callback()")
    TRC_MSG(WLAN_SO_AT_TRC_DEINIT_CB, "[WLAN Srv SO TRACE] srv_wlan_scan_only_deinit_callback()")
    TRC_MSG(WLAN_SO_AT_TRC_INIT_CB, "[WLAN Srv SO TRACE] srv_wlan_scan_only_init_callback()")
    TRC_MSG(WLAN_SO_AT_TRC_SET_MODE_CNF, "[WLAN Srv SO TRACE] srv_wlan_scan_only_send_set_mode_cnf(), state:%d")
    //IrdaMMI.c
...
/* SRV_DA_NEW_END */
    ...
    /* FOTA DIFF PACKAGE */
    //BTPUSHRECVSRV
    TRC_MSG(TRC_SRV_BTPUSHRECV_REGISTER_DIFF_HDLR_SUCCESS, "[BTPushRecvSrv] fota diff update hdlr register success")
    TRC_MSG(TRC_SRV_BTPUSHRECV_REGISTER_DIFF_HDLR_FAIL, "[BTPushRecvSrv] fota diff update hdlr register fail")
    TRC_MSG(TRC_SRV_BTPUSHRECV_REGISTER_GET_VERSION_HDLR_SUCCESS, "[BTPushRecvSrv] get version hdlr register success")
    TRC_MSG(TRC_SRV_BTPUSHRECV_REGISTER_GET_VERSION_HDLR_FAIL, "[BTPushRecvSrv] get version hdlr register fail")
    TRC_MSG(TRC_SRV_BTPUSHRECV_REGISTER_GET_FOTA_TYPE_HDLR_SUCCESS, "[BTPushRecvSrv] get fota type hdlr register success")    
    TRC_MSG(TRC_SRV_BTPUSHRECV_REGISTER_GET_FOTA_TYPE_HDLR_FAIL, "[BTPushRecvSrv] get fota type hdlr register fail")
    TRC_MSG(TRC_SRV_BTPUSHRECV_SEND_CMD_SUCCESS, "[BTPushRecvSrv] send cmd to SP success")
    TRC_MSG(TRC_SRV_BTPUSHRECV_SEND_CMD_FAIL, "[BTPushRecvSrv] send cmd to SP fail")
    TRC_MSG(TRC_SRV_BTPUSHRECV_RECEIVE_BUFFER, "[BTPushRecvSrv] receive buffer, data = %s, len = %d")
    TRC_MSG(TRC_SRV_BTPUSHRECV_RECEIVE_GET_VERSION_CMD, "[BTPushRecvSrv] receive getVersion cmd")
    TRC_MSG(TRC_SRV_BTPUSHRECV_TRIGGER_FUDIFFNET_SUCCESS, "[BTPushRecvSrv] trigger fudiffnet success")
    TRC_MSG(TRC_SRV_BTPUSHRECV_TRIGGER_FUDIFFNET_FAIL, "[BTPushRecvSrv] trigger fudiffnet fail")
    TRC_MSG(TRC_SRV_BTPUSHRECV_BT_CONNECT_SUCCESS, "[BTPushRecvSrv] bt connect success")
    TRC_MSG(TRC_SRV_BTPUSHRECV_FOTA_DELTA_SUCCESS, "[BTPushRecvSrv] fota.delta exist")
    TRC_MSG(TRC_SRV_BTPUSHRECV_FIRMWARE_FD_ALREADY_EXIST, "[BTPushRecvSrv] g_firmware_fd already exist")
    TRC_MSG(TRC_SRV_BTPUSHRECV_OPEN_FIRMWARE_FILE_FAIL, "[BTPushRecvSrv] open firmware file fail")
    TRC_MSG(TRC_SRV_BTPUSHRECV_NEED_RECEIVE_PACKAGES, "[BTPushRecvSrv] Need to receive %d packages")
    TRC_MSG(TRC_SRV_BTPUSHRECV_DELETE_FIRMWARE_FILE_SUCCESS, "[BTPushRecvSrv] delete firmware file success")
    TRC_MSG(TRC_SRV_BTPUSHRECV_FOTA_UPDATE_QUOTA_NOT_ENOUGH, "[BTPushRecvSrv] fota update quota not enough")
    TRC_MSG(TRC_SRV_BTPUSHRECV_WRITE_FIRMWARE_FILE_FAIL, "[BTPushRecvSrv] write to firmware file fail")
    TRC_MSG(TRC_SRV_BTPUSHRECV_BT_TRANSFER_DATA_FAIL, "[BTPushRecvSrv] BT transfer data fail")
    TRC_MSG(TRC_SRV_BTPUSHRECV_OPEN_MODEL_FILE_FAIL, "[BTPushRecvSrv] open model file fail")
    TRC_MSG(TRC_SRV_BTPUSHRECV_REGISTER_UBIN_HDLR_SUCCESS, "[BTPushRecvSrv] fota ubin update hdlr register success")
    TRC_MSG(TRC_SRV_BTPUSHRECV_REGISTER_UBIN_HDLR_FAIL, "[BTPushRecvSrv] fota ubin update hdlr register fail")
    TRC_MSG(TRC_SRV_BTPUSHRECV_TRIGGER_FUNET_SUCCESS, "[BTPushRecvSrv] trigger funet success")
    TRC_MSG(TRC_SRV_BTPUSHRECV_TRIGGER_FUNET_FAIL, "[BTPushRecvSrv] trigger funet fail")
    TRC_MSG(TRC_SRV_BTPUSHRECV_UBIN_IS_EXIST, "[BTPushRecvSrv] ubin file exist")
    TRC_MSG(TRC_SRV_BTPUSHRECV_UBIN_FD_ALREADY_EXIST, "[BTPushRecvSrv] g_ubin_fd already exist")
    TRC_MSG(TRC_SRV_BTPUSHRECV_OPEN_UBIN_FILE_FAIL, "[BTPushRecvSrv] open ubin file fail")
    TRC_MSG(TRC_SRV_BTPUSHRECV_DELETE_UBIN_FILE_SUCCESS, "[BTPushRecvSrv] delete ubin file success")
    TRC_MSG(TRC_SRV_BTPUSHRECV_FOTA_UBIN_QUOTA_NOT_ENOUGH, "[BTPushRecvSrv] fota ubin quota not enough")
    TRC_MSG(TRC_SRV_BTPUSHRECV_WRITE_UBIN_FILE_FAIL, "[BTPushRecvSrv] write ubin file fail")
    TRC_MSG(TRC_SRV_BTPUSHRECV_CLEAR_STATUS, "[BTPushRecvSrv] BT disconnect, clear status")
    TRC_MSG(TRC_SRV_BTPUSHRECV_REGISTER_FBIN_HDLR_SUCCESS, "[BTPushRecvSrv] fota fbin update hdlr register success")
    TRC_MSG(TRC_SRV_BTPUSHRECV_REGISTER_FBIN_HDLR_FAIL, "[BTPushRecvSrv] fota fbin update hdlr register fail")
    TRC_MSG(TRC_SRV_BTPUSHRECV_FBIN_IS_EXIST, "[BTPushRecvSrv] fbin file exist")
    TRC_MSG(TRC_SRV_BTPUSHRECV_FBIN_FD_ALREADY_EXIST, "[BTPushRecvSrv] g_fbin_fd already exist")
    TRC_MSG(TRC_SRV_BTPUSHRECV_OPEN_FBIN_FILE_FAIL, "[BTPushRecvSrv] open fbin file fail")
    TRC_MSG(TRC_SRV_BTPUSHRECV_DELETE_FBIN_FILE_SUCCESS, "[BTPushRecvSrv] delete fbin file success")
    TRC_MSG(TRC_SRV_BTPUSHRECV_FOTA_FBIN_QUOTA_NOT_ENOUGH, "[BTPushRecvSrv] fota fbin quota not enough")
    TRC_MSG(TRC_SRV_BTPUSHRECV_WRITE_FBIN_FILE_FAIL, "[BTPushRecvSrv] write fbin file fail")
    //FUDIFFNETSRV
    TRC_MSG(TRC_SRV_FUDIFFNETSRV_READ_UPDATE_INFO_START, "[FUDiffNetSrv] read update_info start")
    TRC_MSG(TRC_SRV_FUDIFFNETSRV_READ_UPDATE_INFO_FAIL, "[FUDiffNetSrv] read update_info fail, size = %d")
    TRC_MSG(TRC_SRV_FUDIFFNETSRV_OPEN_UPDATE_INFO_FAIL, "[FUDiffNetSrv] open update_info fail")
    TRC_MSG(TRC_SRV_FUDIFFNETSRV_DELETE_FOTA_DELTA_SUCCESS, "[FUDiffNetSrv] delete fota.delta success")
    TRC_MSG(TRC_SRV_FUDIFFNETSRV_UPDATE_INFO_IS_EXIST, "[FUDiffNetSrv] fota update_info exist")
    TRC_MSG(TRC_SRV_FUDIFFNETSRV_ONLY_FOTA_DELTA_EXIST, "[FUDiffNetSrv] only fota.delta exist")
    TRC_MSG(TRC_SRV_FUDIFFNETSRV_TRIGGER_FUDIFFNET_SUCCESS, "[FUDiffNetSrv] trigger fudiffnet success")
    TRC_MSG(TRC_SRV_FUDIFFNETSRV_FOTA_NO_UPDATE, "[FUDiffNetSrv] fota no update")
    TRC_MSG(TRC_SRV_FUDIFFNETSRV_FOTA_FOLDER_NOT_EXIST, "[FUDiffNetSrv] FOTA folder not exist")
    TRC_MSG(TRC_SRV_FUDIFFNETSRV_CREATE_FOTA_DIR_FAIL, "[FUDiffNetSrv] create FOTA dir fail")
    //FUNETSRV
    TRC_MSG(TRC_SRV_FUNETSRV_READ_UPDATE_INFO_START, "[FUNetSrv] read update_info start")
    TRC_MSG(TRC_SRV_FUNETSRV_READ_UPDATE_INFO_FAIL, "[FUNetSrv] read update_info fail, size = %d")
    TRC_MSG(TRC_SRV_FUNETSRV_OPEN_UPDATE_INFO_FAIL, "[FUNetSrv] open update_info fail")
    TRC_MSG(TRC_SRV_FUNETSRV_DELETE_UBIN_SUCCESS, "[FUNetSrv] delete ubin file success")
    TRC_MSG(TRC_SRV_FUNETSRV_UPDATE_INFO_IS_EXIST, "[FUNetSrv] fota update_info exist")
    TRC_MSG(TRC_SRV_FUNETSRV_ONLY_UBIN_FILE_EXIST, "[FUNetSrv] only ubin file exist")
    TRC_MSG(TRC_SRV_FUNETSRV_TRIGGER_FUNET_SUCCESS, "[FUNetSrv] trigger funet success")
    TRC_MSG(TRC_SRV_FUNETSRV_FOTA_NO_UPDATE, "[FUNetSrv] fota no update")
    TRC_MSG(TRC_SRV_FUNETSRV_FOTA_FOLDER_NOT_EXIST, "[FUNetSrv] fota ubin folder not exist")
    TRC_MSG(TRC_SRV_FUNETSRV_CREATE_FOTA_DIR_FAIL, "[FUNetSrv] create ubin dir fail")

    //EPO DOWNLOAD FOR GPS
    TRC_MSG(TRC_SRV_BTEPODOWNSRV_BTDATA_CB_START, "[BTPushRecvSrv][EPO] receive data type = %d, sender_id = %s")
    TRC_MSG(TRC_SRV_BTEPODOWNSRV_BTDATA_CB_EPO_SUCCESS, "[BTPushRecvSrv][EPO] srv_btpr_epo_down_ext_cmd_cb: epo file success")
    TRC_MSG(TRC_SRV_BTEPODOWNSRV_BTDATA_CB_EPO_FAIL, "[BTPushRecvSrv][EPO] srv_btpr_epo_down_ext_cmd_cb: epo file fail,error=%d")
    TRC_MSG(TRC_SRV_BTEPODOWNSRV_BTDATA_CB_MD5_SUCCESS, "[BTPushRecvSrv][EPO] srv_btpr_epo_down_ext_cmd_cb: md5 sucess")
    TRC_MSG(TRC_SRV_BTEPODOWNSRV_BTDATA_CB_MD5_FAIL1, "[BTPushRecvSrv][EPO] srv_btpr_epo_down_ext_cmd_cb: md5 fail,error=%d")
    TRC_MSG(TRC_SRV_BTEPODOWNSRV_BTDATA_CB_MD5_FAIL2, "[BTPushRecvSrv][EPO] srv_btpr_epo_down_ext_cmd_cb: md5 length(%d) wrong")
    TRC_MSG(TRC_SRV_BTEPODOWNSRV_BTDATA_RSG_SUCCESS, "[BTPushRecvSrv][EPO] srv_bt_noti_register_callback: success")
    TRC_MSG(TRC_SRV_BTEPODOWNSRV_BTDATA_RSG_FAIL, "[BTPushRecvSrv][EPO] srv_bt_noti_register_callback: fail")
    TRC_MSG(TRC_SRV_BTEPODOWNSRV_EPO_DEL_SUCCESS, "[BTPushRecvSrv][EPO] srv_btpr_epo_del_epo_file_rsp:del epo file success")
    TRC_MSG(TRC_SRV_BTEPODOWNSRV_EPO_CPY_SUCCESS, "[BTPushRecvSrv][EPO] srv_btpr_epo_copy_epo_file_rsp: epo = %d, md5 = %d") 
    TRC_MSG(TRC_SRV_BTEPODOWNSRV_GPS_UPDATE_REQUEST, "[BTPushRecvSrv][EPO] srv_btpr_epo_gps_request_epo_download: epo request")
    TRC_MSG(TRC_SRV_BTEPODOWNSRV_NOTIY_BT_STATUS, "[BTPushRecvSrv][EPO] srv_btpr_epo_notify_gps_btconn_status: notify gps bt status")
    TRC_MSG(TRC_SRV_BTEPODOWNSRV_EPO_DOWNLOAD_SUCCESS, "[BTPushRecvSrv][EPO] srv_btpr_epo_notify_gps_epodown_success: notify gps down sucess")
	...
	TRC_MSG(TRC_BLE_TIP_REGISTER,     "[BLE_TIPAPP]client_regiter") 
	TRC_MSG(TRC_BLE_TIP_UPDATE_TIME,     "[BLE_TIPAPP]update_time") 
	TRC_MSG(TRC_BLE_TIP_DEREGISTER,     "[BLE_TIPAPP]client_deregiter")
	TRC_MSG(TRC_BLE_TIP_REGISTER_CB,     "[BLE_TIPAPP]register_cb, status =[%d]")
	TRC_MSG(TRC_BLE_TIP_TIME_INFO,     "[BLE_TIPAPP]time_info_cb, status =[%d]")
	TRC_MSG(TRC_BLE_TIP_DEREGISTER_CB,     "[BLE_TIPAPP]deregister_cb, status =[%d]")


	/*App Name: Bluetooth*/

	TRC_MSG(SRV_BT_CM_IS_BOX, "[BTBSRV]: srv_bt_cm_is_box, addr:0x%02x:%02x:%02x:%02x:%02x:%02x, ret=%d")
	TRC_MSG(SRV_BT_CM_IS_BOX_EXT, "[BTBSRV]: srv_bt_cm_is_box_ext, cod=0x%x, name=0x%x, ret=%d")
	TRC_MSG(SRV_BT_CM_IS_MASTER, "[BTBSRV]: srv_bt_cm_is_master, ret=%d")
	TRC_MSG(SRV_BT_CM_SET_AS_MASTER, "[BTBSRV]: srv_bt_cm_set_as_master, %d")
	TRC_MSG(BTB_POWER, "[BTB]power_on=%d,power status=%d")
	TRC_MSG(BTB_EVENT_HDLR, "[BTB]btb_event_hdlr,evt_id=%d")
	TRC_MSG(BTB_EVENT_NOTIFY, "[BTB]btb_event_notify_handle,event=0x%x")
	TRC_MSG(BTB_INIT, "[BTB]: btb_init, handle=%d")
	TRC_MSG(BTB_DEINIT, "[BTB]: btb_deinit, handle=%d")
	TRC_MSG(BTB_CONNECT_EXT, "[BTB]: btb_connect_ext, dev_addr=0x%02x:%02x:%02x:%02x:%02x:%02x,is_connecting=%d")
	TRC_MSG(BTB_DISCONNECT, "[BTB]: btb_disconnect, source=%d")
	TRC_MSG(BTB_INQUIRY_COMPLETE, "[BTB]: btb_inquiry_complete, discoveried_dev_counter=%d,result=%d,is_cancelled=%d")
	TRC_MSG(BTB_INQUIRY_NOTIFY, "[BTB]: btb_inquiry_result_notify, index=%d,cod=%x,addr=[0x%02x:%02x:%02x:%02x:%02x:%02x],is_box=%d,name=[%x-%x-%x-%x]")
	TRC_MSG(BTB_INQUIRY_DEV, "[BTB]: btb_inquiry_dev, %d")
	TRC_MSG(BTB_CONNECT_SUCCESS, "[BTB]btb_connect_success,found source=%d,index=%d")
	TRC_MSG(BTB_PAIR_IND, "[BTB]btb_pair_ind, dev_addr=0x%02x:%02x:%02x:%02x:%02x:%02x")
	TRC_MSG(BTB_PAIR_RES, "[BTB]btb_pair_res, result=%d,dev_addr=0x%02x:%02x:%02x:%02x:%02x:%02x")
	TRC_MSG(BTB_CONNECT_RES, "[BTB]btb_connect_res, result=%d,profile_id=%x,dev_addr=0x%02x:%02x:%02x:%02x:%02x:%02x")
	TRC_MSG(BTB_DISCONNECT_IND, "[BTB]btb_disconnect_ind, profile_id=%x,dev_addr=0x%02x:%02x:%02x:%02x:%02x:%02x")
	TRC_MSG(BTB_CONNECT_A2DP_SRC_CB, "[BTB]btb_connect_a2dp_src_cb, dev_addr=0x%02x:%02x:%02x:%02x:%02x:%02x,conn_type=%d,result=%d,is_connect=%d,is_indicate=%d")
	...
	TRC_MSG(TRC_MMI_BT_RMTCAP_PIC_SHOW,	            "[MMI][BTRMTCAP]mmi_bt_rmtcap_pic_show()")TRC_MSG(TRC_MMI_BT_RMTCAP_DRAW_SHOT_SCREEN, "[MMI][BTRMTCAP]mmi_bt_rmtcap_draw_shot_screen, filename %x, buffer %x")
	TRC_MSG(TRC_MMI_BT_RMTCAP_PEN_DOWN_HDLR, "[MMI][BTRMTCAP]mmi_bt_rmtcap_pen_down_hdlr, x=%d, y=%d")
	TRC_MSG(TRC_MMI_BT_RMTCAP_PEN_UP_HDLR, "[MMI][BTRMTCAP]mmi_bt_rmtcap_pen_up_hdlr, x=%d, y=%d")
	TRC_MSG(TRC_MMI_BT_RMTCAP_ENTER_MAIN_CAPTURE, "[MMI][BTRMTCAP]enter mmi_bt_rmtcap_main_capture")
	TRC_MSG(TRC_MMI_BT_RMTCAP_MOVE_TO_IDLE_HDLR, "[MMI][BTRMTCAP]mmi_bt_rmtcap_pen_move_to_idle_hdlr, x=%d, y=%d")
	TRC_MSG(TRC_MMI_BT_RMTCAP_ENTER_MAIN_EXIT, "[MMI][BTRMTCAP]enter mmi_bt_rmtcap_main_exit_capture")
	TRC_MSG(TRC_MMI_BT_RMTCAP_MOVE_TO_DRAW_HDLR, "[MMI][BTRMTCAP]mmi_bt_rmtcap_pen_move_to_draw_hdlr, x=%d, y=%d")
	TRC_MSG(TRC_MMI_BT_RMTCAP_ENTER_EXIT_SHOW, "[MMI][BTRMTCAP]enter mmi_bt_rmtcap_exit_show_pic")
	TRC_MSG(TRC_MMI_BT_RMTCAP_SET_DRAW_PEN_CALLBACK, "[MMI][BTRMTCAP]mmi_bt_rmtcap_set_draw_screen_pen_callback")
	TRC_MSG(TRC_MMI_BT_RMTCAP_SET_CAPTURE_PEN_CALLBACK, "[MMI][BTRMTCAP]mmi_bt_rmtcap_set_capture_screen_pen_callback")
	TRC_MSG(TRC_MMI_BT_RMTCAP_CLEAR_PEN_CALLBACK, "[MMI][BTRMTCAP]mmi_bt_rmtcap_clear_pen_callback")TRC_MSG(TRC_MMI_BT_RMTCAP_SHOW_PIC_SCRN_ACTIVE, "[BTRMT]mmi_bt_rmtcap_show_pic_scrn_proc active")
	TRC_MSG(TRC_MMI_BT_RMTCAP_SHOW_PIC_SCRN_DEINIT, "[BTRMT]mmi_bt_rmtcap_show_pic_scrn_proc inactive")
	TRC_MSG(TRC_MMI_BT_RMTCAP_EXIT_1, "[BTRMT]mmi_bt_rmtcap_exit for show screen, %d")
	TRC_MSG(TRC_MMI_BT_RMTCAP_EXIT_2, "[BTRMT]mmi_bt_rmtcap_exit for show screen")
	TRC_MSG(TRC_MMI_BT_RMTCAP_GET_COST_TIME, "[BTRMT]get data cost time = %d ")
	TRC_MSG(TRC_MMI_BT_RMTCAP_IS_SCRN_PRESENT, "[BTRMT]mmi_frm_scrn_is_present = %d, data err_code = %d ")
	TRC_MSG(TRC_MMI_BT_RMTCAP_STATE_TRANS, "[RMTCAP]State Change: %d-->%d")
	TRC_MSG(TRC_MMI_BT_RMTCAP_DEVICE_HLT_HDLR, "[RMTCAP]highlighthdlr, idx, :%d, lap: %d,uap: %d, nap:%d")
	TRC_MSG(TRC_MMI_BT_RMTCAP_RIGHT_HDLR, "[RMTCAP]mmi_bt_rmtcap_right_hdlr")
	TRC_MSG(TRC_MMI_BT_RMTCAP_MAIN_SHOW_1, "[RMTCAP]main_show, idx, :%d, lap: %d,uap: %d, nap:%d")
	TRC_MSG(TRC_MMI_BT_RMTCAP_MAIN_SCRN_PROC, "[RMTCAP]mmi_bt_rmtcap_main_scrn_proc Active")
	TRC_MSG(TRC_MMI_BT_RMTCAP_CAP_PREVIEW, "[RMTCAP]Preview,cur_state:%d, error_code:%d")
	TRC_MSG(TRC_MMI_BT_RMTCAP_PREVIEW_BY_MEMORY_1, "[RMTCAP]Preview_memory,cur_state:%d, error_code:%d")
	TRC_MSG(TRC_MMI_BT_RMTCAP_PREVIEW_BY_MEMORY_2, "[RMTCAP]Preview")
	...
	TRC_MSG(TRC_BLE_PXPAPP_SWITCH_PROC,     "[BLE_PXPAPP]bt_switch_proc, event =[%d],enum=[%d]") 
	TRC_MSG(TRC_BLE_PXPAPP_SCREEN_LOCK,     "[BLE_PXPAPP]mmi_pxp_notify_screen_lock_hdlr()")
	TRC_MSG(TRC_BLE_PXPAPP_SWITCH_INIT,     "[BLE_PXPAPP]mmi_bt_power_on_to_init()")
	TRC_MSG(TRC_BLE_PXPAPP_SWITCH_DEINIT,   "[BLE_PXPAPP]mmi_bt_power_on_to_deinit()")  
	TRC_MSG(TRC_BLE_PXPAPP_CONFIG_LEVEL,    "[BLE_PXPAPP]config_cb, bdaddr = [%x,%x,%x,%x,%x,%x], alert_level=[%d]")
	TRC_MSG(TRC_BLE_PXPAPP_CONFIG_ALERT,    "[BLE_PXPAPP]mmi_pxpapp_lls_config_alert()")
	TRC_MSG(TRC_BLE_PXPAPP_CONFIG_ALERT_DISABLE,    "[BLE_PXPAPP]mmi_pxpapp_lls_config_alert_disable()")
	TRC_MSG(TRC_BLE_PXPAPP_CONNECT_CB,      "[BLE_PXPAPP]connect_cb, bdaddr = [%x,%x,%x,%x,%x,%x], connect_state=[%d]")
	TRC_MSG(TRC_BLE_PXPAPP_ALERT_CB,        "[BLE_PXPAPP]alert_cb, bdaddr =[%x,%x,%x,%x,%x,%x],alert_level=[%d]")
	TRC_MSG(TRC_BLE_PXPAPP_ENTER_POPUP,     "[BLE_PXPAPP]mmi_pxpapp_launch_enter_popup()")
	TRC_MSG(TRC_BLE_PXPAPP_CLOSE_POPUP,     "[BLE_PXPAPP]mmi_pxpapp_grp_proc()")
	TRC_MSG(TRC_BLE_PXPAPP_CREATE_CNTX,     "[BLE_PXPAPP]mmi_pxpapp_create_cntx()")
	TRC_MSG(TRC_BLE_PXPAPP_ALERT_ENABLE,    "[BLE_PXPAPP]mmi_pxpapp_target_alert_enable()")
	TRC_MSG(TRC_BLE_PXPAPP_PEN_RIGHT,       "[BLE_PXPAPP]mmi_pxpapp_pen_right_hdlr()")
	TRC_MSG(TRC_BLE_PXPAPP_SEND_DATA_SUCCESS,    "[BLE_PXPAPP]prxr_send_data() Success!")
	TRC_MSG(TRC_BLE_PXPAPP_SEND_DATA_FAIL,    "[BLE_PXPAPP]prxr_send_data() Fail!")
	TRC_MSG(TRC_BLE_PXPAPP_ALERT_DISABLE,   "[BLE_PXPAPP]mmi_pxpapp_target_alert_disable()")
	TRC_MSG(TRC_BLE_PXPAPP_EXIT_SCREEN_PROC,   "[BLE_PXPAPP]mmi_pxpapp_exit_notification_screen_proc()")
	TRC_MSG(TRC_BLE_PXPAPP_FREE_CNTX,     "[BLE_PXPAPP]mmi_pxpapp_free_cntx()")
	TRC_MSG(TRC_BLE_PXPAPP_ALERT_SHOW,      "[BLE_PXPAPP]alert, str_id =[%d],g_pxp_cntx_p->image_id=[%d]")
	...
	TRC_MSG(TRC_MMI_HR_SCRN_SHOW, "[HR]mmi_heart_rate_scrn_show, bpm = %d\n")
	TRC_MSG(TRC_MMI_HR_UPDATE_DATA, "[HR]mmi_heart_rate_update_data: bpm = %d, status = %d\n")
	TRC_MSG(TRC_MMI_HR_SEND_DATA_TO_BT, "[HR]Data sent: len = %d, result = %d\n")
	TRC_MSG(TRC_MMI_HR_SEND_DATA, "[HR]mmi_heart_rate_send_data, raw_len = %d\n")
	TRC_MSG(TRC_MMI_HR_HANDSHAKE, "[HR]Handshake rsponse, result = %d, len = %d\n")
	TRC_MSG(TRC_MMI_HR_CONNECTION_CHANGE, "[HR]BT_NOTI_CONNECTION_STATUS_CHANGE, connected = %d\n")

	/*App Name: BLOODPRESSURE*/

	TRC_MSG(TRC_MMI_BP_TIMEOUT, "[BP]mmi_blood_pressure_detect_timeout\n")
	TRC_MSG(TRC_MMI_BP_SCRN_SHOW, "[BP]mmi_bp_scrn_show, detect_timeout = %d, sdp = %d, dbp = %d\n")
	TRC_MSG(TRC_MMI_BP_UPDATE_DATA,  "[BP]mmi_blood_pressure_update_data, sdp = %d, dbp = %d\n")
	TRC_MSG(TRC_MMI_BP_SEND_DATA_TO_BT,  "[BP]Send data: len = %d, result = %d\n")
	TRC_MSG(TRC_MMI_BP_SEND_DATA,  "[BP]mmi_blood_pressure_send_data, raw_len = %d\n")
	TRC_MSG(TRC_MMI_BP_HANDSHAKE,  "[BP]Handshake response, result = %d, len = %d\n")
	TRC_MSG(TRC_MMI_BP_PARSE_SCCUESS,  "[BP]parse success, write_NVRAM_len = %d\n")
	TRC_MSG(TRC_MMI_BP_SEND_RESPONSE,  "[BP]Send RSP: len = %d, result = %d\n")
	TRC_MSG(TRC_MMI_BP_CONNECTION_CHANGE,  "[BP]BT_NOTI_CONNECTION_STATUS_CHANGE, connected = %d\n")
	TRC_MSG(TRC_MMI_BP_DETECT_TIMER_START,  "[BP]Detect timer start\n")
	...
	TRC_MSG(TRC_PDMS_FIND_UUID_BY_HANDLE,     "[PDMS] pdms_find_uuid_by_handle %x!\n") 
	TRC_MSG(TRC_PDMS_FIND_UUID_TYPE,     "[PDMS] svc_list->type %d!\n") 
	TRC_MSG(TRC_PDMS_READ_CB,     "[PDMS] pdms_request_read_callback handle:%x, type:%d, uuid %x, offset %d, long %d!\n") 
	TRC_MSG(TRC_PDMS_READ_CB_END,     "[PDMS] pdms_request_read_callback -!\n") 
	TRC_MSG(TRC_PDMS_REGISTER_CB,     "[PDMS] pdms_register_server_callback status %x, state %d, op_flag %d!\n") 
	TRC_MSG(TRC_PDMS_REGISTER_CB_END,     "[PDMS] pdms_register_server_callback -!\n")
	TRC_MSG(TRC_PDMS_CONNECT_CB,     "[PDMS] pdms_connection_callback connected %d!\n") 
	TRC_MSG(TRC_PDMS_FIND_IN_LIST,     "[PDMS] find in list!\n") 
	TRC_MSG(TRC_PDMS_NOT_FIND_IN_LIST,     "[PDMS] not find in list!\n") 
	TRC_MSG(TRC_PDMS_WRITE_CB,     "[PDMS]pdms_request_write_callback attr_handle %x, svc_uuid16 %x, chr_uuid16 %x!\n") 
	TRC_MSG(TRC_PDMS_CONNECT_FAIL,     "[PDMS] pdms_request_write_callback doesn't connected!\n") 
	TRC_MSG(TRC_PDMS_WRITE_VALUE,     "[PDMS] value %x %d %d %d %d") 
	TRC_MSG(TRC_PDMS_SERVICE_START_CB,     "[PDMS] pdms_service_started_callback status %d, srvc_handle %d!\n") 
	TRC_MSG(TRC_PDMS_SERVICE_ADD_CB,     "[PDMS] pdms_add_services_callback status %d, state %d, op_flag %d!\n") 
	TRC_MSG(TRC_PDMS_LIST_EMPTY,     "[PDMS] is empty service list!\n") 
	TRC_MSG(TRC_PDMS_INIT,     "[PDMS] pdms_init state %d, op_flag %d!\n") 
	TRC_MSG(TRC_PDMS_DEINIT,     "[PDMS] pdms_deinit state %d, op_flag %d!\n") 
	TRC_MSG(TRC_PDMS_DISCONN_EVENT_HANDLER,     "[PDMS] pdms_disconnect_event_handler !\n") 
	TRC_MSG(TRC_PDMS_DISCONN_EVENT_ADDR,     "[PDMS] pdms_disconnect_event_handler pConnCur->bdaddr %s!\n") 
	TRC_MSG(TRC_PDMS_SEND_DATA,     "[PDMS] pdms_send_data buf:%x, size:%d !\n")
	TRC_MSG(TRC_PDMS_DISCONN_EVENT_STATUS,     "[PDMS] find in list conn_status %d !\n") 
	TRC_MSG(TRC_PDMS_RECV_EVENT_HANDLER,     "[PDMS] pdms_recv_event_handler evt->evt_id %d!\n") 
	TRC_MSG(TRC_PDMS_RECV_EVENT_ADDR,     "[PDMS] pdms_recv_event_handler remote_addr %s!\n") 
	...
	TRC_MSG(TRC_BT_NOTIFICATION_CURRENT_ADDRESS,                   "[BTNOTIFICATION]current_dev=[%d],current_address=[%x-%x-%x],enum=[%d]")
	TRC_MSG(TRC_BT_NOTIFICATION_PROC,                               "[BTNOTIFICATION]proc, evt_id=[%d],enum=[%d]")
	TRC_MSG(TRC_BT_NOTIFICATION_MRE,                                "[BTNOTIFICATION]mre, ret_code=[%d],error-code=[%d]")
	...
	TRC_MSG(TRC_BLE_FMPAPP_CLIENT_INIT,     "[BLE_FMPAPP]client_init, mmi_fmpapp_client_init()") 
	TRC_MSG(TRC_BLE_FMPAPP_BTC_SWITCH_ON,     "[BLE_FMPAPP]Switch_on, mmi_bt_power_on_init_fmpl()") 
	TRC_MSG(TRC_BLE_FMPAPP_BTC_SWITCH_OFF,     "[BLE_FMPAPP]Switch_off, mmi_bt_power_on_deinit_fmpl()")
	TRC_MSG(TRC_BLE_FMPAPP_FREE_CNTX,     "[BLE_FMPAPP]free_cntx, mmi_fmpapp_free_context()")
	TRC_MSG(TRC_BLE_FMPAPP_CREATE_CNTX,     "[BLE_FMPAPP]create_cntx, mmi_fmpapp_create_context()")
	TRC_MSG(TRC_BLE_FMPAPP_ENTER_START,     "[BLE_FMPAPP]enter_start, mmi_fmpapp_entry_normal_screen()")
	TRC_MSG(TRC_BLE_FMPAPP_START_SHOW,     "[BLE_FMPAPP]start_show, mmi_fmpapp_normal_sreen_show()")
	TRC_MSG(TRC_BLE_FMPAPP_LOCATOR_CNNC,      "[BLE_FMPAPP]Lconnect_cb, rbd_addr =[%x,%x,%x,%x,%x,%x],connect_state=[%d]")
	TRC_MSG(TRC_BLE_FMPAPP_LOCATOR_ALERT,      "[BLE_FMPAPP]fmpl_alert, addr =[%x,%x,%x,%x,%x,%x],alert_result=[%d]")
	TRC_MSG(TRC_BLE_FMPAPP_LOCATOR_ALERT_CB,      "[BLE_FMPAPP]Lalert_notify_cb, addr =[%x,%x,%x,%x,%x,%x],alert_result=[%d]")
	TRC_MSG(TRC_BLE_FMPAPP_ENTER_STOP,     "[BLE_FMPAPP]enter_stop, mmi_fmpapp_entry_finding_screen()")
	TRC_MSG(TRC_BLE_FMPAPP_STOP_SHOW,     "[BLE_FMPAPP]stop_show, mmi_fmpapp_finding_sreen_show()")
	TRC_MSG(TRC_BLE_FMPAPP_STOP_SHOW_CLOSE,     "[BLE_FMPAPP]stop_to_start, mmi_fmpapp_stop_clicked_cb()")
	TRC_MSG(TRC_BLE_FMPAPP_SERVER_INIT,     "[BLE_FMPAPP]server_init, mmi_fmpapp_server_init()")
	TRC_MSG(TRC_BLE_FMPAPP_BTS_SWITCH_ON,     "[BLE_FMPAPP]Switch_on, mmi_bt_power_on_init_fmps()") 
	TRC_MSG(TRC_BLE_FMPAPP_BTS_SWITCH_OFF,     "[BLE_FMPAPP]Switch_off, mmi_bt_power_on_deinit_fmps()")
	TRC_MSG(TRC_BLE_FMPAPP_REMOTER_CNNC,      "[BLE_FMPAPP]Rconnect_cb, bdaddr =[%x,%x,%x,%x,%x,%x],connect_state=[%d]")
	TRC_MSG(TRC_BLE_FMPAPP_REMOTER_ALERT,      "[BLE_FMPAPP]Ralert_cb, bdaddr =[%x,%x,%x,%x,%x,%x],alert_level=[%d]")
	TRC_MSG(TRC_BLE_FMPAPP_REMOTER_ALERT_START,     "[BLE_FMPAPP]alert_enable, mmi_fmpapp_target_alert_enable()")
	TRC_MSG(TRC_BLE_FMPAPP_REMOTER_ALERT_STOP,     "[BLE_FMPAPP]alert_disable, mmi_fmpapp_target_alert_disable()")


	/*App Name: APP_ANCS*/

	TRC_MSG(TRC_MMI_ANCS_EVT_HD, "[ANCS] mmi_bt_ancs_evt_hdlr, evt_id:%d, ind_type:%d")
	TRC_MSG(TRC_MMI_ANCS_EVT_HD_UCM, "[ANCS] mmi_bt_ancs_evt_hdlr, UCM show, ind_type:%d")
	TRC_MSG(TRC_MMI_ANCS_POP_SHOW, "[ANCS] mmi_bt_ancs_notify_popup_show, noti_id:%d")
	TRC_MSG(TRC_MMI_ANCS_DETAIL_SHOW, "[ANCS] mmi_bt_ancs_notify_details_show, hilit_nid:%d")
	TRC_MSG(TRC_MMI_ANCS_LIST_SHOW, "[ANCS] mmi_bt_ancs_notify_list_show")
	...
	TRC_MSG(TRC_BLE_ANPAPP_CLIENT_INIT,     "[BLE_ANPAPP]client_init, mmi_anpapp_client_init()") 
	TRC_MSG(TRC_BLE_ANPAPP_BTC_SWITCH_ON,     "[BLE_ANPAPP]BT_Switch_on, mmi_bt_power_on_init_anpc()") 
	TRC_MSG(TRC_BLE_ANPAPP_BTC_SWITCH_OFF,     "[BLE_ANPAPP]BT_Switch_off, mmi_bt_power_on_deinit_anpc()")
	TRC_MSG(TRC_BLE_ANPAPP_READ_NEW_CNF2,     "[BLE_ANPAPP]read_new_cnf,cat_bits = [%d],cat_id = [%d]")
	TRC_MSG(TRC_BLE_ANPAPP_READ_UNREAD_CNF2,     "[BLE_ANPAPP]read_unread_cnf,cat_bits = [%d],cat_id = [%d]")
	TRC_MSG(TRC_BLE_ANPAPP_READ_NEW_CNF_SIMPLE,     "[BLE_ANPAPP]read_new_cnf,simple alert")
	TRC_MSG(TRC_BLE_ANPAPP_READ_NEW_CNF_EMAIL,     "[BLE_ANPAPP]read_new_cnf,email")
	TRC_MSG(TRC_BLE_ANPAPP_READ_NEW_CNF_NEWS,     "[BLE_ANPAPP]read_new_cnf,news")
	TRC_MSG(TRC_BLE_ANPAPP_READ_NEW_CNF_CALL,     "[BLE_ANPAPP]read_new_cnf,call")
	TRC_MSG(TRC_BLE_ANPAPP_READ_NEW_CNF_MISSED_CALL,     "[BLE_ANPAPP]read_new_cnf,missed call")
	TRC_MSG(TRC_BLE_ANPAPP_READ_NEW_CNF_SMS_MMS,     "[BLE_ANPAPP]read_new_cnf,message")
	TRC_MSG(TRC_BLE_ANPAPP_READ_NEW_CNF_VOICE_MAIL,     "[BLE_ANPAPP]read_new_cnf,voice mail")
	TRC_MSG(TRC_BLE_ANPAPP_READ_NEW_CNF_SCHEDULE,     "[BLE_ANPAPP]read_new_cnf,schedule")
	TRC_MSG(TRC_BLE_ANPAPP_READ_NEW_CNF_HIGH_PRO,     "[BLE_ANPAPP]read_new_cnf,high priority")
	TRC_MSG(TRC_BLE_ANPAPP_READ_NEW_CNF_INSTANT,     "[BLE_ANPAPP]read_new_cnf,instant message")
	TRC_MSG(TRC_BLE_ANPAPP_READ_UNREAD_CNF_SIMPLE,     "[BLE_ANPAPP]read_unread_cnf,simple alert")
	TRC_MSG(TRC_BLE_ANPAPP_READ_UNREAD_CNF_EMAIL,     "[BLE_ANPAPP]read_unread_cnf,email")
	TRC_MSG(TRC_BLE_ANPAPP_READ_UNREAD_CNF_NEWS,     "[BLE_ANPAPP]read_unread_cnf,news")
	TRC_MSG(TRC_BLE_ANPAPP_READ_UNREAD_CNF_CALL,     "[BLE_ANPAPP]read_unread_cnf,call")
	TRC_MSG(TRC_BLE_ANPAPP_READ_UNREAD_CNF_MISSED_CALL,     "[BLE_ANPAPP]read_unread_cnf,missed call")
	TRC_MSG(TRC_BLE_ANPAPP_READ_UNREAD_CNF_SMS_MMS,     "[BLE_ANPAPP]read_unread_cnf,message")
	TRC_MSG(TRC_BLE_ANPAPP_READ_UNREAD_CNF_VOICE_MAIL,     "[BLE_ANPAPP]read_unread_cnf,voice mail")
	TRC_MSG(TRC_BLE_ANPAPP_READ_UNREAD_CNF_SCHEDULE,     "[BLE_ANPAPP]read_unread_cnf,schedule")
	TRC_MSG(TRC_BLE_ANPAPP_READ_UNREAD_CNF_HIGH_PRO,     "[BLE_ANPAPP]read_unread_cnf,high priority")
	TRC_MSG(TRC_BLE_ANPAPP_READ_UNREAD_CNF_INSTANT,     "[BLE_ANPAPP]read_unread_cnf,instant message")
	TRC_MSG(TRC_BLE_ANPAPP_ENABLE_CNF,     "[BLE_ANPAPP]Enable_cb, param->result =[%d]")
	TRC_MSG(TRC_BLE_ANPAPP_DISCONNECT_ND,     "[BLE_ANPAPP]Disconnect_ind")
	TRC_MSG(TRC_BLE_ANPAPP_CNNC_CNF,     "[BLE_ANPAPP]Connect_cb, param->result =[%d]")
	TRC_MSG(TRC_BLE_ANPAPP_READ_NEW_CNF1,     "[BLE_ANPAPP]Read_new_cnf, param->result =[%d]")
	TRC_MSG(TRC_BLE_ANPAPP_READ_UNREAD_CNF1,     "[BLE_ANPAPP]Read_unread_cnf, param->result =[%d]")
	TRC_MSG(TRC_BLE_ANPAPP_LISTEN_CNF,     "[BLE_ANPAPP]Listen_cb, param->result =[%d]")
	TRC_MSG(TRC_BLE_ANPAPP_WRITE_CP_CNF,     "[BLE_ANPAPP]write_cp_cb, param->cmd =[%d],param->result =[%d],param->category_id =[%d]")
	TRC_MSG(TRC_BLE_ANPAPP_WRITE_CP_NEW_CNF,     "[BLE_ANPAPP]write_cp_cb, param->cat_bit =[%d],param->category_id =[%d]")
	TRC_MSG(TRC_BLE_ANPAPP_WRITE_CP_UNREAD_CNF,     "[BLE_ANPAPP]write_cp_cb, param->cat_bit =[%d],param->category_id =[%d]")
	TRC_MSG(TRC_BLE_ANPAPP_CONFIG_NEW_CNF,     "[BLE_ANPAPP]config_new_alert_cb")
	TRC_MSG(TRC_BLE_ANPAPP_CONFIG_UNREAD_CNF,     "[BLE_ANPAPP]config_unread_alert_cb")
	TRC_MSG(TRC_BLE_BT_ANP_POST_EVT,     "[BLE_ANPAPP]ANP_POST_EVT done,evt_id = [%d]")
	TRC_MSG(TRC_BLE_ANPAPP_NEW_IND_NOTIFY,     "[BLE_ANPAPP]Read_New_Notify, param->alert_num =[%d],[%x],[%x],[%x],[%x],[%x],[%x],[%x],[%x],[%x],[%x],[%x],[%x],[%x],[%x],[%x],[%x],[%x],[%x]")
	TRC_MSG(TRC_BLE_ANPAPP_UNREAD_IND_NOTIFY,     "[BLE_ANPAPP]Read_Unread_Notify, param->alert_num =[%d],[%x],[%x],[%x],[%x],[%x],[%x],[%x],[%x],[%x],[%x],[%x],[%x],[%x],[%x],[%x],[%x],[%x],[%x]")
	TRC_MSG(TRC_BLE_ANPAPP_NEW_IND_MISSED_CALL,     "[BLE_ANPAPP]Read_New_missed_call, param->alert_num =[%d],[%x],[%x],[%x],[%x],[%x],[%x],[%x],[%x],[%x],[%x],[%x],[%x],[%x],[%x],[%x],[%x],[%x],[%x]")
	TRC_MSG(TRC_BLE_ANPAPP_NEW_IND_SMS_MMS,     "[BLE_ANPAPP]Read_New_Message, param->alert_num =[%d],[%x],[%x],[%x],[%x],[%x],[%x],[%x],[%x],[%x],[%x],[%x],[%x],[%x],[%x],[%x],[%x],[%x],[%x]")
	TRC_MSG(TRC_BLE_ANPAPP_UNREAD_IND_MISSED_CALL,     "[BLE_ANPAPP]Read_Unread_missed_call, param->alert_num =[%d],[%x],[%x],[%x],[%x],[%x],[%x],[%x],[%x],[%x],[%x],[%x],[%x],[%x],[%x],[%x],[%x],[%x],[%x]")
	TRC_MSG(TRC_BLE_ANPAPP_UNREAD_IND_SMS_MMS,     "[BLE_ANPAPP]Read_Unread_Message, param->alert_num =[%d],[%x],[%x],[%x],[%x],[%x],[%x],[%x],[%x],[%x],[%x],[%x],[%x],[%x],[%x],[%x],[%x],[%x],[%x]")
	...
	TRC_MSG(SRV_BLE_CM_SEARCH_FUNC, "[BLECM]: srv_ble_cm_search(), max_response=%d, timeout=%d, cod=%d, name_discovery=%d, state=%d")
	TRC_MSG(SRV_BLE_CM_INIT_FUNC, "[BLECM]: srv_ble_cm_init()")
	TRC_MSG(SRV_BLE_CM_DISCOVERY_RESULT_IND_HDLER, "[BLECM]: srv_ble_cm_discovery_result_ind_hdler(),cod=%d,Addr:0x%02x:%02x:%02x:%02x:%02x:%02x,state=%d")
	TRC_MSG(SRV_BLE_CM_GET_DEV_INDEX, "[BLECM]: srv_ble_cm_get_dev_index(), Addr:0x%02x:%02x:%02x:%02x:%02x:%02x, dev_type=%d")
	TRC_MSG(SRV_BLE_CM_GET_DEV_INDEX_2, "[BLECM]: srv_ble_cm_get_dev_index()=%d")
	TRC_MSG(SRV_BLE_CM_INCREASE_DISCOVERED_DEV_NUM, "[BLECM] : g_srv_ble_cm_cntx.discovered_dev_num++=%d")
	TRC_MSG(SRV_BLE_CM_DEV_UPDATE_NAME, "[BLECM]: srv_ble_cm_dev_update_name(), Addr:0x%02x:%02x:%02x:%02x:%02x:%02x, dev_name=%d")
	TRC_MSG(SRV_BLE_CM_DISCOVERY_CNF, "[BLECM] : srv_ble_cm_discovery_cnf_hdler(), state = %d")
	TRC_MSG(SRV_BLE_CM_CANCEL_DISCOVERY_CNF_HDLER, "[BLECM]: srv_ble_cm_cancel_discovery_cnf_hdler(),state=%d")
	TRC_MSG(SRV_BLE_CM_GET_DEV_INFO_BY_ADDR, "[BLECM]: srv_ble_cm_get_dev_info_by_addr(), Addr:0x%02x:%02x:%02x:%02x:%02x:%02x, dev_type=%d")
	TRC_MSG(SRV_BLE_CM_SEARCH_ABORT, "[BLECM]: srv_ble_cm_search_abort(),state=%d")
	TRC_MSG(SRV_BLE_CM_GET_STATE, "[BLECM]: srv_ble_cm_get_state(),state=%d")
	TRC_MSG(SRV_BLE_CM_SET_STATE, "[BLECM]: srv_ble_cm_set_state(),state=%d")
	TRC_MSG(SRV_BLE_CM_CONNECT_REQ, "[BLECM]: srv_ble_cm_connect_req(), Addr:0x%02x:%02x:%02x:%02x:%02x:%02x")
	TRC_MSG(SRV_BLE_CM_DISCONNECT_REQ, "[BLECM]: srv_ble_cm_disconnect_req(), Addr:0x%02x:%02x:%02x:%02x:%02x:%02x")
	TRC_MSG(SRV_BLE_CM_GATT_CNF, "[BLECM]: srv_ble_cm_gatt_cnf(), Addr:0x%02x:%02x:%02x:%02x:%02x:%02x,is_conn=%d,is_ind=%d,result=%d,reason=%d")
	TRC_MSG(SRV_BLE_CM_GET_DEV_NUM_FUNC, "[BLECM]: srv_ble_cm_get_connected_dev_num(), connected_num=%d")
	TRC_MSG(SRV_BLE_CM_ADD_CONNECTED_LIST, "[BLECM]: srv_ble_cm_add_connected_list(), Addr:0x%02x:%02x:%02x:%02x:%02x:%02x,is_ind=%d, connect_num=%d")
	TRC_MSG(SRV_BLE_CM_CONNECTED_LIST, "[BLECM]: connected list after add a dev,i=%d, Addr:0x%02x:%02x:%02x:%02x:%02x:%02x,connect_num=%d")
	TRC_MSG(SRV_BLE_CM_SEARCHED_LIST, "[BLECM]: scan list after add a dev,i=%d, Addr:0x%02x:%02x:%02x:%02x:%02x:%02x,discovery_num=%d")
	TRC_MSG(SRV_BLE_CM_CONNECTED_LIST_1, "[BLECM]: connected list after delete a dev,i=%d, Addr:0x%02x:%02x:%02x:%02x:%02x:%02x,connect_num=%d")
	TRC_MSG(SRV_BLE_CM_DEL_CONNECTED_LIST, "[BLECM]: srv_ble_cm_del_connected_list(), Addr:0x%02x:%02x:%02x:%02x:%02x:%02x,is_ind=%d")
	TRC_MSG(SRV_BLE_CM_GET_DEV_NUM, "[BLECM]: srv_ble_cm_get_dev_num(), dev_type=%d, total_num=%d")
	TRC_MSG(SRV_BLE_CM_GET_CONNECTED_DEV_INFO, "[BLECM]: srv_ble_cm_get_connected_dev_info(), index=%d")
	TRC_MSG(SRV_BLE_CM_GET_SEARCHED_DEV_INFO, "[BLECM]: srv_ble_cm_get_searched_dev_info(), index=%d")
	TRC_MSG(SRV_BLE_CM_SET_VISIBILITY, "[BLECM]: srv_ble_cm_set_visibility(), vis=%d, type=%d, state=%d")
	TRC_MSG(SRV_BLE_CM_WRITE_SCANENABLE_MODE_REQ, "[BLECM]: set ble vis req, page_inquiry_mode=%d")
	TRC_MSG(SRV_BLE_CM_WRITE_SCANENABLE_MODE_CNF, "[BLECM]: srv_ble_cm_write_scanenable_mode_cnf(), state=%d,result=%d")
	TRC_MSG(SRV_BLE_CM_HAVE_NAME, "[BLECM]have name")
	TRC_MSG(SRV_BLE_CM_NO_NAME, "[BLECM]no name")
	TRC_MSG(SRV_BLE_CM_NO_NAME_2, "[BLECM]le srv i:%d j:%d name:%x")
	TRC_MSG(SRV_BLE_CM_GET_CONNED_LIST_INX, "[BLECM]srv_ble_cm_get_connected_list_inx,idx=%d")
	TRC_MSG(SRV_BLE_CM_UPDATE_CONN_DEV_NAME, "[BLECM]srv_ble_cm_update_conn_dev_name")
	TRC_MSG(SRV_BLE_CM_IS_AUTO_CONN_DEV, "[BLECM]: srv_ble_cm_is_auto_conn_dev(), Addr:0x%02x:%02x:%02x:%02x:%02x:%02x")
	TRC_MSG(SRV_BLE_CM_IS_AUTO_CONN_DEV_2, "[BLECM]: auto_conn dev,idx=%d")
	TRC_MSG(SRV_BLE_CM_SET_AUTO_CONN_DEV, "[BLECM]: srv_ble_cm_set_auto_conn_dev(), Addr:0x%02x:%02x:%02x:%02x:%02x:%02x")
	TRC_MSG(SRV_BLE_CM_AUTO_CONN_DEV_LIST, "[BLECM]: auto_conn list,i=%d,Addr:0x%02x:%02x:%02x:%02x:%02x:%02x,flag=%d")
	TRC_MSG(SRV_BLE_CM_RESET_AUTO_CONN_DEV, "[BLECM]: srv_ble_cm_reset_auto_conn_dev(), Addr:0x%02x:%02x:%02x:%02x:%02x:%02x")
	TRC_MSG(SRV_BLE_CM_GET_CURRENT_DEV, "[BLECM]: srv_ble_cm_get_current_dev(), Addr:0x%02x:%02x:%02x:%02x:%02x:%02x")
	TRC_MSG(SRV_BLE_CM_SET_STATE_2, "[BLECM]: srv_ble_cm_set_state(),Addr:0x%02x:%02x:%02x:%02x:%02x:%02x")
	...
	TRC_MSG(TRC_BLE_SOGP_ADP_SEND_CONN_IND,     "[SOGPS ADP]send connect indication") 
	TRC_MSG(TRC_BLE_SOGP_ADP_SEND_DISCONN_IND,  "[SOGPS ADP]send disconnect indication") 
	TRC_MSG(TRC_BLE_SOGP_ADP_SEND_READ_IND,     "[SOGPS ADP]send read indication") 
	TRC_MSG(TRC_BLE_SOGP_ADP_SEND_WRITE_IND,     "[SOGPS ADP]send write indication") 
	TRC_MSG(TRC_BLE_SOGP_ADP_READ,          "[SOGPS ADP]read data: buf=%x size=%d read=%d recv_buf_len=%d")
	TRC_MSG(TRC_BLE_SOGP_ADP_WRITE,         "[SOGPS ADP]write data: buf = %x len=%d err=%d send_buf_len=%d")
	TRC_MSG(TRC_BLE_SOGP_ADP_CONNECT_CB,    "[SOGPS ADP]connect_state =%d")
	TRC_MSG(TRC_BLE_SOGP_ADP_READ_NOTIFY_CB,    "[SOGPS ADP]data to read cb: [%x %x] , len=%d, recv_buf_len=%d")
	TRC_MSG(TRC_BLE_SOGP_ADP_BUFFER_FULL,     "[SOGPS ADP]data to read cb: buffer full")
	TRC_MSG(TRC_BLE_SOGP_ADP_READ_REQUEST_CB,   "[SOGPS ADP]read data cb: buf=%x size=%d read=%d send_buf_len=%d")
	TRC_MSG(TRC_BLE_SOGP_ADP_SEND_DATA,   "[SOGPS ADP]send data: buf=%x send_buf_len=%d err=%d")
	TRC_MSG(TRC_BLE_SOGP_RESET_CONN_INTERVAL,     "[SOGPS] sogps_conn_param_interval_reset success\n") 
	TRC_MSG(TRC_BLE_SOGP_ADDR_NULL,     "[SOGPS] addr is null\n") 
	TRC_MSG(TRC_BLE_SOGP_SET_CONN_INTERVAL,     "[SOGPS] sogps_conn_param_interval_req success\n") 
	TRC_MSG(TRC_BLE_SOGP_FIND_UUID,     "[SOGPS] sogps_find_uuid_by_handle %x!\n") 
	TRC_MSG(TRC_BLE_SOGP_SERVER_REGISTER_CB,     "[SOGPS] sogps_register_server_callback status %x, state %d, op_flag %d!\n") 
	TRC_MSG(TRC_BLE_SOGP_FIND_UUID_TYPE,     "[SOGPS] svc_list->type %d!\n") 
	TRC_MSG(TRC_BLE_SOGP_CONNECT_CB,     "[SOGPS] sogps_connection_callback connected %d!\n") 
	TRC_MSG(TRC_BLE_SOGP_CONNECT_FAIL,     "[SOGPS] connect fail!\n") 
	TRC_MSG(TRC_BLE_SOGP_FIND_IN_LIST,     "[SOGPS] find in list!\n") 
	TRC_MSG(TRC_BLE_SOGP_NOT_FIND_IN_LIST,     "[SOGPS] not find in list!\n") 
	TRC_MSG(TRC_BLE_SOGP_WRITE_VALUE,     "[SOGPS] value %x %d %d %d %d\n") 
	TRC_MSG(TRC_BLE_SOGP_READ_CB,     "[SOGPS] sogps_request_read_callback handle:%x, type:%d, uuid %x, offset %d, long %d!\n") 
	TRC_MSG(TRC_BLE_SOGP_WRITE_CB,     "[SOGPS] sogps_request_write_callback attr_handle %x, svc_uuid16 %x, chr_uuid16 %x!\n") 
	TRC_MSG(TRC_BLE_SOGP_SERVICE_ADD_CB,     "[SOGPS] sogps_add_services_callback status %d, state %d, op_flag %d!\n") 
	TRC_MSG(TRC_BLE_SOGP_DISCONNECT_EVENT_CB,     "[SOGPS] sogps_disconnect_event_handler!\n") 
	TRC_MSG(TRC_BLE_SOGP_DISCONNECT_EVENT_CB_1,     "[SOGPS] find in list conn_status %d !\n") 
	TRC_MSG(TRC_BLE_SOGP_DISCONNECT_EVENT_CB_2,     "[SOGPS] sogps_disconnect_event_handler pConnCur->bdaddr %s!\n") 
	TRC_MSG(TRC_BLE_SOGP_RECV_EVENT_HANDLER_1,     "[SOGPS] sogps_recv_event_handler evt->evt_id %d!\n") 
	TRC_MSG(TRC_BLE_SOGP_RECV_EVENT_HANDLER_2,     "[SOGPS] sogps_recv_event_handler remote_addr %s!\n") 
	TRC_MSG(TRC_BLE_SOGP_INIT,     "[SOGPS] sogps_init state %d, op_flag %d!\n") 
	TRC_MSG(TRC_BLE_SOGP_DEINIT,     "[SOGPS] sogps_init state %d, op_flag %d!\n") 
	TRC_MSG(TRC_BLE_SOGP_SEND_DATA,     "[SOGPS] sogp_send_data buf:%x, size:%d !\n") 
	TRC_MSG(TRC_BLE_SOGP_EXEC_WRITE_CB,     "[SOGPS] sogps_request_exec_write_callback attr_handle %x, svc_uuid16 %x, chr_uuid16 %x!\n") 
	TRC_MSG(TRC_BLE_SOGP_EXEC_WRITE_SUCCESS,     "[SOGPS] sogps_request_exec_write_callback success trans_id = %d, cancel = %d\n")
