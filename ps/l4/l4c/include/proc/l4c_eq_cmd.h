...
extern kal_bool l4a_eq_control_gpio_led_req(kal_uint8 led, kal_uint8 cmd, kal_uint8 on_time, kal_uint8 off_time);
#endif
...
extern void l4c_em_get_essp_req(kal_uint32 * mode);
