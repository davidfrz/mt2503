...
SRC_LIST =  hal\system\cache\src\cp15.s \
            ...
            hal\system\AP_BtSS\src\AP_BtSS_callbacks.c
...
ifneq ($(strip $(FUDIFFNET_ENABLE)),NONE)
   SRC_LIST +=  hal\system\fudiffnet\src\FUDIFFNET.c
endif
...
ifneq ($(filter __UPDATE_PKG_SENSOR_ONLY__, $(strip $(MODULE_DEFS))),)
  SRC_LIST += drv\src\ubin_symbol_wrapper.c
endif
endif
...
ifeq ($(strip $(TINY_SYS)),TRUE)
  ...
  ifeq ($(strip $(UPDATE_BINARY_FILE)),TRUE)
    SRC_LIST +=  hal\system\AP_BtSS\src\AP_UBin_CSCI.c
  endif
endif
...
ifeq ($(strip $(TINY_SYS)),TRUE)
  ...
  INC_DIR += tiny_system\csd\logging\inc \
             kal\common\include \
             tiny_system\app\swatch\inc \
             tiny_system\hal\display\inc
  endif
endif
