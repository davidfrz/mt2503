 ...
 * Static Declaration
 *****************************************************************************/
 #ifdef __POPULATE_NO_IMAGE_DATA__
    #define MMI_MTE_SYSTEM_IMAGE_RESOURCE_NUM 1
    #define MMI_MTE_SYSTEM_IMAGE_RESOURCE_SIZE 1
...
/* avoid the iot project compilation error */
#if defined(__IOT__)
void mte_to_mmi_hisr(void)
{
}
