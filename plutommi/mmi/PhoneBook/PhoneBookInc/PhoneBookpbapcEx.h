...
#ifndef __PHONE_BOOK_PBAPC_EX_H__
#define __PHONE_BOOK_PBAPC_EX_H__
...
/* under construction !*/
    ...
    U16 phb_input_buffer[SRV_PBAPC_LINK_NUM][MMI_PHB_NAME_LENGTH + 1];
    U16 cui_input_buffer[SRV_PBAPC_LINK_NUM][MMI_PHB_NAME_LENGTH + 1];
...
typedef struct
{
    ...
    S32 speci_index;
    S32 ret;
}mmi_phb_pbapc_for_connect_struct;
/* func */
