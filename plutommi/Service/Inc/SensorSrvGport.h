...
typedef void (*SRV_SENSOR_HR_DATA_CB)(void *sensor_data); 
#endif
typedef void (*SRV_SENSOR_ACC_DATA_CB)(void *acc_x, void *acc_y, void *acc_z); 
...
#ifdef __HEART_RATE_ENABLE__
extern void srv_sensor_hr_data_hdlr(void *info);
extern void srv_sensor_hr_data_rigister_cb(SRV_SENSOR_HR_DATA_CB event_hdlr);
#endif
extern void srv_sensor_acc_data_rigister_cb(SRV_SENSOR_ACC_DATA_CB event_hdlr);
