...
static kal_char buf[MAXCHARS];
#pragma arm section zidata

static LOG_LEVEL debug_level = LOG_NONE;  //Prevent from being used before set_debug_level is called
...
static void itoa(kal_char **buf, kal_uint32 i, kal_uint32 base)
{
   kal_char *s;
#define LEN   20
   kal_uint32 rem;
...
static void itof(kal_char **buf, kal_int32 i)
{
   kal_char *s;
#define LEN   20
   kal_int32 rem, j;
