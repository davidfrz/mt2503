...
/* Auth mode used in SP */
typedef enum
{
  SRV_DTCNT_WLAN_SP_AUTH_MODE_OPEN,
  SRV_DTCNT_WLAN_SP_AUTH_MODE_SHARED,
  SRV_DTCNT_WLAN_SP_AUTH_MODE_AUTO_SWITCH,
  SRV_DTCNT_WLAN_SP_AUTH_MODE_WPA,
  SRV_DTCNT_WLAN_SP_AUTH_MODE_WPA_PSK,
  SRV_DTCNT_WLAN_SP_AUTH_MODE_WPA_NONE,
  SRV_DTCNT_WLAN_SP_AUTH_MODE_WPA2,
  SRV_DTCNT_WLAN_SP_AUTH_MODE_WPA2_PSK,
  SRV_DTCNT_WLAN_SP_AUTH_MODE_WAP1WPA2,
  SRV_DTCNT_WLAN_SP_AUTH_MODE_WAP1WPA2_PSK,
  
  SRV_DTCNT_WLAN_SP_AUTH_MODE_MAX
} srv_dtcnt_wlan_sp_auth_mode_enum;
...
typedef enum
{
    ...
    SRV_DTCNT_WLAN_STATE_SNIFFER_ON_WAIT,
    SRV_DTCNT_WLAN_STATE_SNIFFER_ON,
    SRV_DTCNT_WLAN_STATE_SNIFFER_OFF_WAIT,
...
typedef struct
{
    ...
    U16 min_pack_len;
    U16 max_pack_len;
}srv_dtcnt_wlan_sniffer_on_cfg_struct;


typedef struct
{   
    srv_dtcnt_wlan_sniffer_on_cb_type_enum    cb_type;
    srv_dtcnt_wlan_sniffer_res_enum           result;
    srv_dtcnt_prof_wlan_struct*               profile; // Get by sniffer
}srv_dtcnt_wlan_sniffer_on_res_struct;
...
/*****************************************************************************
 * FUNCTION
 *  srv_dtcnt_wlan_sniffer_on_cb_func_ptr
 * DESCRIPTION
 *  sniffer on callback function. If set sniffer on successfully, callback will be called
 *  again to get the AP info.
 * PARAMETERS
 *  user_data       :   [IN]    APP's piggyback user_data
 *  res             :   [IN]    the result of setting sniffer on
 * RETURNS
 *  void
 *****************************************************************************/
typedef void (*srv_dtcnt_wlan_sniffer_on_cb_func_ptr) (
            void *user_data,
...
/*****************************************************************************
 * FUNCTION
 *  srv_dtcnt_wlan_sniffer_off_cb_func_ptr
 * DESCRIPTION
 *  sniffer off callback function. If set sniffer off successfully, callback will be called
 *  again to get the AP info.
 * PARAMETERS
 *  user_data       :   [IN]    APP's piggyback user_data
 *  res             :   [IN]    the result of setting sniffer off
 * RETURNS
 *  void
 *****************************************************************************/
typedef void (*srv_dtcnt_wlan_sniffer_off_cb_func_ptr) (
            void *user_data,
...
extern srv_dtcnt_result_enum srv_dtcnt_wlan_sniffer_on(
                        srv_dtcnt_wlan_sniffer_on_cfg_struct *sniffer_on_config,
                        srv_dtcnt_wlan_sniffer_on_cb_func_ptr callback,
                        void *user_data);

extern srv_dtcnt_result_enum srv_dtcnt_wlan_sniffer_off(
...
/*****************************************************************************
 * FUNCTION
 *  srv_dtcnt_get_wlan_conn_prof
 * DESCRIPTION
 *  Get dtcnt profile reserved specially for srv_wlan_connect().
 * PARAMETERS
 *  NULL.
 * RETURN VALUES
 * srv_dtcnt_prof_wlan_struct*  :   Pointer points to the profile.
 *****************************************************************************/
