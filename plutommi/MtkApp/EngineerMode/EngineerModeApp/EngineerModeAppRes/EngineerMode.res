 ...
 * $Log$
 *
 * 08 18 2016 zhen.tian
 * [MAUI_03557305] [MT2503AE]Engineermode  check in
 * . Add GPS Item.
 *
 * 03 30 2015 zhen.tian
...
<!----------------- Level1 Menu : Mainmenu ------------------------------------>
    ...
    <MENU id = "MENU_ID_EM_MAIN_MENU" type = "APP_MAIN" str = "STR_ID_EM_APP_NAME">
		...
		<MENUITEM_ID>MENU_ID_EM_HIDD_TEST_MODE</MENUITEM_ID>
...
<!----------------- Device | HID TEST Mode ----------------------------------------->
    ...
    <!----------------- String Id ----------------------------------------->             
    <STRING id = "STR_ID_EM_HIDD_TEST_MODE">HID Test For IOS</STRING>           <!-- Engineer Mode Menu Caption String -->
    <STRING id = "STR_ID_EM_HIDD_TEST_MODE_DONE_INFO">Power off BT firstly</STRING>
	<SCREEN id = "GRP_ID_EM_HIDD_TEST_MODE"/>
    <!----------------- Menu Id ------------------------------------------->             
    <MENU id = "MENU_ID_EM_HIDD_TEST_MODE" type = "APP_SUB" str = "STR_ID_EM_HIDD_TEST_MODE" flag = "RADIO">
        <MENUITEM id = "MENU_ID_EM_HIDD_TEST_MODE_ON" str = "STR_GLOBAL_ON"/>
        <MENUITEM id = "MENU_ID_EM_HIDD_TEST_MODE_OFF" str = "STR_GLOBAL_OFF"/>
    </MENU>
    
    <CACHEDATA type="byte" id="BT_EM_HIDD_TEST" restore_flag="TRUE">
        <DEFAULT_VALUE> [0X00] </DEFAULT_VALUE>
        <DESCRIPTION> BT HIDD TEST flag </DESCRIPTION>
    </CACHEDATA>
#endif /* __MMI_HIDD_SUPPORT__ */    
<!----------------- EM Item End ----------------------------------------------->
<!----------------- Device | NAND Format -------------------------------------->
