...
extern void wgui_cat033_show_BT_dialer_info(void);
extern void AddIdleScreenBTDeviceInfo(srv_bt_cm_dev_struct * dev_info);
extern void DelIdleScreenBTDeviceInfo(srv_bt_cm_dev_struct * dev_info);
extern void ClearIdleScreenBTDeviceInfo(void);
extern U32 GetIdleScreenPairingDeviceNum(void);
extern MMI_BOOL CheckIsIdleScreenBTDeviceInfoEmpty(void);
extern MMI_BOOL CheckIsIdleScreenBTDeviceInfoFull(void);
extern void mmi_bt_dialer_show_candidate_list_scr(mmi_scrn_essential_struct * param);
#endif
