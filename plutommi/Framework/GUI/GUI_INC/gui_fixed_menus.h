...
extern UI_list_menu_theme *current_fixed_list_menu_theme;
/* <group dom_menu_variables> */
extern UI_matrix_menu_theme *current_fixed_matrix_menu_theme;
...
extern void gui_set_fixed_list_menu_theme(fixed_list_menu *m, UI_list_menu_theme *t);
...
#define gui_fixed_list_menu_locate_highlighted_item(_arg) gui_list_menu_locate_highlighted_item(_arg)
//extern void gui_fixed_list_menu_goto_item(fixed_list_menu *m, S32 i);
#define gui_fixed_list_menu_goto_item(_arg0, _arg1) gui_list_menu_goto_item(_arg0, _arg1)
//extern void gui_fixed_list_menu_goto_next_item(fixed_list_menu *m);
#define gui_fixed_list_menu_goto_next_item(_arg) gui_list_menu_goto_next_item(_arg)
//extern void gui_fixed_list_menu_goto_previous_item(fixed_list_menu *m);
#define gui_fixed_list_menu_goto_previous_item(_arg) gui_list_menu_goto_previous_item(_arg)
...
#define gui_show_fixed_list_menu_no_draw(_arg) gui_show_list_menu_no_draw(_arg)
/* common fuctions for fixed/dynamic/asyncdynamic menu */
extern void gui_list_menu_locate_highlighted_item(fixed_list_menu *m);
extern MMI_BOOL gui_list_menu_locate_item_compute_first(fixed_list_menu *m);
...
extern MMI_BOOL gui_is_list_menu_show_vertical_scrollbar(fixed_list_menu *m);
...
extern void gui_set_fixed_matrix_menu_theme(fixed_matrix_menu *m, UI_matrix_menu_theme *t);
...
extern MMI_BOOL gui_fixed_matrix_auto_disable_scrollbar(fixed_matrix_menu *m);
#else/*#ifndef __MMI_UI_MENU_AUTO_DISABLE_SCROLLBAR__*/
#define gui_fixed_matrix_auto_disable_scrollbar(_arg) MMI_TRUE
...
extern void UI_fixed_menuitem_dummy_function(void *item, void *common_item_data);
extern void UI_fixed_menuitem_dummy_function_with_2_S32(void *item, void *common_item_data, S32 x, S32 y);
//extern void UI_fixed_menuitem_dummy_display_function(void *item, void *common_item_data, S32 x, S32 y);
#define UI_fixed_menuitem_dummy_display_function UI_fixed_menuitem_dummy_function_with_2_S32
//extern void UI_fixed_menuitem_dummy_hide_function(void *item, void *common_item_data, S32 x, S32 y);
#define UI_fixed_menuitem_dummy_hide_function UI_fixed_menuitem_dummy_function_with_2_S32
...
#define UI_fixed_menuitem_dummy_highlight_function UI_fixed_menuitem_dummy_function
//extern void UI_fixed_menuitem_dummy_remove_highlight_function(void *item, void *common_item_data);
#define UI_fixed_menuitem_dummy_remove_highlight_function UI_fixed_menuitem_dummy_function
//extern void UI_fixed_menuitem_dummy_resize_function(S32 x, S32 y);
#define UI_fixed_menuitem_dummy_resize_function UI_dummy_function_with_2_s32
extern void UI_fixed_menuitem_dummy_get_length_function(void *item, void *common_item_data, S32 *width);

#ifdef __MMI_TOUCH_SCREEN__
extern MMI_BOOL UI_fixed_menuitem_dummy_pen_function(
                void *item,
                void *common_item_data,
                S32 item_x,
                S32 item_y,
...
//add by huking
extern MMI_BOOL gui_is_all_menuitem_in_list_disabled(fixed_list_menu *m);
extern MMI_BOOL gui_is_index_in_menu_valid_region(S32 indx, void *m);
extern void gui_menu_auto_adjust_current_displayed_item(fixed_list_menu *m, U32 i);
extern void gui_async_list_update_hilited(S32 hilited_indx);
extern MMI_BOOL gui_is_list_menu_disable_draw(S32 flags);
#ifdef __MMI_UI_LIST_GRID_LINE__
extern S32 gui_menu_compute_grid_line_x_pos(S32 x1, fixed_list_menu *m);
#endif/*__MMI_UI_LIST_GRID_LINE__*/

extern GDI_HANDLE gui_get_list_menu_alpha_layer(void);
extern void gui_draw_list_menuitem_separator_line(GDI_HANDLE src_layer, S32 x1, S32 y1, S32 x2, S32 y2);
