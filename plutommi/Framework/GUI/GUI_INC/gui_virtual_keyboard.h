...
#define __MMI_IME_VKV1_SLIM__
    ...
    || defined(__MMI_LANG_SA_PORTUGUESE__) \
    ...
    || defined(__MMI_VKBD_EUROPEAN_SUPPORT__) \
    ...
    #define __MMI_IME_VKV1_DEAD_KEY__
#else
#undef __MMI_IME_VKV1_DEAD_KEY__
#endif
