...
/* under construction !*/
        ...
        case EDITOR_SINGLE_LINE_INPU_BOX:
            ...
            old_show_action_s = MMI_multiline_inputbox_singleline.show_action_flag;
            MMI_multiline_inputbox_singleline.show_action_flag = 0;
            while ((*input) != 0)
            {
                if (((*input)==0x0d) && (*(input+1)==0x0a))
                {
            ...
            MMI_multiline_inputbox_singleline.show_action_flag = old_show_action_s;
            wgui_inputs_sl_redraw();
            singleline_inputbox_input_callback();
...
#else  /*__MMI_EDITOR_SINGLINE_SUPPORT__*/ 
   #ifdef __MMI_MULTILINE_INPUT_BOX_SINGLINE_STYLE_WITH_FTE__
                ret = gui_multi_line_input_box_test_first_position(&MMI_multiline_inputbox_singleline);
   #endif
#endif /* __MMI_EDITOR_SINGLINE_SUPPORT__*/
            }
            break;
...
#else/*__MMI_EDITOR_SINGLINE_SUPPORT__*/
    #ifdef __MMI_MULTILINE_INPUT_BOX_SINGLINE_STYLE_WITH_FTE__
                ret = gui_multi_line_input_box_test_last_position(&MMI_multiline_inputbox_singleline);
    #endif
#endif /* __MMI_EDITOR_SINGLINE_SUPPORT__*/
            }
            break;
