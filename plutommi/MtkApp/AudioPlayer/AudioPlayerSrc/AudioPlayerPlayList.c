...
/* under construction !*/
    ...
    //Use long press to enter playlist option screen.
    mmi_pen_register_long_tap_handler(mmi_audply_playlist_entry_playlist_option_single);
...
/* under construction !*/
    ...
    if (file_ext_index >= 0)
    {
	    ...
	    /* Don't show icon list menu in wearable project */
        *img_buff_p = (PU8) NULL;
    #else
