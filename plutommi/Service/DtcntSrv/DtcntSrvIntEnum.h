...
typedef enum
{
    ...
    SRV_DTCNT_WLAN_ACTION_SNIFFER_ON,
    SRV_DTCNT_WLAN_ACTION_SNIFFER_OFF,
...
typedef enum
{
    SRV_DTCNT_WLAN_SNIF_ON,
    SRV_DTCNT_WLAN_SNIF_OFF,
    SRV_DTCNT_WLAN_SNIF_NOTI_AP,
    
    SRV_DTCNT_WLAN_SNIF_END
}srv_dtcnt_wlan_snif_job_type_enum;
