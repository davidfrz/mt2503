...
typedef struct 
{
	...
	/*-----------------------------------*/
	kal_bool autoChangePol; /* for auto change the poloartiy after eint callback. mre request */
	kal_bool is_set_dst_mod_id;/*add this for send message to mre callback. the dst mod is given by mre engin */
	kal_uint16 eint_msg_dst_mod; /*add this for send message to mre callback. the dst mod is given by mre engin */
	/*-----------------------------------*/
} eint_func_t;
