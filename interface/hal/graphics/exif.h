...
#define exif_tag_ImageDescription   0x010e	/* A, Image title */
...
#define exif_tag_JPEGInterchangeFormat   0x0201
#define exif_tag_JPEGInterchangeFormatLength   0x0202
#define exif_tag_YCbCrPositioning   0x0213	/* S, Y and C positioning */
#define exif_tag_ExifIFD   0x8769	/* L, Exif IFD Pointer */
#define exif_tag_GPSIFD		 0x8825  /* L, GPS IFD Pointer */
...
/* Supported IFD Interoperability tags */
#define exif_tag_InteroperabilityIFDPointer     0xa005
#define exif_tag_InteroperabilityIndex          0x0001
...
#define EXIF_MAXIMUM_SIZE   60*1024
...
#define EXIF_RATIONAL_PRECISION   "%1.2f"
...
enum exif_EXIFIFD_Entry
{
   ...
   EXIF_INTEROPERABILITYIFDPOINTER,
   EXIF_EXPOSURE_MODE,
...
enum exif_IFD1_Entry
{
   EXIF_IFD1_COMPRESSION,
   EXIF_IFD1_X_RESOLUTION,
   EXIF_IFD1_Y_RESOLUTION,
   EXIF_IFD1_RESOLUTION_UNIT,
   EXIF_IFD1_JPEGINTERCHANGEFORMAT,
   EXIF_IFD1_JPEGINTERCHANGEFORMATLENGTH,
   EXIF_IFD1_YCBCR_POSITIONING,

   IFD1_Number_of_Entry
};

enum exif_InteroperabilityIFD_Entry
{
   EXIF_INTEROPERABILITYINDEX,

   InteroperabilityIFD_Number_of_Entry
};

typedef enum
{
   EXIF_DEC_IDLE_STATE,
   EXIF_DEC_PREPROCESS_DONE_STATE,
   EXIF_DEC_PARSE_DONE_STATE
} EXIF_DEC_STATE;
...
typedef struct
{
    exif_SHORT      Compression;
    exif_SHORT      Orientation;
    exif_RATIONAL   XResolution;
    exif_RATIONAL   YResolution;
    exif_SHORT      ResolutionUnit;
    exif_LONG       JPEGInterchangeFormat;
    exif_LONG       JPEGInterchangeFormatLength;

} exif_thumbnail_para_struct;

typedef struct
{
    exif_ASCII*     InteroperabilityIndex;

} exif_interoperability_para_struct;
...
typedef struct
{
   ...
   exif_LONG   InteroperabilityIFDPointer;
