...
// option to set __MMI_SMART_WATCH_MAINMENU_TYPE__
/*
Description: the mainmenu type of smart watch
__ONE__: there is only one icon in a page of smart watch's mainmenu
__FOUR__: there are four icons in a page of smart watch's mainmenu
__ALL__: support the two type above
