...
//#endif
#if defined(__BTMTK__) && (defined(__BT_SPP_PROFILE__) || defined(__BT_HFG_PROFILE__))
//do nothing, the serial port init was moved to BT driver itself, after FOTA seperation
#elif defined __CMUX_SUPPORT__
{
   kal_uint16 i;
...
/* under construction !*/
  ...
  print_bootup_trace_exit(SST_INIT_DRV2_PFC);
    ...
    spi_init();
#endif
#ifdef DRV_SPI_SLAVE_SUPPORT
   DclSpiSlave_Initialize(DCL_SPI_SLAVE); 
#endif
