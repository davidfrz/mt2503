...
void* (*mmi_frm_asm_alloc_int_p)(kal_uint16, kal_uint32, asm_alloc_flag, char*, kal_uint32);
void (*mmi_frm_asm_free_int_p)(kal_uint16, void*, char*, kal_uint32);
#endif
...
void *med_alloc_ext_mem_ext(kal_int32 size, kal_uint8 location, char* file_p, long line_p)
{
	...
	{
		#ifdef __UPDATE_BINARY_FILE__
			p = mmi_frm_asm_alloc_int_p(0, size, ASM_ALLOC_IS_FB_FLAG, file_p, line_p);
		#else
	...
	{
		#ifdef __UPDATE_BINARY_FILE__
			p = mmi_frm_asm_alloc_int_p(0, size, ASM_ALLOC_DEFAULT_FLAG, file_p, line_p);
		#else
...
#if defined(__MED_IN_ASM__) && defined(__PLUTO_MMI_PACKAGE__)
	#ifdef __UPDATE_BINARY_FILE__
	 	mmi_frm_asm_free_int_p(0, *pointer, file_p, line_p);
	#else
