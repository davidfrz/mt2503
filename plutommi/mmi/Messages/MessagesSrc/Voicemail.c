...
mmi_pen_hdlr mmi_sms_fte_voicemail_server_long_tap_callback(mmi_pen_point_struct pos)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/   
...
static void mmi_sms_vm_entry_voice_mail_server(void)
{
            ...
            MMI_FRM_FULL_SCRN))
    {
		...
		wgui_register_pen_long_tap_handler(mmi_sms_fte_voicemail_server_long_tap_callback);
		#endif
    #endif /* #if defined(__MMI_FTE_SUPPORT__) && defined(__MMI_TOUCH_SCREEN__) */
    }
}
