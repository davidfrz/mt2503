...
#elif defined(DRV_KBD_75_KEYS)
   #define  kbd_allkeys          80
   #define  KBD_ROW              5
   #define  KBD_COLUMN_MASK      0xFF //8 bits mask
   #define  KBD_COLUMN           16  //simulate 5*11,while the real col and row is 5*5 
...
#elif  defined(DRV_KBD_DRVTOOL_EXTEND_81_KEYS) // GND
   kal_uint8 keypad[81];  
#elif  defined(DRV_KBD_DRVTOOL_EXTEND_90_KEYS) // GND+GPIO
   kal_uint8 keypad[90]; 
#elif  defined(DRV_KBD_DRVTOOL_EXTEND_99_KEYS) // GND+2GPIO
   kal_uint8 keypad[99]; 
#else
