...
#if defined(__MMI_FACTORY_MODE__) && defined(__MMI_WEARABLE_DEVICE__)
	#ifndef __MMI_WEARABLE_DEVICE_FACTORY_MODE__
	#define __MMI_WEARABLE_DEVICE_FACTORY_MODE__
	#endif
#endif

#ifdef __MMI_WEARABLE_DEVICE_FACTORY_MODE__
#define __SUPPORT_LED_FEATURE__
//#define __MMI_WEARABLE_DEVICE_FM_SENSOR_TEST__
