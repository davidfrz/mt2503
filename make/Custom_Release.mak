...
ifeq ($(strip $(RTOS)),THREADX)
	...
	@if exist $(FIXPATH)\make\ubin_Gsm2.mak copy /z $(FIXPATH)\make\ubin_Gsm2.mak "$(RELEASE_DIR)"\make\.
	@if exist $(FIXPATH)\make\ubin_Option.mak copy /z $(FIXPATH)\make\ubin_Option.mak "$(RELEASE_DIR)"\make\.
ifeq ($(strip $(CUSTOM_RELEASE)),FALSE)
