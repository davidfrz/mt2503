...
//Only for MT6250 MT6260/61/2501/2502
...
#elif (defined(MT6260) || defined(MT6261) || defined(MT2501) || defined(MT2502)) && !defined(__UBL__) // Bootloader should not toggle Code compressor
#define SFI_MaskAhbChannel(x)  do {	\
	if(x != 0) \
