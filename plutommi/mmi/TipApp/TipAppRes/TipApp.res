...
#if defined(__MMI_BLE_TIP_SUPPORT__)
<?xml version = "1.0" encoding = "UTF-8"?>

<APP id = "APP_TIPAPP"
    package_name = "native.mtk.tipapp"
    //name = "STR_ID_TIP_MAINMENU"  
    //img = "IMG_TIPAPP_ICON_ID"
...
>
    ...
    <!--Screen ID Area-->
    <!--Screen ID Area-->s
    <SCREEN id = "GRP_ID_TIPAPP_MAIN"/>	
    <SCREEN id="SCR_ID_TIPAPP_SHOW"/>
