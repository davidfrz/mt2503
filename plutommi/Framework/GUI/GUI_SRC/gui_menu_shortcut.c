 ...
 *  void
 *****************************************************************************/
void gui_shortcut_handler_keyinput(
	...
	UI_character_type c)
{
    ...
    {
#ifndef __MMI_TITLE_BAR_NO_ICON_SHCT__
        if (sc->display_disabled )//display== MMI_FALSE
        {
            sc->display_disabled = MMI_FALSE;//display
            sc->input_buffer[0] = 0;
        }
#endif/*__MMI_TITLE_BAR_NO_ICON_SHCT__*/
...
void gui_shortcut_create_ex_int(
    gui_shortcut_struct *sc
#ifndef __MMI_TITLE_BAR_NO_ICON_SHCT__     
    , S32 x, 
    S32 y, 
 ...
 *  void
 *****************************************************************************/
void gui_shortcut_register_callback_ex(
        gui_shortcut_struct *sc,
...
void gui_shortcut_show(gui_shortcut_struct *sc)
{
    ...
    if (!sc->display_disabled && sc->number >= 0 && sc->max_number > 0)
    {
       // gdi_layer_push_clip();
        ...
        if (mmi_fe_get_r2l_state())
        {
          	gdi_layer_push_and_set_clip(sc->x + GUI_SHORTCUT_INSERT_GAP, sc->y, sc->x + sc->width - 1, sc->y + sc->height - 1);
            if(sc->hide_callback)
            {
...
void gui_shortcut_close(gui_shortcut_struct *sc)
{
    ...
    sc->timer_callback = UI_dummy_function;//gui_shortcut_dummy_timer_callback;	
#ifndef __MMI_TITLE_BAR_NO_ICON_SHCT__      
    sc->hide_callback = UI_dummy_function_with_4_s32;//gui_shortcut_dummy_hide_menu;
//    sc->display = MMI_TRUE;
 ...
 *  void
 *****************************************************************************/
void gui_shortcut_set_item_count(
	gui_shortcut_struct *sc, 
	S32 n_items)
{
    /*----------------------------------------------------------------*/
...
MMI_BOOL gui_shortcut_is_show(gui_shortcut_struct *sc)
{
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
    return (!sc->display_disabled && sc->number >= 0 && sc->max_number > 0);
#if 0
/* under construction !*/
/* under construction !*/
/* under construction !*/
 ...
 *  void
 *****************************************************************************/
void  gui_shortcut_set_target_layer(
	gui_shortcut_struct *sc, 
	gdi_handle target_layer)
{
    /*----------------------------------------------------------------*/
 ...
 *  void
 *****************************************************************************/
void  gui_shortcut_set_target_lcd(
	gui_shortcut_struct *sc, 
	gdi_handle target_lcd)
{
    /*----------------------------------------------------------------*/
 ...
 *  void
 *****************************************************************************/
void  gui_shortcut_set_alpha_blend_layer(
	gui_shortcut_struct *sc, 
	gdi_handle alpha_blend_layer)
{
    /*----------------------------------------------------------------*/
 ...
 *  void
 *****************************************************************************/
void gui_shortcut_register_hide_callback(
	gui_shortcut_struct *sc, 
