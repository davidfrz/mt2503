...
#define DTCNT_WLAN_MAX_SPEC_SSID_LIST_NUM WNDRV_MAX_SSID_LIST_NUM
...
typedef struct
{
    ...
    void *user_data;
    U8                          ssid_list_num;
    srv_dtcnt_ssid_struct       ssid_list[DTCNT_WLAN_MAX_SPEC_SSID_LIST_NUM];
} srv_dtcnt_wlan_desired_ssid_list_job_struct;
...
} srv_dtcnt_wlan_enable_roaming_struct;
...
typedef struct
{
    ...
    void *user_data;
    U16 dwell_time;
} srv_dtcnt_wlan_dwell_time_struct;
...
typedef struct srv_dtcnt_sniffer_job_list_st
{    
    srv_dtcnt_wlan_snif_job_type_enum action;
    srv_dtcnt_wlan_job_struct job;
    struct srv_dtcnt_sniffer_job_list_st *next;
} srv_dtcnt_wlan_sniffer_job_list;
...
{        
    ...
    U8 ssid_list_num;
    srv_dtcnt_ssid_struct ssid_list[DTCNT_WLAN_MAX_SPEC_SSID_LIST_NUM];
}srv_dtcnt_wlan_scan_setting_struct;
...
typedef struct
{
    ...
    srv_dtcnt_wlan_desired_ssid_list_job_struct *set_spec_ssid_list_job;
    srv_dtcnt_wlan_enable_roaming_struct *set_roaming_para_job;
    srv_dtcnt_wlan_dwell_time_struct *set_dwell_time_job;
    srv_dtcnt_prof_wlan_struct *connected_wlan_profile;
    U8 ap_list_num;
    supc_abm_bss_info_struct ap_list[SRV_DTCNT_WLAN_MAX_AP_LIST_NUM];
    srv_dtcnt_wlan_sniffer_job_list *sniffer_job_list;
    U8 sniffer_mode_req_count;
