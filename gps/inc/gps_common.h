...
#define GPS_TIME_SYNC_TO_LOCAL_TIME_PER    (24*60*60*1000)     
#define GPS_TIME_SYNC_TO_LOCAL_TIME_OFFSET (1000)        //means 1000ms
#endif
...
/* under construction !*/
#endif
    GPS_UART_GPS_ASSIT_TIME,  
    GPS_UART_GPS_ASSIT_POS,
#endif
