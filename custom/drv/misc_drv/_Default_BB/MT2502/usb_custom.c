...
__align(16) kal_uint8 USB_BUFFER[USB_MAX_MEMORY_SIZE]; // USB total buffer 
...
#ifndef __UBL__
#if defined(__USB_ENABLE__)&&defined(__USB_MASS_STORAGE_ENABLE__)
	#if ((defined(__MSDC_MS__))||(defined(__MSDC_MSPRO__))||(defined(__MSDC_SD_MMC__))||(defined(__MSDC2_SD_MMC__)) )
		#ifdef __SIM_PLUS__
