...
#if defined(L1_CATCHER)
	#define L1Audio_Msg_AM_2G_Delay(v1, v2, v3, v4) do {\
		if(L1Audio_Trace_Filter[0]==1 && (L1Audio_Trace_Filter[1]&0x02)!=0 )\
			L1TRC_Send_L1Audio_Msg_AM_2G_Delay((unsigned short)(v1), (unsigned short)(v2), (unsigned short)(v3), (unsigned short)(v4));\
} while(0)
#else
	#define L1Audio_Msg_AM_2G_Delay(v1, v2, v3, v4)
#endif

#if defined(L1_CATCHER)
	#define L1Audio_Msg_AM_Manager(v1, v2, v3) do {\
		if(L1Audio_Trace_Filter[0]==1 && (L1Audio_Trace_Filter[1]&0x02)!=0 )\
			L1TRC_Send_L1Audio_Msg_AM_Manager((short)(v1), (short)(v2), (short)(v3));\
} while(0)
#else
	#define L1Audio_Msg_AM_Manager(v1, v2, v3)
#endif
...
void L1TRC_Send_L1Audio_Msg_AM_2G_Delay(unsigned short v1, unsigned short v2, unsigned short v3, unsigned short v4);
void L1TRC_Send_L1Audio_Msg_AM_Manager(short v1, short v2, short v3);
...
#define ChkL1MsgFltr_L1Audio_Msg_AM_2G_Delay()	ChkL1ClsFltr_L1Audio_AM_Inf_H()
#define ChkL1MsgFltr_L1Audio_Msg_AM_Manager()	ChkL1ClsFltr_L1Audio_AM_Inf_H()
