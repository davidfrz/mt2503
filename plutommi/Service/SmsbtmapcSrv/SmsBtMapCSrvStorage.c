...
SMS_HANDLE srv_sms_btmapc_get_save_handle(void)
{
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
    kal_prompt_trace(MOD_MMI, "[SMS], Entry srv_sms_btmapc_get_save_handle srv_sms_btmapc_alloc_cntx");
...
SMS_HANDLE srv_sms_btmapc_get_update_handle(void)
{
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
    kal_prompt_trace(MOD_MMI, "[SMS], Entry srv_sms_btmapc_get_update_handle srv_sms_btmapc_alloc_cntx");
...
static void srv_sms_btmapc_save_msg_callback(srv_sms_callback_struct *callback_data)
{
    ...
    if (result)
    {
        ...
        if (msg_id != SRV_SMS_INVALID_MSG_ID)
        {
            ...
            if(msg_node->status == SRV_SMS_STATUS_DRAFT && mmi_sms_get_send_msg_case() == SMS_SEND_CASE_EDIT_DRAFT)
            {
    ...
    else
    {
        if(msg_id != SRV_SMS_INVALID_MSG_ID)
        {
            srv_sms_btmapc_get_msg_name(save_cntx->bt_index, msg_id, MMI_FALSE, file_name);
...
S32 srv_sms_btmapc_create_xml_data(FS_HANDLE fh, U8 *data)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
...
S32 srv_sms_btmapc_create_xml_data_usc2_to_utf8(FS_HANDLE fh, U8 *data)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
    ...
    result = srv_sms_btmapc_create_xml_data(fh, utf8_data);
...
extern void srv_sms_btmapc_send_msg_callback(SMS_HANDLE sms_handle, MMI_BOOL result, srv_sms_cause_enum cause)
{
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
    kal_prompt_trace(MOD_MMI, "[SMS], Entry srv_sms_btmapc_send_msg_callback");
    ...
    {
        kal_prompt_trace(MOD_MMI, "[SMS], Entry srv_sms_btmapc_send_msg_callback  srv_sms_btmapc_free_send_handle");
...
void srv_sms_btmapc_free_send_handle(SMS_HANDLE sms_handle)
{
    ...
    OslMfree(hd_data);
    hd_data = NULL;
    send_hd->hd_data = NULL;

    OslMfree(send_hd);
    send_hd = NULL;
    sms_handle  = NULL;
    kal_prompt_trace(MOD_MMI, "[SMS], Entry srv_sms_btmapc_free_send_handle");
}
...
SMS_HANDLE srv_sms_btmapc_get_send_handle(void)
{
    ...
    kal_prompt_trace(MOD_MMI, "[SMS], Entry srv_sms_btmapc_get_send_handle");
