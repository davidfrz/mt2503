...
#elif defined(__MMI_WEARABLE_DEVICE__) /* __MMI_BTBOX_NOLCD__ */
...
>
	...
	<STRING id="STR_ID_FMRDO_SEARCH_CHANNEL_LIST"/>
	<STRING id="STR_ID_FMRDO_NO_CHANNEL_FOUND"/>
...
<!--------------------------------------------------------------------------------------------------------------------->
  ...
  <IMAGE id="IMG_ID_FMRDO_ICON_COSMOS_STYLE">CUST_IMG_PATH"\\\\MainLCD\\\\VUI\\\\Launcher\\\\Mainmenu\\\\Icons\\\\FmRadio.png"</IMAGE>
    ...
    <IMAGE id="IMG_ID_FMRDO_BG_IMAGE">CUST_IMG_PATH"\\\\MainLCD\\\\Multimedia\\\\fm_radio_bg.png"</IMAGE>
    <IMAGE id="IMG_ID_FMRDO_NEXT_BUTTON_UP">CUST_IMG_PATH"\\\\MainLCD\\\\Multimedia\\\\wr_next.png"</IMAGE>
    <IMAGE id="IMG_ID_FMRDO_PREV_BUTTON_UP">CUST_IMG_PATH"\\\\MainLCD\\\\Multimedia\\\\wr_prev.png"</IMAGE>
    <IMAGE id="IMG_ID_FMRDO_VOL_INC_BUTTON_UP">CUST_IMG_PATH"\\\\MainLCD\\\\Multimedia\\\\wr_volume_up.png"</IMAGE>
    <IMAGE id="IMG_ID_FMRDO_VOL_DEC_BUTTON_UP">CUST_IMG_PATH"\\\\MainLCD\\\\Multimedia\\\\wr_volume_down.png"</IMAGE>
    <IMAGE id="IMG_ID_FMRDO_POWER_ON_BUTTON_UP">CUST_IMG_PATH"\\\\MainLCD\\\\Multimedia\\\\fm_power_on.png"</IMAGE>
    <IMAGE id="IMG_ID_FMRDO_POWER_OFF_BUTTON_UP">CUST_IMG_PATH"\\\\MainLCD\\\\Multimedia\\\\fm_power_off.png"</IMAGE>
    <IMAGE id="IMG_ID_FMRDO_CURR_CHANNEL_TICK">CUST_IMG_PATH"\\\\MainLCD\\\\Multimedia\\\\fm_radio_curr_channel_tick.png"</IMAGE>
...
<!--------------------------------------------------------------------------------------------------------------------->
        <!--Menu Item Area-->
        <!--Menu Item Area-->
        <TIMER id="FMRDO_VOLUME_BAR_TIMER"/>
