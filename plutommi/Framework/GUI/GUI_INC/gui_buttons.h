...
//for fte or touch, will display icon in button
#if defined(__MMI_FTE_SUPPORT__)|| defined(__MMI_TOUCH_SCREEN__)|| defined(__MMI_MAINLCD_96X64__)
	#ifndef __MMI_ICONTEXT_BTN_DISPLAY_ICON__
	#define __MMI_ICONTEXT_BTN_DISPLAY_ICON__
	#endif
 ...
 *  void
 *****************************************************************************/
extern void gui_text_button_set_text_position(
	text_button *b, 
	S32 x, 
	S32 y);
 ...
 *  void
 *****************************************************************************/
extern void gui_resize_icon_button(
	icon_button *b, 
	S32 width, 
	S32 height);
 ...
 *  void
 *****************************************************************************/
extern void gui_move_icon_button(
	icon_button *b, 
	S32 x, 
	S32 y);
 ...
 *  void
 *****************************************************************************/
extern void gui_icon_button_set_icon_positon(
	icon_button *b, 
	S32 x, 
	S32 y);
...
#else
#define gui_icon_button_set_icon(_arg1, _arg2, _arg3)
 ...
 *  void
 *****************************************************************************/
extern void gui_resize_icontext_button(
	icontext_button *b, 
	S32 width, 
	S32 height);
 ...
 *  void
 *****************************************************************************/
extern void gui_move_icontext_button(
	icontext_button *b, 
	S32 x, 
	S32 y);
 ...
 *  void
 *****************************************************************************/
extern void gui_icontext_button_set_icon_positon(
	icontext_button *b, 
	S32 x, 
	S32 y);
 ...
 *  void
 *****************************************************************************/
extern void gui_icontext_button_set_text_position(
	icontext_button *b, 
	S32 x, 
	S32 y);
...
extern void gui_icontext_button_set_icon(
                ...
                PU8 button_icon,
                UI_transparent_color_type icon_transparent_color);
#else/*#ifdef __MMI_ICONTEXT_BTN_DISPLAY_ICON__*/
#define gui_icontext_button_set_icon(_arg1, _arg2, _arg3)
