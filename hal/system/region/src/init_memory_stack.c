...
#else /* _NAND_FLASH_BOOTING || __NOR_FLASH_BOOTING__ || __EMMC_BOOTING__ */

/* for INT_QueryBiggestPool */
#if ( !defined(MT6205B) && !defined(MT6208) && !defined(MT6251))
#if defined(__DYNAMIC_SWITCH_CACHEABILITY__) || defined(__ARM9_DCACHEABLE__)
extern kal_uint32 Image$$DYNAMIC_CACHEABLE_EXTSRAM_DEFAULT_NONCACHEABLE_ZI$$Base;
extern kal_uint32 Image$$DYNAMIC_CACHEABLE_EXTSRAM_DEFAULT_NONCACHEABLE_ZI$$ZI$$Limit;
#else /* __DYNAMIC_SWITCH_CACHEABILITY__ || __ARM9_DCACHEABLE__ */
...
#endif /* !MT6251 */
#if defined(MT6235) || defined(MT6235B) || defined(MT6268A) || defined(MT6268) || defined(MT6276) || defined(MT6573) || defined(MT6575)
extern kal_uint32 Image$$EXTSRAM$$ZI$$Limit;
#endif /* MT6235 || MT6235B || MT6268A ||MT6268 || MT6276 || MT 6573 || MT6575*/

#if defined(__ZIMAGE_SUPPORT__)
extern kal_uint32 Image$$ZIMAGE$$Base;
extern kal_uint32 Image$$ZIMAGE$$Length;
...
extern kal_uint32 Load$$ALICE$$Base;
...
/* KeTing: Get the raw data start address */
extern kal_uint32 AliceGetRawDataAddress(kal_uint32 address);
#endif /* __ALICE_SUPPORT__ */
...
#elif defined(MT6205B) || defined(MT6208) || defined(MT6251)  /* IC_BURNIN_TEST */
...
*
* DESCRIPTION
*  Retrieve the remapped flash base address
...
{
   return AliceGetRawDataAddress(INT_RetrieveRemappedFlashBaseAddr());
}
...
{
	return custom_get_DSPTXRX_Info(TX_Base,RX_Base,CS,TX_Size,RX_Size);
}
...
kal_uint32 INT_SwitchStackToRun(void *stack_start, kal_uint32 stack_size, kal_func_ptr func, kal_uint32 argc, ...)
{
   ...
   *(stack_ptr+1) = *((kal_uint32*)&_stack_pattern_ptr[4]);
    ...
    */
#if defined(__RVCT__) && !defined(__APCS_ADSABI)
...
{
	return custom_get_SysRam_Info(addr,len);
}
