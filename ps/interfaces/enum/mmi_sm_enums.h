...
#define MAX_NUM_CONFIG_OPTION_PACKETS   8
...
#define MAX_CONFIG_OPTION_CONTENT_LEN 	TCM_MAX(TCM_MAX_GPRS_USER_NAME_LEN + TCM_MAX_GPRS_PASSWORD_LEN + 6, 128) // Support PAP or CHAP ID and PW length up to 128 Bytes
