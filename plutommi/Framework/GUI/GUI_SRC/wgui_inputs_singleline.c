...
MMI_BOOL g_is_disable_up_down_key_register = MMI_TRUE;
MMI_BOOL g_is_disable_left_right_key_register = MMI_FALSE;
...
static void wgui_inputs_sl_handle_right_softkey_touch_repeat(void);
 ...
 void wgui_inputs_sl_handle_left_arrow_repeat(void);
 void wgui_inputs_sl_handle_right_arrow_repeat(void);
 void wgui_inputs_sl_handle_right_softkey_repeat(void);
 void wgui_inputs_sl_handle_right_softkey_touch_repeat(void);
#endif/*__MMI_MULTILINE_INPUT_BOX_SINGLINE_STYLE_WITH_FTE__ */
...
/* under construction !*/
        ...
        wgui_inputs_ml_create_set_buffer_ext( buffer, buffer_length, text_length, edit_position,&MMI_multiline_inputbox_singleline);
...
void wgui_inputs_sl_show(void)
{
    ...
    wgui_inputs_ml_show();
   #else /*__MMI_MULTILINE_INPUT_BOX_SINGLINE_STYLE_WITH_FTE__*/
       wgui_inputs_ml_show_ext(&MMI_multiline_inputbox_singleline);
   #endif/*__MMI_MULTILINE_INPUT_BOX_SINGLINE_STYLE_WITH_FTE__*/
#endif /* __MMI_EDITOR_SINGLINE_SUPPORT__*/
}
...
/* under construction !*/
    ...
    #else /*__MMI_MULTILINE_INPUT_BOX_SINGLINE_STYLE_WITH_FTE__*/
        wgui_inputs_ml_redraw_ext(&MMI_multiline_inputbox_singleline);
    #endif/*__MMI_MULTILINE_INPUT_BOX_SINGLINE_STYLE_WITH_FTE__*/
#endif /* __MMI_EDITOR_SINGLINE_SUPPORT__*/
...
S32 wgui_inputs_sl_multitap_input_string(PU8 str)
{
    ...
    #else /*__MMI_MULTILINE_INPUT_BOX_SINGLINE_STYLE_WITH_FTE__*/
        return wgui_inputs_ml_multitap_input_string_ext(str,&MMI_multiline_inputbox_singleline);
    #endif/*__MMI_MULTILINE_INPUT_BOX_SINGLINE_STYLE_WITH_FTE__*/
...
MMI_BOOL wgui_inputs_sl_multitap_input(UI_character_type c)
{
    ...
    #else /*__MMI_MULTILINE_INPUT_BOX_SINGLINE_STYLE_WITH_FTE__*/
        wgui_inputs_ml_multitap_input_ext(c,&MMI_multiline_inputbox_singleline);  
    #endif/*__MMI_MULTILINE_INPUT_BOX_SINGLINE_STYLE_WITH_FTE__*/
...
void wgui_inputs_sl_multitap_input_complete(void)
{
    ...
    #else /*__MMI_MULTILINE_INPUT_BOX_SINGLINE_STYLE_WITH_FTE__*/
        wgui_inputs_ml_multitap_input_complete_ext(&MMI_multiline_inputbox_singleline); 
    #endif/*__MMI_MULTILINE_INPUT_BOX_SINGLINE_STYLE_WITH_FTE__*/
...
/* under construction !*/
   ...
   #else /*__MMI_MULTILINE_INPUT_BOX_SINGLINE_STYLE_WITH_FTE__*/
        return wgui_inputs_ml_direct_input_ext(c,&MMI_multiline_inputbox_singleline);
   #endif/*__MMI_MULTILINE_INPUT_BOX_SINGLINE_STYLE_WITH_FTE__*/    
#endif /* __MMI_EDITOR_SINGLINE_SUPPORT__*/    
}
...
MMI_BOOL wgui_inputs_sl_direct_input_no_draw(UI_character_type c)
{
    ...
    #else /*__MMI_MULTILINE_INPUT_BOX_SINGLINE_STYLE_WITH_FTE__*/
        wgui_inputs_ml_direct_input_no_draw_ext(c,&MMI_multiline_inputbox_singleline);
    #endif/*__MMI_MULTILINE_INPUT_BOX_SINGLINE_STYLE_WITH_FTE__*/  
...
/* under construction !*/
    ...
    #else /*__MMI_MULTILINE_INPUT_BOX_SINGLINE_STYLE_WITH_FTE__*/
        wgui_inputs_ml_delete_character_ext(&MMI_multiline_inputbox_singleline);
    #endif/*__MMI_MULTILINE_INPUT_BOX_SINGLINE_STYLE_WITH_FTE__*/   
...
void wgui_inputs_sl_delete_character_no_draw(void)
{
    ...
    #else /*__MMI_MULTILINE_INPUT_BOX_SINGLINE_STYLE_WITH_FTE__*/
        wgui_inputs_ml_delete_character_no_draw_ext(&MMI_multiline_inputbox_singleline);   
    #endif/*__MMI_MULTILINE_INPUT_BOX_SINGLINE_STYLE_WITH_FTE__*/    
...
void wgui_inputs_sl_previous_character(void)
{
    ...
    #else /*__MMI_MULTILINE_INPUT_BOX_SINGLINE_STYLE_WITH_FTE__*/
        wgui_inputs_ml_previous_character_ext(&MMI_multiline_inputbox_singleline);
    #endif/*__MMI_MULTILINE_INPUT_BOX_SINGLINE_STYLE_WITH_FTE__*/
#endif /* __MMI_EDITOR_SINGLINE_SUPPORT__*/            
}
...
void wgui_inputs_sl_next_character(void)
{
    ...
    #else /*__MMI_MULTILINE_INPUT_BOX_SINGLINE_STYLE_WITH_FTE__*/
        wgui_inputs_ml_next_character_ext(&MMI_multiline_inputbox_singleline);
    #endif/*__MMI_MULTILINE_INPUT_BOX_SINGLINE_STYLE_WITH_FTE__*/    
#endif /* __MMI_EDITOR_SINGLINE_SUPPORT__*/
}
...
wgui_inputs_ml_delete_current_character();
    #else /*__MMI_MULTILINE_INPUT_BOX_SINGLINE_STYLE_WITH_FTE__*/
        wgui_inputs_ml_delete_current_character_ext(&MMI_multiline_inputbox_singleline);
    #endif/*__MMI_MULTILINE_INPUT_BOX_SINGLINE_STYLE_WITH_FTE__*/
...
void wgui_inputs_sl_delete_all_characters(void)
{
    ...
    wgui_inputs_ml_delete_all_characters();
        ...
        wgui_inputs_ml_delete_all_characters_ext(&MMI_multiline_inputbox_singleline);
    #endif/*__MMI_MULTILINE_INPUT_BOX_SINGLINE_STYLE_WITH_FTE__*/
#endif /* __MMI_EDITOR_SINGLINE_SUPPORT__*/ 
}
...
void wgui_inputs_sl_register_keys(void)
{
   ...
   // SetKeyHandler(wgui_inputs_sl_delete_all_characters, KEY_VOL_DOWN, KEY_LONG_PRESS);
    ...
    #else /*__MMI_MULTILINE_INPUT_BOX_SINGLINE_STYLE_WITH_FTE__*/
        wgui_inputs_ml_register_keys_ext(&MMI_multiline_inputbox_singleline);    
    #endif/*__MMI_MULTILINE_INPUT_BOX_SINGLINE_STYLE_WITH_FTE__*/  
#endif /* __MMI_EDITOR_SINGLINE_SUPPORT__*/ 
}
...
void wgui_inputs_sl_set_mask(U8 m)
{
    ...
    #else /*__MMI_MULTILINE_INPUT_BOX_SINGLINE_STYLE_WITH_FTE__*/
        wgui_inputs_ml_set_mask_ext(m,&MMI_multiline_inputbox_singleline);
    #endif/*__MMI_MULTILINE_INPUT_BOX_SINGLINE_STYLE_WITH_FTE__*/  
#endif /* __MMI_EDITOR_SINGLINE_SUPPORT__*/     
}
...
/* under construction !*/
    ...
    #else /*__MMI_MULTILINE_INPUT_BOX_SINGLINE_STYLE_WITH_FTE__*/    
        wgui_inputs_ml_reset_ext(&MMI_multiline_inputbox_singleline);
    #endif/*__MMI_MULTILINE_INPUT_BOX_SINGLINE_STYLE_WITH_FTE__*/
...
MMI_BOOL wgui_inputs_sl_get_display_status(void)
{
    ...
    #else /*__MMI_MULTILINE_INPUT_BOX_SINGLINE_STYLE_WITH_FTE__*/
        return wgui_inputs_ml_get_display_status_ext(&MMI_multiline_inputbox_singleline);
    #endif/*__MMI_MULTILINE_INPUT_BOX_SINGLINE_STYLE_WITH_FTE__*/    
#endif /* __MMI_EDITOR_SINGLINE_SUPPORT__*/     
}
...
void wgui_inputs_sl_resize(S32 width, S32 height)
{
    ...
    #else /*__MMI_MULTILINE_INPUT_BOX_SINGLINE_STYLE_WITH_FTE__*/
        wgui_inputs_ml_resize_ext( width, height, &MMI_multiline_inputbox_singleline);    
    #endif/*__MMI_MULTILINE_INPUT_BOX_SINGLINE_STYLE_WITH_FTE__*/    
#endif /* __MMI_EDITOR_SINGLINE_SUPPORT__*/ 
}
...
void wgui_inputs_sl_move(S32 x, S32 y)
{
    ...
    #else /*__MMI_MULTILINE_INPUT_BOX_SINGLINE_STYLE_WITH_FTE__*/
        wgui_inputs_ml_move_ext( x, y, &MMI_multiline_inputbox_singleline);
    #endif/*__MMI_MULTILINE_INPUT_BOX_SINGLINE_STYLE_WITH_FTE__*/ 
#endif /* __MMI_EDITOR_SINGLINE_SUPPORT__*/ 
}
...
U8 wgui_inputs_sl_is_empty(void)
{
    ...
    #else /*__MMI_MULTILINE_INPUT_BOX_SINGLINE_STYLE_WITH_FTE__*/
        return wgui_inputs_ml_is_empty_ext(&MMI_multiline_inputbox_singleline);
    #endif/*__MMI_MULTILINE_INPUT_BOX_SINGLINE_STYLE_WITH_FTE__*/    
#endif /* __MMI_EDITOR_SINGLINE_SUPPORT__*/     
}
...
void wgui_inputs_sl_redraw_remaining_characters_display(void)
{
    ...
    #else /*__MMI_MULTILINE_INPUT_BOX_SINGLINE_STYLE_WITH_FTE__*/
        wgui_inputs_ml_redraw_remaining_characters_display_ext(&MMI_multiline_inputbox_singleline);
    #endif/*__MMI_MULTILINE_INPUT_BOX_SINGLINE_STYLE_WITH_FTE__*/ 
#endif /* __MMI_EDITOR_SINGLINE_SUPPORT__*/ 
}
...
void wgui_inputs_sl_redraw_information_bar(void)
{
    ...
    #else /*__MMI_MULTILINE_INPUT_BOX_SINGLINE_STYLE_WITH_FTE__*/
        wgui_inputs_ml_redraw_input_information_bar_ext(&MMI_multiline_inputbox_singleline);
    #endif/*__MMI_MULTILINE_INPUT_BOX_SINGLINE_STYLE_WITH_FTE__*/    
#endif /* __MMI_EDITOR_SINGLINE_SUPPORT__*/ 
}
...
U8 wgui_inputs_sl_set_category_history(U16 history_ID, U8 *history_buffer)
{
    ...
    #ifndef __MMI_MULTILINE_INPUT_BOX_SINGLINE_STYLE_WITH_FTE__
        return wgui_inputs_ml_set_category_history(history_ID,history_buffer);

    #else /*__MMI_MULTILINE_INPUT_BOX_SINGLINE_STYLE_WITH_FTE__*/
        return wgui_inputs_ml_set_category_history_ext(&MMI_multiline_inputbox_singleline,history_ID,history_buffer);
    #endif/*__MMI_MULTILINE_INPUT_BOX_SINGLINE_STYLE_WITH_FTE__*/    
#endif /* __MMI_EDITOR_SINGLINE_SUPPORT__*/ 
}
...
void wgui_inputs_sl_get_category_history(U16 history_ID, U8 *history_buffer)
{
    ...
    #else /*__MMI_MULTILINE_INPUT_BOX_SINGLINE_STYLE_WITH_FTE__*/
        wgui_inputs_ml_get_category_history_ext(&MMI_multiline_inputbox_singleline, history_ID, history_buffer);
    #endif/*__MMI_MULTILINE_INPUT_BOX_SINGLINE_STYLE_WITH_FTE__*/    
#endif /* __MMI_EDITOR_SINGLINE_SUPPORT__*/ 
}
...
/* under construction !*/
    ...
    #else /*__MMI_MULTILINE_INPUT_BOX_SINGLINE_STYLE_WITH_FTE__*/
        wgui_inputs_ml_handle_right_softkey_down_ext(&MMI_multiline_inputbox_singleline);
    #endif/*__MMI_MULTILINE_INPUT_BOX_SINGLINE_STYLE_WITH_FTE__*/    
...
void wgui_inputs_sl_handle_right_softkey_up(void)
{
    ...
    #else /*__MMI_MULTILINE_INPUT_BOX_SINGLINE_STYLE_WITH_FTE__*/
        wgui_inputs_ml_handle_right_softkey_up_ext(&MMI_multiline_inputbox_singleline);    
    #endif/*__MMI_MULTILINE_INPUT_BOX_SINGLINE_STYLE_WITH_FTE__*/    
#endif /* __MMI_EDITOR_SINGLINE_SUPPORT__*/     
}
...
void wgui_inputs_sl_handle_right_softkey_long_press(void)
{
    ...
    #else /*__MMI_MULTILINE_INPUT_BOX_SINGLINE_STYLE_WITH_FTE__*/
        wgui_inputs_ml_handle_right_softkey_long_press_ext(&MMI_multiline_inputbox_singleline);
    #endif/*__MMI_MULTILINE_INPUT_BOX_SINGLINE_STYLE_WITH_FTE__*/    
...
void wgui_inputs_sl_handle_input(void)
{
    ...
    #else /*__MMI_MULTILINE_INPUT_BOX_SINGLINE_STYLE_WITH_FTE__*/
        wgui_inputs_ml_handle_input_ext(&MMI_multiline_inputbox_singleline);
    #endif/*__MMI_MULTILINE_INPUT_BOX_SINGLINE_STYLE_WITH_FTE__*/  
#endif /* __MMI_EDITOR_SINGLINE_SUPPORT__*/ 
}
...
void wgui_inputs_sl_handle_navigate(void)
{
    ...
    #else /*__MMI_MULTILINE_INPUT_BOX_SINGLINE_STYLE_WITH_FTE__*/
        wgui_inputs_ml_handle_navigate_ext(&MMI_multiline_inputbox_singleline);
    #endif/*__MMI_MULTILINE_INPUT_BOX_SINGLINE_STYLE_WITH_FTE__*/    
#endif /* __MMI_EDITOR_SINGLINE_SUPPORT__*/     
}
...
S32 wgui_inputs_sl_get_ucs2_count(void)
{
    ...
    #else /*__MMI_MULTILINE_INPUT_BOX_SINGLINE_STYLE_WITH_FTE__*/
        return (MMI_multiline_inputbox_singleline.UCS2_count);
    #endif/*__MMI_MULTILINE_INPUT_BOX_SINGLINE_STYLE_WITH_FTE__*/    
...
S32 wgui_inputs_sl_get_ext_gsm_count(void)
{
    ...
    #else /*__MMI_MULTILINE_INPUT_BOX_SINGLINE_STYLE_WITH_FTE__*/
        return (MMI_multiline_inputbox_singleline.GSM_ext_count);
    #endif/*__MMI_MULTILINE_INPUT_BOX_SINGLINE_STYLE_WITH_FTE__*/    
#endif /* __MMI_EDITOR_SINGLINE_SUPPORT__*/ 
}
...
void wgui_inputs_sl_set_RSK(void)
{
    ...
    #else /*__MMI_MULTILINE_INPUT_BOX_SINGLINE_STYLE_WITH_FTE__*/
        wgui_inputs_ml_set_RSK_ext(&MMI_multiline_inputbox_singleline);
    #endif/*__MMI_MULTILINE_INPUT_BOX_SINGLINE_STYLE_WITH_FTE__*/    
#endif /* __MMI_EDITOR_SINGLINE_SUPPORT__*/ 
}
        ...
        U32 (*msg_call_back) (void * input_box_handle, mmi_imc_message_struct_p msg_ptr))
{
    ...
    gui_single_line_input_box_locate_cursor(&MMI_singleline_inputbox);
        ...
        if(msg_call_back == mmi_input_box_msg_call_back_singleline)
        {
           msg_call_back_input = mmi_input_box_msg_call_back_multiline_ext;
        }
        else
        {
          msg_call_back_input =  msg_call_back;
       ...
       #ifdef __MMI_MULTILINE_INPUT_BOX_SINGLINE_STYLE__     
               MMI_multiline_inputbox_singleline.ext_flags |= GUI_MULTI_LINE_INPUT_BOX_SINGLINE_STYLE;
       #endif /*__MMI_MULTILINE_INPUT_BOX_SINGLINE_STYLE__*/
...
void wgui_inputs_sl_close(void)
{
    ...
    #else /*__MMI_MULTILINE_INPUT_BOX_SINGLINE_STYLE_WITH_FTE__*/
        wgui_inputs_ml_close_ext(&MMI_multiline_inputbox_singleline);
    #endif/*__MMI_MULTILINE_INPUT_BOX_SINGLINE_STYLE_WITH_FTE__*/    
#endif /* __MMI_EDITOR_SINGLINE_SUPPORT__*/   
}
			...
			MMI_BOOL (*handler)(gui_multi_line_input_box_change_event_enum event,U16 C))
{
    ...
    #else /*__MMI_MULTILINE_INPUT_BOX_SINGLINE_STYLE_WITH_FTE__*/
        gui_multi_line_input_box_register_change_event_handler(&MMI_multiline_inputbox_singleline,handler);
   #endif/*__MMI_MULTILINE_INPUT_BOX_SINGLINE_STYLE_WITH_FTE__*/
...
void wgui_inputs_sl_move_cursor(wgui_inputs_cursor_pos_enum pos)
{
    ...
    #else /*__MMI_MULTILINE_INPUT_BOX_SINGLINE_STYLE_WITH_FTE__*/
        wgui_inputs_ml_move_cursor_ext(pos,&MMI_multiline_inputbox_singleline);
    #endif/*__MMI_MULTILINE_INPUT_BOX_SINGLINE_STYLE_WITH_FTE__*/   
#endif /* __MMI_EDITOR_SINGLINE_SUPPORT__*/    
}
...
U32 wgui_inputs_sl_insert_string(UI_string_type str, U32 len, MMI_BOOL is_redraw)
{
    ...
    #else /*__MMI_MULTILINE_INPUT_BOX_SINGLINE_STYLE_WITH_FTE__*/
        return wgui_inputs_ml_insert_string_ext(str, len, is_redraw,&MMI_multiline_inputbox_singleline);
    #endif/*__MMI_MULTILINE_INPUT_BOX_SINGLINE_STYLE_WITH_FTE__*/
...
void wgui_inputs_sl_disable(void)
{
    ...
    #else /*__MMI_MULTILINE_INPUT_BOX_SINGLINE_STYLE_WITH_FTE__*/
        wgui_inputs_ml_disable_ext(&MMI_multiline_inputbox_singleline);        
    #endif/*__MMI_MULTILINE_INPUT_BOX_SINGLINE_STYLE_WITH_FTE__*/
...
void wgui_inputs_sl_enable(void)
{
    ...
    #else /*__MMI_MULTILINE_INPUT_BOX_SINGLINE_STYLE_WITH_FTE__*/
        wgui_inputs_ml_enable_ext(&MMI_multiline_inputbox_singleline);        
    #endif/*__MMI_MULTILINE_INPUT_BOX_SINGLINE_STYLE_WITH_FTE__*/
