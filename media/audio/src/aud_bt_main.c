...
extern void aud_bt_hf_sco_connect_cnf_hdlr(ilm_struct *ilm_ptr);
extern void aud_bt_hf_sco_connect_ind_hdlr(ilm_struct *ilm_ptr);
extern void aud_bt_hf_sco_disconnect_cnf_hdlr(ilm_struct *ilm_ptr);
extern void aud_bt_hf_sco_disconnect_ind_hdlr(ilm_struct *ilm_ptr);
#endif

#ifdef __MED_BT_HFP_MOD__
extern void aud_bt_hfp_sco_connect_cnf_hdlr(ilm_struct *ilm_ptr);
extern void aud_bt_hfp_sco_connected_ind_hdlr(ilm_struct *ilm_ptr);
extern void aud_bt_hfp_sco_disconnect_cnf_hdlr(ilm_struct *ilm_ptr);
extern void aud_bt_hfp_sco_disconnected_ind_hdlr(ilm_struct *ilm_ptr);
#endif
...
kal_bool aud_bt_main(ilm_struct *ilm_ptr)
{
    ...
    switch (ilm_ptr->msg_id)
    {
        ...
        case MSG_ID_BT_HF_SCO_CONNECT_CNF:
            aud_bt_hf_sco_connect_cnf_hdlr(ilm_ptr);
            break;			
        case MSG_ID_BT_HF_SCO_CONNECT_IND:
            aud_bt_hf_sco_connect_ind_hdlr(ilm_ptr);
            break;
        case MSG_ID_BT_HF_SCO_DISCONNECT_CNF:
            aud_bt_hf_sco_disconnect_cnf_hdlr(ilm_ptr);
            break;
        case MSG_ID_BT_HF_SCO_DISCONNECT_IND:
            aud_bt_hf_sco_disconnect_ind_hdlr(ilm_ptr);
            break;
	#endif
