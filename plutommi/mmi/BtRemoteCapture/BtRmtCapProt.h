...
#define MMI_BT_RMTCAP_CAP_TIME_OUT (2*1000)
#define MMI_BT_RMTCAP_PIC_DEFAULT_PATH L"z:\\@cap\\DefaultPic.jpg"
#define MMI_BT_RMTCAP_FOLDER_PATH L"z:\\@BtRmtCap"
#define MMI_BT_RMTCAP_SENDER_ID "remotecapture"
#define MMI_BT_RMTCAP_CMD_HEADER "EXCD"
...
extern U16 mmi_bt_rmt_cap_gen_cmd_genaral(char *cmd, mmi_bt_rmt_cap_cmd_type cmd_type, void *data);
 extern void mmi_bt_rmtcap_draw_screen(
		S8 *file_name_ptr,
		U8 *buffer_ptr,
        S32 *category_error_flag);

 extern void mmi_bt_rmtcap_set_draw_screen_pen_callback();

 extern void mmi_bt_rmtcap_draw_shot_screen(S8 * file_name_ptr,U8 * buffer_ptr);

 extern void mmi_bt_rmtcap_set_capture_screen_pen_callback();

 extern void mmi_bt_rmtcap_clear_pen_callback();
