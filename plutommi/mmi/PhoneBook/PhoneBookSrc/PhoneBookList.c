...
mmi_phb_entry_type g_phb_entry_type = MMI_PHB_ENTRY_NONE;
...
extern MMI_BOOL mmi_phb_pbapc_is_connect(void);
#endif
...
static void mmi_phb_fte_contact_list_tap_callback(mmi_tap_type_enum tap_type, S32 index)
{
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
#if !(defined( __MMI_WEARABLE_DEVICE__) && defined(__MMI_TELEPHONY_SUPPORT__))
...
/* under construction !*/
	...
	if(g_phb_entry_type == MMI_PHB_ENTRY_BT)
	{
		mmi_phb_pbapc_exit_list();
	}
#endif
...
#if defined(__MMI_WEARABLE_DEVICE__) && defined(__MMI_TELEPHONY_SUPPORT__) && defined(__MMI_BT_PBAP_CLIENT__)
...
#else /*defined(__MMI_WEARABLE_DEVICE__) && defined(__MMI_TELEPHONY_SUPPORT__) && defined(__MMI_BT_PBAP_CLIENT__)*/
...
#if defined(__MMI_BT_PBAP_CLIENT__) && defined(__MMI_APP_WITHOUT_LOCAL__)
    mmi_phb_pbapc_entry_list();
    return;
#endif
...
/* Tab style */
    ...
    #endif
    phb_pbapc_cntx_p = mmi_phb_pbapc_get_cntx();
    //ret = srv_bt_cm_is_profile_connected_ex(SRV_BT_CM_PBAPC_CONNECTION, phb_pbapc_cntx_p->bt_index);
...
#endif /*!defined (__MMI_PHB_UI_IN_TABS__) && defined (__MMI_PHB_PBAPC_SYNC_CONTACT__)*/
#endif /*SRV_PBAPC_LINK_NUM > = 2*/
#endif /*defined(__MMI_WEARABLE_DEVICE__) && defined(__MMI_TELEPHONY_SUPPORT__) && defined(__MMI_BT_PBAP_CLIENT__)*/
...
static mmi_pen_hdlr g_mmi_phb_list_longtap_hdlr_bakcup = NULL;

mmi_pen_hdlr mmi_phb_entry_op_option_long_tap_hdlr(mmi_pen_point_struct pos)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
	...
	if(g_pen_to_control && g_pen_to_control != DM_TITLE1)
	{
	...
	if(g_mmi_phb_list_longtap_hdlr_bakcup != NULL)
	{
		g_mmi_phb_list_longtap_hdlr_bakcup(pos);
	}
...
#if defined(__MMI_FTE_SUPPORT__) && defined(__MMI_TOUCH_SCREEN__)
#if defined(__MMI_WEARABLE_DEVICE__)
	g_mmi_phb_list_longtap_hdlr_bakcup = mmi_pen_get_pen_handler(MMI_PEN_EVENT_LONG_TAP);
	wgui_register_pen_long_tap_handler(mmi_phb_entry_op_option_long_tap_hdlr);
#endif /*__MMI_WEARABLE_DEVICE__*/
