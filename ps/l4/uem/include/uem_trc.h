...
BEGIN_TRACE_MAP(MOD_UEM)
    ...
    TRC_MSG(FUNC_UEM_KEYPAD_ESTIMATE_TIME, "uemdrv_ccci_em_req_hdlr, estimate_time=%d")
    ...
    TRC_MSG(FUNC_UEM_DRV_PWRON_START, "uem_drv_power_on() start")
    TRC_MSG(FUNC_UEM_DRV_PWRON_END, "uem_drv_power_on() end")
    TRC_MSG(FUNC_UEM_MMICHECK_LOGOSTART, "MMICheckDiskDisplay start")
    TRC_MSG(FUNC_UEM_MMICHECK_LOGOEND, "MMICheckDiskDisplay end")
