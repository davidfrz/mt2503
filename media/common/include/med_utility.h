...
extern void* (*mmi_frm_asm_alloc_int_p)(kal_uint16, kal_uint32, asm_alloc_flag, char*, kal_uint32);
extern void (*mmi_frm_asm_free_int_p)(kal_uint16, void*, char*, kal_uint32);

#define med_alloc_asm_mem(id, size)             mmi_frm_asm_alloc_int_p(id, size, ASM_ALLOC_IS_FB_FLAG, FILE_PATH_VALUE, __LINE__)
#define med_alloc_asm_mem_cacheable(id, size)   mmi_frm_asm_alloc_int_p(id, size, ASM_ALLOC_DEFAULT_FLAG, FILE_PATH_VALUE, __LINE__)
#define med_alloc_asm_mem_framebuffer(id, size) mmi_frm_asm_alloc_int_p(id, size, ASM_ALLOC_IS_FB_FLAG, FILE_PATH_VALUE, __LINE__)
#define med_alloc_asm_mem_topmost_noncacheable(id, size)    mmi_frm_asm_alloc_int_p(id, size, ASM_ALLOC_IS_FB_FLAG, FILE_PATH_VALUE, __LINE__)
#define med_alloc_asm_mem_topmost_cacheable(id, size)       mmi_frm_asm_alloc_int_p(id, size, ASM_ALLOC_DEFAULT_FLAG, FILE_PATH_VALUE, __LINE__)
#define med_free_asm_mem(id, ptr)               do {mmi_frm_asm_free_int_p(id, *(ptr), FILE_PATH_VALUE, __LINE__); *(ptr)=NULL;}while(0);
...
#ifdef __UPDATE_BINARY_FILE__
#define med_alloc_mem(id, size, file, line)                     mmi_frm_asm_alloc_int_p(id, size, ASM_ALLOC_IS_FB_FLAG, file, line)
#define med_alloc_mem_cacheable(id, size, file, line)           mmi_frm_asm_alloc_int_p(id, size, ASM_ALLOC_DEFAULT_FLAG, file, line)
#define med_alloc_mem_framebuffer(id, size, file, line)         mmi_frm_asm_alloc_int_p(id, size, ASM_ALLOC_IS_FB_FLAG, file, line)
#define med_alloc_mem_topmost_noncacheable(id, size, file, line)mmi_frm_asm_alloc_int_p(id, size, ASM_ALLOC_IS_FB_FLAG, file, line)
#define med_alloc_mem_topmost_cacheable(id, size, file, line)   mmi_frm_asm_alloc_int_p(id, size, ASM_ALLOC_DEFAULT_FLAG, file, line)

#define med_free_mem(id, ptr, file, line)                       do {mmi_frm_asm_free_int_p(id, *(ptr), file, line); *(ptr)=NULL;}while(0);
