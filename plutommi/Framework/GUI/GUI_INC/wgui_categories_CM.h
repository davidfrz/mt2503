...
#ifdef __MMI_WEARABLE_DEVICE__
//#define __WGUI_CAT16_DTMF_LONGPRESS_ENABLE__
#define __WGUI_CATE_CM_WEARABLE_SOFTKEY_DISABLE__
#endif /*__MMI_WEARABLE_DEVICE__*/
/***************************************************************************** 
 * Typedef
 *****************************************************************************/
#ifdef __MMI_WEARABLE_DEVICE__
/* MOMT call screen  type */
typedef enum
{
    WGUI_CATE_MOMT_INCOMING_CALL = 0, 
    WGUI_CATE_MOMT_OUTGOING_CALL,
    WGUI_CATE_MOMT_END_CALL
} wgui_cate_momt_call_type_enum; 

/*dialer screen*/
typedef enum
{
    WGUI_CAT16_NORMAL_STYLE = 0, 
    WGUI_CAT16_DTMF_STYLE,
    WGUI_CAT16_PIN_STYLE,
    WGUI_CAT16_END_STYLE
} wgui_cat16_dialer_style_enum;
...
#ifdef __MMI_WEARABLE_DEVICE__
extern void ShowCategory16Screen_for_dtmf(
		        U16 left_softkey,
		        U16 left_softkey_icon,
		        U16 right_softkey,
		        U16 right_softkey_icon,
		        ...
		        U32 BufferLength,
		        U8 *history_buffer);
extern void ShowCategory16Screen_for_pin(
				U16 *title_str,
		        U16 left_softkey,
		        U16 right_softkey,
		        U8 *Buffer,
		        U32 BufferLength,
		        U8 *history_buffer);
extern void SetDialingPinOkHandler(void (*handler) (void));
...
#ifdef __MMI_WEARABLE_DEVICE__
extern void SetOutGoingEndhandler(void (*handler) (void));
extern void SetInComingAccepthandler(void (*handler) (void));
extern void SetInComingRejecthandler(void (*handler) (void));
extern void ShowCategory17Screen_ext(
                U16 left_softkey,
                U16 right_softkey,
                U16 NotificationStringId,
                PU8 NameOrNumber,
                ...
                PU8 history_buffer);
extern void RedrawCategory17Screen(U16 string_id);

extern void SetInCallSwaphandler(void (*handler) (void));
extern void SetInCallMutehandler(void (*handler) (void));
extern void SetInCallEndhandler(void (*handler) (void));
 ...
 *  void
 *****************************************************************************/
extern void SetOutGoingEndButtonState(U8 state);
extern void RedrawOutGoingEndButton(void);
 ...
 *  void
 *****************************************************************************/
extern void SetInCallMuteState(U8 state);
extern void RedrawInCallMuteIcon(void);
 ...
 *  void
 *****************************************************************************/
extern void SetInCallEndButtonState(U8 state);
extern void RedrawInCallEndButton(void);

extern void ShowInCallVolBar(U16 max_level, U16 cur_level, MMI_BOOL is_show);
extern void UpdateInCallVolBar(U16 max_level, U16 cur_level);

extern void wgui_in_call_pen_register_up_handler(void (*handler) (mmi_pen_point_struct pos));
extern void wgui_in_call_pen_register_down_handler(void (*handler) (mmi_pen_point_struct pos));
extern void wgui_in_call_pen_register_move_handler(void (*handler) (mmi_pen_point_struct pos));

extern void SetInCallVolInfoContentShow(MMI_BOOL is_show);
extern void ShowInCallDuration(void);

extern void wgui_cat9023_show_ex(
                U16  left_softkey,
                U16  right_softkey,
                U16  default_image_id,
                wgui_cat9023_call_info_struct *CM_info,
                U8 *history_buffer);
extern MMI_BOOL wgui_cat_is_in_call_cateogry(icontext_button *b);
extern void RedrawCat9023Screen(U16 string_id);
#endif /*__MMI_WEARABLE_DEVICE__*/
