...
*/
#if defined(__MMI_MAINLCD_96X64__) ||defined(__MMI_MAINLCD_128X128__) || defined(__MMI_MAINLCD_128X160__) || (defined(__MMI_MAINLCD_320X240__) && !defined(__MMI_FTE_SUPPORT__)) || defined(__MMI_MAINLCD_128X64__) || defined(__MMI_MAINLCD_128X32__)
...
/* Editor title layout */
// SLIM_96_64_SLIM
#if (defined(__MMI_MAINLCD_96X64__)) ||(defined(__MMI_MAINLCD_320X240__)) || ((defined(__MMI_MAINLCD_240X320__)||defined(__MMI_MAINLCD_320X320__)||defined(__MMI_MAINLCD_240X240__)) && (defined(__MMI_FTE_SUPPORT__)))
...
#elif defined(__MMI_MAINLCD_240X240__)//_MMI_WEARABLE_DEVICE__
#define WGUI_CATCALL_FTE_IMG_X              (89)
#define WGUI_CATCALL_FTE_IMG_Y              (27)
#define WGUI_CATCALL_FTE_IMG_W              (64)
#define WGUI_CATCALL_FTE_IMG_H              (64)
#elif defined(__MMI_MAINLCD_320X320__)//_MMI_WEARABLE_DEVICE__
#define WGUI_CATCALL_FTE_IMG_X              (89)
#define WGUI_CATCALL_FTE_IMG_Y              (27)
#define WGUI_CATCALL_FTE_IMG_W              (64)
#define WGUI_CATCALL_FTE_IMG_H              (64)
...
#define WGUI_CATCALL_FTE_ICONBAR_UNLOCK_H   (32)
        ...
        #define MMI_DIALING_BOX_HEIGHT                          (75)
            ...
            #endif
        #endif
	#elif defined(__MMI_FTE_SUPPORT__) && defined(__MMI_MAINLCD_240X240__)
        #define MMI_DIALING_KEYPAD_COLOMNS                      (3)
        #define MMI_DIALING_KEYPAD_ROWS                         (4)
        #define MMI_DIALING_KEYPAD_LAYER_WIDTH                  (240)
	...
	#ifdef __MMI_WEARABLE_DEVICE__
        #define MMI_DIALING_KEYPAD_X                            (0)
        #define MMI_DIALING_KEYPAD_Y                            (48)//(95)
        #define MMI_DIALING_KEYPAD_WIDTH                        (240)
        #define MMI_DIALING_KEYPAD_HEIGHT                       (190)//(145)
        #define MMI_DIALING_KEY_WIDTH                           (80)
        #define MMI_DIALING_KEY_HEIGHT                          (48)//(36)
        #define MMI_DIALING_KEY_HORIZONTAL_GAP                  (0)
		#define MMI_DIALING_KEY_VERTICAL_GAP                    (0)
        #define MMI_DIALING_BOX_X                               (4)
        #define MMI_DIALING_BOX_Y                               (0)//(18)
        #define MMI_DIALING_BOX_WIDTH                           (232)
        #define MMI_DIALING_BOX_HEIGHT                          (47)//(72)
	#else /*__MMI_WEARABLE_DEVICE__*/
        #define MMI_DIALING_KEYPAD_X                            (4)
        #define MMI_DIALING_KEYPAD_Y                            (95)
        #define MMI_DIALING_KEYPAD_WIDTH                        (234)
        #define MMI_DIALING_KEYPAD_HEIGHT                       (120)
        #define MMI_DIALING_KEY_WIDTH                           (76)
        #define MMI_DIALING_KEY_HEIGHT                          (28)
        #define MMI_DIALING_KEY_HORIZONTAL_GAP                  (2)
        #define MMI_DIALING_KEY_VERTICAL_GAP                    (0)
        #define MMI_DIALING_BOX_X                               (6)
        #define MMI_DIALING_BOX_Y                               (18)
        #define MMI_DIALING_BOX_WIDTH                           (229)
        #define MMI_DIALING_BOX_HEIGHT                          (72)
	#endif /*__MMI_WEARABLE_DEVICE__*/
            ...
            #endif
        #endif	
	#elif defined(__MMI_FTE_SUPPORT__) && defined(__MMI_MAINLCD_320X320__)
        #define MMI_DIALING_KEYPAD_COLOMNS                      (3)
        #define MMI_DIALING_KEYPAD_ROWS                         (4)
        #define MMI_DIALING_KEYPAD_LAYER_WIDTH                  (320)
        #define MMI_DIALING_KEYPAD_LAYER_HEIGHT                 (320)
	...
	#ifdef __MMI_WEARABLE_DEVICE__
        #define MMI_DIALING_KEYPAD_X                            (0)
        #define MMI_DIALING_KEYPAD_Y                            (48)
        #define MMI_DIALING_KEYPAD_WIDTH                        (320)
        #define MMI_DIALING_KEYPAD_HEIGHT                       (270)
        #define MMI_DIALING_KEY_WIDTH                           (107)
        #define MMI_DIALING_KEY_HEIGHT                          (68)
        #define MMI_DIALING_KEY_HORIZONTAL_GAP                  (0)
		#define MMI_DIALING_KEY_VERTICAL_GAP                    (0)
        #define MMI_DIALING_BOX_X                               (4)
        #define MMI_DIALING_BOX_Y                               (0)
        #define MMI_DIALING_BOX_WIDTH                           (312)
		...
		#define MMI_DIALING_BOX_HEIGHT							(65)
#else
        ...
        /* For function key on idlescreen */
                ...
                #define MMI_DIALING_FUNC_KEY_HEIGHT                 (33)
                #define MMI_DIALING_FUNC_KEY_HORIZONTAL_GAP         (12)
                #define MMI_DIALING_FUNC_KEY_VERTICAL_GAP           (18)
            #endif   /* __DUALMODE_TOUCH_DIAL_SCREEN_WITH_SLAVE_FUNCTION__ */    
        #endif /* defined (__MMI_TOUCH_DIAL_SCREEN_WITH_FUNCTION__) */	
        ...
        #define MMI_DIALING_KEYPAD_ROWS                     (4)
        #define MMI_DIALING_KEYPAD_LAYER_WIDTH              (240)
        #define MMI_DIALING_KEYPAD_LAYER_HEIGHT             (141) ///(212)
        #define MMI_DIALING_KEYPAD_LAYER_X                  (0)//((MAIN_LCD_DEVICE_WIDTH-MMI_DIALING_KEYPAD_LAYER_WIDTH)>>1)
        #define MMI_DIALING_KEYPAD_LAYER_Y                  (((MAIN_LCD_DEVICE_HEIGHT-MMI_DIALING_KEYPAD_LAYER_HEIGHT)>>1)+20) //(((MAIN_LCD_DEVICE_HEIGHT-MMI_DIALING_KEYPAD_LAYER_HEIGHT)>>1)+30)
        #define MMI_DIALING_KEYPAD_X                        (0) //(0)
        #define MMI_DIALING_KEYPAD_Y                        (0) //(0)
        #define MMI_DIALING_KEYPAD_WIDTH                    (240)
        #define MMI_DIALING_KEYPAD_HEIGHT                   (141)//(212)
        #define MMI_DIALING_KEY_WIDTH                       (61) //(61)
        #define MMI_DIALING_KEY_HEIGHT                      (26) //(53)
        #define MMI_DIALING_KEY_HORIZONTAL_GAP              (0) //(0)
        #define MMI_DIALING_KEY_VERTICAL_GAP                (0) //(0)
        #define MMI_DIALING_BOX_X                           (0)
        #define MMI_DIALING_BOX_Y                           (0)
        #define MMI_DIALING_BOX_WIDTH                       (0)
        #define MMI_DIALING_BOX_HEIGHT                      (47) //(60)
        /* For function key on idlescreen */
        #if defined (__MMI_TOUCH_DIAL_SCREEN_WITH_FUNCTION__)
            #ifdef __DUALMODE_TOUCH_DIAL_SCREEN_WITH_SLAVE_FUNCTION__
                #define MMI_DIALING_KEYPAD_FUNC_COLOMNS     (1) 
 ...
 ******************************************************************************/
	...
	#define CFG_UI_IDLE_EXTRA_Y_WITH_STATUS_AT_BOTTOM				(90)
...
/* main menu matrix menuitem image width and height */
	...
	#define CFG_UI_STATUS_BAR_HEIGHT					   (14)
#else
   ...
   /* height of softkey bar*/
    ...
    #endif
#elif (defined(__MMI_MAINLCD_240X320__) || defined(__MMI_MAINLCD_240X240__) ||defined(__MMI_MAINLCD_320X240__)|| defined(__MMI_MAINLCD_320X320__) )
	#if defined(__MMI_UI_SCROLLBAR_DEFAULT_STYLE_5__)
		#define CFG_UI_SCROLLBAR_WIDTH          13
    #elif defined(__MMI_TOUCH_SCREEN__)
 ...
 */
#ifdef __MMI_WEARABLE_DEVICE__
#define CFG_UI_TEXT_MENUITEM_TEXT_X        6
#else 
#if defined(__MMI_FTE_SUPPORT__)
...
#ifdef __MMI_WEARABLE_DEVICE__
#define CFG_UI_ICONTEXT_MENUITEM_ICON_X    6
#else
#if defined(__MMI_FTE_SUPPORT__)
...
#endif
#elif defined(__MMI_FTE_SUPPORT__) && (defined(__MMI_MAINLCD_240X320__) || defined(__MMI_MAINLCD_240X240__) || defined(__MMI_MAINLCD_320X320__) || defined(__MMI_MAINLCD_240X400__))
...
/* static calendar on idle screen */
       ...
       #define CFG_UI_IDLE_STATIC_SEARCH_IMAGE_STRING_GAP                 (10)
       #else
       #define CFG_UI_IDLE_STATIC_SEARCH_START_Y                         (1560)
       #define CFG_UI_IDLE_STATIC_SEARCH_IMAGE_STRING_GAP                 (10)
       #endif
   #elif defined(__MMI_MAINLCD_320X320__)	   
       #if !defined(__MMI_CALENDAR_ON_IDLE_SCREEN__)
