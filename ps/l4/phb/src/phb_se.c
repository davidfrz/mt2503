...
/* under construction !*/
...
#endif 
    {
        ...
        data_entry_pos = phb_det_append(
                            ...
                            (phb_storage_enum)phb_entry->storage,
                            record_index,
                            signature,
                            tel_num,
                            ext_index);
...
static kal_bool phb_se_assign_file_idx(phb_type_enum type, control_block_type *control_block)
{
    ...
    switch (type)
    {
        ...
        #ifdef __PHB_USIM_SUPPORT__
            else if (phb_util_is_usim(phb_which_sim_ex()))
            {
    ...
    switch(type)
    {
        ...
        case PHB_BDN:
        {
           ...
           */
            ...
            control_block->storage = (phb_storage_enum)data_entry->storage;
            break;      
