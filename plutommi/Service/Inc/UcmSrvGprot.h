...
typedef enum
{
    SRV_UCM_NONE_ORIGIN = 0, /* None */
    SRV_UCM_MO_ORIGIN,  /* MO call */
    SRV_UCM_MT_ORIGIN, /* MT call */
    SRV_UCM_CALL_ORIGIN_TOTAL  /* Total enum number */
} srv_ucm_call_origin_enum;
...
#ifdef __MMI_HFP_SUPPORT__
    srv_ucm_call_origin_enum call_origin;
#endif /* __MMI_HFP_SUPPORT__ */
...
typedef enum
{
    ...
    EVT_ID_SRV_UCM_BT_ACTION_NOTIFY,
    EVT_ID_SRV_UCM_BT_INDICATION,
#endif
 ...
 *  void
 *****************************************************************************/
extern void srv_ucm_hfg_init(void);
#endif /* __MMI_HFP_SUPPORT__ */
...
/*****************************************************************************
 * FUNCTION
 *  srv_ucm_is_alert_outgoing_call
 * DESCRIPTION
 *  check if there is outgoing call which is alerting
 * PARAMETERS
 *  void
 * RETURNS
 *  MMI_TRUE means there is.
 *  MMI_FALSE means there is not.
 *****************************************************************************/
extern MMI_BOOL srv_ucm_is_alert_outgoing_call(void);
#endif /* __MMI_HFP_SUPPORT__ */
