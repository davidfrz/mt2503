...
REL_SRC_COMP_COMMON += inet_adaption
...
REL_SRC_COMP_COMMON += sensor_algo
REL_SRC_COMP_COMMON += sensor_subsys
REL_SRC_COMP_COMMON += sim_driver
REL_SRC_COMP_COMMON += sss
REL_SRC_COMP_COMMON += swflash
REL_SRC_COMP_COMMON += system
REL_SRC_COMP_COMMON += system_ubin
REL_SRC_COMP_COMMON += tencentmcarev31adp
REL_SRC_COMP_COMMON += ts_audio
REL_SRC_COMP_COMMON += ts_display
REL_SRC_COMP_COMMON += ts_mre
REL_SRC_COMP_COMMON += ts_peripheral
REL_SRC_COMP_COMMON += ts_system
REL_SRC_COMP_COMMON += ts_storage
REL_SRC_COMP_COMMON += ts_swatch
REL_SRC_COMP_COMMON += ts_test
REL_SRC_COMP_COMMON += ubinverno
...
REL_MTK_COMP_COMMON += ts_nucleus
REL_MTK_COMP_COMMON += ts_nucleus_critical_data
REL_MTK_COMP_COMMON += ts_nucleus_ctrl_code
REL_MTK_COMP_COMMON += ts_nucleus_debug
REL_MTK_COMP_COMMON += ts_nucleus_int
REL_MTK_COMP_COMMON += ts_sleep_drv
