...
S8 *GetImageTheme(U16 ImageId)
{
    ...
    switch(ImageId)
    {
	 ...
	 //IMG_GLOBAL_L1...IMG_GLOBAL_L30
    if((ImageId >= IMG_GLOBAL_L1)&&(ImageId <= IMG_GLOBAL_L30))
       img = *(&current_MMI_theme->list_menuitem_auto_number_img1 + ImageId - IMG_GLOBAL_L1);
	 //END IMG_GLOBAL_L1..IMG_GLOBAL_L30
