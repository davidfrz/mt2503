 ...
 * Global Variable
 *****************************************************************************/ 
#define MMI_fixed_text_menuitem MMI_fixed_icontext_menuitem
#define MMI_fixed_text_menuitems MMI_fixed_icontext_menuitems
#define fixed_text_menu_n_items fixed_icontext_menu_n_items
 ...
 *  MMI_MENUITEM_HEIGHT
 *****************************************************************************/
#define get_menu_item_height() MMI_MENUITEM_HEIGHT
 ...
 *  void
 *****************************************************************************/
extern void fixed_text_menuitem_apply_theme(UI_menuitem_theme *t);
...
extern MMI_BOOL fixed_matrix_auto_disable_scrollbar(void);
#else/*__MMI_UI_MENU_AUTO_DISABLE_SCROLLBAR__*/
#define fixed_matrix_auto_disable_scrollbar() MMI_TRUE
 ...
 *  void
 *****************************************************************************/
extern void fixed_icontext_menuitem_apply_theme(UI_menuitem_theme *t);
...
#define wgui_enable_hints_in_icontext_menuitem()
...
#define wgui_show_icon_only_highlight_in_icontext_menuitem() 
 ...
 *  void
 *****************************************************************************/
extern void fixed_twostate_menuitem_apply_theme(UI_menuitem_theme *t);
 ...
 *****************************************************************************/
extern MMI_BOOL get_fixed_twostate_item_state(S32 index);
 ...
 *****************************************************************************/
extern MMI_BOOL get_two_line_menuitem_height(void);
 ...
 *  Return 1 for two line; otherwise, 0 for single line.
 *****************************************************************************/
extern MMI_BOOL get_two_line_dynamic_menuitem_height(void);
 ...
 *  Return 1 for two line; otherwise, 0 for single line.
 *****************************************************************************/
extern MMI_BOOL get_two_line_asyncdynamic_menuitem_height(void);
...
//add by huking
extern void wgui_show_list_menu_no_draw(void (*show_func) (fixed_list_menu *m));
