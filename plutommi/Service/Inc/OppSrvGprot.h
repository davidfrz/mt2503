...
typedef void(*srv_oppc_cm_cb) (srv_bt_cm_bt_addr *dev_addr, srv_bt_cm_connection_type conn_type, MMI_BOOL result, MMI_BOOL is_connect, MMI_BOOL is_indicate);
#endif
...
extern MMI_BOOL srv_oppc_is_connecting(void);
/*****************************************************************************
 * FUNCTION
...
#ifdef __MMI_BT_APK_SMART_INSTALL_SUPPORT__
extern void srv_oppc_handle_smart_install(MMI_BOOL connect_flag, MMI_BOOL success_flag);
extern MMI_BOOL srv_oppc_apk_pushed_record_check(srv_bt_cm_bt_addr* dest_dev);
extern MMI_BOOL srv_oppc_set_conn_app_cb(void* conn_cb);

extern MMI_BOOL srv_oppc_clear_conn_app_cb(void);
