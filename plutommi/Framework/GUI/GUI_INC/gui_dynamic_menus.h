...
#define gui_show_dynamic_list_menu gui_show_dynamic_list_menu_int
...
/* under construction !*/
#endif//0
#define gui_dynamic_list_menu_goto_item(_arg0, _arg1) gui_list_menu_goto_item(_arg0, _arg1)
#define gui_dynamic_list_menu_goto_next_item(_arg) gui_list_menu_goto_next_item(_arg)
#define gui_dynamic_list_menu_goto_previous_item(_arg) gui_list_menu_goto_previous_item(_arg)
...
#define gui_dynamic_list_menu_locate_highlighted_item(_arg) gui_list_menu_locate_highlighted_item(_arg)
...
extern void gui_show_dynamic_list_menu_draw_items(fixed_list_menu *m, S32 x1, S32 y1, S32 x2, S32 y2, MMI_BOOL disable_draw);
