...
#define task_entry_map(task, entry)
...
typedef enum {
    ...
    /*IV. ******MOD id for tiny trace**********/
    MOD_TINY_BEGIN = 380,
    #include "tiny_trace_config.h"
	
    /* remember that the maximum module id should be lower than 384 due to 2k buffer */
    MOD_BOUNDARY,
    END_OF_MOD_ID = 384 
}module_type;
