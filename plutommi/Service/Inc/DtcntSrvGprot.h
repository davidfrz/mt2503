...
typedef enum
{
    SRV_DTCNT_WLAN_SNIFFER_ON_RES,
    SRV_DTCNT_WLAN_SNIFFER_ON_AP_INFO,

    SRV_DTCNT_WLAN_SNIFFER_ON_END
}srv_dtcnt_wlan_sniffer_on_cb_type_enum;
...
typedef enum
{  
   SRV_DTCNT_WLAN_SNIFFER_SUCCESS = 0,
   SRV_DTCNT_WLAN_SNIFFER_FAIL_INVALID_CHANNEL,
   SRV_DTCNT_WLAN_SNIFFER_FAIL_INVALID_SNIFFERFILTEROPTIONS,
   SRV_DTCNT_WLAN_SNIFFER_FAIL_INVALID_ONOFFSWITCH,
   SRV_DTCNT_WLAN_SNIFFER_FAIL_NETWORK_IS_CONNECTED,   
   SRV_DTCNT_WLAN_SNIFFER_FAIL_UNKNOWN,
   SRV_DTCNT_WLAN_SNIFFER_FAIL_STATE_ERROR,
   SRV_DTCNT_WLAN_SNIFFER_FAIL_HW_ERROR
} srv_dtcnt_wlan_sniffer_res_enum;
...
/*****************************************************************************
 * FUNCTION
 *  srv_dtcnt_wlan_get_connected_ap_prof_id
 * DESCRIPTION
 ...
 *****************************************************************************/
extern MMI_BOOL srv_dtcnt_wlan_get_connected_ap_prof_id(U32 *prof_id);


/*****************************************************************************
 * FUNCTION
 *  srv_dtcnt_wlan_set_scan_spec_ssid_list
 * DESCRIPTION
 *  The function is used to set specialized ssid list for scaning. User should not set the specialized ssid list
 *  again before the last set process finishes.
 * PARAMETERS
 ...
 *  SRV_DTCNT_RESULT_INVALID_INPUT   : There is(are) invalid input parameter(s).
 *****************************************************************************/
extern srv_dtcnt_result_enum srv_dtcnt_wlan_set_scan_spec_ssid_list(
        U8 ssid_list_num, 
...
/*****************************************************************************
 * FUNCTION
 *  srv_dtcnt_wlan_get_scan_spec_ssid_list
 * DESCRIPTION
 *  The function is used to get customized specialized ssid list for scaning. If customer hasn't set the list, 
 *  then *ssid_list_num will be returned as 0 and ssid_list will be cleared to zero.
 * 
 ...
 * RETURN VALUES
 * SRV_DTCNT_RESULT_SUCCESS        : Get profile id succ
 * SRV_DTCNT_RESULT_FAILED         : Get profile id fail
 * SRV_DTCNT_RESULT_INVALID_INPUT  : There is(are) invalid input parameter(s).
 *****************************************************************************/
extern srv_dtcnt_result_enum srv_dtcnt_wlan_get_scan_spec_ssid_list(
    U8 *ssid_list_num, 
...
/*****************************************************************************
 * FUNCTION
 *  srv_dtcnt_wlan_set_roaming_para
 * DESCRIPTION
 *  The function is used to set roaming parameter.
 * PARAMETERS
 *  roaming_para     :   [IN]    WLAN roaming parameter
 * RETURN VALUES
 *  void
 *****************************************************************************/
extern srv_dtcnt_result_enum srv_dtcnt_wlan_set_roaming_para(
...
/*****************************************************************************
 * FUNCTION
 *  srv_dtcnt_wlan_get_roaming_para
 * DESCRIPTION
 *  The function is used to get roaming parameter.
 * PARAMETERS
 *  roaming_para     :   [OUT]    WLAN roaming parameter
 * RETURN VALUES
 *  void
 *****************************************************************************/
extern srv_dtcnt_result_enum srv_dtcnt_wlan_get_roaming_para(MMI_BOOL * is_roaming);


/*****************************************************************************
 * FUNCTION
 *  srv_dtcnt_wlan_set_scan_dwell_time
 * DESCRIPTION
 *  The function is used to set roaming parameter.
 * PARAMETERS
 *  roaming_para     :   [IN]    WLAN roaming parameter
 ...
 *  void
 *****************************************************************************/
extern srv_dtcnt_result_enum srv_dtcnt_wlan_set_scan_dwell_time(
    U16 dwell_time,
    srv_dtcnt_wlan_cb_func_ptr callback, 
    void *user_data);
...
/*****************************************************************************
 * FUNCTION
 *  srv_dtcnt_wlan_get_scan_dwell_time
 * DESCRIPTION
 *  The function is used to set roaming parameter.
 * PARAMETERS
 *  roaming_para     :   [IN]    WLAN roaming parameter
 ...
 *  void
 *****************************************************************************/
extern srv_dtcnt_result_enum srv_dtcnt_wlan_get_scan_dwell_time(U16 * dwell_time);
