 ...
 * $Log$
 *
 * 03 29 2016 anuj.agarwal
 * [MAUI_03554382] [MP Build Error] Build Error for //MAUI/BRANCHES_11C/11CW1418SP4/mcu/plutommi/Customer/CustResource/mmi_rp_callback_mgr_table.c
 * 
 * 
 * Wrap proximity handling for CALL_SUPPORT projects
 *
 * 03 17 2015 rid.chen
 * [MAUI_03533288] Patch back Watch_Tracker to SP4
 * UCM part.
 *
 * 03 17 2015 rid.chen
 * [MAUI_03533288] Patch back Watch_Tracker to SP4
 * UCM part.
 *
 * 12 30 2014 zhiwei.yang
 * [MAUI_03527219] [LinkIt]ear phone not work when voice call
 * .
 *
 * 12 04 2014 ting.wang
 * [MAUI_03522728] [MT2502A]LocationLogger GPS定位抓取数据时候timer没有timeout一直循环在抓数据
 * Start backlight timer in bootup flow and let LCD sleep in while tracker + gdi.
 *
 * 07 28 2014 ting.wang
 * [MAUI_03499409] [Smart Tracker] Project definition check-in
 * Fix build error due to enable MRE auto start feature.
 *
 * 07 28 2014 zhixiong.wang
 * [MAUI_03510928] Wrap Megaphone & FM Code by Macro
 * Wrap Megaphone & FM Code by Macro.
 *
 * 07 21 2014 lindun.tang
 * [MAUI_03511109] [Wristband]Patch back to W1418MP.
 * patch back wristband new feature
 *
 * 06 12 2014 shengxi.xu
 * [MAUI_03504697] [UI] ?main menu?????????????????; ????
 * .
 *
 * 06 02 2014 shengxi.xu
 * [MAUI_03503100] [Known Issue][Tiny System]Should not enter tiny system when back light is light
 * .
 *
 * 05 20 2014 lindun.tang
 * [MAUI_03491198] new feature of touchscreen on wearable device
 * patch back wearable device new feature
 *
 * 05 19 2014 ankur.saxena
 * [MAUI_03494083] [Wearable Device][FM Radio] Latest code check-in
 * FM Radio Wearable latest code check-in.
 *
 * 05 05 2014 hujin.hu
 * [MAUI_03495461] [BT Box] BTB Feature check in to 11C & 11CW1418MP from 11CW1412OF_BTBOX_DEV
 * .
 *
 * 03 18 2014 rid.chen
 ...
 * .
 *
 * 01 15 2014 shengxi.xu
 * [MAUI_03483070] [BT box] BT box wo LCD check in to 11C
 * .
 *
 * 01 15 2014 hujin.hu
 * [MAUI_03483070] [BT box] BT box without LCD feature check in to 11C
 * BTbox w/o patch back to 11C.
 *
 * 01 15 2014 xianggao.kong
 * [MAUI_03483070] [BT box] BT box wo LCD check in to 11C
 * App Slim for BTBOX wo LCD.
 *
 * 12 24 2013 lindun.tang
 * [MAUI_03481143] 11C iot code check in
 * check in IOT code to 11C
 *
...
<APP id="APP_CB_MGR">
	...
	<SENDER id="EVT_ID_KEY_CLICK_SINGLE" hfile="GlobalResDef.h"/>
	<SENDER id="EVT_ID_KEY_CLICK_DOUBLE" hfile="GlobalResDef.h"/>
#endif

#if defined(__MMI_WEARABLE_DEVICE__)
	<SENDER id="EVT_ID_WEARABLE_DEVICE_MOVE_LEFT" hfile="GlobalResDef.h"/>
	<SENDER id="EVT_ID_WEARABLE_DEVICE_MOVE_RIGHT" hfile="GlobalResDef.h"/>
#endif
...
#if !defined(__COSMOS_MMI_PACKAGE__) && defined(__PXS_APP_ENABLE__) && defined (__MMI_GSM_CALL_SUPPORT__)
...
#endif
	#if !defined( __COSMOS_MMI_PACKAGE__) && !defined(__IOT_NO_MULTIMEDIA__)
  ...
  #endif
#if !defined(__COSMOS_MMI_PACKAGE__) && defined(__MMI_SAFE_MODE__) && !defined(__IOT__)
...
#endif
	#if defined(__MMI_INTERACTIVE_PROFILNG__) && !defined(__IOT__)
	...
	#endif
	#if defined(__MMI_GSM_CALL_SUPPORT__) && !defined(__IOT__)
    ...
    <RECEIVER id="EVT_ID_PRE_TOUCH_EVT_ROUTING" proc="mmi_pre_touch_routing_handle"/>
    <RECEIVER id="EVT_ID_PRE_KEY_EVT_ROUTING" proc="mmi_pre_key_routing_handle"/>
#endif
    ...
    <SENDER id="EVT_ID_SRV_UCM_BT_ACTION_NOTIFY" hfile="UcmSrvGprot.h"/>
    <SENDER id="EVT_ID_SRV_UCM_BT_INDICATION" hfile="UcmSrvGprot.h"/>
#endif
    ...
    #if defined(__MMI_TELEPHONY_SUPPORT__) && !defined(__IOT__)
...
#if defined(__PLUTO_MMI_PACKAGE__) && defined(__MMI_BACKLIGHT_SUPPORT__)
#if !defined(__IOT__)
...
#if	(!defined(__IOT__) || defined(__LINKIT_DEV_KIT__))
...
#ifndef __COSMOS_MMI_PACKAGE__
#if !defined(__IOT__) && !defined(__KEEP_LCD_ENGINE_ON__)
...
#if defined(__MMI_BT_SUPPORT__) && !defined(__IOT__)
...
/*********************************input event**************************************************************/
    ...
    <SENDER id="EVT_ID_INPUT_EVENT_APP_SWITCH" hfile="GlobalResDef.h"/>
	<SENDER id="EVT_ID_BTB_CHANGE_VISIBILITY" hfile="GlobalResDef.h"/>
    <SENDER id="EVT_ID_BTB_CONNECT" hfile="GlobalResDef.h"/>
	<SENDER id="EVT_ID_BTB_DISCONNECT" hfile="GlobalResDef.h"/>
	<SENDER id="EVT_ID_BTB_RESET" hfile="GlobalResDef.h"/>
    <SENDER id="EVT_ID_INPUT_EVENT_LAUNCH_AUDPLY" hfile="GlobalResDef.h"/>
    #ifdef __MMI_FM_RADIO__
    <SENDER id="EVT_ID_INPUT_EVENT_LAUNCH_FM" hfile="GlobalResDef.h"/>
    #endif
    #ifdef __MMI_MEGAPHONE_SUPPORT__
    <SENDER id="EVT_ID_INPUT_EVENT_LAUNCH_MEGAPHONE" hfile="GlobalResDef.h"/>
    #endif
#endif
/*********************************input event end**************************************************************/
