...
extern MMI_BOOL gui_asyncdynamic_list_loading_error;
...
#define gui_show_asyncdynamic_list_menu gui_show_dynamic_list_menu_int
//extern void gui_show_asyncdynamic_list_menu_no_draw(fixed_list_menu *m);
#define gui_show_asyncdynamic_list_menu_no_draw(_arg) gui_show_list_menu_no_draw(_arg)
...
#else/*defined(__SOCIAL_NETWORK_SUPPORT__) || defined(__MMI_UM_CONVERSATION_BOX_ENHANCE__)*/
#define gui_asyncdynamic_list_menu_goto_item(_arg0, _arg1) gui_list_menu_goto_item(_arg0, _arg1)
#define gui_asyncdynamic_list_menu_goto_next_item(_arg)  gui_list_menu_goto_next_item(_arg)
#define gui_asyncdynamic_list_menu_goto_previous_item(_arg) gui_list_menu_goto_previous_item(_arg)
...
#define gui_asyncdynamic_list_menu_locate_highlighted_item(_arg) gui_list_menu_locate_highlighted_item(_arg)
...
extern void gui_asyncdynamic_menu_switch_highlighted_item(void *m, S32 last_highlighted_item);
//extern void gui_asyncdynamic_list_menu_switch_highlighted_item(fixed_list_menu *m, S32 last_highlighted_item);
#define gui_asyncdynamic_list_menu_switch_highlighted_item gui_asyncdynamic_menu_switch_highlighted_item
...
#define gui_asyncdynamic_matrix_menu_switch_highlighted_item(_arg0, _arg1) gui_asyncdynamic_menu_switch_highlighted_item(_arg0, _arg1)
#endif  /* __MMI_SUPPORT_ASYNCDYNAMIC_MATRIX_MENU__ */
