...
#else
	{
        SRV_PROF_VOL_LEVEL_4, SRV_PROF_VOL_LEVEL_2, SRV_PROF_VOL_LEVEL_4, SRV_PROF_MEDIA_VOL_LEVEL_4, SRV_PROF_ALERT_TYPE_RING,KAL_TRUE,KAL_FALSE,SRV_PROF_RING_TYPE_REPEAT,
