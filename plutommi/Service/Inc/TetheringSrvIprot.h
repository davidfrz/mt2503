...
*****************************************************************************/
#ifdef __IOT__
#define SRV_APMODE_MAX_SWITCH_REQ_INFO_NUM              5
#endif
...
typedef struct
{
    ...
    void *user_data;
}srv_apmode_switch_req_info_struct;
#endif
...
#ifdef __IOT__
    srv_apmode_switch_req_info_struct apmode_switch_on_callback;
    srv_apmode_switch_req_info_struct apmode_switch_off_callback;
#endif
