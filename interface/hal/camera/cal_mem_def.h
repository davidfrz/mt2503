...
#if ((defined(MT6252) || defined(MT6255)|| defined(MT6250)|| defined(MT6256)|| defined(MT6260)|| defined(MT6261)|| defined(MT2501)|| defined(MT2502)) && !defined(__CAMCO_QUICK_VIEW_ROTATE_SHRAE_APP_MEM__) && !defined(__CAMERA_NO_NEED_QUICK_VIEW_ROTATE__)) /* QVI rotate buffer from APP to reduce memory usage */
