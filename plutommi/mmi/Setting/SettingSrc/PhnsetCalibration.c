...
#include "csci.h"
#include "AP_BtSS.h"
#endif /*defined(__TINY_SYS__) && defined( __MMI_WEARABLE_DEVICE__)*/
...
static void mmi_phnset_entry_calibration_scrn(mmi_scrn_essential_struct *scrn_data)
{
	...
	#if defined(__TINY_SYS__) && defined( __MMI_WEARABLE_DEVICE__)
    AP_BtSS_mode_block(SUSPEND, AP_BTSS_MODE_BLOCKER_PENCALIB);
    AP_BtSS_mode_block(HIBERNATION, AP_BTSS_MODE_BLOCKER_PENCALIB);
    #endif /*defined(__TINY_SYS__) && defined( __MMI_WEARABLE_DEVICE__)*/
...
static void ExitCalibrationSettingScr(void)
{
	...
	#if defined(__TINY_SYS__) && defined( __MMI_WEARABLE_DEVICE__) 
    AP_BtSS_mode_unblock(SUSPEND, AP_BTSS_MODE_BLOCKER_PENCALIB);
    AP_BtSS_mode_unblock(HIBERNATION, AP_BTSS_MODE_BLOCKER_PENCALIB);
    #endif /*defined(__TINY_SYS__) && defined( __MMI_WEARABLE_DEVICE__)*/
