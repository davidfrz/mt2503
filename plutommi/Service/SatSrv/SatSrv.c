...
case MSG_ID_MMI_SAT_DISPLAY_TEXT_IND:
...
case MSG_ID_MMI_SAT_GET_INKEY_IND:
...
case MSG_ID_MMI_SAT_GET_INPUT_IND:
...
case MSG_ID_MMI_SAT_CALL_SETUP_IND:
...
case  MSG_ID_MMI_SAT_PLAY_TONE_IND:
...
case	MSG_ID_MMI_SAT_SEND_SMS_IND:
case	MSG_ID_MMI_SAT_SEND_SS_IND:
case	MSG_ID_MMI_SAT_SEND_USSD_IND:
case	MSG_ID_MMI_SAT_SETUP_IDLE_DISPLAY_IND:
case	MSG_ID_MMI_SAT_SEND_DTMF_IND:

			break;
				
case   MSG_ID_MMI_SAT_LANG_NOTIFY_IND:
