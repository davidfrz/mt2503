...
static VMBOOL vm_diable_screenlock = VM_FALSE;
...
void vm_switch_backlight(VMINT turn_on)
{
    ...
    {
        srv_backlight_turn_on(SRV_BACKLIGHT_PERMANENT);
        if (vm_power_saving_controller.vm_power_saving_switch == TRUE)
        {
            srv_backlight_turn_on(SRV_BACKLIGHT_SHORT_TIME);
            srv_backlight_turn_off();
        }
...
/*****************************************************************************
 * FUNCTION
 *  vm_scrlocker_event_notify_handler
 * DESCRIPTION
 *  
 * PARAMETERS
 *  
 ...
 *  mmi_ret
 *****************************************************************************/
extern mmi_ret vm_scrlocker_event_notify_handler(mmi_event_struct *event)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
    ...
    {
        if (vm_diable_screenlock == VM_TRUE)
        {
            return MMI_RET_ERR;
        }
    }
