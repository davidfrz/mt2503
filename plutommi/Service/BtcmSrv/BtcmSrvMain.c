...
/* under construction !*/
    ...
    mmi_frm_set_multi_protocol_event_handler(MSG_ID_BT_BM_DISCOVERY_RESULT_IND, srv_bt_cm_discovery_result_ind_hdler);
	mmi_frm_set_multi_protocol_event_handler(MSG_ID_BT_BM_DISCOVERY_UPDATE_IND, srv_bt_cm_discovery_update_ind_hdler);
    mmi_frm_set_multi_protocol_event_handler(MSG_ID_BT_BM_DISCOVERY_CNF, srv_bt_cm_discovery_cnf_hdler);
    mmi_frm_set_multi_protocol_event_handler(MSG_ID_BT_BM_DISCOVERY_CANCEL_CNF, srv_bt_cm_cancel_discovery_cnf_hdler);
    ...
    SetProtocolEventHandler(srv_bt_cm_remote_name_ind_hdler, MSG_ID_BT_BM_REMOTE_NAME_IND);
