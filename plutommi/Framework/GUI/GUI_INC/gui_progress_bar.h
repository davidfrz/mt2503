...
//volumn bar define
#ifdef __MMI_WEARABLE_DEVICE__
//#define MMI_VOLUME_BAR_SLOT_GAP			1
#define MMI_VOLUME_BAR_BG_TOP_OFFSET 	3
#define MMI_VOLUME_BAR_BG_LEFT_OFFSET 	3
#endif
...
typedef struct __gui_watch_progress_bar_struct_type
{
    U16 x; //volume bar location
    U16 y;
    U16 max_value;
    U16 level_value;
} gui_watch_progress_bar_struct;
#else
typedef struct __gui_volume_bar_struct_type
{
	U8 bg_opacity;
    U16 x; //volume bar location
    U16 y;
	...
	gdi_color normal_color;
	MMI_BOOL show_bg;
} gui_volume_bar_struct;
