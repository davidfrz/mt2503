...
extern kal_bool l4c_set_sim_capability_req(kal_uint8 src_id, kal_uint8 setting, l4c_rat_enum new_rat);
extern kal_bool l4c_get_sim_capability_req(kal_uint8 *setting);
