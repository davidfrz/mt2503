...
kal_bool IOT_create(comptask_handler_struct **handle) 
{
    return KAL_FALSE;
}

void iot_daemon_init(void)
{
}
#endif
#endif
    ...
    const mmi_bootup_init_table_entry_struct *table)
{
    ...
    for (entry = table; entry->hdlr != NULL; entry++)
    {
        ...
        prev_tick = curr_tick;
        kal_get_time(&curr_tick);
        MMI_TRACE(MMI_COMMON_TRC_FUNC, TRC_FRM_BOOTUP_INIT_TIME,
...
void mmi_bootup_early_init(void)
{
    ...
    MMI_TRACE(MMI_BOOTUP_TRC_GROUP, TRC_FRM_BOOTUP_EARLY_INIT, '{');
    ...
    const mmi_frm_proc_id_info_struct id_info)
{
    ...
    MMI_TRACE(MMI_BOOTUP_TRC_GROUP, TRC_FRM_BOOTUP_NORMAL_INIT, '{');
...
void mmi_bootup_notify_before_idle(void)
{
    ...
    MMI_TRACE(MMI_BOOTUP_TRC_GROUP, TRC_FRM_BOOTUP_BEFORE_IDLE, '{');
...
void mmi_bootup_notify_completed(void)
{
    ...
    MMI_TRACE(MMI_BOOTUP_TRC_GROUP, TRC_FRM_BOOTUP_COMPLETED, '{');
