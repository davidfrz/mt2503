...
#elif defined(MT2502)
{
    switch (numLpo)
    {
          ...
          case (GPS_LPO_GPIO_NUM | 36): //CLKM2
              ...
              GPS_GPIO_SetClkOut(2, mode_f32k_ck);
              break;
          case (GPS_LPO_GPIO_NUM | 41): //CLKM3
              modeLpo = 2;
              GPS_GPIO_SetClkOut(3, mode_f32k_ck);
              break;
     }
...
#if defined (MT6260)||defined (MT6250)|| defined (MT6252)|| defined (MT6255)||defined (MT6256)||defined (MT6261)||defined (MT2502)/* avoid one EINT number -> multiple GPIO PIN */
