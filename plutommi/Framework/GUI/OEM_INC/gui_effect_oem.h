...
#define SWATCH_MIN_FREE_RUN_MOMENTUM 30
...
#define GUI_MENU_SSP_POS_DELTA      6
#else
...
#define GUI_SSP_FOCUS_TO_HOLD_STATE_Y_THRESHOLD_STEP    1
	...
	#define GUI_SSP_FOCUS_TO_HOLD_STATE_Y_THRESHOLD 2   /* focus to hold state y absolute movement threshold */
	#else
...
#ifdef __MMI_WEARABLE_DEVICE__
#define GUI_SSP_MENU_OVER_LIMIT_COEFFICIENT     0.5F
#else
#define GUI_SSP_MENU_OVER_LIMIT_COEFFICIENT     0//0.5F /* menu height ratio for over limit operation */
#endif /*__MMI_WEARABLE_DEVICE__*/

#ifdef __MMI_WEARABLE_DEVICE__
#define GUI_SSP_MENU_TRIGGER_FREE_RUN_COEFFICIENT_MIN     0.2F
#define GUI_SSP_MENU_TRIGGER_FREE_RUN_COEFFICIENT_MAX     1.0F
#define GUI_SSP_MENU_TRIGGER_FREE_RUN_COEFFICIENT_STEP    0.1F

#define GUI_SSP_MENU_TRIGGER_FREE_RUN_COEFFICIENT    0.2F

#ifdef  __MMI_SCREEN_SWITCH_EFFECT__
#define GUI_SSP_SUPPORT_FOOTER_AREA_NO_CHANGE
...
#if defined(__MMI_MAINLCD_240X240__)
#define NO_CHANGE_AREA_MAX_HEGITH 25
#define NO_CHANGE_AREA_TEMP_DATA_BUFFER (GDI_LCD_WIDTH * NO_CHANGE_AREA_MAX_HEGITH * GUI_SCREEN_SWITCH_EFFECT_PIXEL_BYTE_SIZE)
#else
#define NO_CHANGE_AREA_MAX_HEGITH 25
#define NO_CHANGE_AREA_TEMP_DATA_BUFFER (GDI_LCD_WIDTH * NO_CHANGE_AREA_MAX_HEGITH * GUI_SCREEN_SWITCH_EFFECT_PIXEL_BYTE_SIZE)
#endif

extern void gui_effect_some_area_slide_no_change_frame(MMI_BOOL no_change_flag,U16 no_change_height,U16 start_y );
#endif
...
typedef struct _gui_list_ssp_parameter_struct
{
    ...
    // range: [3, 40], step: 1
	float g_gui_ssp_menu_trigger_free_run_coefficient;
...
typedef enum
{
    ...
    GUI_SSE_SCENARIO_WEARABLE_CLOCK_SLIDE_UP,
    GUI_SSE_SCENARIO_WEARABLE_CLOCK_SLIDE_DOWN,
