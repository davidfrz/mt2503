...
#endif /*__FLAVOR_PLUTO_QVGA_CLIENT_AUTH_*/
...
U32 session_handle1;
U32 session_handle2;
int* app_mem_alloc(int size)
{
    return (int*)OslMalloc(size);
}
...
handle_inet_srv_response1(void)
{
}
handle_inet_srv_response2(void)
{

}
void dummy_invoke_certman_client_auth_public(void)
{
	
	S32 ret;
	U32 req_handle = 0;
	session_handle1 =0;
	session_handle1 = srv_inet_session_new( &app_mem_alloc, &app_mem_free);
	
     req_handle = srv_inet_http_req_new( session_handle1,
                                    SRV_INET_HTTP_METHOD_GET,
                                    SRV_INET_HTTP_OPTION_NO_CACHE,
                                    "https://182.71.30.232:6087");
                                    
	ret= srv_inet_http_send_request( session_handle1,
                            req_handle,
                            NULL,
                            NULL,
                            0,
                            NULL,
                            &handle_inet_srv_response1);
	
}
void dummy_invoke_certman_client_auth_internal(void)
{
	//U32 session_handle;
	S32 ret;
	U32 req_handle = 0;
	session_handle2 =0;
	session_handle2 = srv_inet_session_new( &app_mem_alloc, &app_mem_free);
	
     req_handle = srv_inet_http_req_new( session_handle2,
                                    SRV_INET_HTTP_METHOD_GET,
                                    SRV_INET_HTTP_OPTION_NO_CACHE,
                                    "https://172.25.39.12:6087");
	
	ret= srv_inet_http_send_request( session_handle2,
                            req_handle,
                            NULL,
                            NULL,
                            0,
                            NULL,
                            &handle_inet_srv_response2);
	
}
void dummy_close_internal(void)
{
S32 ret;
ret=srv_inet_session_close(session_handle2);
}
void dummy_close_public(void)
{
S32 ret;
ret=srv_inet_session_close(session_handle1);
}
#endif
