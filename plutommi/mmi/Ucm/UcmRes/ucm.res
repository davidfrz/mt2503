...
>
  ...
  <RECEIVER id="EVT_ID_SRV_UCM_ACTION_NOTIFY" proc="vm_ivr_handler"/>
    ...
    <RECEIVER id="EVT_ID_PRE_TOUCH_EVT_ROUTING" proc="mmi_ucm_pre_touch_hdlr"/>
...
#ifdef __MMI_WEARABLE_DEVICE__
    <TIMER id="UCM_VOL_BAR_SHOW_TIMER"/>
    <TIMER id="UCM_VOL_STR_SHOW_TIMER"/>
#endif /* __MMI_WEARABLE_DEVICE__ */
...
#if defined(__MMI_WEARABLE_DEVICE__) && !defined(__MMI_BT_CALL_SUPPORT__)
...
#endif /* __MMI_WEARABLE_DEVICE__ && !__MMI_BT_CALL_SUPPORT__ */
...
#ifdef __MMI_WEARABLE_DEVICE__
    <SCREEN id="GRP_ID_UCM_HW_CNF"/>
    <SCREEN id="SCR_ID_UCM_HW_CNF"/>
#endif /* __MMI_WEARABLE_DEVICE__ */
