...
{   
   ...
   // GDI_HANDLE target_layer, abm_layer;
	...
	if(!MMI_softkeys[(WGUI_SOFTKEY_ENUM)key].height)
	{
		return;
	}
#endif
    ...
    #endif
            {
                ...
                if (mmi_frm_is_screen_width_height_swapped())
                {
                    ...
                    show_softkey_background_with_clipping(
                      ...
                      show_softkey_background_with_clipping(
                        b.x - offset_x,
                        UI_device_height - MMI_softkeys[key].height - offset_y,
                        b.x + b.width - 1 - offset_x,
                        UI_device_height - 1 - offset_y); 
				#else
                    show_softkey_background_with_clipping(
...
#if defined( __MMI_MAINLCD_176X220__) || (defined (__MMI_MAINLCD_240X320__)&& !defined(__MMI_WEARABLE_DEVICE__)) || defined (__MMI_MAINLCD_320X240__) || defined (__MMI_MAINLCD_240X400__) || defined (__MMI_MAINLCD_128X160__) || defined (__MMI_MAINLCD_320X480__) || defined (__MMI_MAINLCD_360X640__) || defined (__MMI_MAINLCD_480X800__)
...
//    gui_fill_rectangle(x1, y1, x2, y2, c);
    ...
    if (current_MMI_theme->softkey_bar_bkg_filler)
	{
		...
		if (wgui_softkey_is_in_popup())
		{
            ...
            UI_device_width - 1,
            UI_device_height - 1,
            current_MMI_theme->popup_screen_bg_filler);
		}
		else
