...
#if defined(__IOT__)
#define SRV_BT_CM_IOT_MASK_ON                      0x01
#define SRV_BT_CM_IOT_MASK_ON_IN_FLIGHT_MODE       0x02
#define SRV_BT_CM_IOT_MASK_OFF_BY_FLIGHT_MODE      0x04
#define SRV_BT_CM_IOT_MASK_ON_BY_FLIGHT_MODE       0x08
#define SRV_BT_CM_IOT_MASK_JUST_NOTIFY_FLIGHT_MODE 0x10
#endif
#ifdef __MMI_BTBOX_NOLCD__
#define BOX_MASTER_NAME "BTB_MASTER"
#define BOX_COD (0x6a0204)//(SRV_BT_AUDIO_MAJOR_SERVICE_MASK)  //0x200000 (0x240404)
...
#endif  //__MMI_BTBOX_NOLCD__
#ifdef __TINY_SYS__
	/* the power mode: 0-manual selected, 1-auto switch on when bootup or back from H mode*/
	U8 tiny_switch_on_mode; 	
#endif
