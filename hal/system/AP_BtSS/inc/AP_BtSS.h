...
#define get_duration(prev, cur) (((cur) >= (prev))? (((cur) - (prev))): ((0xFFFFFFFF - (prev) + (cur))))
...
enum AP_BtSS_blocker
{
	...
	AP_BTSS_MODE_BLOCKER_USB = BIT(2),
	AP_BTSS_MODE_BLOCKER_RTC    = BIT(3),
	AP_BTSS_MODE_BLOCKER_CLOCK = BIT(4),
	AP_BTSS_MODE_BLOCKER_BT = BIT(5),
	AP_BTSS_MODE_BLOCKER_CLOCK_SLEEP = BIT(6),
	AP_BTSS_MODE_BLOCKER_CATCHER = BIT(7),
	AP_BTSS_MODE_BLOCKER_PENCALIB = BIT(8),
	AP_BTSS_MODE_BLOCKER_MCSV = BIT(9),
	AP_BTSS_MODE_BLOCKER_BMT = BIT(10),
