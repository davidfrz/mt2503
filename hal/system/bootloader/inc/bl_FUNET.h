...
#define COMPRESSED_BIN_MAGIC 0xCA1234B7

#define FUNET_PKG_PATH             L"Z:\\@fota_iot\\image.bin"
#define UI_PATH                    L"Z:\\@fota_iot_data\\update_info"
#define UPDATED_STATUS_PATH        L"Z:\\@fota_iot_data\\update_status"
...
#define BL_FUNET_ERROR_DECOMPRESSION                                      (-327)
...
#define BL_FUNET_ERROR_UBIN_ADDR_NOT_MATCH_WITH_TARGET                    (-417)
#define BL_FUNET_ERROR_UBIN_SIZE_OVER_MAXIMUM                             (-418)
#define BL_FUNET_ERROR_UBIN_BUILD_TIME_NOT_MATCH                          (-419)
#define BL_FUNET_ERROR_UBIN_PROJECT_ID_NOT_MATCH                          (-420)
...
#define BL_FUNET_ERROR_DECOMPRESSED_READ_FAIL                             (-1109)//new
