...
#if defined(DRV_RTC_BBPU_AS_6276) || defined(DRV_RTC_BBPU_AS_6260)
  #define RTC_BBPU_PWR_SW	            0x0004 
  #define RTC_BBPU_AUTOPDN            0x0008
  #define RTC_BBPU_CLRPKY            0x0010
  #define RTC_BBPU_RELOAD            0x0020
...
#if defined(__DRV_MISC_POWER_SWITCH__)
  #define RTC_BBPU_PWR_SW           0x0000 
  #define RTC_BBPU_ALARM_SW         0x0000
#endif
...
#if defined(DRV_RTC_BBPU_AS_6260)
   #define RTC_BBPU_POWERON        (RTC_BBPU_PWR_SW|RTC_BBPU_AUTOPDN|RTC_BBPU_KEY)
   #define RTC_BBPU_POWEROFF       (RTC_BBPU_ALARM_SW|RTC_BBPU_AUTOPDN|RTC_BBPU_KEY)
#endif   /*DRV_RTC_BBPU_AS_6260*/
...
extern kal_bool RTC_is_Extend_To_Keep_RTC_Time(void);
#endif
