...
static mmi_ret mmi_bootup_sec_key_proc(mmi_event_struct *evt)
{
    ...
    MMI_TRACE(MMI_BOOTUP_TRC_GROUP, TRC_FRM_BOOTUP_SEC_KEY_ON_PASSWORD,
                ...
                WCHAR *str_buffer)
{
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
    MMI_TRACE(MMI_BOOTUP_TRC_GROUP, TRC_FRM_BOOTUP_PHONE_VERIFICATION);
                    ...
                    WCHAR *str_buffer)
{
    ...
    MMI_TRACE(MMI_BOOTUP_TRC_GROUP, TRC_FRM_BOOTUP_SIM_VERIFICATION, sim, veri_type);
                            ...
                            const mmi_frm_proc_id_info_struct id_info)
{
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
    MMI_TRACE(MMI_BOOTUP_TRC_GROUP, TRC_FRM_BOOTUP_FLOW_SECURITY);
