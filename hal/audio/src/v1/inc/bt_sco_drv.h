...
#define BT_CVSD_VOC_DEBUG         0
#if BT_CVSD_VOC_DEBUG
#define BT_CVSD_VOC_RX_DEBUG      0
#define BT_CVSD_VOC_TX_DEBUG      0
#endif

#if defined(BT_DIALER_SPE_FOR_LOUDSPEAKER) && defined(__VM_CODEC_SUPPORT__) 
#define BT_VM_EPL_DEBUG           1
#endif
