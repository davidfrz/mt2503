...
#if !defined(__IOT_NO_MULTIMEDIA__) && !defined(__GPS_ADAPTOR_SUPPORT__)
    MMI_BOOTUP_INIT_REG(mdi_gps_uart_init)
#endif
    MMI_BOOTUP_INIT_REG(gps_uart_state_init)
#if !defined(__IOT__) && !defined(__GPS_ADAPTOR_SUPPORT__)
...
#endif
#if defined(__TCPIP__) && !defined(__IOT__)    
...
#elif defined(__MMI_TELEPHONY_SUPPORT__) && !defined(__BOOTUP_BT_POWER_OFF__)
    MMI_BOOTUP_INIT_REG(srv_bt_cm_init_power)
#endif
#endif
#if !defined(__IOT__)
...
#endif
#endif
#ifdef __MMI_MODSMSAL_FOR_BTBOX__
...
#endif
#if defined(__MMI_MRE_AUTO_START__) && !defined(__IOT__)
...
#endif
#if defined(__MMI_AUTO_KEYPAD_LOCK__) && !defined(__IOT__)
...
#endif
#if defined (__MULTI_THREAD_SUPPORT__)
	MMI_BOOTUP_INIT_REG(app_frm_thread_init)
#endif

#if	(defined(__MMI_WLAN_FEATURES__) && defined(__MULTI_THREAD_SUPPORT__) && defined(__IOT__))
    MMI_BOOTUP_INIT_REG(mmi_frm_mapping_ports_init)
#endif
//#if !defined(__IOT__) 
...
#endif
#if defined(__MMI_TELEPHONY_SUPPORT__) && defined(__UM_SUPPORT__)
...
#endif
#if defined(__CERTMAN_SUPPORT__) && !defined(__IOT__)
...
#endif
#endif /* __MMI_MODSMSAL_FOR_BTBOX__ */
#ifdef __MMI_TELEPHONY_SUPPORT__
	MMI_BOOTUP_INIT_ADP(srv_sim_acess_init)
#endif
#if defined(__MMI_MODSMSAL_FOR_BTBOX__) || defined(__MMI_TELEPHONY_SUPPORT__)
    MMI_BOOTUP_INIT_ADP(srv_sms_init)
#ifndef __IOT__
    MMI_BOOTUP_INIT_ADP(InitMessagesApp)
#endif
#endif /* defined(__MMI_MODSMSAL_FOR_BTBOX__) || defined(__MMI_TELEPHONY_SUPPORT__) */
...
#endif
#if defined(__MMI_ENGINEER_MODE__) && !defined(__IOT__)    /* For saperate MMI feature by project */
    MMI_BOOTUP_INIT_ADP(InitEngineerMode)
#endif
#if defined(__MMI_FACTORY_MODE__) && !defined(__IOT__)     /* For saperate MMI feature by project */
    MMI_BOOTUP_INIT_ADP(InitFactoryMode)
#endif
#if defined(__MMI_FILE_MANAGER__) && !defined(__IOT__)
...
/* under construction !*/
#endif
#if defined(__MMI_SOUND_RECORDER__) && !defined(__IOT__)
...
#else /* IOT */
   	MMI_BOOTUP_INIT_ADP(srv_bt_cm_init) 
#ifdef __MMI_SPP_SUPPORT__
	MMI_BOOTUP_INIT_ADP(srv_spp_init)
#endif /* __MMI_SPP_SUPPORT__*/
#if defined(__MMI_BT_NOTI_SRV__) && defined(__MMI_SPP_SUPPORT__)
	  MMI_BOOTUP_INIT_ADP(mmi_bt_spp_init)
#endif /* defined(__MMI_BT_NOTI_SRV__) && defined(__MMI_SPP_SUPPORT__) */
#ifdef __MMI_A2DP_SUPPORT__
    MMI_BOOTUP_INIT_ADP(srv_a2dp_init)
#endif /*__MMI_A2DP_SUPPORT__*/
#if !defined(__LINKIT_DEV_KIT__)
    MMI_BOOTUP_INIT_ADP(bt_switch_mode_app_init)
#endif
#endif /* IOT */
...
#endif /* __SOCIAL_NETWORK_SUPPORT__ */
#if defined(__MMI_SAFE_MODE__)&&!defined(__IOT__)
	MMI_BOOTUP_INIT_REG(mmi_safe_mode_main_evt_hdlr)
#endif

#if defined(__MMI_SAFE_MODE__)&& defined(__IOT__)&& defined(__LINKIT_DEV_KIT__) && defined(__MTK_TARGET__)
	MMI_BOOTUP_INIT_REG(srv_mre_appmgr_handle_bootup_early_init)
#endif

#if defined(__LCD_COLOR_ENGINE_SUPPORT__) && !defined(__IOT__)
