...
BEGIN_TRACE_MAP(MOD_GPSADAPTOR)
   ...
   /* --------------------------------------------------------------- */
    ...
    TRC_MSG(GPSADAPOOR_EPODOWNLOAD_BT_DOWNLOAD_SUCCESS, "[epodownload]:bt download success.\n")
    TRC_MSG(GPSADAPOOR_EPODOWNLOAD_EPOFILE_ACCESS_OWNER, "[epodownload]:(0:NONE;1:MNL;2:GPRS;3:BT)  owner=%d.\n")
