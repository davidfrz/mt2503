...
#if (defined( __MMI_BT_APPLICATION_BQB__ ) && defined(__MMI_WEARABLE_DEVICE__)) || defined(__MMI_BT_APK_SMART_INSTALL_SUPPORT__)
#include "custom_btcm_config.h"
extern void mmi_bt_send_smart_phone_apk(MMI_ID parent_id, srv_bt_cm_bt_addr* dev_addr);
