...
typedef enum
{
    MENU_ID_IMGVIEW_APP = 35014 + 1, /* BASE_ID + 1 */
...
typedef enum
{
    STR_ID_IMGVIEW_NAME = 35014 + 1, /* BASE_ID + 1 */
...
typedef enum
{
    SCR_ID_IMGVIEW_VIEW = 35014 + 1, /* BASE_ID + 1 */
...
typedef enum
{
    NVRAM_IMGVIEW_VIEW_SYTLE = 35014 + 1, /* BASE_ID + 1 */     /*         BYTE */ 
...
typedef enum
{
    IMG_ID_IMGVIEW_MAIN_ICON = 35014 + 1, /* BASE_ID + 1 */
    IMG_ID_IV_ERROR,
    IMG_ID_IV_LOAD,
