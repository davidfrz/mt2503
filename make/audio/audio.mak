...
SRC_LIST += $(strip $(AUDFOLDER))\Sal_exp.c
SRC_LIST += $(strip $(AUDFOLDER))\Sal_impl.c
...
ifneq ($(filter __DUAL_TALK_MODEM_SUPPORT__, $(strip $(MODULE_DEFS))),)
   ifeq ($(strip $(PLATFORM)),MT6261)
     ...
     SRC_LIST += $(strip $(AUDFOLDER))\spc_bgSnd.c \
                 $(strip $(AUDFOLDER))\spc_io.c \
                 $(strip $(AUDFOLDER))\pcmrec_drv.c \
                 $(strip $(AUDFOLDER))\sidetone.c
   else
      SRC_LIST += $(strip $(AUDFOLDER))\spc_drv_6252.c
