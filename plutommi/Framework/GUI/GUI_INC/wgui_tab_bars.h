...
#define UI_MAX_TAB_BAR_ITEMS   5 //  20
...
/* one wgui_tab_struct include several mmi_frm_tab_struct
*  wgui_tab_struct is a manager group 
*  mmi_frm_tab_struct is screen and related tab bar info.
*/
#if defined(__MMI_FTE_SUPPORT__) && defined(__MMI_BT_DIALER_SUPPORT__) && defined(__MMI_PHB_UI_IN_TABS__)
#define MMI_MAX_TAB_INST  5
#elif defined(__MMI_PHB_UI_IN_TABS__)
#define MMI_MAX_TAB_INST  4
#else 
#define MMI_MAX_TAB_INST  3
#endif
...
typedef struct
{
    ...
    U8 tab_pages_count;
    U8 sel_idx;    
    U8 *gui_buf[UI_MAX_TAB_BAR_ITEMS];
    WCHAR *input_buf[UI_MAX_TAB_BAR_ITEMS];    
    void *user_data;
    mmi_frm_tab_struct tab_bar_info[UI_MAX_TAB_BAR_ITEMS];    
}wgui_tab_struct;
