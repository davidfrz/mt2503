...
//huking    
    menu_theme.disabled_filler = current_menuitem_theme->disabled_filler;
    menu_theme.disabled_text_color = current_menuitem_theme->disabled_text_color;
    menu_theme.flags = current_menuitem_theme->flags;
    menu_theme.focussed_text_color = current_menuitem_theme->focussed_text_color;
    menu_theme.normal_filler = current_menuitem_theme->normal_filler;
    menu_theme.normal_text_color = current_menuitem_theme->normal_text_color;
    menu_theme.selected_text_color = current_menuitem_theme->selected_text_color;
    menu_theme.text_font = current_menuitem_theme->text_font;
