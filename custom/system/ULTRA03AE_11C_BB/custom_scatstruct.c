...
kal_uint32 custom_query_dump_region(EXTSRAM_REGION_INFO_T* region)
{
    ...
    region[1].addr = (kal_uint32)&Image$$DYNAMIC_CACHEABLE_EXTSRAM_DEFAULT_NONCACHEABLE_ZI_MMIPOOL$$Base;
    region[1].len = (kal_uint32)&Image$$DYNAMIC_CACHEABLE_EXTSRAM_DEFAULT_NONCACHEABLE_RW$$ZI$$Limit - region[1].addr;
    region[2].addr = (kal_uint32)&Image$$SINGLE_BANK_CODE$$Base;
    region[2].len = (kal_uint32)&Image$$EXTSRAM$$ZI$$Limit - region[2].addr;
    region[3].addr = (kal_uint32)&Image$$EXTSRAM_DSP_TX$$Base;
    region[3].len = 0x6000;
    region[4].addr = (kal_uint32)&Image$$EXTSRAM_DSP_RX$$Base;
    region[4].len = 0xf000;
    ...
    region[7].len = (kal_uint32)&Image$$EXTSRAM_GADGET$$ZI$$Limit - region[7].addr;
    region[8].addr = (kal_uint32)&Image$$DYNAMIC_CACHEABLE_EXTSRAM_DEFAULT_NONCACHEABLE_ZI_MMIPOOL$$Base;
    region[8].len = (kal_uint32)&Image$$DYNAMIC_CACHEABLE_EXTSRAM_DEFAULT_NONCACHEABLE_RW$$ZI$$Limit - region[8].addr;
    region[8].addr = MAP2CREGVA(region[8].addr);
