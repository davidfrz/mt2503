...
typedef enum
{
    ...
    MDI_GPS_UART_MODE_DEBUG_RAW_DATA
...
typedef struct
{
    ...
    void            (*gps_uart_debug_raw_cb[MDI_GPS_UART_APP_PER_PORT_MAX])(mdi_gps_parser_info_enum type, void *buffer, U32 length);           /*uart port number*/
    S16             port;
    MMI_BOOL        is_opened;
