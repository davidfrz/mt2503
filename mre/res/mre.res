...
<APPCONCURRENT concurrent_w_order ="APP_MRE, VAPP_CBM"/>
    ...
    <RECEIVER id="EVT_ID_SCREEN_LOCK_KEY_PRE_LOCK_EVT_ROUTING" proc="vm_scrlocker_event_notify_handler"/>
#endif
...
<RECEIVER id="EVT_ID_GPIO_AFTER_LCD_SLEEP_IN" proc="vm_timer_block_precise_timer_event_notify_handler"/>
...
#endif
        <RECEIVER id="EVT_ID_SRV_CHARBAT_NOTIFY" proc="mmi_mre_battery_status_notify_hdlr"/>
    <RECEIVER id="EVT_ID_SRV_UCM_ACTION_NOTIFY" proc="vm_call_int_ind_handler"/>
    <RECEIVER id="EVT_ID_SRV_UCM_INDICATION" proc="vm_call_int_ind_handler"/>
    <RECEIVER id="EVT_ID_SRV_UCM_STATUS_CHANGE" proc="vm_call_int_ind_handler"/>
#ifdef __MRE_SAL_BTCM__
#ifdef __BT_4_0_BLE__
    <RECEIVER id="SRV_LE_CM_EVENT_CONNECT_REQ" proc="vm_ble_int_event_handler"/>
    <RECEIVER id="SRV_LE_CM_EVENT_CONNECT_CNF" proc="vm_ble_int_event_handler"/>
    <RECEIVER id="SRV_LE_CM_EVENT_DISCONNECT_REQ" proc="vm_ble_int_event_handler"/>
    <RECEIVER id="SRV_LE_CM_EVENT_DISCONNECT_CNF" proc="vm_ble_int_event_handler"/>
    <RECEIVER id="SRV_LE_CM_EVENT_VIS_CNF" proc="vm_ble_int_event_handler"/>
    <RECEIVER id="SRV_LE_CM_EVENT_INQUIRY_IND" proc="vm_ble_int_event_handler"/>
    <RECEIVER id="SRV_LE_CM_EVENT_INQUIRY_COMPLETE" proc="vm_ble_int_event_handler"/>
    <RECEIVER id="SRV_LE_CM_EVENT_SET_VISIBILITY" proc="vm_ble_int_event_handler"/>
    <RECEIVER id="SRV_LE_CM_EVENT_UPDATE_NAME" proc="vm_ble_int_event_handler"/> 
...
<FILE_TYPES>
    ...
    defined (__FLAVOR_MRE_SDK_IOT__)  || \
    defined (__FLAVOR_MRE_SDK_WEARABLE__) ||\
    ...
    <RECEIVER id="EVT_ID_SRV_NW_INFO_STATUS_CHANGED" proc="vm_pmng_deal_nw_info_status_changed_event"/>
