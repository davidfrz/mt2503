...
void PopulateSSCRes()
{
	...
	ADD_APPLICATION_STRING2(SSC_SCR_LANGUAGE_ZAWGYI_STR_ID,"Language set to Zawgyi","Set Zawgyi SSC string screen.");
#endif
...
#if defined(__MMI_LANG_ZAWGYI_MYANMAR__) 
	ADD_APPLICATION_STRING2(SSC_STR_ERR_SET_ZAWGYI,"Error in Set Zwagyi Language","String assoicated with Error in Set Zawgyi.");
#endif
