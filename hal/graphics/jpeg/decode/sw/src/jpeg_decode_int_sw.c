...
#if defined(__MTK_TARGET__) && defined(__JPEG_PFMC_ENHANCE_USE_CACHE_LINE_PREFILL__)
#pragma arm section zidata = "INTSRAM_ZI"
volatile kal_uint32 g_dummy_data;
#pragma arm section zidata
#endif /* __MTK_TARGET__ && __JPEG_PFMC_ENHANCE_USE_CACHE_LINE_PREFILL__*/

//#define __JPEG_SW_PFMC_LOG_ENABLE__
...
//#define __USE_DRV_GET_CURRENT_TIME__

#if defined(__USE_DRV_GET_CURRENT_TIME__)
...
#else /* #if defined(__USE_DRV_GET_CURRENT_TIME__) */
#include "us_timer.h"
...
{\
  if (JPEG_DEC_PFMC_DATAIL_LOG_ENABLE)\
  {\
     jpeg_dec_pfmc_detail_log.huff_dec_start_time = ust_get_current_time();\
     if (0 == jpeg_dec_pfmc_detail_log.huff_dec_log_start[jpeg_dec_pfmc_detail_log.huff_dec_index])\
     {\
       jpeg_dec_pfmc_detail_log.huff_dec_exet_time[jpeg_dec_pfmc_detail_log.huff_dec_index] = 0;\
       jpeg_dec_pfmc_detail_log.huff_dec_log_start[jpeg_dec_pfmc_detail_log.huff_dec_index] = 1;\
...
{\
  ...
  {\
     ...
     jpeg_dec_pfmc_detail_log.huff_dec_end_time = ust_get_current_time();\
     jpeg_dec_pfmc_detail_log.huff_dec_exet_time[jpeg_dec_pfmc_detail_log.huff_dec_index] += ust_get_duration(jpeg_dec_pfmc_detail_log.huff_dec_start_time, jpeg_dec_pfmc_detail_log.huff_dec_end_time);\
  }\
}
...
{\
  if (JPEG_DEC_PFMC_DATAIL_LOG_ENABLE)\
  {\
     jpeg_dec_pfmc_detail_log.huff_dec_reset_start_time = ust_get_current_time();\
     if (0 == jpeg_dec_pfmc_detail_log.huff_dec_reset_log_start[jpeg_dec_pfmc_detail_log.huff_dec_reset_index])\
     {\
       jpeg_dec_pfmc_detail_log.huff_dec_reset_exet_time[jpeg_dec_pfmc_detail_log.huff_dec_reset_index] = 0;\
       jpeg_dec_pfmc_detail_log.huff_dec_reset_log_start[jpeg_dec_pfmc_detail_log.huff_dec_reset_index] = 1;\
...
{\
  ...
  {\
   ...
   {\
     ...
     jpeg_dec_pfmc_detail_log.huff_dec_reset_end_time = ust_get_current_time();\
     jpeg_dec_pfmc_detail_log.huff_dec_reset_exet_time[jpeg_dec_pfmc_detail_log.huff_dec_reset_index] += ust_get_duration(jpeg_dec_pfmc_detail_log.huff_dec_reset_start_time, jpeg_dec_pfmc_detail_log.huff_dec_reset_end_time);\
  }\
}
...
{\
  if (JPEG_DEC_PFMC_DATAIL_LOG_ENABLE)\
  {\
     jpeg_dec_pfmc_detail_log.idct_dec_start_time = ust_get_current_time();\
     if (0 == jpeg_dec_pfmc_detail_log.idct_dec_log_start[jpeg_dec_pfmc_detail_log.idct_dec_index])\
     {\
       jpeg_dec_pfmc_detail_log.idct_dec_exet_time[jpeg_dec_pfmc_detail_log.idct_dec_index] = 0;\
       jpeg_dec_pfmc_detail_log.idct_dec_log_start[jpeg_dec_pfmc_detail_log.idct_dec_index] = 1;\
...
{\
  ...
  {\
     if (0 == jpeg_dec_pfmc_detail_log.idct_dec_log_start[jpeg_dec_pfmc_detail_log.idct_dec_index])\
        { ASSERT(0);}\
     jpeg_dec_pfmc_detail_log.idct_dec_end_time = ust_get_current_time();\
     jpeg_dec_pfmc_detail_log.idct_dec_exet_time[jpeg_dec_pfmc_detail_log.idct_dec_index] += ust_get_duration(jpeg_dec_pfmc_detail_log.idct_dec_start_time, jpeg_dec_pfmc_detail_log.idct_dec_end_time);\
  }\
}
...
{\
  if (JPEG_DEC_PFMC_DATAIL_LOG_ENABLE)\
  {\
     jpeg_dec_pfmc_detail_log.frag_pro_start_time = ust_get_current_time();\
     if (0 == jpeg_dec_pfmc_detail_log.frag_pro_log_start[jpeg_dec_pfmc_detail_log.frag_pro_index])\
     {\
       jpeg_dec_pfmc_detail_log.frag_pro_exet_time[jpeg_dec_pfmc_detail_log.frag_pro_index] = 0;\
       jpeg_dec_pfmc_detail_log.frag_pro_log_start[jpeg_dec_pfmc_detail_log.frag_pro_index] = 1;\
...
{\
  ...
  {\
     if (0 == jpeg_dec_pfmc_detail_log.frag_pro_log_start[jpeg_dec_pfmc_detail_log.frag_pro_index])\
    { ASSERT(0);}\
     jpeg_dec_pfmc_detail_log.frag_pro_end_time = ust_get_current_time();\
     jpeg_dec_pfmc_detail_log.frag_pro_exet_time[jpeg_dec_pfmc_detail_log.frag_pro_index] += ust_get_duration(jpeg_dec_pfmc_detail_log.frag_pro_start_time, jpeg_dec_pfmc_detail_log.frag_pro_end_time);\
  }\
}
...
#endif  /* #if defined(__USE_DRV_GET_CURRENT_TIME__) */
