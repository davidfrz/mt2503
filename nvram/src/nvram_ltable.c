...
/*****************************************************************************
 * FUNCTION
 *  nvram_assign_table_entry
 * DESCRIPTION
 *  This function adjust and check attribute of LID.
 * PARAMETERS
 *  LID
 *  point to the ldi
 * RETURNS
...
static void nvram_assign_table_entry(nvram_lid_enum position, nvram_ltable_entry_struct* ldi)
{
    ...
    //        and don't care about data item in folder A & B  //[vincent.yu]what's different maui with sp
