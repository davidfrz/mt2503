...
/*MT6250RF*/ #define BAND_CW_LSB          (13)
/*MT6250RF*/ #define CW1_DATA_DEFAULT     (0x80000)  // CW1, DFM_LGCP_OSTOL2:1, DFM_LGCP_OSTOL:0
/*MT6250RF*/ #define CW2_DATA_RX_DEFAULT  (0x40000)  // CW2, TRX: rx, MODE: standby
/*MT6250RF*/ #define CW2_DATA_TX_DEFAULT  (0x48000)  // CW2, TRX: tx, MODE: standby
   #else
/*MT6256RF*/ #define BAND_CW_LSB          (16)
/*MT6256RF*/ #define CW1_DATA_DEFAULT     (0xC0000)  // CW1, DFM_LG_COE:1, DFM_SDM_IFM:1 
/*MT6256RF*/ #define CW2_DATA_RX_DEFAULT  (0x04000)  // CW2, TRX: rx, MODE: standby
/*MT6256RF*/ #define CW2_DATA_TX_DEFAULT  (0x44000)  // CW2, TRX: tx, MODE: standby
   #endif
...
/*MT6256RF*/
/*MT6256RF*/    // CW2, TRX: rx, BAND, MODE: standby, N_RFC[22:10]
/*MT6256RF*/    *ifN = BSI_CW( 0x02, CW2_DATA_RX_DEFAULT|(Nfrac>>10)|((rf_band-1)<<BAND_CW_LSB) );
/*MT6256RF*/    // CW1, N_INT[7:0], N_FRAC[9:0]
/*MT6256RF*/    *rfN = BSI_CW( 0x01, CW1_DATA_DEFAULT|(Nfrac&0x3FF)|(Nint<<10) );
/*MT6256RF*/
...
/*MT6256RF*/    *ifN = BSI_CW( 0x02, CW2_DATA_TX_DEFAULT|(Nfrac>>10)|((rf_band-1)<<BAND_CW_LSB) );
/*MT6256RF*/    // CW1, N_INT[7:0], N_FRAC[9:0]
/*MT6256RF*/    *rfN = BSI_CW( 0x01, CW1_DATA_DEFAULT|(Nfrac&0x3FF)|(Nint<<10) );
/*MT6256RF*/
   #if IS_CHIP_MT6250 || IS_CHIP_MT6260                                              // 130*Nfrac = (2^23)*K
/*MT6250RF*/    if( ( ( Nfrac*130 >= 234881024 ) && ( Nfrac*130 <= 301989888 ) ) ||  // (K>=28)&&(K<=36) 
/*MT6250RF*/        ( ( Nfrac*130 >= 419430400 ) && ( Nfrac*130 <= 486539264 ) ) ||  // (K>=50)&&(K<=58)
/*MT6250RF*/        ( ( Nfrac*130 >= 645922816 ) && ( Nfrac*130 <= 721420288 ) ) ||  // (K>=77)&&(K<=86)
/*MT6250RF*/        ( ( Nfrac*130 >= 956301312 ) && ( Nfrac*130 <= 1073741824) )     //(K>=114)&&(K<=128)
/*MT6250RF*/      )
/*MT6250RF*/    {  /* CW1, DFM_LGCP_IOSTPOL = 1 */
/*MT6250RF*/       *rfN |= (0x1<<18);
/*MT6250RF*/    }
   #elif IS_CHIP_MT6256_S00 || IS_CHIP_MT6251_S00
/*MT6256RF*/    /* Do nothing */
