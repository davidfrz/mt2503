...
/*****************************************************************************
 * FUNCTION
 *  srv_bootup_is_hibernation_mode
 * DESCRIPTION
 *  Is hibernation bootup. The return value will be MMI_TRUE only if hibernation resume happen.
 * PARAMETERS
 *  void
 * RETURNS
 *  MMI_TRUE if it is hibernation bootup.
 * SEE ALSO
 *  srv_bootup_get_booting_mode
 *****************************************************************************/
#if defined(__TINY_SYS__)

extern MMI_BOOL srv_bootup_is_hibernation_mode(void);
