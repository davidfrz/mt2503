...
//status icon bar
#define MMI_SMALL_SW_STATUS_ICON_BAR_WIDTH				128
#define MMI_SMALL_SW_STATUS_ICON_BAR_HEIGHT				14
//indicator
#define MMI_SMALL_SW_INDICATOR_HEIGHT					6
//content
#define MMI_SMALL_SW_CONTENT_GAP_WITH_SIDE				6
#define MMI_SMALL_SW_SCREEN_CONTENT_WIDTH				88
#define MMI_SMALL_SW_1_COLUMN_SCREEN_CONTENT_HEIGHT		102
#define MMI_SMALL_SW_2_COLUMN_SCREEN_CONTENT_HEIGHT		51
#define MMI_SMALL_SW_3_COLUMN_SCREEN_CONTENT_HEIGHT		34
#define MMI_SMALL_SW_COMMON_SCREEN_TEXT_X_OFFSET		1
//side bar
#define MMI_SMALL_SW_SIDE_BAR_BTN_WIDTH					14
#define MMI_SMALL_SW_SIDE_BAR_BTN_HEIGHT				57
#define MMI_SMALL_SW_SIDE_BAR_RIGHT_BTN_X_OFFSET		114
//9 block
#define MMI_SMALL_SW_9_BLOCK_SCREEN_LEFT_GAP			13
#define MMI_SMALL_SW_9_BLOCK_SCREEN_TOP_GAP				6
#define MMI_SMALL_SW_9_BLOCK_SCREEN_BLOCK_WIDTH			34
#define MMI_SMALL_SW_9_BLOCK_SCREEN_BLOCK_HEIGHT		34
#define MMI_SMALL_SW_9_BLOCK_CONTENT_X_OFFSET			13
#define MMI_SMALL_SW_9_BLOCK_CONTENT_Y_OFFSET			54
//list
#define MMI_ICONTEXT_COLUMN_GAP			4
#define MMI_ICONTEXT_ROW_GAP			1
//key
 ...
 *******************/
    ...
    #define MMI_STATUS_BAR_HEIGHT                       0
	#elif __MMI_MAINLCD_320X320__
	#define MMI_STATUS_BAR_HEIGHT                       0
	#elif __MMI_MAINLCD_240X320__
	#define MMI_STATUS_BAR_HEIGHT                       0
	#else
	#define MMI_STATUS_BAR_HEIGHT                       CFG_UI_STATUS_BAR_HEIGHT//14
...
//add by xl
#if defined(__MMI_WEARABLE_DEVICE__)
	#define MMI_BUTTON_BAR_HEIGHT                       0
	#define MMI_SOFTKEY_BAR_HEIGHT                      0
	#define MMI_SOFTKEY_HEIGHT							0
#if defined(__MMI_MAINLCD_240X240__)
#ifdef __MMI_WEARABLE_DEVICE_UI_ENHANCE__
	#define MMI_SW_BUTTON_BAR_HEIGHT					60
#else
	#define MMI_SW_BUTTON_BAR_HEIGHT					40
	...
	#define MMI_SW_BUTTON_BAR_HEIGHT					0
#else
	#define MMI_SW_BUTTON_BAR_HEIGHT				CFG_UI_BUTTON_BAR_HEIGHT
#endif /*__MMI_MAINLCD_240X240__*/
#else
...
#if defined(__MMI_WEARABLE_DEVICE__)
#if defined(__MMI_MAINLCD_240X240__)
#define MMI_MENUITEM_HEIGHT  		52
#define MMI_MENUITEM_TWOLINE_HEIGHT  69
#define MMI_MENUITEM_MULTIROW_HEIGHT  69
#elif defined(__MMI_MAINLCD_240X320__)
#define MMI_MENUITEM_HEIGHT  		52
#define MMI_MENUITEM_TWOLINE_HEIGHT  69
#define MMI_MENUITEM_MULTIROW_HEIGHT  69
...
#define MMI_MENUITEM_TWOLINE_HEIGHT  38
#define MMI_MENUITEM_MULTIROW_HEIGHT 38 
#else
#define MMI_MENUITEM_HEIGHT                         CFG_UI_MENUITEM_HEIGHT
...
#define MMI_MENUITEM_TOP_GAP 				17
#define MMI_MENUITEM_BOTTOM_GAP     		17
#define MMI_TWOLINE_MENUITEM_TOP_GAP		15
#define MMI_TWOLINE_MENUITEM_BOTTOM_GAP 	14
#define MMI_ICONTEXT_COLUMN_GAP				5
#define MMI_ICONTEXT_ROW_GAP				6
#ifdef __MMI_WEARABLE_DEVICE_NOTI_UI_ENHANCE__
#define MMI_TWOLINE_MENUITEM_RIGHT_TEXT_WIDTH 25 
...
#define MMI_POP_UP_DIALOG_HEIGHT                    MAIN_LCD_DEVICE_HEIGHT
#define MMI_POP_UP_DIALOG_GAP						0
#else
#define MMI_POP_UP_DIALOG_WIDTH                     MAIN_LCD_DEVICE_WIDTH
#define MMI_POP_UP_DIALOG_HEIGHT                    MAIN_LCD_DEVICE_HEIGHT
#define MMI_POP_UP_DIALOG_GAP						10
#endif
#else
...
//add by xl
#if defined(__MMI_WEARABLE_DEVICE__) &&  defined(__MMI_MAINLCD_240X240__)
#define MMI_THIN_TITLE_HEIGHT  32
#define MMI_THICK_TITLE_HEIGHT 32
#elif defined(__MMI_WEARABLE_DEVICE__) &&  defined(__MMI_MAINLCD_320X320__)
#define MMI_THIN_TITLE_HEIGHT  32
#define MMI_THICK_TITLE_HEIGHT 32
#else
...
#if defined(__MMI_WEARABLE_DEVICE__) && defined(__MMI_MAINLCD_128X128__)
		#define MMI_MULTIROW_MENUITEM_HEIGHT                (38)
#elif defined(__MMI_WEARABLE_DEVICE__) &&  defined(__MMI_MAINLCD_320X320__)		
...
/* under construction !*/
        ...
        #define MMI_INLINE_EDIT_MENUITEM_HEIGHT             (30)
		#if defined(__MMI_WEARABLE_DEVICE__)
		#define MMI_MULTIROW_MENUITEM_HEIGHT                (69)
		#else
        #define MMI_MULTIROW_MENUITEM_HEIGHT                (48)
 		#endif		
#if 0
...
/* under construction !*/
        ...
        #define MMI_ICONTEXT_MENUITEM_HEIGHT                (30)
        #define MMI_INLINE_EDIT_MENUITEM_HEIGHT             (30)
		#if defined(__MMI_WEARABLE_DEVICE__) && defined(__MMI_MAINLCD_320X320__)
		#define MMI_MULTIROW_MENUITEM_HEIGHT                (69)
		#else
        #define MMI_MULTIROW_MENUITEM_HEIGHT                (48)
		#endif /*__MMI_WEARABLE_DEVICE__*/
        ...
        #define MMI_ROTATED_TITLE_WIDTH                     (310)
        #define MMI_ROTATED_TITLE_HEIGHT                    (MMI_TITLE_HEIGHT)
...
#if defined(__MMI_MAINLCD_240X320__)  || defined(__MMI_MAINLCD_320X320__) || defined(__MMI_MAINLCD_240X240__)  ||defined(__MMI_MAINLCD_240X400__) || defined(__MMI_MAINLCD_320X240__) 
...
#define MMI_SINGLELINE_INPUTBOX_WIDTH                       (MAIN_LCD_DEVICE_WIDTH-10)
    ...
    #define MMI_SINGLELINE_INPUTBOX_HEIGHT                  (7)
...
#define MMI_HORIZONTAL_TAB_BAR_WIDTH                        (MMI_TITLE_WIDTH)
    ...
    #elif (defined(__MMI_MAINLCD_240X400__) || defined(__MMI_MAINLCD_320X320__) || defined(__MMI_MAINLCD_240X240__) || defined(__MMI_MAINLCD_240X320__) || defined(__MMI_MAINLCD_320X240__))
...
#define MMI_DROPDOWN_MENUITEM_HEIGHT                        (18)
    ...
    #if defined(__MMI_MAINLCD_240X320__)  || defined(__MMI_MAINLCD_240X240__) || defined(__MMI_MAINLCD_320X320__)  || defined(__MMI_MAINLCD_240X400__)  || defined(__MMI_MAINLCD_320X240__) 
