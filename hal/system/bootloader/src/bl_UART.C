...
34909,	12800, 3200,  1600, 800,  400, 200, 100, 67, 33};
   ...
   34909,  12800, 3200,  1600, 800,  400, 200, 100, 67, 33};
#elif (defined(MT6276_S01)||defined(MT6276)|| defined(MT6256))
   29544,  10834, 2708,  1352, 676,  340, 168, 84, 56, 28};
#elif defined(MT6251)
   44318,  16250, 4063,  2031, 1015,  507, 254, 127, 84, 42};
#else
//#if ( defined(MPLL_52MHZ) || defined(MPLL_104MHZ) )
#if ( defined(MCU_52M) || defined(MCU_104M)  || defined(MCU_208M) || defined(MCU_312M)||defined(MCU_512M))
   29544,  10834, 2708,  1352, 676,  340, 168, 84, 56, 28};
...
//#ifndef __SV5_ENABLED__
   ...
   UART_WriteReg(UART1_DLL, 0x1);  
   UART_WriteReg(UART1_DLH, 0x0);
   #else 
 ...
 #if defined(__DUAL_TALK_MODEM_SUPPORT__)
  UART_WriteReg(UART1_SPEED, 0x3);
  UART_WriteReg(UART1_SAMPLE_COUNT, 0x21);
  UART_WriteReg(UART1_SAMPLE_POINT, 0x11);
