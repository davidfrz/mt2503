...
#if  defined(__UPDATE_BINARY_FILE__) && !defined(__MBA_CUST_ONLY__)
void* custpack2ndJumpTbl[] = 
{
    ...
    (void *)0,
#ifndef EMPTY_MMI
	 (void *)0, //CUSTPACK_AUTOGEN_AUDIO
#else
    (void *)0,
#endif
	(void *)&custpack_nvram_ptr, 	//CUSTPACK_NVRAM
#if defined (WAP_SUPPORT) || defined (__CERTMAN_SUPPORT__)
     (void *)0, 	    /* CUSTPACK_ROOT_CA */
#else
    (void *)0,
#endif /* WAP_SUPPORT */ 
#ifdef __J2ME__
    (void *)0,	    /* CUSTPACK_JAVA_CA */
#else /* !__J2ME__ */
    (void *)0,
#endif /* __J2ME__ */
#if !defined(EMPTY_MMI)&& !defined(__MMI_UI_DISPLAY_LEVEL_NONE__)
    (void *)0,  /* for XML-based theme,CUSTPACK_VENUS_THEME , like Cosmos theme, etc. */
#else
    (void *)0,
#endif
	(void *)0						//CUSTPACK_VAR
...
#endif /* __J2ME__ */
#if !defined(EMPTY_MMI)&& !defined(__MMI_UI_DISPLAY_LEVEL_NONE__)
    (void *)&g_mmi_res_theme_system_data,   /* for XML-based theme,CUSTPACK_VENUS_THEME , like Cosmos theme, etc. */
#else
    (void *)0,
#endif
	(void *)0						//CUSTPACK_VAR
