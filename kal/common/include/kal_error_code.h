...
X_KAL_ERROR(KAL_ERROR_BUFFMNGR_GETBUFF_HEADER_CORRUPTED,                         kal_get_buffer___pm_header_is_corrupted)
/* 3. free */
...
X_KAL_ERROR(KAL_ERROR_BUFFMNGR_RELEASEBUFF_HEADER_CORRUPTED,                     kal_release_buffer___pm_header_is_corrupted)
/* 4. guard pattern */
...
X_KAL_ERROR(KAL_ERROR_DIV_BY_0_FAILED,                                           divide_by_zero)
...
X_KAL_ERROR(KAL_ERROR_DCM_PROC_FAILED,                                           dcm_process_failed)
X_KAL_ERROR_ASSIGN(KAL_ERROR_DCMGR_INVALID_CODE_ID,                     0x0b40,  dcmgr_invalid_code_id)
X_KAL_ERROR(KAL_ERROR_DCMGR_POOL_NOT_EXISTING,                                   dcmgr_pool_not_existing)
X_KAL_ERROR(KAL_ERROR_DCMGR_GROUP_NOT_EXISTING,                                  dcmgr_group_not_existing)
X_KAL_ERROR(KAL_ERROR_DCMGR_POOL_OCCUPIED,                                       dcmgr_pool_occupied)
X_KAL_ERROR(KAL_ERROR_DCMGR_REGION_NOT_LOADED,                                   dcmgr_region_not_loaded)
