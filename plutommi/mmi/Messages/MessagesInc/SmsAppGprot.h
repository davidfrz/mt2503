...
#if defined(__MMI_ICON_BAR_SUPPORT__) && !defined(__MMI_WEARABLE_DEVICE__)
#ifndef __MMI_SMS_ICON_BAR_SUPPORT__
#define __MMI_SMS_ICON_BAR_SUPPORT__
#endif /*__MMI_SMS_CUI_ICON_BAR_SUPPORT__*/
#endif /*defined(__MMI_ICON_BAR_SUPPORT__) && !defined(__MMI_WEARABLE_DEVICE__)*/
...
#if (defined(__MMI_FTE_SUPPORT__) && defined(__UM_SUPPORT__))
/*****************************************************************************
 * FUNCTION
