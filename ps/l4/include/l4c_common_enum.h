...
/* under construction !*/
    ...
    GPS_POWER_ON_EXE,
    GPS_POWER_OFF_EXE,
    GPS_SET_START_MODE_EXE,
    GPS_GET_CUR_SENTENCE_EXE,
    GPS_SET_PARAM_EXE,  //Yuhua
#endif
#if defined(__GPRS_TCPIP_AT_SUPPORT__) || defined(__WIFI_TCPIP_AT_SUPPORT__)
    TCPIP_GET_ACCOUNT,
    TCPIP_SET_ACCOUNT,
    TCPIP_GET_ACCOUNT_STATE,
    TCPIP_DEACT_ACCOUNT,
    TCPIP_ACT_ACCOUNT,
    TCPIP_CLOSE_SOCKET,
    TCPIP_CREATE_SCOKET,
    TCPIP_QUERY_SOCKET_PARA,
    TCPIP_QUERY_SOCKET_STATISTIC,
    TCPIP_SEND_DATA,
    TCPIP_RECV_DATA,
    TCPIP_DNS,
    TCPIP_SERVER_LAUNCH,
    ...
    TCPIP_WIFI_ACT,
    TCPIP_WIFI_DEACT,
    TCPIP_WIFI_GET_STATE,
#endif
#if defined(__WIFI_SCAN_ONLY_AT_CMD__) 
    TCPIP_WIFI_SET_MODE,
    TCPIP_WIFI_SCAN,
#endif
    #ifdef __BCM_AT_CMD__
