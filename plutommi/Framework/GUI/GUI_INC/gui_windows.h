 ...
 *  void
 *****************************************************************************/
extern void gui_set_pop_up_description_theme(
 ...
 *  void
 *****************************************************************************/
extern void gui_create_pop_up_description(
	UI_pop_up_description *b, 
	S32 x, 
	S32 y, 
	S32 width, 
 ...
 *  void
 *****************************************************************************/
extern void gui_resize_pop_up_description(
	UI_pop_up_description *b, 
	S32 width, 
	S32 height);
 ...
 *  void
 *****************************************************************************/
extern void gui_move_pop_up_description(
	UI_pop_up_description *b, 
	S32 x, 
	S32 y);
 ...
 *  void
 *****************************************************************************/
extern void gui_set_pop_up_description(
	UI_pop_up_description *b, 
	S32 x, 
	S32 y, 
	S32 width, 
 ...
 *  void
 *****************************************************************************/
extern void gui_set_pop_up_description_n_strings(
	UI_pop_up_description *b, 
	S32 n);
 ...
 *  void
 *****************************************************************************/
extern void gui_set_pop_up_description_text(
	UI_pop_up_description *b, 
	S32 i, 
	UI_string_type text);
 ...
 *****************************************************************************/
extern U8 gui_autoresize_pop_up_description(
	UI_pop_up_description *b, 
	S32 width, 
	S32 height);
...
#else
#define gui_pop_up_description_stop_scroll()
#ifdef __MMI_UI_HINT_TOGGLE_TRANSITION__
#define gui_setup_pop_up_description_transition(_arg)
#define gui_reset_pop_up_description_transition(_arg)
#define gui_reset_pop_up_description_transition_ex(_arg)
#endif/*__MMI_UI_HINT_TOGGLE_TRANSITION__*/ 
 ...
 *  void
 *****************************************************************************/
extern void default_scrolling_text_draw_background(
	S32 x1, 
	S32 y1, 
	S32 x2, 
	S32 y2);
 ...
 *  void
 *****************************************************************************/
extern void gui_change_scrolling_text_font(
	scrolling_text *s, 
	UI_font_type font);
 ...
 *  void
 *****************************************************************************/
extern void gui_change_scrolling_text(
	scrolling_text *s, 
	UI_string_type text);
 ...
 *  void
 *****************************************************************************/
extern void gui_layer_transparent(
	S32 gui_show_layer, 
	U8 trans_value, 
	S32 x1, 
	S32 y1, 
 ...
 *  
 *****************************************************************************/
extern gui_wait_longpress_enum gui_pen_wait_longpress(
