        ...
        U8 *history_buffer)
{
    ...
    gui_set_single_line_input_box_theme(&MMI_singleline_inputbox, &PIN_singleline_inputbox_theme);
        ...
        gui_set_multi_line_input_box_theme(&MMI_multiline_inputbox_singleline, &PIN_singleline_inputbox_theme);
...
static void wgui_cat2001_redraw_counter(void)
{
    ...
    S32 editor_y = MMI_multiline_inputbox.y;   
    #else /*__MMI_MULTILINE_INPUT_BOX_SINGLINE_STYLE_WITH_FTE__*/
    S32 editor_y = MMI_multiline_inputbox_singleline.y;   
    #endif/*__MMI_MULTILINE_INPUT_BOX_SINGLINE_STYLE_WITH_FTE__*/
#endif /*__MMI_EDITOR_SINGLINE_SUPPORT__*/ 
...
void wgui_cat2001_redraw_information_bar(void)
{
    ...
    S32 panel_h = 0;
        ...
        S32 editor_height = MMI_multiline_inputbox.height;
        #else /*__MMI_MULTILINE_INPUT_BOX_SINGLINE_STYLE_WITH_FTE__*/
        S32 editor_x =      MMI_multiline_inputbox_singleline.x;   
        S32 editor_y =      MMI_multiline_inputbox_singleline.y;    
        S32 editor_width =  MMI_multiline_inputbox_singleline.width; 
        S32 editor_height = MMI_multiline_inputbox_singleline.height;        
        #endif/*__MMI_MULTILINE_INPUT_BOX_SINGLINE_STYLE_WITH_FTE__*/        
#endif /*__MMI_EDITOR_SINGLINE_SUPPORT__*/ 
    /*----------------------------------------------------------------*/
    /* Code Body                                                      */
...
void wgui_cat2001_get_inputbox_coordinate(wgui_cat_inputbox_coordinate_struct *inputbox)
{
    ...
    #else /*__MMI_MULTILINE_INPUT_BOX_SINGLINE_STYLE_WITH_FTE__*/
    inputbox->x = MMI_multiline_inputbox_singleline.x;
    inputbox->y = MMI_multiline_inputbox_singleline.y;
    inputbox->width = MMI_multiline_inputbox_singleline.width;
    inputbox->height = MMI_multiline_inputbox_singleline.height;    
    #endif/*__MMI_MULTILINE_INPUT_BOX_SINGLINE_STYLE_WITH_FTE__*/
#endif /*__MMI_EDITOR_SINGLINE_SUPPORT__*/     
}
...
static U32 wgui_cat2001_editor_msg_callback(void * input_box_handle, mmi_imc_message_struct_p msg_ptr)
{
    ...
    #else /*__MMI_MULTILINE_INPUT_BOX_SINGLINE_STYLE_WITH_FTE__*/
        if (editor_ptr == &MMI_multiline_inputbox_singleline)
    #endif/*__MMI_MULTILINE_INPUT_BOX_SINGLINE_STYLE_WITH_FTE__*/
#endif /*__MMI_EDITOR_SINGLINE_SUPPORT__*/        
    {
#ifdef __MMI_CATEGORY2001_PANEL_SUPPORT__
        ...
        U32 category_flags)
{
...
#ifndef __MMI_EDITOR_SINGLINE_SUPPORT__ 
    #ifndef __MMI_MULTILINE_INPUT_BOX_SINGLINE_STYLE_WITH_FTE__ 
    multi_line_input_box *multiline_editor = &MMI_multiline_inputbox;
    #else /*__MMI_MULTILINE_INPUT_BOX_SINGLINE_STYLE_WITH_FTE__*/
    multi_line_input_box *multiline_editor = &MMI_multiline_inputbox_singleline;
    #endif/*__MMI_MULTILINE_INPUT_BOX_SINGLINE_STYLE_WITH_FTE__*/
#endif /*__MMI_EDITOR_SINGLINE_SUPPORT__*/
    /*----------------------------------------------------------------*/
    /* Code Body                                                      */
    ...
    if ((history_buffer == NULL) || (category_flags & WGUI_CAT2001_HIGHLIGHT_TEXT))
    {   
        multiline_editor->flags |= UI_MULTI_LINE_INPUT_BOX_WORD_HIGHLIGHT ;
        multiline_editor->ext2_flags |= UI_MULTI_LINE_INPUT_BOX_AUTO_CLEAR_HIGHLIGHT_MODE; 
    }
    multiline_editor->highlight_start_position = buffer;
    multiline_editor->highlight_end_position = buffer + buffer_size;
            
    #ifndef __MMI_FTE_SUPPORT__
        multiline_editor->text_x = 1;
        gui_set_multi_line_input_box_theme(multiline_editor, &g_wgui_cat2001_singleline_inputbox_theme);
    #endif /* __MMI_FTE_SUPPORT__ */ 

    #ifndef __MMI_FTE_SUPPORT__ 
    {
        multiline_editor->text_y = 0;
    }
    #endif
#endif /*__MMI_EDITOR_SINGLINE_SUPPORT__*/ 
...
#else /* __MMI_EDITOR_SINGLINE_SUPPORT__ */
    editor_x =      multiline_editor->x;   
    editor_y =      multiline_editor->y;    
    editor_width =  multiline_editor->width; 
    editor_height = multiline_editor->height;
#endif /*__MMI_EDITOR_SINGLINE_SUPPORT__*/ 
...
#else /* __MMI_EDITOR_SINGLINE_SUPPORT__ */
                    multiline_editor->flags |= (UI_MULTI_LINE_INPUT_BOX_STATE_DISABLED | UI_MULTI_LINE_INPUT_BOX_DISABLE_CURSOR_DRAW);                    
#endif /*__MMI_EDITOR_SINGLINE_SUPPORT__*/ 
...
#else /* __MMI_EDITOR_SINGLINE_SUPPORT__ */
        multiline_editor->change_callback = wgui_cat2001_change_callback;
#endif /*__MMI_EDITOR_SINGLINE_SUPPORT__*/ 
