...
CONST_HARDWARE color PIN_inputbox_selected_text_color_defaultTheme={0,0,0,100};

CONST_HARDWARE color PIN_inputbox_selector_color_defaultTheme={255,255,255,100};
