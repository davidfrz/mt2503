...
extern void wgui_watch_progress_bar_create(gui_watch_progress_bar_struct *instance,
        U16 x,
        U16 y,
        U16 max_value,
        U16 level_value);
extern void wgui_watch_progress_bar_draw(gui_watch_progress_bar_struct instance);
