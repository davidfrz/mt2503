...
mmi_pen_hdlr mmi_clog_vr_entry_options_long_tap_hdlr(mmi_pen_point_struct pos)
{

	g_mmi_clog_vr_scrn_data.key_tbl->hdlr[MMI_CLOG_KEY_LSK]();
}
#endif
...
/* under construction !*/
		...
		wgui_register_pen_long_tap_handler(mmi_clog_vr_entry_options_long_tap_hdlr);
#endif
