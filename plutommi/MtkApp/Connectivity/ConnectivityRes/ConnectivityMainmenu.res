 ...
 * $Log$
 *
 * 06 16 2016 baohua.ye
 * [MAUI_03556433] [2503AE] for 2503AE Check in
 * display connectivity BT menu.
 *
...
#endif
#if defined(__MMI_BT_SUPPORT__) && !defined(__MMI_VUI_3D_MAINMENU__) && (defined(__MMI_WEARABLE_DEVICE__) || !defined(__MMI_APP_MANAGER_SUPPORT__)||defined(__MMI_LAUNCHER_APP_LIST__))
