...
typedef enum
{
    SRV_AVRCP_CONNECTIVITY_CONNECTED = 1,               /* connected */
    SRV_AVRCP_CONNECTIVITY_CONNECT_FAIL,                /* connected */
    SRV_AVRCP_CONNECTIVITY_DISCONNECTED,                /* disconnected */
    SRV_AVRCP_CONNECTIVITY_DISCONNECT_FAIL,             /* connected */
} srv_avrcp_connectivity_notify_result;
...
typedef void(*srv_avrcp_cmd_cnf_callback) (srv_bt_cm_bt_addr *dev_addr, U16 op_code, U16 command_type, MMI_BOOL key_press);
typedef void(*srv_avrcp_connectivity_notify_hdlr) (srv_bt_cm_bt_addr *dev_addr, srv_avrcp_connectivity_notify_result);
typedef void(*srv_avrcp_cm_callback) (srv_bt_cm_bt_addr *dev_addr, srv_bt_cm_connection_type conn_type, MMI_BOOL result, MMI_BOOL is_connect, MMI_BOOL is_indicate);
/***************************************************************************** 
* Functions
*****************************************************************************/
 ...
 *  void
 *****************************************************************************/
extern void srv_avrcp_connect_from_cm(srv_bt_cm_bt_addr *dev_addr, srv_avrcp_cm_callback cb_ptr);
 ...
 *  void
 *****************************************************************************/
extern void srv_avrcp_disconnect_from_cm(srv_bt_cm_bt_addr *dev_addr, srv_avrcp_cm_callback cb_ptr);
 ...
 *  void
 *****************************************************************************/
extern void srv_avrcp_connect_ct_req(srv_bt_cm_bt_addr *dev_addr, srv_avrcp_connectivity_notify_hdlr cb_ptr);
 ...
 *  void
 *****************************************************************************/
extern void srv_avrcp_connect_tg_req(srv_bt_cm_bt_addr *dev_addr, srv_avrcp_connectivity_notify_hdlr cb_ptr);
 ...
 *  void
 *****************************************************************************/
extern void srv_avrcp_connect_req(U8 role, srv_bt_cm_bt_addr *dev_addr, srv_avrcp_connectivity_notify_hdlr cb_ptr);
 ...
 *  void
 *****************************************************************************/
extern void srv_avrcp_connect_tg_req_from_a2dp(srv_bt_cm_bt_addr *dev_addr, srv_avrcp_connectivity_notify_hdlr cb_ptr);
 ...
 *  void
 *****************************************************************************/
extern void srv_avrcp_connect_ct_req_from_a2dp(srv_bt_cm_bt_addr *dev_addr, srv_avrcp_connectivity_notify_hdlr cb_ptr);
 ...
 * DESCRIPTION
 *  disconnect AVRCP ct request
 * PARAMETERS
 *  dev_addr        :           [IN] device address to connect
 * RETURNS
 *  void
 *****************************************************************************/
extern void srv_avrcp_disconnect_ct_req(srv_bt_cm_bt_addr *dev_addr);
 ...
 * DESCRIPTION
 *  connect AVRCP ct request
 * PARAMETERS
 *  cmgr_id        :           [IN] cmgr id
 * RETURNS
 *  void
 *****************************************************************************/
extern void srv_avrcp_disconnect_ct_tg_req(U32 cmgr_id);
 ...
 *  void
 *****************************************************************************/
extern void srv_avrcp_disconnect_req(srv_bt_cm_bt_addr *dev_addr);
 ...
 *  void
 *****************************************************************************/
extern void srv_avrcp_disconnect_from_a2dp(srv_bt_cm_bt_addr *dev_addr, MMI_BOOL set);
 ...
 *  void
 *****************************************************************************/
extern void srv_avrcp_disconnect_tg_req(srv_bt_cm_bt_addr *dev_addr);
 ...
 *  void
 *****************************************************************************/
extern void srv_avrcp_set_cmd_frame_cnf_hdlr(srv_bt_cm_bt_addr *dev_addr, srv_avrcp_cmd_cnf_callback callback_func);
 ...
 *  U8
 *****************************************************************************/
extern U8 srv_avrcp_get_role(srv_bt_cm_bt_addr *dev_addr);
 ...
 *  void
 *****************************************************************************/
extern void srv_avrcp_set_role(srv_bt_cm_bt_addr *dev_addr, U8 role);
 ...
 * DESCRIPTION
 *  To check avrcp is connected or not
 * PARAMETERS
 *  MMI_BOOL    [IN]
 * RETURNS
 *  void
 *****************************************************************************/
extern MMI_BOOL srv_avrcp_is_avrcp_connected(srv_bt_cm_bt_addr *dev_addr);
 ...
 * FUNCTION
 *  SRV_AVRCP_BT_DIALER_TG_CMD_CALLBACK
 * DESCRIPTION: 
 * This function is used for BT music to handle command sent from tg bt dialer device
 * PARAMETERS
 ...
 * MMI_BOOL
 *****************************************************************************/
typedef MMI_BOOL(*SRV_AVRCP_BT_DIALER_TG_CMD_CALLBACK)(srv_bt_cm_bt_addr *dev_addr, U8 command_type, srv_avrcp_key_events key_events);


/*****************************************************************************
 * FUNCTION
 * srv_avrcp_register_bt_dialer_tg_cmd_callback
 * DESCRIPTION: 
 * Application should register the above callback function using this interface
 * to handle command sent from bt dialer tg device
 * PARAMETERS
 *  dev_addr        :       [IN] device address
 *  cb_ptr          :       [IN] callback
 * RETURNS
 *  U8
 *****************************************************************************/
extern void srv_avrcp_register_bt_dialer_tg_cmd_callback(SRV_AVRCP_BT_DIALER_TG_CMD_CALLBACK cb_ptr);
...
typedef enum 
{
    ...
    SRV_AVRCP_NOTIFICATION_CALLBACK_PARAMETER_ERR,
...
* void
 *****************************************************************************/
typedef void(*srv_avrcp_notification_hdlr)(srv_bt_cm_bt_addr *dev_addr, srv_avrcp_event_enum notify_event_id, srv_avrcp_result_union result);


/*****************************************************************************
* FUNCTION
 * srv_avrcp_register_notification_hdlr
* DESCRIPTION: 
* Application should register the above callback function using this interface
...
*  U8
 *****************************************************************************/
extern U8 srv_avrcp_register_notification_hdlr(srv_bt_cm_bt_addr *dev_addr, srv_avrcp_notification_hdlr cb_ptr);
 ...
 *****************************************************************************/
extern U8 srv_avrcp_get_play_status_req(srv_bt_cm_bt_addr *dev_addr);
 ...
 *****************************************************************************/
extern void srv_avrcp_get_elements_attr_request(srv_bt_cm_bt_addr *dev_addr);
 ...
 * RETURNS
 *  void
 * will be phased later in BTD3.0
 *****************************************************************************/
 ...
 *  void
 *****************************************************************************/
extern void srv_avrcp_send_cmd_frame(srv_bt_cm_bt_addr *dev_addr, S32 cmd_frame);
